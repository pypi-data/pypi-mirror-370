...
class EventTypes(enum.Enum):
    SAB_LOAN_REPAYMENTS_LRR = 'sab/loan_repayments/lrr' # overdue payments
    SAB_LOAN_REPAYMENTS_LNF = 'sab/loan_repayments/lnf' # early settlement
    SAB_LOAN_REPAYMENTS_PRR = 'sab/loan_repayments/prr' # refunds


LS_EVENTS = [
    EventTypes.SAB_LOAN_REPAYMENTS_LRR.value,
    EventTypes.SAB_LOAN_REPAYMENTS_LNF.value,
    EventTypes.SAB_LOAN_REPAYMENTS_PRR.value,
]
