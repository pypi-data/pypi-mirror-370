...
import pyprocessors_opennre


# -- Project information -----------------------------------------------------

project = "pyprocessors_opennre"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_opennre.__version__
release = pyprocessors_opennre.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_opennre.__file__)
