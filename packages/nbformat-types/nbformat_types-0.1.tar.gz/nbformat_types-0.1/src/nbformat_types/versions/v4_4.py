...
class _CodeCellMetadata(TypedDict, total=False):
    ...
    execution: Union[dict[str, str], "_CodeCellMetadataExecutionTyped"]
    """
...
_CodeCellMetadataExecutionTyped = TypedDict('_CodeCellMetadataExecutionTyped', {
