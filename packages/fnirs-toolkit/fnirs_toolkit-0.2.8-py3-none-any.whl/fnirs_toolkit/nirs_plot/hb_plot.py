...
def hb_heatmap(channel_df, data_df, file_name, signal_type="oxy", 
...
def hb_region_plot(region_df, file_name, output_path, title=None, mode='oxy', path_corrected=False):
    """
