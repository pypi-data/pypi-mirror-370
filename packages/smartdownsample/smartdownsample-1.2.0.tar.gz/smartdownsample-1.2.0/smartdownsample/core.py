...
def sample_diverse(
    ...
    if show_progress:
        print(f"Using diversity-first sampling across {len(buckets)} buckets")
    ...
    # Phase 2: Use remaining quota to fill up buckets (largest first)
    if remaining_quota > 0:
        for i, (bucket_key, indices) in enumerate(bucket_list):
            ...
            if available_in_bucket > 0:
                # Take more from this bucket
                take_additional = min(available_in_bucket, remaining_quota)
        ...
        for bucket_idx, (bucket_key, indices) in enumerate(bucket_list):
            ...
            if available_in_bucket > 0:
                ...
                if take_additional > 0:
                    ...
                    bucket_stats[bucket_idx]['phase'] = 'diversity+fill'
