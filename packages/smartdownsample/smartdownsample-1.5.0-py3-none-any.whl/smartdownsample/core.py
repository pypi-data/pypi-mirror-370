...
def sample_diverse(
    ...
    # Use bits spread across hash for better visual similarity detection
    n_bucket_bits = 4  # Always use 4 bits = 16 buckets max
    bucket_keys = []
    ...
    if show_progress:
        ...
        print(f"Using hash bit indices: {bit_indices} from {total_bits} total bits")
