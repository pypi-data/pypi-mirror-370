...
def sample_diverse(
    ...
    for features in hashes:
        ...
        # 2 center structure + 1 brightness + 1 color + 1 overall_brightness = 5 dimensions
        # Max buckets: 2^2 × 2^1 × 2 × 2 = 4 × 2 × 2 × 2 = 32 buckets
    ...
    if show_progress:
        ...
        print(f"Features: center structure (2 bits) + brightness pattern (1 bit) + color type (2 levels) + brightness level (2 levels)")
