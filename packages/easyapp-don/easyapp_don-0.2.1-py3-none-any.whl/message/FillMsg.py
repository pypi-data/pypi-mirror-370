...
qu=queue.Queue()
class FillMsg(MDApp):
    def __init__(self, ts=None, tie="FillMsgEasyapp",theme=LIGHT,color=WHITE12,ok=None,cal=None,tip=None,fs=None,**kwargs):
        ...
        if ts is None:
            ts = [["Text1", (0.7, 0.7)],
                  ["Text2", (0.7, 0.5)],
                  ["Text3", (0.7, 0.3)],
                  ["Hello,easyapp-lazydonkey!", (0.5, 0.2)]]
    ...
    def on_space(self,instance):
        pass
def fillmsg(ts=None, tie="FillMsgEasyapp",theme=LIGHT,color=WHITE12,ok=None,cal=None,tip=None,fs=None) -> list:
    """
    ...
    :param tie: Page title
               Example: "Survey Form"
    :type tie: str
    :param theme: Page theme, there are 2 options: LIGHT and DARK. You need to import easyapp-lazydonkey.tools.colors to get them.
               Example: LIGHT
    :type theme: str
    :param color: Page background color. You need to import easyapp-lazydonkey.tools.colors to get color variables,
    ...
    :param ok: OK button configuration. It is a list in the format:
               ...
               - ok_color: Button background color (from easyapp-lazydonkey.tools.colors)
