...
qu=queue.Queue()
class BtnApp(MDApp):
    def __init__(self, t=None, tie="BtnEasyapp", theme=LIGHT, color=WHITE12,bs=None, tip=None,**kwargs):
    ...
    def on_space(self,instance):
        pass
def btn(t=None, tie="BtnEasyapp", theme=LIGHT, color=WHITE12,bs=None, tip=None) -> Optional[int] :
    """
