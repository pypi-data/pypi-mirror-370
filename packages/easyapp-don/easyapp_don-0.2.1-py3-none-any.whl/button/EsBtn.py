...
class EsBtnApp(MDApp):
    def __init__(self, ts=None, tie="EsBtnEasyapp", color=WHITE12, theme=LIGHT,tip=None, bs=None, **kwargs):
    ...
    def on_space(self,instance):
        pass
def esbtn(ts=None, tie="EsBtnEasyapp", color=WHITE12, theme=LIGHT,tip=None, bs=None) -> Optional[int] :
    """
        ...
        :type ts: list
        :param tie: Page title.Example:"Easyapp title"
        :type tie: str
        :param theme: Page theme, only LIGHT and DARK are available. You need to import easyapp-lazydonkey.tools.colors to get the colors.
                Example: LIGHT
        :type theme: str
        :param color: Page background color.
        You also need to import easyapp-lazydonkey.tools.colors to get color variables,
