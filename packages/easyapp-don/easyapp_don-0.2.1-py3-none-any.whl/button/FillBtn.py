...
class FillBtnApp(MDApp):
    def __init__(self, ts=None, tie="FillBtnEasyapp", theme=LIGHT, color=WHITE12, tip=None,bs=None, fs=None, **kwargs):
    ...
    def on_space(self,instance):
        pass
def fillbtn(ts=None, tie="FillBtnEasyapp", theme=LIGHT, color=WHITE12, tip=None,bs=None, fs=None) -> list:
    """
