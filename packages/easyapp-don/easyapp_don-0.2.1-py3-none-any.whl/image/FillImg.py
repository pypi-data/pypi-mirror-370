...
class FillImgApp(MDApp):
    def __init__(self, ts=None, tip=None, tie="FillImgEasyapp", color=WHITE12, theme=LIGHT,ok=None, cal=None,fs=None, i=None,**kwargs):
    ...
    def on_space(self,instance):
        pass
def fill_img(ts=None, tip=None, tie="FillImgEasyapp", color=WHITE12,
