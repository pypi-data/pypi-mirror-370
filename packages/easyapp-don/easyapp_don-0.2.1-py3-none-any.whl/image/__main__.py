if __name__ == '__main__':
    ...
    print("\n\n\n\n\n\n-------------------------------------MainDemo----------------------------------------")
    print("---------------------------------------Demo easyapp-lazydonkey.image start-----------------------------------")
    print("\n-------------------------------------demo img()--------------------------------------------------")
    a = img()
    print(f"\n\n\n\n\n\n------------------------------Page1 return: {a}-------------------------------------------------\n\n\n\n\n\n")
    b = img(i=[["images/sky.png",(1,1),(0.5,0.5),0.6]],
            ...
            color=PINK10,
            tip={"ok":[]},
            tie="Welcome to easyapp-lazydonkey.image's img() class!")
    print(f"\n\n\n\n\n\n----------------------------------Page2 return: {b}----------------------------------------------------------")
    ...
    d = btn_img(ts=[[f"Page3 return:\n {c}",(0.5,0.5)]],
                ...
                tie="Welcome to easyapp-lazydonkey.image's btn_img() class!",
    ...
    f = fill_img(ts=[[f"Page5 return: \n{e}",(0.5,0.5)]],
                 tie="Welcome to easyapp-lazydonkey.image's fill_msg() class!",
    ...
    h = fill_btn_img(ts=[[f"Page7 return: \n{g}",(0.5,0.5)]],
                     ...
                     fs=[],
                     tie="Welcome to easyapp-lazydonkey.image's fill_btn_img() class!")
    print(f"\n\n\n\n\n\n--------------------------------Page8 return: {h}------------------------------------------")
    print("-------------------------------------------demo fill_btn_img() was successful-----------------------------------------")
    print("\n-----------------------------------easyapp-lazydonkey.image demo end----------------------------------------------")
    print("-----------------------------------demo easyapp-lazydonkey.images MainDemo was successful--------------------------------------------")