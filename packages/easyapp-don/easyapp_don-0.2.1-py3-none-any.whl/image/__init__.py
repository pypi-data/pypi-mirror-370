...
- **Example**:
  ```python
  from easyapp-lazydonkey.image import img
  # Basic usage
  result = img()
  # Customized usage
  result = img(
...
- **Parameters**:
  ...
  - `tie`: Window title (default: "ImgEasyapp")
...
- **Example**:
  ```python
  from easyapp-lazydonkey.image import fill_img
  result = fill_img(
...
- **Example**:
  ```python
  from easyapp-lazydonkey.image import btn_img
  result = btn_img(
...
- **Example**:
  ```python
  from easyapp-lazydonkey.image import fill_btn_img
  result = fill_btn_img(
...
1. **Colors and Themes**:
   - Color parameters (e.g., "BLUE8", "GREY4") are imported from `easyapp-lazydonkey.tools.colors`.
   - Theme parameters ("LIGHT"/"DARK") are imported from `easyapp-lazydonkey.tools.Manner`.
