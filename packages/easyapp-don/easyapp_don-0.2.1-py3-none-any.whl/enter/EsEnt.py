...
class EsEntApp(MDApp):
    def __init__(self, ts=None, es=None, ok=None,cal=None, tie="EsEntEasyapp", theme=LIGHT, color=WHITE12,tip=None, **kwargs):
        ...
        if ts is None:
            ts = [["Hello,easyapp-lazydonkey!", (0.5, 0.9)],
                  ["Text1", (0.2, 0.7)],
                  ["Text2", (0.2, 0.5)],
                  ["Text3", (0.2, 0.3)]]
    ...
    def on_space(self,instance):
        pass
def esent(ts=None, es=None, ok=None,cal=None, tie="EsEntEasyapp", theme=LIGHT, color=WHITE12,tip=None):
    """
    ...
    Parameters:
        ...
        tie (str): Title of the application window. Defaults to "EsEntEasyapp".
