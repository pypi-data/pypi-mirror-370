...
def pages(page=None):
    ...
    If you need image functionality, please import the img_pages() function from easyapp-lazydonkey.supermarket.imgbooks.Imgbook.
    ...
    "ts": [
    ["Hello, easyapp-lazydonkey!", (0.5, 0.9)], # This is page content. The first part is text content, the second is position. If you don't want to write the position, you can omit it, and it will default to the center.
    ["Text1", (0.1, 0.65)],
    ["Text2", (0.5, 0.65)],
    ["Text3", (0.9, 0.65)],
    ["1/1", (0.5, 0.05)]
