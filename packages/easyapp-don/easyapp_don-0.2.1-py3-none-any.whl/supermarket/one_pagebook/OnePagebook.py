...
class OnePageApp(MDApp):
    def __init__(self, ts=None, tip=None, color=WHITE12, theme=LIGHT, tie="OnePageEasyapp",
    ...
    def on_bi(self,bi_idx):
        ...
        qu.put(self.res)
        self.stop()
def page(ts=None, tip=None, color=WHITE12, theme=LIGHT, tie="OnePageEasyapp",
