...
class FillBtnImgApp(MDApp):
    def __init__(self, ts=None, tip=None, color=WHITE2, theme=LIGHT, tie="FillBtnImgEasyapp",
        ...
        if i is None:
            i = [["images/easyapp-lazydonkey.png", (1, 1), (0.5, 0.5), 0.6]]
        if cal is None:
        ...
        if tip is None:
            tip = {"txt": "Close app?",
                   ...
                   "cal": ["No", BLUE8]}
        if ts is None:
            ts = [["Hello,easyapp-lazydonkey!", (0.5, 0.95)],
                  ["Text a", (0.5, 0.75)],
                  ["Text b", (0.5, 0.55)],
                  ["Text c", (0.5, 0.35)]]
        self.ts=fill_ts(ts)
    ...
    def on_bi(self,bi_idx):
        ...
        qu.put(self.res)
        self.stop()
def fill_btn_img(ts=None, tip=None, color=WHITE2, theme=LIGHT, tie="FillBtnImgEasyapp",
    ...
    """
        ...
        :param ts: Configuration for text labels. Each sublist defines a text label's content and position.
            ...
            - Default: `[["Hello,easyapp!", (0.5, 0.95)], ["Text a", (0.5, 0.75)], ["Text b", (0.5, 0.55)], ["Text c", (0.5, 0.35)]]`
        ...
        :param color: Background color of the app screen. Uses color constants from `easyapp.tools.colors`.
            - Default: `WHITE2`
        :type color: Optional[str]

        :param theme: App theme style (`LIGHT` or `DARK`). Uses theme constants from `easyapp.tools.Manner`.
            - Default: `LIGHT`
        :type theme: Optional[str]

        :param tie: Title of the app window.
            - Default: `"FillBtnImgEasyapp"`
        :type tie: Optional[str]

        :param ok: Configuration for the "OK" button.
            - Structure: List `[text, color, size_hint, pos_hint, is_close]`
                - `text` (str): Button text.
                - `color` (str): Button background color (from `easyapp.tools.colors`).
        ...
        :param i: Configuration for static images displayed in the app.
            ...
            - Default: `[["images/easyapp-lazydonkey.png", (1, 1), (0.5, 0.5), 0.6]]`
