...
qu=queue.Queue()
class ImgApp(MDApp):
    def __init__(self, ts=None, ok=None,cal=None, theme=LIGHT, color=WHITE12, tie="ImgEasyapp",tip=None, i=None, **kwargs):
    ...
    def on_space(self,instance):
        pass
def img(ts=None, ok=None,cal=None, theme=LIGHT, color=WHITE12, tie="ImgEasyapp",tip=None, i=None) -> Optional[bool]:
    """
