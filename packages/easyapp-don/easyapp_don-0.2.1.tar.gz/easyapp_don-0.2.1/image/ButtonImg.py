...
class BtnImgApp(MDApp):
    def __init__(self, ts=None, tip=None, tie="BtnImgEasyapp", theme=LIGHT, color=WHITE12,ok=None, cal=None,i=None, bi=None,**kwargs):
    ...
    def on_bi(self,bi_idx):
        qu.put(bi_idx)
        self.stop()
def btn_img(ts=None, tip=None, tie="BtnImgEasyapp", theme=LIGHT,
