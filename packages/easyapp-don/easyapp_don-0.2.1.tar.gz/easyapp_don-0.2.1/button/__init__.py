...
Function: btn(t=None, tie="BtnEasyapp", theme=LIGHT, color=WHITE12, bs=None, tip=None) -> Optional[int]
...
Function: esbtn(ts=None, tie="EsBtnEasyapp", color=WHITE12, theme=LIGHT, tip=None, bs=None) -> Optional[int]
...
Function: fillbtn(ts=None, tie="FillBtnEasyapp", theme=LIGHT, color=WHITE12, tip=None, bs=None, fs=None) -> list
