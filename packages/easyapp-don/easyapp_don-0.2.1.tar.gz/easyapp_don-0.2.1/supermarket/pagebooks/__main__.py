if __name__ == '__main__':
    ...
    print("\n\n\n\n\n\n---------------------------MainDemo-------------------------------")
    print("---------------------demo easyapp-lazydonkey.supermarket.pagebooks---------------------------\n")
    print("----------------------demo pages()------------------")
    a = pages()
    print(f"\n\n\n\n\n\n----------------------Page1,2,3 return:\n {a}-----------------------------------------\n\n\n\n\n\n")
    ...
    b_page={"Page1":{"tie":"Welcome to easyapp-lazydonkey.supermarket.pagebooks' pages() class!",
    ...
    print("--------------------------------demo easyapp-lazydonkey.supermarket.pagebooks end-------------------------------------------------")
