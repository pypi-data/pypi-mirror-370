...
1. ent()
   ...
   - Parameters:
     - t (list, optional): Configuration for the title text. Format: [text_content, (x_position, y_position)] where positions are normalized (0-1 relative to screen). Defaults to ["Hello,easyapp-lazydonkey!", (0.5, 0.7)].
     - tie (str, optional): Title of the application window. Defaults to "EntEasyapp".
...
2. esent()
   ...
   - Parameters:
     ...
     - tie (str, optional): Window title. Defaults to "EsEntEasyapp".
...
3. fillent()
   ...
   - Parameters:
     ...
     - tie (str, optional): Window title. Defaults to "FillEntEasyapp".
...
Note: To modify colors and themes, import color constants and theme utilities from 'easyapp-lazydonkey.tools.colors' (e.g., WHITE12, BLUE8, LIGHT, DARK).
"""
__version__="0.2.1"
__author__="LvYanHua"
__all__=['Ent',
