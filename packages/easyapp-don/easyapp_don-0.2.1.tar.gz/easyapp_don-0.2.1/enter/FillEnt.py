...
class FillEntApp(MDApp):
    def __init__(self, ts=None, fs=None, es=None,color=WHITE12, theme=LIGHT, tip=None, ok=None,cal=None, tie="FillEntEasyapp", **kwargs):
    ...
    def on_space(self,instance):
        pass
def fillent(ts=None, fs=None, es=None,color=WHITE12, theme=LIGHT, tip=None, ok=None,cal=None, tie="FillEntEasyapp") -> list:
    """
    ...
    Parameters:
        ...
        tie (str): Application window title. Defaults to "FillEntEasyapp".
