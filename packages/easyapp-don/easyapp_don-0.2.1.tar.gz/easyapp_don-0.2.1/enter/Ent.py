...
qu=queue.Queue()
class EntApp(MDApp):
    def __init__(self, t=None, tie="EntEasyapp", color=WHITE12, theme=LIGHT,tip=None, ok=None, cal=None,e=None, **kwargs):
    ...
    def on_space(self,instance):
        pass
def ent(t=None, tie="EntEasyapp", color=WHITE12, theme=LIGHT,tip=None, ok=None, cal=None,e=None) -> list :
    """
