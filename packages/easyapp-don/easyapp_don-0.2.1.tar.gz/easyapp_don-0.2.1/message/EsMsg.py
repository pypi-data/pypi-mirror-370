...
class EsMsgApp(MDApp):
    def __init__(self, ts=None, ok=None, cal=None,tie="EsMsgEasyapp",color=WHITE12,theme=LIGHT,
                 tip=None,**kwargs):
    ...
    def on_space(self,instance):
        pass
def esmsg(ts=None, ok=None, cal=None,tie="EsMsgEasyapp",color=WHITE12,theme=LIGHT,
