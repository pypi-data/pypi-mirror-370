...
class Audio:
    ...
    def from_file(cls, file_path: Path) -> "Audio":
        ...
        audio = Audio(data=data, sample_rate=sample_rate)
        audio.initial_processing()
        return audio
    ...
    def initial_processing(self) -> None:
        """
        Perform initial processing on the audio segment, such as normalization.
        """
        # Normalize using "loudness" (RMS)
        self.data = librosa.util.normalize(self.data, norm=2)
