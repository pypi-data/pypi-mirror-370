...
> **Note:** The examples below use the built-in datasets. Install with `uv pip install nonconform[data]` (UV) or `pip install nonconform[data]` (pip) to run these examples.
