import{j as e,B as o}from"./index-k5nYwGaK.js";const m=({record:i,resultTableList:a,plot:r})=>{const n=()=>a.bowtie2_align_metaphlan.map(t=>t.content.log);return e.jsx(e.Fragment,{children:e.jsx(o,{type:"primary",onClick:()=>{r({moduleName:"bowtie2_mapping",params:{log_path_list:n(),mappping_type:"unpaired"},tableDesc:`
