...
class FoundApplicationEntitlementData(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoundApplicationEntitlementData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoundApplicationEntitlementData from a dict"""
        if obj is None:
            return None
    ...
    def __eq__(self, other):
        if not isinstance(other, FoundApplicationEntitlementData):
            return False
        return (
            self.integration_specific_id,
            self.integration_specific_resource_id,
