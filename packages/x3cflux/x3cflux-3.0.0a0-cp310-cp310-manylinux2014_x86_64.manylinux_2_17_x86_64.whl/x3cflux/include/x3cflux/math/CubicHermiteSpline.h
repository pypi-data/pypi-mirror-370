...
template <typename FunctionValueType> class CubicHermiteSpline {
  public:
    typedef FunctionValueType FunctionValue;
    typedef typename FunctionValue::Scalar Scalar;
    typedef std::conditional_t<std::is_same<FunctionValue, Matrix<Scalar>>::value, Vector<Scalar>, Scalar> ElementValue;
