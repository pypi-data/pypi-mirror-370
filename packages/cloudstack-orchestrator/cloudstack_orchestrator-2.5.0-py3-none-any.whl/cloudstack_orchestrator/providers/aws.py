...
class AWSSecretsProvider:
    ...
    def __init__(self, region: str, cluster_name: str):
        ...
        self.prefix = f"cso/{cluster_name}"
    ...
    async def set_secret(self, key: str, value: str, description: Optional[str] = None) -> None:
        """Set a secret value."""
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                self.client.create_secret(
                    Name=secret_name,
                    Description=description or f"CloudStack Orchestrator secret: {key}",
                    SecretString=secret_data,
                    Tags=[
