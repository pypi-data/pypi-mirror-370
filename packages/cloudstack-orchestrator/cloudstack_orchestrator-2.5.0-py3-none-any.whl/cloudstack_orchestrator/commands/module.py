...
class ModuleSpec:
    ...
    def __init__(self, path: Path):
        ...
        self.root_spec_file = path / "cso-module.yaml"
        self.spec = None

        # Try .cso/module.yaml first (new structure)
        if self.spec_file.exists():
            with open(self.spec_file) as f:
                self.spec = yaml.safe_load(f)
        # Fallback to root cso-module.yaml (legacy/alternative structure)
    ...
    def is_valid(self) -> bool:
        """Check if module has valid CSO specification."""
...
def validate_module(
    ...
    if not module.is_valid:
        console.print("[red]✗ No CSO module specification found![/red]")
        console.print("Expected one of:")
        console.print("  - .cso/module.yaml (preferred)")
        console.print("  - cso-module.yaml (alternative)")
        console.print(
    ...
    with Progress(
        ...
        # 9. Check for additional files in .cso directory (if it exists)
        progress.update(task, description="Checking additional configurations...")

        if module.cso_dir.exists():
            expected_files = [
                "module.yaml",
                "compliance.yaml",
                "dependencies.yaml",
            ...
            warnings.append("No .cso directory found - using root cso-module.yaml")
...
def init_module(
    ...
    console.print("[green]✓[/green] Created .cso/module.yaml")
...
"""
    ...
    console.print("\nNext steps:")
    console.print("  1. Update .cso/module.yaml with your module details")
