"""Terraform infrastructure provisioning for CloudStack Orchestrator."""
...
class TerraformManager:
    """Manages Terraform operations for CSO infrastructure."""

    def __init__(self, console: Optional[Console] = None):
        self.console = console or Console()
        self.state_dir = Path.home() / ".cso" / "terraform"
        self.state_dir.mkdir(parents=True, exist_ok=True)

        # Set up Terraform directory in .cso
    ...
    def _download_terraform_files(self):
        ...
        repo_url = "https://api.github.com/repos/killerapp/cloudstack-orchestrator/zipball/main"
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                extracted_dirs = [
                    ...
                    if d.is_dir()
                    and d.name.startswith("killerapp-cloudstack-orchestrator")
                ]
                ...
                # Copy terraform files to local .cso directory
                terraform_dest = self.state_dir / "modules"
                if terraform_dest.exists():
                    shutil.rmtree(terraform_dest)
    ...
    def _create_tfvars(
        ...
        **kwargs,
        ...
        tfvars = f"""# Auto-generated by CSO
project_id = "{project_id}"
region     = "{region}"
cluster_name = "{cluster_name}"
environment = "{environment}"
...
argocd_repo_url = "{kwargs.get('argocd_repo_url', 'https://github.com/killerapp/cloudstack-orchestrator')}"
"""
