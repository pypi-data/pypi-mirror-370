...
from cloudstack_orchestrator.core.config import Config
from cloudstack_orchestrator.providers.azure import AzureProvider
...
class TestCLICommands:
    ...
    @pytest.mark.skipif(
        subprocess.run(["where", "cso"], capture_output=True, shell=True).returncode
        != 0,
        reason="CSO CLI not installed",
    )
