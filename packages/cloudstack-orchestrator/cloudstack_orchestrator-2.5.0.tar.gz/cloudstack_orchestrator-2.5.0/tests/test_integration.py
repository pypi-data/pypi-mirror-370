"""Integration tests for CloudStack Orchestrator."""
...
from cloudstack_orchestrator.core import Orchestrator
    ...
    async def test_sdk_full_setup_flow(self, test_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('subprocess.run') as mock_run, \
                ...
                secrets_file = Path(tmpdir) / ".cso" / "secrets" / "secrets.json"
    ...
    async def test_local_to_kubernetes_secrets_flow(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('kubernetes.config.load_kube_config'), \
                ...
                k8s_secrets = await sdk.orchestrator.secrets_manager.export_kubernetes_secrets()
    ...
    async def test_setup_with_no_kubernetes(self):
        ...
        with patch('kubernetes.config.load_kube_config') as mock_config:
            ...
            with patch.object(sdk.orchestrator, '_command_exists', return_value=True):
                ...
                assert any("Kubernetes client not initialized" in error for error in result["errors"])
