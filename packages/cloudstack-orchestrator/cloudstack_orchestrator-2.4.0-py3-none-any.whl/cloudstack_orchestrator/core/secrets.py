"""Secrets management for CloudStack Orchestrator."""
...
class SecretsManager:
    ...
    async def _ensure_secret(
        ...
        raise ValueError(f"No value provided for secret '{key}' and no generator available")
    ...
    async def export_kubernetes_secrets(self) -> Dict[str, Dict[str, str]]:
        ...
        k8s_secrets = {
            ...
            "keycloak-admin-creds": {
                "namespace": "platform",
                "data": {
                    "admin-password": secrets_map["keycloak_admin_password"]
                }
            },
