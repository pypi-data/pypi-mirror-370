...
try:
    ...
    from PySide2.QtCore import Qt, QFileSystemWatcher, Signal, QCoreApplication
...
class CampaignTab(QWidget):
    ...
    def init_ui(self):
        ...
        # Dual PySide compatibility for QSizePolicy
        if PYSIDE_VERSION == 6:
            ...
            self.recipients_table.setSizePolicy(
                ...
                QSizePolicy.Expanding   # Vertical expansion
            )
