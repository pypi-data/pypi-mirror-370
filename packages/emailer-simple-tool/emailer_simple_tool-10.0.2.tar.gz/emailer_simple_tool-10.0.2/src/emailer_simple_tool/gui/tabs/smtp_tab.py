...
# Dual PySide6/PySide2 compatibility
try:
    ...
    from PySide2.QtCore import QTimer, QRegExp, Qt
...
class SMTPTab(QWidget):
    ...
    def refresh_translations(self):
        ...
        if hasattr(self, 'config_group'):
            # Get the current form layout - dual PySide compatibility
            if PYSIDE_VERSION == 6:
    ...
    def init_ui(self):
        ...
        self.smtp_port.setText("587")
        # Add numeric validator for port (1-65535) - dual PySide compatibility
        if PYSIDE_VERSION == 6:
            ...
            port_validator = QRegExpValidator(QRegExp(r"^([1-9][0-9]{0,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])$"))
    ...
    def test_connection(self):
        ...
        if not self.current_campaign_path:
            ...
            # Ask user if they want to continue - dual PySide compatibility
            if PYSIDE_VERSION == 6:
