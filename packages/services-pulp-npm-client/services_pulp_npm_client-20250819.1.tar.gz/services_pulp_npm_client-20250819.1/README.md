...
```python
import services-pulp_npm-client
```
...
import services-pulp_npm-client
from services-pulp_npm-client.rest import ApiException
...
configuration = services-pulp_npm-client.Configuration(
...
with services-pulp_npm-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = services-pulp_npm-client.ContentPackagesApi(api_client)
