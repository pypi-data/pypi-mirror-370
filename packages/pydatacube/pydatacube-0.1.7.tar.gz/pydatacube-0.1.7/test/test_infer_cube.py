...
from src.pyCube.session.infer_cube import get_all_table_names, get_fact_table, get_lowest_levels
...
class TestInferCube(unittest.TestCase):
    ...
    def setUp(self):
        self.fact_table_name = get_fact_table(self.cursor)
    ...
    def test_get_lowest_level_names(self):
        actual_lowest_level_names_unsorted = get_lowest_levels(self.cursor, self.fact_table_name)
