...
class NodeUpdateTransactionBody(_message.Message):
    __slots__ = ("node_id", "account_id", "description", "gossip_endpoint", "service_endpoint", "gossip_ca_certificate", "grpc_certificate_hash", "admin_key")
    ...
    def __init__(self, node_id: _Optional[int] = ..., account_id: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ..., description: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., gossip_endpoint: _Optional[_Iterable[_Union[_basic_types_pb2.ServiceEndpoint, _Mapping]]] = ..., service_endpoint: _Optional[_Iterable[_Union[_basic_types_pb2.ServiceEndpoint, _Mapping]]] = ..., gossip_ca_certificate: _Optional[_Union[_wrappers_pb2.BytesValue, _Mapping]] = ..., grpc_certificate_hash: _Optional[_Union[_wrappers_pb2.BytesValue, _Mapping]] = ..., admin_key: _Optional[_Union[_basic_types_pb2.Key, _Mapping]] = ...) -> None: ...
