...
class PagedResponseObj:
    """
    Attributes:
        result (list[Union['PagedResponseObjResultItemType0', None]]): List of query result json objects
    ...
    result: list[Union["PagedResponseObjResultItemType0", None]]
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for result_item_data in _result:
            ...
            def _parse_result_item(data: object) -> Union["PagedResponseObjResultItemType0", None]:
                if data is None:
                    return data
                try:
                    ...
                    pass
                return cast(Union["PagedResponseObjResultItemType0", None], data)
