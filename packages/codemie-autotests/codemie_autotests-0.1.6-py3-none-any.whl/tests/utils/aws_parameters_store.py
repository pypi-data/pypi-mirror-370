...
class AwsParameterStore:
    ...
    def get_cloud_provider_credentials(cls, provider: str) -> dict:
        ...
        parameter_value = cls._instance.get_parameter(parameter_path)
...
class CredentialsUtil:
    ...
    def aws_credentials() -> List[CredentialValues]:
        ...
        return [
            ...
            CredentialValues(key="aws_region", value=aws_creds["aws"]["region"]),
            CredentialValues(
                key="aws_access_key_id", value=aws_creds["aws"]["access_key_id"]
            ),
            CredentialValues(
                key="aws_secret_access_key", value=aws_creds["aws"]["secret_access_key"]
            ),
        ]
    ...
    def gcp_credentials() -> List[CredentialValues]:
        ...
        gcp_api_key = base64.b64decode(gcp_creds["gcp"]["sa_key_in_base64"]).decode()
    ...
    def azure_credentials() -> List[CredentialValues]:
        ...
        return [
            ...
            CredentialValues(
                ...
                value=azure_creds["azure"]["subscription_id"],
            ),
            CredentialValues(
                key="azure_tenant_id", value=azure_creds["azure"]["tenant_id"]
            ),
            CredentialValues(
                key="azure_client_id", value=azure_creds["azure"]["client_id"]
            ),
            CredentialValues(
                key="azure_client_secret", value=azure_creds["azure"]["client_secret"]
            ),
        ]
    ...
    def sonar_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(
                key="url", value=sonar_creds["sonar"]["self-hosted"]["url"]
            ),
            CredentialValues(
                key="token", value=sonar_creds["sonar"]["self-hosted"]["token"]
            ),
            CredentialValues(
                key="sonar_project_name",
                value=sonar_creds["sonar"]["self-hosted"]["projectKey"],
            ),
        ]
    ...
    def sonar_cloud_credentials() -> List[CredentialValues]:
        sonar_creds = AwsParameterStore.get_cloud_provider_credentials("sonar")
        return [
            CredentialValues(key="url", value=sonar_creds["sonar"]["cloud"]["url"]),
            CredentialValues(key="token", value=sonar_creds["sonar"]["cloud"]["token"]),
            CredentialValues(
                key="sonar_project_name",
                value=sonar_creds["sonar"]["cloud"]["projectKey"],
            ),
        ]
    ...
    def jira_cloud_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(key="url", value=jira_creds["jiracloud"]["url"]),
            CredentialValues(key="username", value=jira_creds["jiracloud"]["email"]),
            CredentialValues(key="token", value=jira_creds["jiracloud"]["token"]),
    ...
    def confluence_cloud_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(
                key="url", value=confluence_creds["confluencecloud"]["url"]
            ),
            CredentialValues(
                key="username", value=confluence_creds["confluencecloud"]["email"]
            ),
            CredentialValues(
                key="token", value=confluence_creds["confluencecloud"]["token"]
            ),
            CredentialValues(key="is_cloud", value=True),
        ]
    ...
    def gmail_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(key="url", value=gmail_creds["email"]["url"]),
            CredentialValues(
                key="smtp_username", value=gmail_creds["email"]["smtp_username"]
            ),
            CredentialValues(
                key="smtp_password", value=gmail_creds["email"]["smtp_password"]
            ),
        ]
    ...
    def telegram_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(key="token", value=telegram_creds["telegram"]["token"]),
        ]
    ...
    def azure_devops_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(
                key="url", value=azure_devops_creds["azure_devops"]["url"]
            ),
            CredentialValues(
                key="token",
                value=azure_devops_creds["azure_devops"]["personal_access_token"],
            ),
            CredentialValues(
                key="project", value=azure_devops_creds["azure_devops"]["project_name"]
            ),
            CredentialValues(
                key="organization",
                value=azure_devops_creds["azure_devops"]["organization_name"],
            ),
        ]
    ...
    def elastic_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(key="url", value=elastic_creds["url"]),
            CredentialValues(key="elastic_api_key_id", value=elastic_creds["apiKeyId"]),
            CredentialValues(key="elastic_api_key", value=elastic_creds["apiKey"]),
        ]
    ...
    def sql_credentials(db_dialect: DataBaseDialect) -> List[CredentialValues]:
        ...
        sql_creds = sql_creds if os.getenv("ENV") == "preview" else sql_creds["sandbox"]

        return [
            CredentialValues(key="url", value=sql_creds[db_dialect]["url"]),
            CredentialValues(key="dialect", value=sql_creds[db_dialect]["dialect"]),
            CredentialValues(key="port", value=sql_creds[db_dialect]["port"]),
            CredentialValues(
                key="database_name", value=sql_creds[db_dialect]["database_name"]
            ),
            CredentialValues(key="username", value=sql_creds[db_dialect]["username"]),
            CredentialValues(key="password", value=sql_creds[db_dialect]["password"]),
        ]
    ...
    def servicenow_credentials() -> List[CredentialValues]:
        ...
        return [
            CredentialValues(key="url", value=servicenow_creds["url"]),
            CredentialValues(key="api_key", value=servicenow_creds["token"]),
        ]
