...
```python
import services-pulp_service-client
```
...
import services-pulp_service-client
from services-pulp_service-client.rest import ApiException
...
configuration = services-pulp_service-client.Configuration(
...
with services-pulp_service-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = services-pulp_service-client.ApiCreateDomainApi(api_client)
    domain = services-pulp_service-client.Domain() # Domain | 
