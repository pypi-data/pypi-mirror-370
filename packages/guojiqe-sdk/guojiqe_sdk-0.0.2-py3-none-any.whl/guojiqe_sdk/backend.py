...
from guojiqe_sdk.base import BackendBase
from qiskit_ibm_runtime.models import BackendStatus
from itertools import combinations
from guojiqe_sdk.device_types import DeviceType
from guojiqe_sdk.noise_model import NoiseModel
...
class GjqBackend(BackendBase):
    ...
    def run(self, circuit: QuantumCircuit, **options):
        ...
        Returns:
            表示提交任务的Job对象
        """
        from guojiqe_sdk.job import GjqJob  # 延迟导入
        # options = {
