...
from guojiqe_sdk.base import ServiceBase
from guojiqe_sdk.client import GjqClient
from guojiqe_sdk.job import GjqJob
from guojiqe_sdk.device_types import DeviceType, ChannelType
...
class GjqRuntimeService(ServiceBase):
    ...
    def least_busy(self):
        """获取当前channel最空闲的后端"""
        from guojiqe_sdk.backend import GjqBackend  # 延迟导入，避免循环依赖
