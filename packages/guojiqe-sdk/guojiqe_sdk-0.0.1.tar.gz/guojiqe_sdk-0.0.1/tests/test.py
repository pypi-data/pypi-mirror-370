...
# 创建服务实例
# service = TgqRuntimeService(channel="quantum")
#
# # 获取后端
# backend = service.least_busy()
# target = backend.target
# print(target)
# print("后端:", backend.name)

# simulator细分不同类型，走楷文scheduler接口
# 指定设备类型按比特数由大到小排序，看是否有idle的设备，如果都是running，根据设备的jobNum数量选作业最少的设备信息返回
