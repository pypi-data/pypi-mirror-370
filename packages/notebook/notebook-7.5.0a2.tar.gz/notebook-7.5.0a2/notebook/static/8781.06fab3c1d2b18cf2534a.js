...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45895);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(10002),
    __webpack_require__(42040),
    __webpack_require__(41659),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(57594),
  __webpack_require__(13645),
  __webpack_require__(41522),
  __webpack_require__(83667),
  __webpack_require__(91114),
  __webpack_require__(11620),
  __webpack_require__(6116),
  
      (__webpack_require__(66067)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(68554)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(87057),
  __webpack_require__(16839),
  
      (__webpack_require__(93607)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(23125)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(96035),
  
      (__webpack_require__(82735)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(13818)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(38106)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(78745)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(98779)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(11825),
  __webpack_require__(96028),
  __webpack_require__(39388),
  __webpack_require__(45083),
  
      (__webpack_require__(98142)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(75129),
  __webpack_require__(39997),
  __webpack_require__(19548),
  
      (__webpack_require__(56582)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(79773),
  __webpack_require__(29385),
  __webpack_require__(86385),
  __webpack_require__(1865),
  __webpack_require__(11993),
  __webpack_require__(68755),
  __webpack_require__(62875),
  __webpack_require__(16618),
  __webpack_require__(66929),
  __webpack_require__(76593),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(17184)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(21220),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(88835),
  __webpack_require__(1225),
  
      (__webpack_require__(93853)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(49213),
  __webpack_require__(35238),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(4389)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(39352)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(3540).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(47131).IServiceManager);
...
//# sourceMappingURL=8781.06fab3c1d2b18cf2534a.js.map?v=06fab3c1d2b18cf2534a