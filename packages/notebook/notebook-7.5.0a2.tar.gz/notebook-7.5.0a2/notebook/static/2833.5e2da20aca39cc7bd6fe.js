"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[2833],{
...
/* harmony import */ var _chunk_L5ZGVLVO_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(56615);
/* harmony import */ var _chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(58074);
/* harmony import */ var _chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5554);
/* harmony import */ var _chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36850);
/* harmony import */ var _chunk_M6DAPIYF_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24279);
/* harmony import */ var _chunk_MXNHSMXR_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21587);
/* harmony import */ var _chunk_JW4RIYDF_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3106);
/* harmony import */ var _chunk_AC5SNWB5_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(45564);
/* harmony import */ var _chunk_UWXLY5YG_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(85951);
/* harmony import */ var _chunk_QESNASVV_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(99408);
/* harmony import */ var _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(88226);
/* harmony import */ var _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(5090);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(35321);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(26616);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(14728);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)();
    ...
    this.funs = [];
    this.setAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setAccTitle */ .GN;
    this.setAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setAccDescription */ .U$;
    this.setDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setDiagramTitle */ .g2;
    this.getAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getAccTitle */ .eu;
    this.getAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getAccDescription */ .Mx;
    this.getDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getDiagramTitle */ .Kr;
  ...
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(this, "FlowDB");
  }
  sanitizeText(txt) {
    return _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .common_default */ .SY.sanitizeText(txt, this.config);
  }
  /**
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (metadata !== void 0) {
      ...
      doc = (0,_chunk_L5ZGVLVO_mjs__WEBPACK_IMPORTED_MODULE_1__/* .load */ .z)(yamlData, { schema: _chunk_L5ZGVLVO_mjs__WEBPACK_IMPORTED_MODULE_1__/* .JSON_SCHEMA */ .A });
    }
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_JW4RIYDF_mjs__WEBPACK_IMPORTED_MODULE_7__/* .isValidShape */ .dW)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.info("abc78 Got edge...", edge);
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__/* .getEdgeId */ .Ln)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__/* .getEdgeId */ .Ln)(edge.start, edge.end, {
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.info("Pushing edge...");
...
You have to call mermaid.initialize.`
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.info("addLink", _start, _end, id);
  ...
  setClickFun(id, functionName, functionArgs) {
    ...
    if ((0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default */ .w8.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default */ .w8.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_13__/* .select */ .Ys)(".mermaidTooltip");
    if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
      tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_13__/* .select */ .Ys)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
    }
    const svg = (0,d3__WEBPACK_IMPORTED_MODULE_13__/* .select */ .Ys)(element).select("svg");
    const nodes = svg.selectAll("g.node");
    nodes.on("mouseover", (e) => {
      const el = (0,d3__WEBPACK_IMPORTED_MODULE_13__/* .select */ .Ys)(e.currentTarget);
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)();
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .clear */ .ZH)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const uniq = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)((a) => {
    ...
    let dir = result.dir;
    const flowchartConfig = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)().flowchart ?? {};
    dir = dir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)().direction ?? void 0 : void 0);
    ...
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  getData() {
    const config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__/* .getEdgeId */ .Ln)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .defaultConfig2 */ .Fy.flowchart;
  }
};

// src/diagrams/flowchart/flowRenderer-v3-unified.ts

var getClasses = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.info("REF0:");
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.info("Drawing state diagram (v2)", id);
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .nV)();
  let sandboxElement;
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_13__/* .select */ .Ys)("#i" + id);
  }
  const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.debug("Data: ", data4Layout);
  const svg = (0,_chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getDiagramElement */ .q)(id, securityLevel);
  const direction = diag.db.getDirection();
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getRegisteredLayoutAlgorithm */ ._b)(layout);
  if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.warn(
  ...
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .log */ .cM.debug("REF1:", data4Layout);
  await (0,_chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_4__/* .render */ .sY)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default */ .w8.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupViewPortForSVG */ .j)(svg, padding, "flowchart", conf?.useMaxWidth || false);
  for (const vertex of data4Layout.nodes) {
    const node = (0,d3__WEBPACK_IMPORTED_MODULE_13__/* .select */ .Ys)(`#${id} [id="${vertex.id}"]`);
    if (!node || !vertex.link) {
      continue;
    }
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function parse(input) {
      ...
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)(Parser, "Parser");
...
var fade = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)((color, opacity) => {
  const channel2 = khroma__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z;
  const r = channel2(color, "r");
  const g = channel2(color, "g");
  const b = channel2(color, "b");
  return khroma__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z(r, g, b, opacity);
}, "fade");
var getStyles = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)((options) => `.label {
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .__name */ .eW)((cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    if (cnf.layout) {
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setConfig2 */ .Y4)({ layout: cnf.layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setConfig2 */ .Y4)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
};
...
//# sourceMappingURL=2833.5e2da20aca39cc7bd6fe.js.map?v=5e2da20aca39cc7bd6fe