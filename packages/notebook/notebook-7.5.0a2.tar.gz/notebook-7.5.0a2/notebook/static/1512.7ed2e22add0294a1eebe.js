"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[1512],{
...
var getDiagramElement = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((id, securityLevel) => {
  let sandboxElement;
...
/* harmony export */ });
/* harmony import */ var _chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58074);
/* harmony import */ var _chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5554);
/* harmony import */ var _chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36850);
/* harmony import */ var _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(88226);
/* harmony import */ var _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5090);
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 3:
          yy.setRootDoc($$[$0]);
    ...
    parseError: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function parse(input) {
      ...
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(Parser, "Parser");
...
var getDir = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("REF0:");
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Drawing state diagram (v2)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  diag.db.extract(diag.db.getRootDocV2());
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramElement */ .q)(id, securityLevel);
  ...
  await (0,_chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_2__/* .render */ .sY)(data4Layout, svg);
  const padding = 8;
  try {
    ...
    links.forEach((linkInfo, key) => {
      ...
      if (!stateId) {
        _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.warn("\u26A0\uFE0F Invalid or missing stateId from key:", JSON.stringify(key));
        return;
      }
      ...
      if (!matchedElem) {
        _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.warn("\u26A0\uFE0F Could not find node matching text:", stateId);
        return;
      }
      const parent = matchedElem.parentNode;
      if (!parent) {
        _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.warn("\u26A0\uFE0F Node has no parent, cannot wrap:", stateId);
        return;
      }
      ...
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("\u{1F517} Wrapped node in <a> tag for:", stateId, linkInfo.url);
    });
  } catch (err) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.error("\u274C Error injecting clickable links:", err);
  }
  _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ .w8.insertTitle(
    svg,
    "statediagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .j)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
}, "draw");
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(stateDomId, "stateDomId");
var setupDoc = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeText(item.description ?? "", (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()),
...
var getDir2 = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(insertOrUpdateNode, "insertOrUpdateNode");
function getClassesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.classes?.join(" ") ?? "";
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.styles ?? [];
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(getStylesFromDbInfo, "getStylesFromDbInfo");
var dataFetcher = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  const itemId = parsedItem.id;
  const dbState = diagramStates.get(itemId);
  const classStr = getClassesFromDbInfo(dbState);
  const style = getStylesFromDbInfo(dbState);
  const config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("dataFetcher parsedItem", parsedItem, dbState, style);
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeText(itemId, config),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeTextOrArray(newNode.description, config);
    }
    ...
    if (!newNode.type && parsedItem.doc) {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Setting cluster for XCX", itemId, getDir2(parsedItem));
      newNode.type = "group";
    ...
    if (parent && parent.id !== "root") {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
  ...
  if (parsedItem.doc) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.trace("Adding nodes children ");
    setupDoc(parsedItem, parsedItem.doc, diagramStates, nodes, edges, !altFlag, look, classes);
  }
}, "dataFetcher");
var reset = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(() => {
  nodeDb.clear();
  graphItemCount = 0;
}, "reset");
...
var newClassesList = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(() => /* @__PURE__ */ new Map(), "newClassesList");
var newDoc = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var clone = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((o) => JSON.parse(JSON.stringify(o)), "clone");
var StateDB = class {
  constructor(version) {
    ...
    this.getAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccTitle */ .eu;
    this.setAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccTitle */ .GN;
    this.getAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccDescription */ .Mx;
    this.setAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccDescription */ .U$;
    this.setDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setDiagramTitle */ .g2;
    this.getDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getDiagramTitle */ .Kr;
    this.clear();
  ...
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(this, "StateDB");
  }
  static {
    this.relationType = {
      AGGREGATION: 0,
  ...
  setRootDoc(o) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Setting root doc", o);
    this.rootDoc = o;
    if (this.version === 1) {
      this.extract(o);
    } else {
  ...
  docTranslator(parent, node, first) {
    ...
    if (doc.length > 0 && currentDoc.length > 0) {
      const newNode = {
        stmt: STMT_STATE,
        id: (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_3__/* .generateId */ .Ox)(),
        type: "divider",
  ...
  addState(id, type = DEFAULT_STATE_TYPE, doc = void 0, descr = void 0, note = void 0, classes = void 0, styles = void 0, textStyles = void 0) {
    ...
    if (!this.currentDocument.states.has(trimmedId)) {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Adding state ", trimmedId, descr);
    ...
    if (descr) {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Setting state description", trimmedId, descr);
    ...
    if (note) {
      ...
      doc2.note = note;
      doc2.note.text = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeText(doc2.note.text, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)());
    }
    if (classes) {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Setting state classes", trimmedId, classes);
    ...
    if (styles) {
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Setting state styles", trimmedId, styles);
  ...
  clear(saveCommon) {
    ...
    if (!saveCommon) {
      this.links = /* @__PURE__ */ new Map();
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .clear */ .ZH)();
    }
  }
  getState(id) {
  ...
  logDocuments() {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Documents = ", this.documents);
  }
  getRelations() {
  ...
  addLink(stateId, url, tooltip) {
    ...
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.warn("Adding link", stateId, url, tooltip);
  }
  /**
  ...
  addRelationObjs(item1, item2, relationTitle = "") {
    ...
    this.currentDocument.relations.push({
      id1,
      id2,
      relationTitle: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeText(relationTitle, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)())
    });
  }
  /**
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object" && typeof item2 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: title ? _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeText(title, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()) : void 0
      });
    }
  }
  addDescription(id, descr) {
    ...
    theState?.descriptions?.push(_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.sanitizeText(_descr, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()));
  }
  cleanupLabel(label) {
  ...
  getConfig() {
    return (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)().state;
  }
};

// src/diagrams/state/styles.js
var getStyles = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((options) => `
...
var setupViewPortForSVG = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((svg, padding, cssDiagram, useMaxWidth) => {
  svg.attr("class", cssDiagram);
  const { width, height, x, y } = calculateDimensionsWithPadding(svg, padding);
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .v2)(svg, height, width, useMaxWidth);
  const viewBox = createViewBox(x, y, width, height, padding);
  svg.attr("viewBox", viewBox);
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.debug(`viewBox configured: ${viewBox} with padding: ${padding}`);
}, "setupViewPortForSVG");
var calculateDimensionsWithPadding = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((svg, padding) => {
...
var createViewBox = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((x, y, width, height, padding) => {
...
//# sourceMappingURL=1512.7ed2e22add0294a1eebe.js.map?v=7ed2e22add0294a1eebe