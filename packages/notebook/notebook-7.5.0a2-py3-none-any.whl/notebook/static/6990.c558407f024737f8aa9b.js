"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[6990],{
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(populateCommonDb, "populateCommonDb");
...
/* harmony export */ });
/* harmony import */ var _chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5554);
/* harmony import */ var _chunk_UWXLY5YG_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85951);
/* harmony import */ var _chunk_353BL4L5_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24397);
/* harmony import */ var _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(88226);
/* harmony import */ var _chunk_P3VETL53_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36066);
...
var TreeMapDB = class {
  ...
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(this, "TreeMapDB");
  }
  getNodes() {
    return this.nodes;
  }
  getConfig() {
    const defaultConfig = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .defaultConfig_default */ .vZ;
    const userConfig = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .iE)();
    return (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_3__/* .cleanAndMerge */ .Rb)({
  ...
  addClass(id, _style) {
    ...
    if (styles) {
      styles.forEach((s) => {
        if ((0,_chunk_UWXLY5YG_mjs__WEBPACK_IMPORTED_MODULE_1__/* .isLabelStyle */ .Fh)(s)) {
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(buildHierarchy, "buildHierarchy");

// src/diagrams/treemap/parser.ts
var populate = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((ast, db) => {
  (0,_chunk_353BL4L5_mjs__WEBPACK_IMPORTED_MODULE_2__/* .populateCommonDb */ .A)(ast, db);
  const items = [];
  ...
  const addNodesRecursively = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((nodes, level) => {
...
var getItemName = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((item) => {
  return item.name ? String(item.name) : "";
}, "getItemName");
var parser = {
  // @ts-expect-error - TreeMapDB is not assignable to DiagramDB
  parser: { yy: void 0 },
  parse: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async (text) => {
    try {
      const parseFunc = _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_6__/* .parse */ .Qc;
      const ast = await parseFunc("treemap", text);
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug("Treemap AST:", ast);
      ...
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.error("Error parsing treemap:", error);
      throw error;
    }
  }, "parse")
};
...
var draw = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((_text, id, _version, diagram2) => {
  const treemapDb = diagram2.db;
  const config = treemapDb.getConfig();
  const treemapInnerPadding = config.padding ?? DEFAULT_INNER_PADDING;
  const title = treemapDb.getDiagramTitle();
  const root = treemapDb.getRoot();
  const { themeVariables } = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .iE)();
  if (!root) {
    return;
  }
  const titleHeight = title ? 30 : 0;
  const svg = (0,_chunk_P3VETL53_mjs__WEBPACK_IMPORTED_MODULE_4__/* .selectSvgElement */ .P)(id);
  ...
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .configureSvgSize */ .v2)(svg, svgHeight, svgWidth, config.useMaxWidth);
  let valueFormat;
  try {
    const formatStr = config.valueFormat || ",";
    if (formatStr === "$0,0") {
      valueFormat = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((value) => "$" + (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .format */ .WUZ)(",")(value), "valueFormat");
    } else if (formatStr.startsWith("$") && formatStr.includes(",")) {
      const precision = /\.\d+/.exec(formatStr);
      const precisionStr = precision ? precision[0] : "";
      valueFormat = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((value) => "$" + (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .format */ .WUZ)("," + precisionStr)(value), "valueFormat");
    } else if (formatStr.startsWith("$")) {
      const restOfFormat = formatStr.substring(1);
      valueFormat = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((value) => "$" + (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .format */ .WUZ)(restOfFormat || "")(value), "valueFormat");
    } else {
      valueFormat = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .format */ .WUZ)(formatStr);
    }
  } catch (error) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.error("Error creating format function:", error);
    valueFormat = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .format */ .WUZ)(",");
  }
  const colorScale = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .scaleOrdinal */ .PKp)().range([
    "transparent",
  ...
  const colorScalePeer = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .scaleOrdinal */ .PKp)().range([
    "transparent",
  ...
  const colorScaleLabel = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .scaleOrdinal */ .PKp)().range([
  ...
  const hierarchyRoot = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .hierarchy */ .bT9)(root).sum((d) => d.value ?? 0).sort((a, b) => (b.value ?? 0) - (a.value ?? 0));
  const treemapLayout = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .treemap */ .pNI)().size([width, height]).paddingTop(
  ...
  sections.append("rect").attr("width", (d) => d.x1 - d.x0).attr("height", (d) => d.y1 - d.y0).attr("class", (_d, i) => {
    ...
    const styles = (0,_chunk_UWXLY5YG_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .UG)({ cssCompiledStyles: d.data.cssCompiledStyles });
  ...
  sections.append("text").attr("class", "treemapSectionLabel").attr("x", 6).attr("y", SECTION_HEADER_HEIGHT / 2).attr("dominant-baseline", "middle").text((d) => d.depth === 0 ? "" : d.data.name).attr("font-weight", "bold").attr("style", (d) => {
    ...
    const self = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ys)(this);
  ...
  if (config.showValues !== false) {
    ...
    leafValues.each(function(d) {
      const valueTextElement = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ys)(this);
      const parentCellNode = this.parentNode;
      if (!parentCellNode) {
        valueTextElement.style("display", "none");
        return;
      }
      const labelElement = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ys)(parentCellNode).select(".treemapLabel");
  ...
  (0,_chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .j)(svg, diagramPadding, "flowchart", config?.useMaxWidth || false);
}, "draw");
var getClasses = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(_text, diagramObj) {
...
var getStyles = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(({
  treemap: treemap2
} = {}) => {
  const options = (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_3__/* .cleanAndMerge */ .Rb)(defaultTreemapStyleOptions, treemap2);
  return `
  .treemapNode.section {
...
//# sourceMappingURL=6990.c558407f024737f8aa9b.js.map?v=c558407f024737f8aa9b