"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[5820],{
...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(() => (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)().requirement, "getConfig");
    this.clear();
  ...
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(this, "RequirementDB");
  }
  getDirection() {
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("Added new element: ", name);
    }
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__export */ .r2)(requirementRenderer_exports, {
  draw: () => draw
});
var draw = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(async function(text, id, _version, diag) {
  ...
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("Drawing requirement diagram (unified)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)();
  ...
  (0,_chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .j)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
...
//# sourceMappingURL=5820.273d8b596f8eaa2e3970.js.map?v=273d8b596f8eaa2e3970