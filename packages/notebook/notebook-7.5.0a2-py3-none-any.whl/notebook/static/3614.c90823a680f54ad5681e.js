"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[3614],{
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 23:
          this.$ = $$[$0];
    ...
    parseError: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function parse(input) {
      ...
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(Parser, "Parser");
...
var defaultThemeVariables = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getThemeVariables */ .xN)();
var QuadrantBuilder = class {
  ...
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(this, "QuadrantBuilder");
  }
  getDefaultData() {
    return {
      titleText: "",
  ...
  getDefaultConfig() {
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.chartWidth || 500,
      chartWidth: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.chartHeight || 500,
      titlePadding: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.titlePadding || 10,
      titleFontSize: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.titleFontSize || 20,
      quadrantPadding: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.quadrantPadding || 5,
      xAxisLabelPadding: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.xAxisLabelPadding || 5,
      yAxisLabelPadding: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.yAxisLabelPadding || 5,
      xAxisLabelFontSize: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.xAxisLabelFontSize || 16,
      yAxisLabelFontSize: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.yAxisLabelFontSize || 16,
      quadrantLabelFontSize: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.quadrantLabelFontSize || 16,
      quadrantTextTopPadding: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.quadrantTextTopPadding || 5,
      pointTextPadding: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.pointTextPadding || 5,
      pointLabelFontSize: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.pointLabelFontSize || 12,
      pointRadius: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.pointRadius || 5,
      xAxisPosition: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.xAxisPosition || "top",
      yAxisPosition: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.yAxisPosition || "left",
      quadrantInternalBorderStrokeWidth: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
      quadrantExternalBorderStrokeWidth: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .vZ.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
    };
  }
  ...
  clear() {
    ...
    this.data = this.getDefaultData();
    this.classes = /* @__PURE__ */ new Map();
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.info("clear called");
  }
  setData(data) {
  ...
  setConfig(config2) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.trace("setConfig called with: ", config2);
    this.config = { ...this.config, ...config2 };
  }
  setThemeConfig(themeConfig) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.trace("setThemeConfig called with: ", themeConfig);
...
var InvalidStyleError = class extends Error {
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(this, "InvalidStyleError");
  }
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(validateHexCode, "validateHexCode");
function validateNumber(value) {
  return !/^\d+$/.test(value);
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(validateNumber, "validateNumber");
function validateSizeInPixels(value) {
  return !/^\d+px$/.test(value);
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(validateSizeInPixels, "validateSizeInPixels");

// src/diagrams/quadrant-chart/quadrantDb.ts
var config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .nV)();
function textSanitizer(text) {
  return (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeText */ .oO)(text.trim(), config);
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(textSanitizer, "textSanitizer");
var quadrantBuilder = new QuadrantBuilder();
function setQuadrant1Text(textObj) {
  quadrantBuilder.setData({ quadrant1Text: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setQuadrant1Text, "setQuadrant1Text");
function setQuadrant2Text(textObj) {
  quadrantBuilder.setData({ quadrant2Text: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setQuadrant2Text, "setQuadrant2Text");
function setQuadrant3Text(textObj) {
  quadrantBuilder.setData({ quadrant3Text: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setQuadrant3Text, "setQuadrant3Text");
function setQuadrant4Text(textObj) {
  quadrantBuilder.setData({ quadrant4Text: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setQuadrant4Text, "setQuadrant4Text");
function setXAxisLeftText(textObj) {
  quadrantBuilder.setData({ xAxisLeftText: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setXAxisLeftText, "setXAxisLeftText");
function setXAxisRightText(textObj) {
  quadrantBuilder.setData({ xAxisRightText: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setXAxisRightText, "setXAxisRightText");
function setYAxisTopText(textObj) {
  quadrantBuilder.setData({ yAxisTopText: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setYAxisTopText, "setYAxisTopText");
function setYAxisBottomText(textObj) {
  quadrantBuilder.setData({ yAxisBottomText: textSanitizer(textObj.text) });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setYAxisBottomText, "setYAxisBottomText");
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(parseStyles, "parseStyles");
...
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(addPoint, "addPoint");
function addClass(className, styles) {
  quadrantBuilder.addClass(className, parseStyles(styles));
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(addClass, "addClass");
function setWidth(width) {
  quadrantBuilder.setConfig({ chartWidth: width });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setWidth, "setWidth");
function setHeight(height) {
  quadrantBuilder.setConfig({ chartHeight: height });
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(setHeight, "setHeight");
function getQuadrantData() {
  const config2 = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .nV)();
  ...
  quadrantBuilder.setData({ titleText: (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .Kr)() });
  return quadrantBuilder.build();
}
(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getQuadrantData, "getQuadrantData");
var clear2 = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
  quadrantBuilder.clear();
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear */ .ZH)();
}, "clear");
var quadrantDb_default = {
  ...
  getQuadrantData,
  clear: clear2,
  setAccTitle: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setAccTitle */ .GN,
  getAccTitle: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getAccTitle */ .eu,
  setDiagramTitle: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setDiagramTitle */ .g2,
  getDiagramTitle: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .Kr,
  getAccDescription: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getAccDescription */ .Mx,
  setAccDescription: _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setAccDescription */ .U$
};

// src/diagrams/quadrant-chart/quadrantRenderer.ts

var draw = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((txt, id, _version, diagObj) => {
  function getDominantBaseLine(horizontalPos) {
    return horizontalPos === "top" ? "hanging" : "middle";
  }
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getDominantBaseLine, "getDominantBaseLine");
  function getTextAnchor(verticalPos) {
    return verticalPos === "left" ? "start" : "middle";
  }
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getTextAnchor, "getTextAnchor");
  function getTransformation(data) {
    return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
  }
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getTransformation, "getTransformation");
  const conf = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .nV)();
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.debug("Rendering quadrant chart\n" + txt);
  ...
  (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .v2)(svg, height, width, conf.quadrantChart?.useMaxWidth ?? true);
...
var diagram = {
  ...
  styles: /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(() => "", "styles")
};
...
//# sourceMappingURL=3614.c90823a680f54ad5681e.js.map?v=c90823a680f54ad5681e