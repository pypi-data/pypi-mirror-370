"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[1571],{
...
var ClassMember = class {
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(this, "ClassMember");
  }
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .sanitizeText */ .oO)(input, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .parseGenericTypes */ .UO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .parseGenericTypes */ .UO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .parseGenericTypes */ .UO)(this.returnType);
      }
    }
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((txt) => _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .SY.sanitizeText(txt, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((element) => {
      let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ys)(".mermaidTooltip");
      if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
        tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ys)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
      }
      const svg = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ys)(element).select("svg");
      const nodes = svg.selectAll("g.node");
      nodes.on("mouseover", (event) => {
        const el = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ys)(event.currentTarget);
    ...
    this.direction = "TB";
    this.setAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setAccTitle */ .GN;
    this.getAccTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getAccTitle */ .eu;
    this.setAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setAccDescription */ .U$;
    this.getAccDescription = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getAccDescription */ .Mx;
    this.setDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setDiagramTitle */ .g2;
    this.getDiagramTitle = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getDiagramTitle */ .Kr;
    this.getConfig = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(() => (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)().class, "getConfig");
  ...
  static {
    (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(this, "ClassDB");
  }
  splitClassNameAndType(_id) {
    const id = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .SY.sanitizeText(_id, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .SY.sanitizeText(className, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
  ...
  addRelation(classRelation) {
    _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug("Adding relation: " + JSON.stringify(classRelation));
    const invalidTypes = [
    ...
    classRelation.relationTitle1 = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .SY.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)()
    );
    classRelation.relationTitle2 = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .SY.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    const config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)();
    ids.split(",").forEach((_id) => {
      let id = _id;
      if (/\d/.exec(_id[0])) {
        id = MERMAID_DOM_ID_PREFIX + id;
      ...
      if (theClass) {
        theClass.link = _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .SY.sanitizeText(_domId, (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
    const config = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEdgeId */ .Ln)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var getStyles = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((options) => `g.classGroup text {
...
var getDir = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("REF0:");
  _chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("Drawing class diagram (v3)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_3XYRH5AP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)();
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_BFAMUDN2_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getDiagramElement */ .q)(id, securityLevel);
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getRegisteredLayoutAlgorithm */ ._b)(layout);
  data4Layout.nodeSpacing = conf?.nodeSpacing || 50;
  data4Layout.rankSpacing = conf?.rankSpacing || 50;
  data4Layout.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"];
  data4Layout.diagramId = id;
  await (0,_chunk_IWUHOULB_mjs__WEBPACK_IMPORTED_MODULE_3__/* .render */ .sY)(data4Layout, svg);
  const padding = 8;
  _chunk_55PJQP7W_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.insertTitle(
    svg,
    "classDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_SKB7J2MH_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupViewPortForSVG */ .j)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
...
//# sourceMappingURL=1571.5e2b49dcc1714afbd9f8.js.map?v=5e2b49dcc1714afbd9f8