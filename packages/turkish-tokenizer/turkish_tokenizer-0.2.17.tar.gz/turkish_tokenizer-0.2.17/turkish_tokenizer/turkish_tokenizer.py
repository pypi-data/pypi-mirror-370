...
class TurkishTokenizer:
    ...
    def __call__(self, text: str) -> Dict[str, List[int]]:
        """Make tokenizer instances callable.

        Returns a structure compatible with common tokenizer outputs.

        - input_ids: token ids produced by encode
        - attention_mask: list of 1s with the same length as input_ids
        """
