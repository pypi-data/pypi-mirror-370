...
`;var pe=r(7566),fe=r(40984),me=r(29898),ye=r(42879);function ve(e,t){const{dataType:r,formatter:n,config:o={}}=e,i=r===v.s.Numeric,l=void 0===o.d3SmallNumberFormat?n:o.currencyFormat?new fe.A({d3Format:o.d3SmallNumberFormat,currency:o.currencyFormat}):(0,me.gV)(o.d3SmallNumberFormat);return function(e,t){return void 0===t?[!1,""]:null===t||t instanceof ye.A&&null===t.input?[!1,"N/A"]:e?[!1,e(t)]:"string"==typeof t?(0,pe.fE)(t)?[!0,(0,pe.pn)(t)]:[!1,t]:[!1,t.toString()]}(i&&"number"==typeof t&&Math.abs(t)<1?l:n,t)}var be=r(25766);const we={enter:"Enter",spacebar:"Spacebar",space:" "};function Se(e){return e===v.s.Temporal?"datetime":e===v.s.String?"alphanumeric":"basic"}function ke({column:e}){const{isSorted:t,isSortedDesc:r}=e;let n=(0,c.Y)(g.M,{});return t&&(n=r?(0,c.Y)(p.G,{}):(0,c.Y)(f.X,{})),n}function Ce({count:e,value:t,onChange:r,onBlur:n,inputRef:o}){return(0,c.FD)(E.A,{direction:"horizontal",size:4,className:"dt-global-filter",children:[(0,b.t)("Search"),(0,c.Y)(N.A,{size:"small","aria-label":(0,b.t)("Search %s records",e),placeholder:(0,b.tn)("search.num_records",e),value:t,onChange:r,onBlur:n,ref:o})]})}function xe({options:e,current:t,onChange:r}){const{Option:n}=O.A;return(0,c.FD)(c.FK,{children:[(0,c.Y)("label",{htmlFor:"pageSizeSelect",className:"sr-only",children:(0,b.t)("Select page size")}),(0,b.t)("Show")," ",(0,c.Y)(O.A,{id:"pageSizeSelect",value:t,onChange:e=>r(e),size:"small",css:e=>w.AH`
        ...
        `,"aria-label":(0,b.t)("Show entries per page"),children:e.map((e=>{const[t,r]=Array.isArray(e)?e:[e,e];return(0,c.Y)(n,{value:Number(t),children:r},t)}))})," ",(0,b.t)("entries per page")]})}const Ae=e=>e?(0,b.t)("No matching records found"):(0,b.t)("No records found");function Ee(e){const{timeGrain:t,height:r,width:n,data:i,totals:a,isRawRecords:g,rowCount:p=0,columns:f,alignPositiveNegative:m=!1,colorPositiveNegative:v=!1,includeSearch:E=!1,pageSize:N=0,serverPagination:O=!1,serverPaginationData:z,setDataMask:H,showCellBars:D=!0,sortDesc:B=!1,filters:j,sticky:U=!0,columnColorFormatters:G,allowRearrangeColumns:_=!1,allowRenderHtml:W=!0,onContextMenu:V,emitCrossFilters:X,isUsingTimeComparison:K,basicColorFormatters:Q,basicColorColumnFormatters:Z,hasServerPageLengthChanged:q,serverPageLength:ee,slice_id:te}=e,re=[{key:"all",label:(0,b.t)("Display all")},{key:"#",label:"#"},{key:"△",label:"△"},{key:"%",label:"%"}],ne=(0,u.useCallback)((e=>(0,S.PT)(t)(e)),[t]),[oe,ie]=(0,u.useState)({width:0,height:0}),[ae,se]=(0,u.useState)(!1),[ce,ue]=(0,u.useState)(!1),[de,pe]=(0,u.useState)([re[0].key]),[fe,me]=(0,u.useState)([]),ye=(0,k.DP)(),Ee=(0,u.useMemo)((()=>(O?le.D:le.x).filter((([e])=>O?(e=>e<=p)(e):e<=2*i.length))),[i.length,p,O]),Ne=(0,u.useCallback)((function(e,t){const r=null==i?void 0:i.map((t=>null==t?void 0:t[e])).filter((e=>"number"==typeof e));return i&&r.length===i.length?t?[0,(0,d.A)(r.map(Math.abs))]:(0,h.A)(r):null}),[i]),Oe=(0,u.useCallback)((function(e,t){var r;return!!j&&(null==(r=j[e])?void 0:r.includes(t))}),[j]),Te=(e,r)=>{let n={...j||{}};n=j&&Oe(e,r)?{}:{[e]:[r]},Array.isArray(n[e])&&0===n[e].length&&delete n[e];const o=Object.keys(n),i=Object.values(n),l=[];return o.forEach((e=>{var t;const r=e===C.Tf,o=(0,x.A)(null==(t=n)?void 0:t[e]);if(o.length){const e=o.map((e=>r?ne(e):e));l.push(`${e.join(", ")}`)}})),{dataMask:{extraFormData:{filters:0===o.length?[]:o.map((e=>{var r;const o=(0,x.A)(null==(r=n)?void 0:r[e]);return o.length?{col:e,op:"IN",val:o.map((e=>e instanceof Date?e.getTime():e)),grain:e===C.Tf?t:void 0}:{col:e,op:"IS NULL"}}))},filterState:{label:l.join(", "),value:i.length?i:null,filters:n&&Object.keys(n).length?n:null}},isCurrentValueSelected:Oe(e,r)}},Ye=(0,u.useCallback)((function(e,t){X&&H(Te(e,t).dataMask)}),[X,Te,H]),Ie=[(0,b.t)("Main"),"#","△","%"],Me=(0,u.useMemo)((()=>{if(!K)return f;const e=re[0].key,t=Ie[0],r=de.includes(e);return f.filter((({label:e,key:n})=>{const o=n.substring(e.length),i=fe.includes(o);return e===t||!i&&(!Ie.includes(e)||r||de.includes(e))}))}),[f,re,Ie,K,fe,de]),Pe=V&&!g?(e,t,r,n)=>{const o=[];Me.forEach((t=>{if(!t.isMetric){const r=e[t.key];o.push({col:t.key,op:"==",val:r,formattedVal:ve(t,r)[1]})}})),V(r,n,{drillToDetail:o,crossFilter:t.isMetric?void 0:Te(t.key,t.value),drillBy:t.isMetric?void 0:{filters:[{col:t.key,op:"==",val:t.value}],groupbyFieldName:"groupby"}})}:void 0,$e=(0,u.useMemo)((()=>((e,t)=>{const r={};return t?(e.forEach(((e,t)=>{if(Ie.includes(e.label)){const n=e.key.substring(e.label.length);r[n]?r[n].push(t):r[n]=[t]}})),r):r})(Me,K)),[Me,K]),Fe=(0,u.useCallback)(((e,t)=>{const{key:r,label:n,isNumeric:o,dataType:i,isMetric:l,isPercentMetric:s,config:u={}}=e,d=u.customColumnName||n;let h=d;["#","△","%",(0,b.t)("Main")].includes(e.label)&&(e.label===(0,b.t)("Main")?h=u.customColumnName||e.originalLabel||"":u.customColumnName?h=!1!==u.displayTypeIcon?`${e.label} ${u.customColumnName}`:u.customColumnName:!1===u.displayTypeIcon&&(h=""));const p=Number.isNaN(Number(u.columnWidth))?u.columnWidth:Number(u.columnWidth),f=(e=>{const{isNumeric:t,config:r={}}=e;return{textAlign:r.horizontalAlign||(t&&!K?"right":"left")}})(e),S=void 0===u.alignPositiveNegative?m:u.alignPositiveNegative,C=void 0===u.colorPositiveNegative?v:u.colorPositiveNegative,{truncateLongCells:x}=u,E=o&&Array.isArray(G)&&G.length>0,N=K&&Array.isArray(Q)&&Q.length>0,O=!N&&!E&&(void 0===u.showCellBars?D:u.showCellBars)&&(l||g||s)&&Ne(r,S);let T="";if(X&&!l&&(T+=" dt-is-filter"),l||s){if(Ie.includes(d)){const e=r.substring(d.length),n=$e[e]||[];t===n[n.length-1]&&(T+=" right-border-only")}}else T+=" right-border-only";return{id:String(t),columnKey:r,accessor:e=>e[r],Cell:({value:t,row:n})=>{var o;const[i,a]=ve(e,t),s=i&&W?{__html:a}:void 0;let u,d="";const h=e.key.substring(e.label.length).trim();var g,m,v,b;!E&&N&&(u=null==(g=Q[n.index][h])?void 0:g.backgroundColor,d=e.label===Ie[0]?null==(m=Q[n.index][h])?void 0:m.mainArrow:""),E&&G.filter((t=>t.column===e.key)).forEach((e=>{const r=!(!t&&0!==t)&&e.getColorFromValue(t);r&&(u=r)})),Z&&(null==Z?void 0:Z.length)>0&&(u=(null==(v=Z[n.index][e.key])?void 0:v.backgroundColor)||u,d=e.label===Ie[0]?null==(b=Z[n.index][e.key])?void 0:b.mainArrow:"");const Y=k.I4.td`
          ...
          `;var P;Z&&(null==Z?void 0:Z.length)>0&&(M=w.AH`
              ...
              margin-right: ${ye.sizeUnit}px;
            `);const $={"aria-labelledby":`header-${e.key}`,role:"cell",title:"number"==typeof t?String(t):void 0,onClick:!X||O||l?void 0:()=>{(0,A.j)()||Ye(r,t)},onContextMenu:e=>{Pe&&(e.preventDefault(),e.stopPropagation(),Pe(n.original,{key:r,value:t,isMetric:l},e.nativeEvent.clientX,e.nativeEvent.clientY))},className:[T,null==t?"dt-is-null":"",Oe(r,t)?" dt-is-active-filter":""].join(" "),tabIndex:0};return s?x?(0,c.Y)(Y,{...$,children:(0,c.Y)("div",{className:"dt-truncate-cell",style:p?{width:p}:void 0,dangerouslySetInnerHTML:s})}):(0,c.Y)(Y,{...$,dangerouslySetInnerHTML:s}):(0,c.FD)(Y,{...$,children:[O&&(0,c.Y)("div",{className:y()("cell-bar","number"==typeof t&&t<0?"negative":"positive"),css:I,role:"presentation"}),x?(0,c.FD)("div",{className:"dt-truncate-cell",style:p?{width:p}:void 0,children:[d&&(0,c.Y)("span",{css:M,children:d}),a]}):(0,c.FD)(c.FK,{children:[d&&(0,c.Y)("span",{css:M,children:d}),a]})]})},Header:({column:t,onClick:r,style:n,onDragStart:o,onDrop:i})=>(0,c.FD)("th",{id:`header-${e.originalLabel}`,title:(0,b.t)("Shift + Click to sort by multiple columns"),className:[T,t.isSorted?"is-sorted":""].join(" "),style:{...f,...n},onKeyDown:e=>{Object.values(we).includes(e.key)&&t.toggleSortBy()},role:"columnheader button",onClick:r,"data-column-name":t.id,..._&&{draggable:"true",onDragStart:o,onDragOver:e=>e.preventDefault(),onDragEnter:e=>e.preventDefault(),onDrop:i},tabIndex:0,children:[u.columnWidth?(0,c.Y)("div",{style:{width:p,height:.01}}):null,(0,c.FD)("div",{"data-column-name":t.id,css:{display:"inline-flex",alignItems:"flex-end"},children:[(0,c.Y)("span",{"data-column-name":t.id,children:h}),(0,c.Y)(ke,{column:t})]})]}),Footer:a?0===t?(0,c.Y)("th",{children:(0,c.FD)("div",{css:w.AH`
                  display: flex;
                  align-items: center;
                  & svg {
        ...
        `,children:e})},renderTimeComparisonDropdown:K?()=>{const e=re[0].key;return(0,c.Y)(T.ms,{placement:"bottomRight",open:ce,onOpenChange:e=>{ue(e)},menu:{multiple:!0,onClick:t=>{const{key:r}=t;r===e?pe([e]):de.includes(e)?pe([r]):pe(de.includes(r)?de.filter((e=>e!==r)):[...de,r])},onBlur:()=>{3===de.length&&pe([re[0].key])},selectedKeys:de,items:[{key:"all",label:(0,c.Y)("div",{css:w.AH`
                    max-width: 242px;
