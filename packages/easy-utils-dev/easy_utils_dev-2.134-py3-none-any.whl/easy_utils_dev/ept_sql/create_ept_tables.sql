...
CREATE TABLE PREAMP ( 
 ...
 width TEXT ,
 external TEXT ,
 supportsGainMode TEXT ,
 useNetGain TEXT ,
 minOscSfpDropLoss TEXT ,
 maxOscSfpDropLoss TEXT ,
 release TEXT ,
 hasPowerRanges TEXT ,
 belongHybridOA TEXT ,
 MinPreAmpVOA TEXT ,
...
CREATE INDEX idx_circuitpack_parent     ON circuitpack(parentId);
CREATE INDEX idx_circuitpack_wdmline    ON circuitpack(wdmline);
CREATE INDEX idx_circuitpack_slotid     ON circuitpack(slotid);
CREATE INDEX idx_shelf_id               ON shelf(id);
CREATE INDEX idx_shelf_grandparent      ON shelf(grandparentId);
CREATE INDEX idx_shelf_type             ON shelf(type);
CREATE INDEX idx_line_id                ON "line"(id);
CREATE INDEX idx_line_span              ON "line"(span);
