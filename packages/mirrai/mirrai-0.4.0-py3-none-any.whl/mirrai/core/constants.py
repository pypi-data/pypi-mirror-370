...
WINDOW_FOCUS_DELAY = 0.5  # seconds
WINDOW_FOCUS_ENSURE_DELAY = 0.1  # seconds

# Typing speed constants
TYPING_WPM = 777  # Words per minute
# Assuming average word is 5 chars, convert WPM to millisecond delay between keystrokes
TYPING_DELAY_MS = int(60000 / (TYPING_WPM * 5))
