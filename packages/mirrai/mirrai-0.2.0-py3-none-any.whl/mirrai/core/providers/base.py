...
# Import provider-specific types for the union
if TYPE_CHECKING:
    from openai.types.chat import ChatCompletionToolParam

# Union type for all possible tool definition return types
ProviderToolDefinition = Union[
    Dict[str, Any],  # Anthropic returns a dict version of BetaToolComputerUse20250124Param
    "ChatCompletionToolParam",  # OpenRouter/OpenAI returns this type
]
