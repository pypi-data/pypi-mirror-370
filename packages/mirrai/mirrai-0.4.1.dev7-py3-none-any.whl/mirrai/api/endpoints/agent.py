...
from mirrai.api.converters import agent_execution_to_api_response
...
async def get_execution(
    ...
    try:
        ...
        return agent_execution_to_api_response(execution)
...
async def list_executions(
    ...
    return ExecutionListResponse(
        executions=[agent_execution_to_api_response(e) for e in executions],
        total=total,
        limit=limit,
        offset=offset,
    )
