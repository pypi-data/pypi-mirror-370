...
class MediaMessage(Message):
    ...
    media_hash: Optional[str] = None  # Hash do arquivo para deduplicação
    media_storage_path: Optional[str] = None  # Caminho no storage (S3, etc.)
    ...
    def __post_init__(self):
        ...
        # Definir tipo de mensagem baseado na extensão
