# 🚀 PyWhatsWeb v0.4.3 - Guia para Desenvolvedores
...
### 🎯 **O QUE A BIBLIOTECA FAZ AGORA (v0.4.3)**
...
### **📋 [v0.4.3] - 2025-01-XX - Compatibilidade Python 3.13**
...
| **Sidecar** | v0.4.3 | v0.4.3+ | Health check `/health` | ✅ Verificado |
