...
from ctypes import c_size_t, c_char_p, c_bool, c_void_p
...
from apronpy.manager import PyManager, MemBuf
...
class PyAbstract1(metaclass=ABCMeta):
    ...
    def serialize(self):
        return libapron.ap_abstract1_serialize_raw(self.manager, self)
...
libapron.ap_abstract1_serialize_raw.argtypes = [man_p, pya1]
libapron.ap_abstract1_serialize_raw.restype = MemBuf
# ap_abstract1_t ap_abstract1_deserialize_raw(ap_manager_t* man, void* ptr, size_t* size);
libapron.ap_abstract1_deserialize_raw.argtypes = [man_p, c_void_p, c_size_t]
libapron.ap_abstract1_deserialize_raw.restype = Abstract1
