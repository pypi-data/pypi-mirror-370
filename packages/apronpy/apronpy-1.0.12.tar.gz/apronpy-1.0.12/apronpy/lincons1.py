...
class Lincons1(Structure):
    ...
    def __deepcopy__(self, memodict=None):
        ...
        if self.lincons0.scalar:
            result.lincons0.scalar = libapron.ap_scalar_alloc_set(self.lincons0.scalar)
        else:
...
class PyLincons1:
    ...
    def __init__(self, lincons1_or_typ: Union[Lincons1, ConsTyp], linexpr: PyLinexpr1 = None, scalar: PyScalar = None):
        if isinstance(lincons1_or_typ, Lincons1):
            ...
            if scalar:
                scalar_copy = deepcopy(scalar.scalar.contents)
                s = libapron.ap_scalar_alloc_set(byref(scalar_copy))
                self.lincons1.lincons0.scalar = s
