...
if _sys.version_info >= (3, 10):
    ...
    _U = _var("_U", bound = __.TypingUnionType) # type: ignore
    _UKT = _var("_UKT", bound = __.TypingUnionType) # type: ignore
    _UVT = _var("_UVT", bound = __.TypingUnionType) # type: ignore
...
_ProbabilityType = _uni[
    ...
    __.AVT_Mapping[_T, _uni[int, _EllipsisType, None]]
...
def _get_all_item_types(i: __.AVT_Iterable[_T], /): # 0.3.51
        ...
        if isinstance(type, _UnionTypes):
            ...
            for e in _unique_:
                if not isinstance(e, _Type):
                    error = TypeError("not all items in a tuple are types") 
                    raise error
            
        _exclude_generics_ = tuple([e for e in _unique_ if not isinstance(e, _GenericTypes)])
        _generics_ = tuple([e for e in _unique_ if isinstance(e, _GenericTypes)])
        
        # typing.Any is not generic type. once typing.Any is found, always return 'True'
        # update for 0.3.52
...
class Tense( # 0.3.24
    ...
    @classmethod
    def isList(self, v, /, type = _Any) -> __.TypeIs[__.AVT_List[_T]]:
        """
        @lifetime >= 0.3.26rc1 \\
    ...
    @classmethod
    @__.overload
    def isDict(self, v: _Any, /, ktype: type[_KT] = _Any, vtype: type[_VT] = _Any) -> __.TypeIs[__.AVT_Dict[_KT, _VT]]: ...
    
    @classmethod
    @__.overload
    def isDict(self, v: _Any, /, ktype: type[_KT], vtype: __.AVT_Tuple[__.AVT_Type[_VT], ...]) -> __.TypeIs[__.AVT_Dict[_KT, _VT]]: ...
    ...
    @classmethod
    @__.overload
    def startswith(self, target: __.Union[bytes, __.AVT_Tuple[bytes, ...]], prefix: __.Union[__.Buffer, __.AVT_Tuple[__.Buffer, ...]], /, mode: _Mode = _MODE_OR, start: int = ..., end: int = ...) -> bool: ...
    ...
    @classmethod
    @__.overload
    def endswith(self, target: __.Union[bytes, __.AVT_Tuple[bytes, ...]], prefix: __.Union[__.Buffer, __.AVT_Tuple[__.Buffer, ...]], /, mode: _Mode = _MODE_OR, start: int = ..., end: int = ...) -> bool: ...
    ...
    def getGeneric(self, v: _Any, /):
        ...
        Tense.getGeneric([762])
        # list[int]
        Tense.getGeneric([762, "762"])
        # list[int | str] >= 3.10
        # list[typing.Union[int, str]] < 3.10
        ```
        """
        
        # inspect union expressions (>=3.10)
        def _prepare_union_(*v: type):
        ...
        if isinstance(v, __.Iterable):
            ...
            if isinstance(v, (__.Sequence, __.Uniqual)):
                return _generic_(type(v),
                    _prepare_union_(*self.getAllItemsTypes(list(v)))
                ) if reckon(v) > 0 else None
                ...
                _list_from_gen_ = list(v)
                
                # NOTE: if type(v) is used freely without conditions such as these, the 'generator' would be used as the
                # origin, what is not desired overall
                _type_origin_ = __.Generator if __.Generator not in getattr(v, "__subclasses__", lambda: [object])() else type(v)
            
                # 'send' and 'return' type parameters in both generators and coroutines cannot be deduced
                # normally. since py3.13, the 'close()' method can return the 'return' type, but it doesn't
                # change for 'send' type parameter. we will leave it 'typing.Any' in this case. 'yield'
                # is the easiest to receive
            ...
            if isinstance(v, __.Coroutine):
                ...
                _type_origin_ = __.Coroutine if __.Coroutine not in getattr(v, "__subclasses__", lambda: [object])() else type(v)
                ...
                _type_origin_ = __.Awaitable if __.Awaitable not in getattr(v, "__subclasses__", lambda: [object])() else type(v)
        ...
        elif isinstance(v,(__.FunctionType, __.MethodType)):
    ...
    @classmethod
    @__.overload
    def invert(self, v: _uni[__.Sequence[_uni[int, float]], __.Uniqual[_uni[int, float]], _ab_mod.AbroadInitializer], /) -> __.AVT_List[float]: ...
    ...
    if versionInfo >= (0, 3, 46) or True:
        ...
        @classmethod
        def probability3(self, vf: __.AVT_Mapping[_T, __.Union[int, _EllipsisType]], /):
            """
            @lifetime >= 0.3.46 \\
        ...
        def probability(self, *vf: _ProbabilityType[_T]):
            ...
            if reckon(vf) == 0:
                ...
                e = self.cast(e, __.AVT_Mapping[_T, _uni[int, _EllipsisType, None]])
