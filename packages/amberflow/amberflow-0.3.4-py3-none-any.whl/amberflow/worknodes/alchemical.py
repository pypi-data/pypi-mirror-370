...
class LambdaMDRun(BaseLambdaMDWorkNode):
    ...
    def _run(
        ...
        **kwargs,
        ...
        # If a reference structure wass passed in, copy it to the working dir
        ...
        for clambda, state_rst7 in zip(schdl.formatted(), in_states_rst7.values()):
            ...
            # If the reference rst7 file is provided, use it. Otherwise, use the input rst7 file.
            ref = in_rst7_name if ref is None else ref
