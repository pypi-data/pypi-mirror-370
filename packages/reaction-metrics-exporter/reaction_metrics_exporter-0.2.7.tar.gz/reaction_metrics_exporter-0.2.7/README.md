...
> ⚠️ If you run the exporter before reaction, you'll need to restart the exporter so it gains access to the socket. Further reaction's restarts are automatically handled.
