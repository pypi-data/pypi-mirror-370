...
"""
    ...
    The version of the OpenAPI document: 1.0.0-rc.69
...
class IndexingSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["algorithm", "fft_max_unit_cell_A", "fft_min_unit_cell_A", "fft_high_resolution_A", "fft_num_vectors", "tolerance", "thread_count", "unit_cell_dist_tolerance"]
