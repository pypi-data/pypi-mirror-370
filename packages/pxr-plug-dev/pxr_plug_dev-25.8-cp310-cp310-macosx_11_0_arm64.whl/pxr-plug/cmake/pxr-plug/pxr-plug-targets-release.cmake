...
set_target_properties(pxr::pyPlug PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "@rpath/_plug.so"
  )
...
set_target_properties(pxr::plug PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-plug/lib/libPxrPlug.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPxrPlug.dylib"
  )

list(APPEND _cmake_import_check_targets pxr::plug )
list(APPEND _cmake_import_check_files_for_pxr::plug "${_IMPORT_PREFIX}/pxr-plug/lib/libPxrPlug.dylib" )
