...
```bash
# Quick conversation with preset
duotalk preset debate "Climate change solutions" --max-turns 8

# Interactive conversation builder
duotalk interactive

# Custom conversation
duotalk start "The future of AI" --mode roundtable --agent optimist --agent skeptic --agent pragmatist
