        ...
        **kwargs: Any,
        ...
        try:
            ...
            if result.fixes_applied > 0 and mode == "fix":
                ...
                result.set_automated_log(f"Found {result.issues_found} empty cells.")
            else:
        ...
        try:
            ...
            for sheet_name in sheet_names:
                ...
                if has_illegal_chars or exceeds_excel_limit:
                    ...
                    message += f"Illegal chars: {detected_chars}" if detected_chars else ""
                    message += f" Length: {len(sheet_name)} > 31" if exceeds_excel_limit else ""
            ...
            if result.fixes_applied > 0 and mode == "fix":
                ...
                result.set_automated_log(f"Found {result.issues_found} tab name issues.")
            else:
                result.set_automated_log("No issues found")
