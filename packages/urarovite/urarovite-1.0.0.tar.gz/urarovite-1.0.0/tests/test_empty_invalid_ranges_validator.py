...
class TestEmptyInvalidRangesValidator(unittest.TestCase):
    ...
    def test_validate_with_empty_sheet(self, mock_get_spreadsheet):
        ...
        with patch.object(self.validator, '_get_all_sheet_data', return_value=([], "Sheet1")):
    ...
    def test_validate_no_columns_detected(self, mock_get_spreadsheet):
        ...
        with patch.object(self.validator, '_get_all_sheet_data', return_value=(test_data, "Sheet1")):
            result = self.validator.validate(
                spreadsheet_source="https://docs.google.com/spreadsheets/d/test_id/edit",
                mode="flag",
                auth_credentials={"encoded_credentials": "fake_creds"}
        ...
        self.assertEqual(result["details"]["valid_ranges"], 0)
    ...
    def test_validate_successful_validation(self, mock_get_spreadsheet):
        ...
        with patch.object(self.validator, '_get_all_sheet_data', return_value=(test_data, "Sheet1")):
            with patch.object(self.validator, '_create_sheets_service'):
                with patch.object(self.validator, '_validate_sheet_range', 
        ...
        self.assertEqual(result["details"]["valid_ranges"], 1)
        self.assertEqual(result["details"]["message"], "All ranges are valid and non-empty")
    ...
    def test_validate_with_invalid_ranges(self, mock_get_spreadsheet):
        ...
        with patch.object(self.validator, '_get_all_sheet_data', return_value=(test_data, "Sheet1")):
            with patch.object(self.validator, '_create_sheets_service'):
                with patch.object(self.validator, '_validate_sheet_range', side_effect=mock_validate_range):
                    result = self.validator.validate(
                        spreadsheet_source="https://docs.google.com/spreadsheets/d/test_id/edit",
                        mode="flag",
                        auth_credentials={"encoded_credentials": "fake_creds"},
        ...
        self.assertEqual(result["details"]["valid_ranges"], 1)
        self.assertEqual(len(result["details"]["invalid_ranges"]), 1)
        self.assertEqual(result["details"]["invalid_ranges"][0]["row"], 3)
        self.assertEqual(result["details"]["invalid_ranges"][0]["range"], "InvalidRange")
    ...
    def test_validate_with_exception(self, mock_get_spreadsheet):
        ...
        with patch.object(self.validator, '_get_all_sheet_data', 
