...
def execute_validation(
    ...
    Returns:
        Dict with validation results:
        {
            ...
            "flags_flagged": int,     # Count of flags found but not fixed
            ...
            try:
                ...
                if _should_use_local_excel_optimizer(sheet_url, target, target_format):
                    ...
                    if optimizer_result["success"]:
                        ...
                        result["flags_flagged"] = validation_results["flags_flagged"]
                ...
                if mode == "fix":
                    ...
                    result["flags_flagged"] += validation_result.get("flags_found", 0)
                else:
                    result["flags_flagged"] += validation_result.get("flags_found", 0)
                ...
                if not automated_log:
                    ...
                    elif mode == "flag" and result["flags_flagged"] > 0:
                        automated_log = f"Flagged {result['flags_flagged']} flags"
                        logger.info(f"Validation {check_id}: {automated_log}")
                    else:
    ...
    if result.get("errors"):
        ...
        elif result.get("flags_flagged", 0) > 0:
            success_msg += f" - {result['flags_flagged']} flags found"
        ...
        for check in checks:
            ...
            try:
                ...
                individual_result = {
                    ...
                    "flags_flagged": validation_result.get("flags_flagged", 0),
