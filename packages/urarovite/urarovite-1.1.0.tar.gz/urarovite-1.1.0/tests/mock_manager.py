...
class MockManager:
    ...
    def validation_scenario(
        ...
        Example:
            with mock_manager.validation_scenario({
                ...
                "duplicate_rows": {"issues_found": 2}
            }) as mocks:
                result = execute_validation(...)
        """
        # Default validator configs
        if validator_configs is None:
            validator_configs = {"empty_cells": {"fixes_applied": 3, "issues_found": 0}}
    ...
    def integration_scenario(
        ...
        with (
            ...
            total_issues = sum(v.get("issues_found", 0) for v in validators.values())
            ...
            mock_optimizer.optimize_excel_workflow.return_value = {
                ...
                "validation_results": {
                    ...
                    "issues_flagged": total_issues,
                    "errors": [],
                    "automated_logs": [f"Applied {total_fixes} fixes"],
                    "processing_time": 0.3,
                },
