                ...
                if _should_use_local_excel_optimizer(sheet_url, target, target_format):
                    ...
                    if optimizer_result["success"]:
                        ...
                        result["automated_logs"] = "; ".join(
                            validation_results["automated_logs"]
                        )
    ...
    try:
        ...
        for check in checks:
            ...
            try:
                ...
                result["summary"]["total_issues"] += validation_result.get(
                    "issues_flagged", 0
                )
                ...
                for input_sheet in sheet_pair["input_sheets"]:
                    ...
                    try:
                        ...
                        if input_result["success"]:
                            ...
                            result["summary"]["total_input_issues"] += input_result[
                                "summary"
                            ]["total_issues"]
                        else:
                ...
                for output_sheet in sheet_pair["output_sheets"]:
                    ...
                    try:
                        ...
                        if output_result["success"]:
                            ...
                            result["summary"]["total_output_issues"] += output_result[
                                "summary"
                            ]["total_issues"]
                        else:
                            pair_result["success"] = False
                ...
                try:
                    ...
                    for row_idx, row in enumerate(
                        ...
                        if matching_results:
                            ...
                            if (
                                input_total_issues > 0
                                and input_issues_col in column_indices
                            ):
                                updated_row[column_indices[input_issues_col]] = str(
                                    input_total_issues
                                )
                            ...
                            if (
                                output_total_issues > 0
                                and output_issues_col in column_indices
                            ):
                                updated_row[column_indices[output_issues_col]] = str(
                                    output_total_issues
                                )
