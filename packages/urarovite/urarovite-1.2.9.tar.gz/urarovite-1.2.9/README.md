...
- **Column Name**: `"[utility-name] result"` (e.g., `"batch-sanitize-tab-names result"`)
...
```
| tabs_to_fix | batch-sanitize-tab-names result | batch-validate-a1-ranges result |
|-------------|----------------------------------|----------------------------------|
| sheet1_url  | Passed                           | Passed                           |
| sheet2_url  | Passed                           | Failed                           |
| sheet3_url  | Failed                           | Passed                           |
```
