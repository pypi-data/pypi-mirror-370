...
class ExcelSpreadsheet(SpreadsheetInterface):
    ...
    def __init__(self, file_path: Path, read_only: bool = False, preserve_formulas: bool = True, create_new: bool = False) -> None:
        ...
        try:
            ...
            if range_name:
                ...
                try:
                    ...
                    cell_range = worksheet[f'{get_column_letter(start_col)}{start_row}:{end_col_letter}{end_row}']
