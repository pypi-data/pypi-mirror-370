...
class CloudPods:
    ...
    @enter_and_leave_function
    def create_server_by_guest_image(self,guest_image_id,disk_image_id,arch, disk_size, disks, nets_list, vm_name, sku,count=1,reset_new_password="",hypervisor="kvm"):
        if arch == "x86_64":
            bios="BIOS"
        else:
            bios="UEFI"
        ...
        server = {
            ...
            "bios": bios,
            "schedtags": [{"id": "094cfe0f-7fbf-451f-879d-d44151539240", "strategy": "exclude"}],
        }
