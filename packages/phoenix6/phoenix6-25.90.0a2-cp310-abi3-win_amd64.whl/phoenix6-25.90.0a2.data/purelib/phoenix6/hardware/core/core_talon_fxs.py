...
from phoenix6.signals.spn_enums import ForwardLimitValue, ReverseLimitValue, AppliedRotorPolarityValue, ControlModeValue, ExternalMotorTempStatusValue, MotionMagicIsRunningValue, RobotEnableValue, DeviceEnableValue, MotorOutputStatusValue, DifferentialControlModeValue, BridgeOutputValue, ConnectedMotorValue
...
class CoreTalonFXS(ParentDevice, CommonTalonWithExternalMotor):
    ...
    def get_five_v_rail_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        :rtype: StatusSignal[volt]
        """
        return self._common_lookup(SpnValue.TALON_FXS_5_V_RAIL_VOLTAGE.value, None, "five_v_rail_voltage", volt, True, refresh)
