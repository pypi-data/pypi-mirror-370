...
class ParentDevice:
    ...
    def __init__(self, device_id: int, model: str, canbus: CANBus):
        ...
        :type canbus: CANBus
        """
        self._device_identifier = DeviceIdentifier(device_id, model, canbus.name)
        ...
        self.__version_status = StatusCode.COULD_NOT_RETRIEVE_V6_FIRMWARE
    ...
    def _common_lookup(self, spn: int, generator: Callable[[], dict[int, str]] | None, signal_name: str, signal_type: type[T], report_on_construction: bool, refresh: bool) -> StatusSignal[T]:
