...
class FireAnimation:
    ...
    :type slot: int
    :param brightness:    The brightness of the animation, as a scalar from 0.0 to
                          1.0.
    :type brightness: float
    :param direction:    The direction of the animation.
    :type direction: AnimationDirectionValue
    :param sparking:    The proportion of time in which sparks reignite the fire, as
                        a scalar from 0.0 to 1.0.
    :type sparking: float
    :param cooling:    The rate at which the fire cools along the travel, as a
    ...
    :param frame_rate:    The frame rate of the animation, from [2, 1000] Hz. This
                          ...
                          A frame is defined as a transition in the state of the
                          LEDs, advancing the animation of the fire.
