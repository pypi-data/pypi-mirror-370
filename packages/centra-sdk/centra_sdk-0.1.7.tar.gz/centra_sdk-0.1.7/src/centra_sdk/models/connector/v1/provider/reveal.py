...
class ConnectionInfo(BaseModel):
    ...
    enforcement: Optional[EnforcementInfo] = Field(
        None, description='Additional enforcement information.'
    )
    ...
    source_inventory_item_info: Optional[InventoryItem] = Field(
        None,
        alias='source-inventory-item-info',
    ...
    destination_inventory_item_info: Optional[InventoryItem] = Field(
        None,
        alias='destination-inventory-item-info',
    ...
    bucket_start_time: Optional[int] = Field(
        None,
        alias='bucket-start-time',
        description='Start time of the network event.** for aggregated events (epoch in seconds)',
    )
    bucket_end_time: Optional[int] = Field(
        None,
        alias='bucket-end-time',
