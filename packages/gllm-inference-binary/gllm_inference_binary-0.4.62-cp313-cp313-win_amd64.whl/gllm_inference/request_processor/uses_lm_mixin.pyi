...
class UsesLM:
    ...
    '''
    @classmethod
    def from_lm_components(cls, prompt_builder: PromptBuilder | BasePromptBuilder | MultimodalPromptBuilder, lm_invoker: BaseLMInvoker | BaseMultimodalLMInvoker, output_parser: BaseOutputParser | None = None, **kwargs: Any):
