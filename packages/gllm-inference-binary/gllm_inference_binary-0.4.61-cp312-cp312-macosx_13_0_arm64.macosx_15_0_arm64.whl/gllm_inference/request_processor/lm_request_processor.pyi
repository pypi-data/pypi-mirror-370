    ...
    async def process(self, prompt_kwargs: dict[str, Any], history: MultimodalPrompt | None = None, extra_contents: list[MultimodalContent] | None = None, hyperparameters: dict[str, Any] | None = None, event_emitter: EventEmitter | None = None, attachments: list[Attachment] | None = None, system_multimodal_contents: list[Any] | None = None, user_multimodal_contents: list[Any] | None = None, auto_execute_tools: bool = True, max_lm_calls: int = 5) -> Any:
        ...
        Args:
            ...
            history (MultimodalPrompt | None, optional): A list of conversation history to be included in the prompt.
                Defaults to None.
            extra_contents (list[MultimodalContent] | None, optional): A list of extra contents to be included in the
