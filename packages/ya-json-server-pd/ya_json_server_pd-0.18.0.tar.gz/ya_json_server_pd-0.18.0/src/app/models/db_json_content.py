...
class JsonContentModel:
    ...
    def __init__(self, db_json_filename: str = DB_JSON_FILENAME):
    ...
    def get_data_by_resource_name(self, resource, page, limit):
        ...
        result = self._json_data[resource][low_limit:high_limit]
    ...
    def get_resources_list_and_one_data(self):
        resources = self._json_data.keys()

        result = {resource: {**self._json_data[resource][0]} for resource in resources}
