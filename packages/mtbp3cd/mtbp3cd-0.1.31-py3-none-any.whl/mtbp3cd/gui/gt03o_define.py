...
class TabDefine(QWidget):
    def __init__(self, _p):
        ...
        self.tab_sd_igdef_table.setHorizontalHeaderLabels(["Key", "Value", "Description"])
        ...
        self.tab_ad_igdef_table.setHorizontalHeaderLabels(["Key", "Value", "Description"])
                    ...
                    if mdv is not None:
                        ...
                        for ig_idx, ig in enumerate(itemgroupdef_list):
                            ...
                            for itemref in itemref_list:
                                ...
                                item_oid = item_oid.replace(f".{ig_attr_oid}", "")
                                if item_oid:
                                    if mandatory == "Yes":
