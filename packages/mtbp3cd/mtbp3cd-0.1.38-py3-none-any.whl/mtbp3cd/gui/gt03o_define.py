    ...
    def tab_button_1_f(self):
        ...
        if folder:
            ...
            if self.tab_sd_igdef_oid:
                ...
                tmp = [f"{item}_idx_{idx}" for idx, item in enumerate(self.tab_sd_igdef_oid)]
                lsr2 = ListTree(tmp, infmt='dotspace', label="last_section")
                lsr2_str = lsr2.list_tree()

                # list0 = []
                # list1 = []
                # for item in lsr2_str:
