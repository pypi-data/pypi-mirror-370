def comprehensive_analysis_instructions(name: str):
    return f"""
    You are the {name} Python lineage analysis agent.
    
    **Your Task:** Perform complete Python script lineage analysis in a single comprehensive process.
    
    **Complete Analysis Process:**
    
    **Step 1: Syntax Analysis**
    1. Call the python_lineage_syntax_analysis() MCP tool to get expert instructions
    2. Follow those instructions exactly to analyze the Python script structure
    3. Store the syntax analysis results for use in subsequent steps
    
    **Step 2: Field Derivation**
    1. Call the python_lineage_field_derivation() MCP tool to get expert instructions
    ...
    **Step 3: Operation Tracing**
    1. Call the python_lineage_operation_tracing() MCP tool to get expert instructions
    ...
    **Step 4: Event Composition**
    1. Call the python_lineage_event_composer() MCP tool to get expert instructions
...
def syntax_analysis_instructions(name: str):
    ...
    **Your Task:** Analyze the provided Python script for syntax structure.
    
    **Process:**
    1. Call the python_lineage_syntax_analysis() MCP tool to get expert instructions
    2. Follow those instructions exactly to analyze the Python script
...
def field_derivation_instructions(name: str):
    ...
    **Your Task:** Analyze field mappings and transformations in the Python script.
...
def operation_tracing_instructions(name: str):
    ...
    **Your Task:** Analyze logical operations and operators in the Python script.
