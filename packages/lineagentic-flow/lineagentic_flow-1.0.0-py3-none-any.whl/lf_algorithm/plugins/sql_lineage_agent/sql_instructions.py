def comprehensive_analysis_instructions(name: str):
    ...
    **Your Task:** Perform complete SQL query lineage analysis in a single comprehensive process.
    
    **Complete Analysis Process:**
    
    **Step 1: Syntax Analysis**
    1. Call the sql_lineage_syntax_analysis() MCP tool to get expert instructions
    2. Follow those instructions exactly to analyze the SQL query structure
...
def graph_builder_instructions(name: str):  
    ...
    **Your Task:** Build knowledge graph from the SQL query analysis.
    
    **Process:**
    1. Call the sql_lineage_graph_builder() MCP tool to get expert instructions
    2. Follow those instructions exactly to build the knowledge graph
    3. Return the graph in the format specified by the MCP tool
