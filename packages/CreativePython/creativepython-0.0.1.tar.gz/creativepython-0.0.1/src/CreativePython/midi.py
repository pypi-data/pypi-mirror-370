...
class MidiOut:
   ...
   def note(self, pitch, start, duration, velocity=100, channel=0, panning = -1):
      ...
      noteOn = Timer(start, self.noteOn, [pitch, velocity, channel, panning], False)
   ...
   def frequency(self, frequency, start, duration, velocity=100, channel=0, panning = -1):
      ...
      frequencyOn = Timer(start, self.frequencyOn, [frequency, velocity, channel, panning], False)

      # create a timer for the frequency-off event
      frequencyOff = Timer(start+duration, self.frequencyOff, [frequency, channel], False)
