...
def get_args_and_run():
    ...
    if(args.action == "start_all"):
        ...
        plotsecs = int(args.plotsecs)
        print(f"Starting Uploader with period {uploadsecs} secs and plot window {plotsecs} secs")
        with open(r"C:\Users\drala\Documents\Projects\GitHub\hamplots\upload.bat", "w") as f:
            print("Writing upload.bat")
            f.write("hamplots do_plots --plotsecs {plotsecs}")
