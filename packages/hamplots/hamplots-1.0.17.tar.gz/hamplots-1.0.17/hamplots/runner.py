...
def get_args_and_run():
    ...
    if(args.action == "start_all"):
        ...
        print(f"Starting Uploader with period {uploadsecs}")
        subprocess.Popen(["hamplots", "start_uploader", "--uploadsecs", str(uploadsecs)], creationflags=subprocess.CREATE_NO_WINDOW)
