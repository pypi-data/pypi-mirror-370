...
class HeraldedDetectorErrorModel:
    ...
    def initializer(self) -> mwpf_rational.SolverInitializer:
        ...
        return mwpf_rational.SolverInitializer(vertex_num, weighted_edges, heralds=heralds)
...
class HeraldedDemPredictor(Predictor):
    ...
    def syndrome_of(self, dets_bit_packed: np.ndarray) -> mwpf_rational.SyndromePattern:
        ...
        return mwpf_rational.SyndromePattern(defect_vertices=defect_vertices, heralds=heralds)
