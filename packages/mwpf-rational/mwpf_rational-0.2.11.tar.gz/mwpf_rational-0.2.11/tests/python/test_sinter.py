...
@pytest.mark.parametrize(
    "decoder",
    [
        mwpf.SinterMWPFRationalDecoder(cluster_node_limit=50, **params),
        mwpf.SinterHUFRationalDecoder(**params),
        mwpf.SinterMWPFRationalDecoder(cluster_node_limit=0, **params),
    ],
)
@pytest.mark.parametrize(
    "p",
...
"""
    ...
    decoder = mwpf.SinterMWPFRationalDecoder(**params)
