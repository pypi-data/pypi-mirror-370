...
class AccountCreationWithContentTypeOptionInput(BaseModel):
    ...
    Name: Optional[str] = Field(
        default=None,
        description="""Name of the account (required, max 255 chars). For Person Accounts, this is a concatenated field from the associated contact and not directly modifiable. Please provide a value of type string.""",
    )  # noqa: E501
...
class CreateCampaignRecordViaPostInput(BaseModel):
    ...
    Name: Optional[str] = Field(
        default=None,
        description="""Required. Name of the campaign (limit 80 characters). Please provide a value of type string.""",
    )  # noqa: E501
...
class CreateLeadWithSpecifiedContentTypeInput(BaseModel):
    ...
    Company: Optional[str] = Field(
        default=None,
        description="""Company name (up to 255 characters). If person accounts are enabled and this is null, lead converts to a person account. Please provide a value of type string.""",
    )  # noqa: E501
    ...
    LastName: Optional[str] = Field(
        default=None,
        description="""Last name of the lead (up to 80 characters). Please provide a value of type string.""",
    )  # noqa: E501
...
class RetrieveNoteWithConditionsInput(BaseModel):
    """Input model for SALESFORCE_RETRIEVE_NOTE_WITH_CONDITIONS"""

    fields: Optional[str] = Field(
        default=None,
        description="""Comma-delimited API names of fields for the Note object (e.g., 'Title,Body'). If omitted, all accessible fields are retrieved. Please provide a value of type string.""",
    )  # noqa: E501

    id: str = Field(
        description="""Unique identifier (ID) of the Note object to retrieve. Please provide a value of type string. This parameter is required."""
    )  # noqa: E501
...
class CreateNewContactWithJsonHeaderInput(BaseModel):
    ...
    LastName: Optional[str] = Field(
        default=None,
        description="""Required: Contact's last name (up to 80 characters). Please provide a value of type string.""",
    )  # noqa: E501
...
class CreateOpportunityRecordInput(BaseModel):
    ...
    CloseDate: Optional[str] = Field(
        default=None,
        description="""Expected close date (YYYY-MM-DD). Required. Please provide a value of type string.""",
    )  # noqa: E501
    ...
    Name: Optional[str] = Field(
        default=None,
        description="""Descriptive name for the opportunity. Required. Limit: 120 characters. Please provide a value of type string.""",
    )  # noqa: E501
    ...
    StageName: Optional[str] = Field(
        default=None,
        description="""Current stage (e.g., 'Prospecting', 'Closed Won'). Required. May update ForecastCategoryName, IsClosed, IsWon, and Probability. Query OpportunityStage object or refer to Salesforce setup for valid names. Please provide a value of type string.""",
    )  # noqa: E501
