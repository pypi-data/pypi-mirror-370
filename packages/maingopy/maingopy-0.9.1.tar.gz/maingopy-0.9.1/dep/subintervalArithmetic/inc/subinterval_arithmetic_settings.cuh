...
#define SUBDOMAINS_PER_THREAD 4			// Number of subintervals per thread (previous setting needs to be 1 for using this)
#if MULTIPLE_SUBDOMAINS_PER_THREAD	
#define NUM_THREADS 1024
#define NUM_SUBDOMAINS NUM_THREADS*SUBDOMAINS_PER_THREAD
#endif
