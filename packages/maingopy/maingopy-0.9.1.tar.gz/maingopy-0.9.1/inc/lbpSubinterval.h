...
// Declarations for classes used in subinterval arithmetic
#ifdef CUDA_INSTALLED
namespace SIA {
    class subinterval_arithmetic_settings;
    template <typename T> class subinterval_arithmetic_memory;
}
...
namespace lbp {
    ...
    /**
* @class LbpSubinterval
* @brief Wrapper for handling the lower bounding problems by using a GPU parallized subinterval arithmetic.
*        We can switch between natural interval extension and centered forms for the lower bound calculation of each subinterval
*/
    class LbpSubinterval : public LowerBoundingSolver {
    ...
    public:
        ...
        /**
            ...
            */
        LbpSubinterval(mc::FFGraph& DAG, const std::vector<mc::FFVar>& DAGvars, const std::vector<mc::FFVar>& DAGfunctions,
...
// #ifndef Build_CudaGraph
    ...
    protected:
        ...
        /**
            * @brief Calls the proper function for computing interval bounds via GPU-parallel subinterval arithmetic
            *
    ...
    private:
        /**
            ...
            */
            /**@{*/
        // The type I here is I_cpu of dag
        ...
        std::vector<I> _dagVarValues;          /*!< vector holding Interval bounds of all nodes of the DAG */

#ifdef CUDA_INSTALLED
        std::shared_ptr<SIA::subinterval_arithmetic_settings> _subintervalArithmeticSettings;  
        std::shared_ptr<SIA::subinterval_arithmetic_memory<I_gpu>> _subintervalArithmeticMemory; 
#else
        std::shared_ptr <SVT_DAG::Dag> _svtDag;   
        std::shared_ptr<subinterval_arithmetic::subinterval_arithmetic_settings> _subintervalArithmeticSettings;
        std::shared_ptr<subinterval_arithmetic::subinterval_arithmetic_memory<I>> _subintervalArithmeticMemory; 
#endif                                
        /**@}*/
    };
