...
/**
* @class UbpGurobi
* @brief Wrapper for handling the upper bounding problems by interfacing Gurobi
*
* This class constructs and solves upper bounding problems which were recognized as LP, MIP, QCP or MIQCP using Gurobi.
*
*/
class UbpGurobi : public UpperBoundingSolver {
  ...
  public:
    /**
        ...
        */
    UbpGurobi(mc::FFGraph &DAG, const std::vector<mc::FFVar> &DAGvars, const std::vector<mc::FFVar> &DAGfunctions, const std::vector<babBase::OptimizationVariable> &variables,
  ...
  private:
    ...
    /**
        * @brief Function for taking care of memory management by terminating UBS - empty for Gurobi
        */
    ...
    /**
        ...
        */
    /**@{*/
    GRBEnv grbEnv;               /*!< Gurobi environment  */
    GRBModel grbModel;           /*!< Gurobi model  */
    std::vector<GRBVar> grbVars; /*!< Gurobi variables  */


    // Prevent use of default copy constructor and copy assignment operator by declaring them private:
    UbpGurobi(const UbpGurobi &);            /*!< default copy constructor declared private to prevent use */
    UbpGurobi &operator=(const UbpGurobi &); /*!< default assignment operator declared private to prevent use */
};
