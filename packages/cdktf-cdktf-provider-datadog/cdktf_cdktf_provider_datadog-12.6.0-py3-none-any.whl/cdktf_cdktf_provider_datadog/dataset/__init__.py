...
class Dataset(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the dataset. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/dataset#name Dataset#name}
        :param principals: An array of principals. A principal is a subject or group of subjects. Each principal is formatted as ``type:id``. Supported types: ``role`` and ``team``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/dataset#principals Dataset#principals}
        :param product_filters: product_filters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/dataset#product_filters Dataset#product_filters}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Dataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/dataset#import import section} in the documentation of this resource for the id to use
...
class DatasetProductFilters:
    def __init__(
        ...
        *,
        ...
        '''
        :param filters: A list of tag-based filters used to restrict access to the product type. Each filter is formatted as ``@tag.key:value``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/dataset#filters Dataset#filters}
        :param product: The product type of the dataset. Supported types: ``apm``, ``rum``, ``synthetics``, ``metrics``, ``logs``, ``sd_repoinfo``, ``error_tracking``, ``cloud_cost``, and ``ml_obs``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/dataset#product Dataset#product}
        '''
        if __debug__:
