...
def test_market_flag():
    ...
    cmd = "janito --market --read 'List 2 NASDAQ stocks with bearish technical patterns'"
    ...
    if returncode == 0:
        ...
        found_indicators = [indicator for indicator in technical_indicators if indicator.lower() in stdout.lower()]
...
def test_no_canned_response():
    ...
    if returncode == 0:
        ...
        found_canned = [phrase for phrase in canned_phrases if phrase.lower() in stdout.lower()]
