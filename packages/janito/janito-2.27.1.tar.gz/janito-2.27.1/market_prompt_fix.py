...
def show_usage_guide():
    ...
    print("   janito --set allowed_sites=sec.gov,fred.stlouisfed.org,tradingview.com,investing.com")
    ...
    sources = [
        ...
        ("Federal Reserve", "fred.stlouisfed.org", "Economic indicators, interest rates"),
