...
def view_file(path: str, from_line: Optional[int] = None, to_line: Optional[int] = None) -> str:
...
def replace_text_in_file(path: str, search_text: str, replacement_text: str, 
...
def find_files(paths: str, pattern: str, max_depth: Optional[int] = None, 
               include_gitignored: bool = False) -> str:
...
__plugin_tools__ = [
    create_file, read_files, view_file, replace_text_in_file, validate_file_syntax,
    create_directory, remove_directory, remove_file, copy_file, move_file, find_files
]