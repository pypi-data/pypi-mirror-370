...
from mgquant.utils.logger import system_log, basic_system_log
    ...
    def set_env(self, environment):
        ...
        for idx, (mod_name, user_mod_config) in enumerate(self._mod_list):
            if hasattr(user_mod_config, 'lib'):
                ...
                lib_name = "mgquant.mod.mgquant_mod_" + mod_name
            else:
            ...
            mod_config = MgAttrDict(copy.deepcopy(getattr(mod_module, "__config__", {})))
