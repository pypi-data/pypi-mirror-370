...
from .input_handler import get_input_in_box
from .command_processor import process_command
from .output_monitor import enable_print_monitoring
...
if __name__ == "__main__":
    try:
        ...
        # 清理资源
        try:
            from .output_monitor import disable_print_monitoring, stop_output_monitoring
