...
def time_to_titer(qp,cell_seed_volume,titer,doubling_time,growth='exponential',time_unit='hr',qp_unit='g/cell.hr',seed_unit='cell/l',titer_unit='g/l'):
    ...
    if unit_match[0] == True and unit_match[1] == True and unit_match[2] == True and growth == 'exponential':
        ...
        d = b/c
        t = a * math.log(d)
        return str(str(int(round(t,0)))+' '+time_unit)
    else:
