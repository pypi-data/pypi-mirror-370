...
def handle_exceptions(
    default_exception_type: type = MSAError, context_component: Optional[str] = None, reraise: bool = True
):
    """
    Decorator for standardized exception handling.

    Args:
        default_exception_type: Exception type to use for wrapping unknown exceptions
