...
try:
    ...
    class SynopticWebsocketPipeline2(BaseWebsocketPipeline): # type: ignore[reportRedeclaration]
        name = "synoptic_websocket_2"
        required_settings = ["SYNOPTIC_WS_API_KEY_2", "SYNOPTIC_WS_STREAM_ID_2"]
        ws_stream_api_key = "SYNOPTIC_WS_API_KEY_2"
        ws_stream_id = "SYNOPTIC_WS_STREAM_ID_2"

except ModuleNotFoundError:
    # proxy pattern
    SynopticWebsocketPipeline = create_pipeline_proxy("synoptic_websocket")
    SynopticWebsocketPipeline2 = create_pipeline_proxy("synoptic_websocket_2")