...
try:
    ...
    class BasegRPCPipeline(Pipeline): # type: ignore[reportRedeclaration]
        ...
        def __init__(self, logger: structlog.BoundLogger, db: DBClient, settings: Settings) -> None:
            ...
            if "ingress.opticfeeds.com" in self._uri:
    ...
    class SynopticgRPCEnterprisePipeline1(BasegRPCPipeline): # type: ignore[reportRedeclaration]
        ...
        required_settings = ["SYNOPTIC_ENTERPRISE_GRPC_SERVER_URI", "SYNOPTIC_ENTERPRISE_GRPC_TOKEN", "SYNOPTIC_ENTERPRISE_GRPC_ID"]
        grpc_server_uri = "SYNOPTIC_ENTERPRISE_GRPC_SERVER_URI"
