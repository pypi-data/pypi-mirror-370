...
try:
    ...
    class SynopticgRPCEnterprisePipeline1(BasegRPCPipeline): # type: ignore[reportRedeclaration]
        ...
        grpc_server_uri = "SYNOPTIC_GRPC_ENTERPRISE_SERVER_URI"
        grpc_token = "SYNOPTIC_GRPC_ENTERPRISE_TOKEN"
        grpc_id = "SYNOPTIC_GRPC_ENTERPRISE_ID"

except ModuleNotFoundError:
    SynopticgRPCPipeline = create_pipeline_proxy("synoptic_grpc")
    SynopticgRPCEnterprisePipeline = create_pipeline_proxy("synoptic_grpc_enterprise")