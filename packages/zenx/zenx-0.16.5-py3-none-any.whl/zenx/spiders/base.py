...
class Spider(ABC):
    ...
    pipelines: ClassVar[List[Literal["preprocess","synoptic_websocket","synoptic_websocket_2","synoptic_grpc","synoptic_grpc_useast1","synoptic_grpc_eucentral1","synoptic_grpc_euwest2","synoptic_grpc_useast1chi2a","synoptic_grpc_useast1nyc2a","synoptic_grpc_apnortheast1","synoptic_discord"]]]
