...
class Settings(BaseSettings):
    ...
    SYNOPTIC_GRPC_SERVER_ENTERPRISE_URI: str | None = "ingress.opticfeeds.com"
    SYNOPTIC_GRPC_ENTERPRISE_TOKEN: str | None = None
    SYNOPTIC_GRPC_ENTERPRISE_ID: str | None = None

    SYNOPTIC_DISCORD_WEBHOOK: str | None = None

    SYNOPTIC_WS_API_KEY: str | None = None
    SYNOPTIC_WS_STREAM_ID: str | None = None
    SYNOPTIC_WS_API_KEY_2: str | None = None
    SYNOPTIC_WS_STREAM_ID_2: str | None = None
