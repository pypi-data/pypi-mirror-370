...
class BrainProxy:
    ...
    def _mount(self):
        ...
        async def chat(request: Request, tenant: str):
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            return _sanitize_dict_for_json(chunk_dict)
                        except Exception as e3:
                            self._log(f"Warning: dict conversion failed: {e3}")
                            
                            # Manual extraction as last resort
                            return _extract_chunk_manually(chunk)

            def _sanitize_dict_for_json(obj) -> any:
                ...
                if obj is None:
                    ...
                    return {k: _sanitize_dict_for_json(v) for k, v in obj.items() 
                            if not k.startswith('_') and v is not None}
                elif isinstance(obj, (list, tuple)):
                    return [_sanitize_dict_for_json(item) for item in obj]
                elif hasattr(obj, '__dict__'):
                    return _sanitize_dict_for_json(obj.__dict__)
                elif hasattr(obj, 'dict'):
                    try:
                        return _sanitize_dict_for_json(obj.dict())
                    except:
                        pass
            ...
            def _extract_chunk_manually(chunk) -> dict:
