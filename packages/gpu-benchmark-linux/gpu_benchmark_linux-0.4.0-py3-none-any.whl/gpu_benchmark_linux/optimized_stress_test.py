...
from .stress_test import StressTest, StressTestConfig, StressTestResult
from .monitor import GPUMonitor

logger = logging.getLogger(__name__)


class OptimizedStressTest(StressTest):
    """优化版GPU压力测试类"""
    ...
    def run_stress_test(self, config: StressTestConfig) -> StressTestResult:
        ...
        try:
            ...
            if self.optimization_enabled:
                ...
                if hasattr(result, 'optimization_stats'):
    ...
    def _calculate_optimized_performance_metrics(self, device_results: Dict, 
        ...
        metrics['avg_gflops_per_device'] = total_gflops / device_count if device_count > 0 else 0
        
        # 监控数据统计
        if monitoring_data and 'temperatures' in monitoring_data:
        ...
        if monitoring_data and 'power_usage' in monitoring_data:
        ...
        if monitoring_data and 'gpu_utilization' in monitoring_data:
