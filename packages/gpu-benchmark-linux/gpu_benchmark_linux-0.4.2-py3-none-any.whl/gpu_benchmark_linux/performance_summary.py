...
class PerformanceSummaryGenerator:
    ...
    def _load_gpu_specs(self) -> Dict[str, Dict[str, Union[float, int, str]]]:
        """加载GPU规格数据库"""
        return {
            # NVIDIA RTX 30系列
            'RTX 3080': {
