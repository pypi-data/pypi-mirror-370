...
from .enhanced_html_reporter import generate_enhanced_html_report
...
<body>
    ...
    def save_summary_report(self, data: Dict[str, Any], filename: str = None) -> str:
        ...
        try:
            ...
            logger.info(f"摘要报告已生成: {filepath}")
            return str(filepath)
