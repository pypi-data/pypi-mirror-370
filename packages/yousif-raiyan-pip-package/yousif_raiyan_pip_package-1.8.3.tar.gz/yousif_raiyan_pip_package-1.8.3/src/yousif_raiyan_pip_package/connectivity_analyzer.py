...
class ConnectivityAnalyzer:
    ...
    def generate_graphs_from_edf(self, segment_duration: float = 180.0, 
                                start_time: float = None, stop_time: float = None) -> Path:
        """
        ...
        **Edge Feature Analysis**: Quantifies pairwise connectivity properties with
        ...
        ------
        ValueError
            If segment_duration is outside valid range or temporal parameters
        ...
        >>> hdf5_path = analyzer.generate_graphs_from_edf(segment_duration=300.0)
        >>> 
        >>> # Analyze specific temporal window (5-15 minutes)
        >>> hdf5_path = analyzer.generate_graphs_from_edf(start_time=300, stop_time=900)
        >>> 
        >>> # Process initial 10 minutes only
        >>> hdf5_path = analyzer.generate_graphs_from_edf(stop_time=600)
