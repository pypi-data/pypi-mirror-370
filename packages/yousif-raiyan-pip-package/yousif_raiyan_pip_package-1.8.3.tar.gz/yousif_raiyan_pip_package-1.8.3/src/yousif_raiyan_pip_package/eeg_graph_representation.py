...
class EEGGraphProcessor:
    ...
    def generate_graphs_from_edf(self, segment_duration_minutes: float = 3.0, 
        ...
        Args:
            ...
            start_time: Start time in seconds for processing (default: None, uses beginning of file)
            end_time: End time in seconds for processing (default: None, uses end of file)
        
        Returns:
            Path: Path to the generated HDF5 file containing all graph representations
        
        Raises:
            ValueError: If segment_duration_minutes is outside valid range or time parameters are invalid
        ...
        Examples:
            ...
            >>> 
            >>> # Process specific time range (5-15 minutes)
            >>> hdf5_path = processor.generate_graphs_from_edf(start_time=300, end_time=900)
            >>> 
            >>> # Process first 10 minutes only
            >>> hdf5_path = processor.generate_graphs_from_edf(end_time=600)
        """
