...
class TriggerDetector:
    ...
    def filter_bad_windows(self, clf_path=None, classes_path=None):
        ...
        if clf_path is None or classes_path is None:
            ...
            try:
                clf_path = pkg_resources.resource_filename('yousif_raiyan_pip_package', 'logreg_good_bad.pkl')
                classes_path = pkg_resources.resource_filename('yousif_raiyan_pip_package', 'good_bad_classes.npy')
