...
from samplomatic.samplex.interfaces import SamplexInput, Specification, ValueType
...
def test_sample(rng):
    ...
    registers = {}
    node = TwirlSamplingNode("lhs", "rhs", UniformPauli(10))
    samplex_input = SamplexInput([Specification("num_randomizations", ValueType.INT)], {})
