...
set_target_properties(pxr::pyVt PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "@rpath/_vt.so"
  )
...
set_target_properties(pxr::vt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-vt/lib/libPxrVt.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPxrVt.dylib"
  )

list(APPEND _cmake_import_check_targets pxr::vt )
list(APPEND _cmake_import_check_files_for_pxr::vt "${_IMPORT_PREFIX}/pxr-vt/lib/libPxrVt.dylib" )
