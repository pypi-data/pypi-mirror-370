...
def main():
    ...
    # Console interaction after action
    while True:
        user_input = console.input("Type '[cyan]clear[/cyan]' or '[cyan]exit[/cyan]': ")
        if user_input.lower() == 'clear':
            console.clear()
            console.print("Screen cleared.")
        elif user_input.lower() == 'exit':
            console.print("[yellow]Exiting B.U.R.I...[/yellow]")
            sys.exit(0)
        else:
            console.print("[red]Invalid command. Please type 'clear' or 'exit'.[/red]")
