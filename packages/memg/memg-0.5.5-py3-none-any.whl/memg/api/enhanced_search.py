...
def search_enhanced(
    ...
    yaml_schema_path: str = "config/software_dev.yaml",
    ...
    Args:
        ...
        yaml_schema_path: Path to YAML schema file (default: "config/software_dev.yaml")
...
def analyze_query(
    user_query: str, yaml_schema_path: str = "config/software_dev.yaml"
) -> dict[str, Any]:
    """
