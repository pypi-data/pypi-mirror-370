...
class VertDivision(BaseLayout):
    layout_type: str
    def __init__(self, size: tuple[int, int] = (0, 0), *, flexbox: Flexbox | None = None, align: Literal['left', 'middle', 'right'] | float = 0, parent_relative_alignment: Literal['top', 'middle', 'bottom'] | float = 0, **kwargs: Unpack[VertDivisionArgs]) -> None: ...
    def __enter__(self): ...
