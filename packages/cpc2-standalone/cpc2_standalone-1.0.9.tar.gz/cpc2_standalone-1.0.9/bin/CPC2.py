...
## 2. keep kangyj's check on output_orf
	...
	try:
		...
		package_dir = resources.files('cpc2_standalone')
		data_dir = os.path.join(package_dir, "data") + os.sep
		lib_dir = os.path.join(package_dir, "libs") + os.sep
	except ImportError:
		# Fallback for older Python versions
		import pkg_resources
		package_dir = pkg_resources.resource_filename('cpc2_standalone', '')
		data_dir = os.path.join(package_dir, "data") + os.sep
		lib_dir = os.path.join(package_dir, "libs") + os.sep
	except:
		# Fallback for development mode
		script_dir = os.path.dirname(os.path.abspath(__file__))
		data_dir = os.path.join(script_dir, "..", "data") + os.sep
		lib_dir = os.path.join(script_dir, "..", "libs") + os.sep
