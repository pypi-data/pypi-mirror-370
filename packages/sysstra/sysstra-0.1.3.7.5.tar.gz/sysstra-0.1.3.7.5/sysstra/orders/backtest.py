...
def place_bt_order(order_candle,  position_type, quantity, transaction_type, order_type, orders_list, option_type=None,
                   strike_price=None, exit_type=None, quantity_left=0, params=None, market_type="cash", trade_type=None,
                   trigger_price=None, lot_size=25, user_id=None, strategy_id=None, request_id=None, exchange="NSE",
                   option_params=None):
