    ...
    def make_instance(self, include_optional) -> PaginatedRBACContentGuardResponseList:
        ...
        if include_optional:
            return PaginatedRBACContentGuardResponseList(
                ...
                results = [
                    services-pulpcore-client.models.rbac_content_guard_response.RBACContentGuardResponse(
                        pulp_href = '', 
                        prn = '', 
                        ...
                        description = '', 
                        users = [
                            services-pulpcore-client.models.group_user_response.GroupUserResponse(
                                username = '', 
                                pulp_href = '', 
                                prn = '', )
                            ], 
                        groups = [
                            services-pulpcore-client.models.group_response.GroupResponse(
                                name = '', 
                                pulp_href = '', 
                                prn = '', 
                                id = 56, )
