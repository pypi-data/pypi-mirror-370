    ...
    def make_instance(self, include_optional) -> PaginatedUserResponseList:
        ...
        if include_optional:
            return PaginatedUserResponseList(
                ...
                results = [
                    services-pulpcore-client.models.user_response.UserResponse(
                        pulp_href = '', 
                        prn = '', 
                        id = 56, 
                        username = '', 
                        ...
                        groups = [
                            services-pulpcore-client.models.user_group_response.UserGroupResponse(
                                name = '', 
                                pulp_href = '', 
                                prn = '', )
                            ], 
                        hidden_fields = [
                            services-pulpcore-client.models.generic_remote_response_hidden_fields_inner.GenericRemoteResponse_hidden_fields_inner(
                                name = '', 
                                is_set = True, )
                            ], )
                    ]
