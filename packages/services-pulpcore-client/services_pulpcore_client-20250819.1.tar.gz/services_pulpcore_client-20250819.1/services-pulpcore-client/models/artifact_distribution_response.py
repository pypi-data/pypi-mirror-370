...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "pulp_href", "no_content_change_since", "pulp_last_updated", "pulp_labels", "pulp_created", "hidden", "prn", "name", "base_url", "base_path"]
