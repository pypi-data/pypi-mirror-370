...
@async_wrapper
def _sync_add_subtitles_to_video(video_url: str, subtitles_input: str, font_name: str = "Roboto", font_color: str = "#FFFFFF") -> str:
...
async def async_add_subtitles_to_video_tool(video_url: str, subtitles_input: str, font_name: str = "Roboto", font_color: str = "#FFFFFF") -> str:
