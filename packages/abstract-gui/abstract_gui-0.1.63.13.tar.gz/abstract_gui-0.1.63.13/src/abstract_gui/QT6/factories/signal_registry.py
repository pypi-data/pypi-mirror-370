...
from ..imports import Dict, List, Optional, Tuple, Iterable, Type, inspect, lru_cache, QtWidgets,QtCore , INTERESTING_SUFFIXES,PRIORITY_ORDER,PRIORITY_INDEX,_CONSTRUCTOR_TRIES
# ---------- boilerplate ----------
def ensure_app():
