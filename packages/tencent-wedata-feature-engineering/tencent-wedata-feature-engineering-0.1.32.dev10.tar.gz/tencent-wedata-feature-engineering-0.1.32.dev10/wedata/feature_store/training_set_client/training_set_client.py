    ...
    def score_batch(
        ...
        **kwargs,
        ...
        with (TempDir() as tmp_location):
            ...
            printf(f"wedata local_path:{local_path}")
        ...
        printf(f"wedata feature_input_keys:{feature_input_keys}")

        source_data_names = [
            sdci.name for sdci in feature_spec.source_data_column_infos
        ]
        printf(f"wedata source_data_names:{source_data_names}")

        feature_output_names = [
            fci.output_name for fci in feature_spec.feature_column_infos
        ]
        printf(f"wedata feature_output_names:{feature_output_names}")
        ...
        printf(f"wedata all_output_names:{all_output_names}")
