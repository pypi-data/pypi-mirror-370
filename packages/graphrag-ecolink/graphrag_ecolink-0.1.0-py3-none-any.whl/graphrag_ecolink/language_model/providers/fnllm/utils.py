...
from graphrag_ecolink.language_model.providers.fnllm.cache import FNLLMCacheProvider
...
if TYPE_CHECKING:
    ...
    from graphrag_ecolink.index.typing.error_handler import ErrorHandlerFn
