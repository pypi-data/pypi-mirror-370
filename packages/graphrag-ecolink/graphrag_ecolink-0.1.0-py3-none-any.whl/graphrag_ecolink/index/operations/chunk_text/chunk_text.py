...
from graphrag_ecolink.config.models.chunking_config import ChunkingConfig, ChunkStrategyType
from graphrag_ecolink.index.operations.chunk_text.typing import (
    ChunkInput,
    ChunkStrategy,
)
from graphrag_ecolink.logger.progress import ProgressTicker, progress_ticker
...
def load_strategy(strategy: ChunkStrategyType) -> ChunkStrategy:
    ...
    match strategy:
        case ChunkStrategyType.tokens:
            from graphrag_ecolink.index.operations.chunk_text.strategies import run_tokens

            return run_tokens
        case ChunkStrategyType.sentence:
            # NLTK
            from graphrag_ecolink.index.operations.chunk_text.bootstrap import bootstrap
            from graphrag_ecolink.index.operations.chunk_text.strategies import run_sentences
