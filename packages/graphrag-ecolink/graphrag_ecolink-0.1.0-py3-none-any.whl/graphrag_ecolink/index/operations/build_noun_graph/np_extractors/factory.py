...
from graphrag_ecolink.config.enums import NounPhraseExtractorType
from graphrag_ecolink.config.models.extract_graph_nlp_config import TextAnalyzerConfig
from graphrag_ecolink.index.operations.build_noun_graph.np_extractors.base import (
    BaseNounPhraseExtractor,
)
from graphrag_ecolink.index.operations.build_noun_graph.np_extractors.cfg_extractor import (
    CFGNounPhraseExtractor,
)
from graphrag_ecolink.index.operations.build_noun_graph.np_extractors.regex_extractor import (
    RegexENNounPhraseExtractor,
)
from graphrag_ecolink.index.operations.build_noun_graph.np_extractors.stop_words import (
    EN_STOP_WORDS,
)
from graphrag_ecolink.index.operations.build_noun_graph.np_extractors.syntactic_parsing_extractor import (
