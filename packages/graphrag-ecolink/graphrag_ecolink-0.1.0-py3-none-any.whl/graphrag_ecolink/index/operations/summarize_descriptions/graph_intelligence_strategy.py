...
from graphrag_ecolink.index.operations.summarize_descriptions.description_summary_extractor import (
    SummarizeExtractor,
)
from graphrag_ecolink.index.operations.summarize_descriptions.typing import (
    StrategyConfig,
