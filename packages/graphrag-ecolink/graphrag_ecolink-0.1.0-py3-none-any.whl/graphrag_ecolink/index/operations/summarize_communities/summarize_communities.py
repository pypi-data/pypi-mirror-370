...
from graphrag_ecolink.index.operations.summarize_communities.typing import (
    CommunityReport,
    CommunityReportsStrategy,
    CreateCommunityReportsStrategyType,
)
from graphrag_ecolink.index.operations.summarize_communities.utils import (
    get_levels,
)
from graphrag_ecolink.index.utils.derive_from_rows import derive_from_rows
from graphrag_ecolink.logger.progress import progress_ticker
...
def load_strategy(
    ...
    match strategy:
        case CreateCommunityReportsStrategyType.graph_intelligence:
            from graphrag_ecolink.index.operations.summarize_communities.strategies import (
