...
from graphrag_ecolink.index.operations.embed_text.strategies.typing import TextEmbeddingStrategy
from graphrag_ecolink.vector_stores.base import BaseVectorStore, VectorStoreDocument
...
def load_strategy(strategy: TextEmbedStrategyType) -> TextEmbeddingStrategy:
    ...
    match strategy:
        case TextEmbedStrategyType.openai:
            from graphrag_ecolink.index.operations.embed_text.strategies.openai import (
                run as run_openai,
            )

            return run_openai
        case TextEmbedStrategyType.mock:
            from graphrag_ecolink.index.operations.embed_text.strategies.mock import (
                run as run_mock,
            )
