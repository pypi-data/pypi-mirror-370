...
from graphrag_ecolink.index.operations.embed_graph.typing import NodeEmbeddings
from graphrag_ecolink.index.operations.layout_graph.typing import GraphLayout
...
def _run_layout(
    ...
    if enabled:
        from graphrag_ecolink.index.operations.layout_graph.umap import (
            run as run_umap,
        )
    ...
    from graphrag_ecolink.index.operations.layout_graph.zero import (
        run as run_zero,
    )
