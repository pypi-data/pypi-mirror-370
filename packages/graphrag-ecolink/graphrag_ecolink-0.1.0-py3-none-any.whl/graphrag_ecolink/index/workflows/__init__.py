...
from .generate_text_embeddings_to_neo4j import (
    run_workflow as run_generate_text_embeddings_to_neo4j,
)
...
PipelineFactory.register_all({
    ...
    "generate_text_embeddings_to_neo4j": run_generate_text_embeddings_to_neo4j,
