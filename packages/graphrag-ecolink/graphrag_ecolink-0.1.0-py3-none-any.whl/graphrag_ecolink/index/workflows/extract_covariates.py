...
from graphrag_ecolink.data_model.schemas import COVARIATES_FINAL_COLUMNS
from graphrag_ecolink.index.operations.extract_covariates.extract_covariates import (
