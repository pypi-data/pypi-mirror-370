...
from graphrag_ecolink.config.enums import InputFileType, InputType
from graphrag_ecolink.config.models.input_config import InputConfig
from graphrag_ecolink.index.input.csv import load_csv
from graphrag_ecolink.index.input.json import load_json
from graphrag_ecolink.index.input.text import load_text
...
from graphrag_ecolink.storage.blob_pipeline_storage import BlobPipelineStorage
from graphrag_ecolink.storage.file_pipeline_storage import FilePipelineStorage
from graphrag_ecolink.index.input.oss import load_oss_text  # 导入新的OSS加载函数
...
loaders: dict[str, Callable[..., Awaitable[pd.DataFrame]]] = {
    ...
    InputFileType.oss_text: load_oss_text,  # 新增的OSS文本加载类型
}
