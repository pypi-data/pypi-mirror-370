...
from graphrag_ecolink.index.operations.extract_graph.graph_extractor import GraphExtractor
from graphrag_ecolink.index.operations.extract_graph.typing import (
    Document,
