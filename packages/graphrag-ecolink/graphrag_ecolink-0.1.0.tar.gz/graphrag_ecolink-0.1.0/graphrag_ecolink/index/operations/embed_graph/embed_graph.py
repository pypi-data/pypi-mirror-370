...
from graphrag_ecolink.index.operations.embed_graph.embed_node2vec import embed_node2vec
from graphrag_ecolink.index.operations.embed_graph.typing import (
    NodeEmbeddings,
)
from graphrag_ecolink.index.utils.stable_lcc import stable_largest_connected_component
