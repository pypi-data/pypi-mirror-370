...
from graphrag_ecolink.query.context_builder.builders import ContextBuilderResult
from graphrag_ecolink.query.context_builder.community_context import (
    build_community_context,
)
from graphrag_ecolink.query.context_builder.conversation_history import (
    ConversationHistory,
)
from graphrag_ecolink.query.context_builder.entity_extraction import (
    EntityVectorStoreKey,
    map_query_to_entities,
)
from graphrag_ecolink.query.context_builder.local_context import (
    build_covariates_context,
    build_entity_context,
    build_relationship_context,
    get_candidate_context,
)
from graphrag_ecolink.query.context_builder.source_context import (
    build_text_unit_context,
    count_relationships,
)
from graphrag_ecolink.query.input.retrieval.community_reports import (
    get_candidate_communities,
)
from graphrag_ecolink.query.input.retrieval.text_units import get_candidate_text_units
from graphrag_ecolink.query.llm.text_utils import num_tokens
from graphrag_ecolink.query.structured_search.base import LocalContextBuilder
...
class LocalSearchMixedContext(LocalContextBuilder):
    ...
    def __init__(
        ...
        self.entity_text_embeddings = None
