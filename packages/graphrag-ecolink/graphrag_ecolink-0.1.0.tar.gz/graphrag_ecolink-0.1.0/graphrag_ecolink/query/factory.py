...
from graphrag_ecolink.language_model.providers.fnllm.utils import (
    get_openai_model_parameters_from_config,
)
from graphrag_ecolink.query.context_builder.entity_extraction import EntityVectorStoreKey
from graphrag_ecolink.query.structured_search.basic_search.basic_context import (
    BasicSearchContext,
)
from graphrag_ecolink.query.structured_search.basic_search.search import BasicSearch
from graphrag_ecolink.query.structured_search.drift_search.drift_context import (
    DRIFTSearchContextBuilder,
)
from graphrag_ecolink.query.structured_search.drift_search.search import DRIFTSearch
from graphrag_ecolink.query.structured_search.global_search.community_context import (
    GlobalCommunityContext,
)
from graphrag_ecolink.query.structured_search.global_search.search import GlobalSearch
from graphrag_ecolink.query.structured_search.local_search.mixed_context import (
    LocalSearchMixedContext,
)
from graphrag_ecolink.query.structured_search.local_search.search import LocalSearch
...
def get_local_search_engine_for_ecolink(
    config: GraphRagConfig,
    # response_type: str,
    system_prompt: str | None = None,
) -> LocalSearch:
