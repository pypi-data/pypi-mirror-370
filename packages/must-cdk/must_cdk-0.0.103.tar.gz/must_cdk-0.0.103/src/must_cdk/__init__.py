...
class EcsCodeDeploy(
    ...
    def __init__(
        ...
        *,
        ...
        :param load_balancer_subnets: Select which subnets the ALB will be placed on.
        :param memory_limit: 
        :param subnets: (deprecated) Select which subnets the ECS service will be placed on.
...
class EcsCodeDeployProps(TaggableProps):
    ...
    def subnets(self) -> typing.Optional[_aws_cdk_aws_ec2_ceddda9d.SubnetSelection]:
        '''(deprecated) Select which subnets the ECS service will be placed on.

        :deprecated: Use taskSubnets and loadBalancerSubnets instead for more control
