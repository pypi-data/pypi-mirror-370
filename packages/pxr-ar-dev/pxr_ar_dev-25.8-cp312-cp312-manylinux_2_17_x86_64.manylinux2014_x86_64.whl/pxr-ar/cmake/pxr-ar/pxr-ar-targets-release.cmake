...
set_target_properties(pxr::pyAr PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "_ar.so"
  )
...
set_target_properties(pxr::ar PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-ar/lib/libPxrAr.so"
  IMPORTED_SONAME_RELEASE "libPxrAr.so"
  )

list(APPEND _cmake_import_check_targets pxr::ar )
list(APPEND _cmake_import_check_files_for_pxr::ar "${_IMPORT_PREFIX}/pxr-ar/lib/libPxrAr.so" )
