__all__ = ["Model", "ModelConfig", "ModelLoRA", "get_activation"]
...
_ACTIV_NAMES: TypeAlias = Literal[
    "threshold",
    "relu",
    "rrelu",
    "hardtanh",
...
class ModelConfig(ABC, OrderedDict):
    ...
    @staticmethod
    def get_activation(activation: _ACTIV_NAMES, *args, **kwargs):
