...
class EpisodicLoggerTest(parameterized.TestCase):
  ...
  def test_data_is_written_correctly(self):
    ...
    timesteps, actions, policy_extras = (
        mcap_parser_utils.parse_examples_to_dm_env_types(
            ...
            episodic_logger._STEP_TYPE_KEY,
            episodic_logger._OBSERVATION_KEY_PREFIX,
            episodic_logger._REWARD_KEY,
            episodic_logger._DISCOUNT_KEY,
            episodic_logger._ACTION_KEY_PREFIX,
            episodic_logger._POLICY_EXTRA_PREFIX,
        )
    )
  ...
  def test_camera_image_encoding_and_byte_handling(self):
    ...
    obs_prefix = episodic_logger._OBSERVATION_KEY_PREFIX
