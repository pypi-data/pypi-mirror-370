...
def entry_exit_threshold(
    ...
    elif mode_id in (MODE_MM_MOMENTUM, MODE_MM_MOMENTUM_0, MODE_MM_MOMENTUM_EMA, MODE_MM_MOMENTUM_SMA, MODE_MM_MOMENTUM_WMA, MODE_MM_MR, MODE_MM_MR_EMA, MODE_MM_MR_SMA, MODE_MM_MR_WMA):
