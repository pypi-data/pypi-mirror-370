...
# Import core logic
import psvmp.psmedia as core

try:
    from psvmp.VERSION import VERSION as APP_VERSION
except Exception:
    APP_VERSION = "unknown"
...
class PSVitaMediaGUI(QMainWindow):
    def __init__(self):
        ...
        # Set window logo
        logo_path = os.path.join("psvmp", "imgs", "logo.png")
    ...
    def check_updates(self):
        import psvmp.updater as updater
