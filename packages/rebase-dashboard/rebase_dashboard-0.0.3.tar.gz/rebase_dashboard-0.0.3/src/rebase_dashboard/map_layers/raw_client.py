...
class RawMapLayersClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def list_map_layers(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[MapLayer]]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[MapLayer],  # type: ignore
    ...
    def get_map_layer(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/dashboard/map-layers/{jsonable_encoder(layer_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawMapLayersClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_map_layers(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[MapLayer]]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
