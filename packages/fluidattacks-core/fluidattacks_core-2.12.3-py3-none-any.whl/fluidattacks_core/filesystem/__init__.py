...
def _scan_dir(
    ...
    subprojects: list[tuple[Path, str, list[str]]] = []
...
def find_projects(root_dir: str | Path) -> list[tuple[Path, str, list[str]]]:
    ...
    for p_path, p_lang, p_excls in projects:
        ...
        enriched_projects.append((p_path, p_lang, final_excls))

    # Exclusiones for the root = all detected projects + skipped dirs
    ...
    return [(root_dir, "root", root_exclusions), *enriched_projects]
