...
How to execute dotevals evaluations using different methods and control their behavior.
...
uv pytest eval_model.py --experiment my_eval --samples 100 --concurrent
```
...
# Example dataset
my_dataset = [("What is 2+2?", "4"), ("What is 5+3?", "8")]
