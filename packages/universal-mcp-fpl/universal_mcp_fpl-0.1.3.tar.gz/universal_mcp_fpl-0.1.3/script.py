...
tool_manager.add_tool(app_instance.team_info)
...
async def main():
    ...
    tool = tool_manager.get_tool("team_info")
    if tool:
    ...
    result=await tool_manager.call_tool(name="team_info",arguments={"team_id":"9709022"})
    print(result)
    print(type(result))
