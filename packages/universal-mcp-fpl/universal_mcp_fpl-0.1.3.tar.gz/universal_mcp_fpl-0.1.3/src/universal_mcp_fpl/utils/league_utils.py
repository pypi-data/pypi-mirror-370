...
def get_teams_historical_data(team_ids: list[int], api, 
                             start_gw: int | None = None, end_gw: int | None = None) -> dict[str, Any]:
...
def _get_league_historical_performance(league_id: int, api,  # noqa: F821
                                     start_gw: int | None = None, end_gw: int | None = None) -> Dict[str, Any]:
...
def _get_league_team_composition(league_id: int, api,  # noqa: F821
