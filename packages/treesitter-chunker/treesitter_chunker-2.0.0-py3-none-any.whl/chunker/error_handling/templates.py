...
class TemplateRenderer:
    ...
    def _render_text(
        self, content: str, template: ErrorTemplate, variables: dict[str, Any],
    ) -> str:
...
class TemplateValidator:
    ...
    def validate_syntax(
        self, template_string: str, template_format: TemplateFormat,
    ) -> list[str]:
                    ...
                    "template": """
{
    ...
    def export_templates(
        self, file_path: str | Path, template_ids: list[str] | None = None,
    ) -> bool:
...
def create_template_system(
    cache_size: int = 1000, load_builtin: bool = True,
