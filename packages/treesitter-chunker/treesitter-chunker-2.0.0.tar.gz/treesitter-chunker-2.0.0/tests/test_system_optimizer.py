...
class TestSystemOptimizer(unittest.TestCase):
    ...
    def test_optimize_cpu_delegation(self):
        ...
        with patch.object(
            self.optimizer.cpu_optimizer, "optimize_performance",
        ) as mock_opt:
    ...
    def test_optimize_memory_delegation(self):
        ...
        with patch.object(
            self.optimizer.memory_optimizer, "optimize_performance",
        ) as mock_opt:
    ...
    def test_optimize_io_delegation(self):
        ...
        with patch.object(
            self.optimizer.io_optimizer, "optimize_performance",
        ) as mock_opt:
    ...
    def test_measure_improvements_with_baseline(self):
        ...
        with patch.object(
            self.optimizer.performance_manager, "collect_system_metrics",
        ) as mock_collect:
            mock_current = Mock()
...
class TestCPUOptimizer(unittest.TestCase):
    ...
    def test_set_optimal_cpu_affinity(self, mock_psutil):
        ...
        with patch.object(
            self.optimizer, "set_cpu_affinity", return_value=True,
        ) as mock_set:
...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_cpu_optimizer_collect_metrics_error(self):
        ...
        with patch(
            "chunker.performance.optimization.system_optimizer.HAS_PSUTIL", True,
        ):
            with patch(
