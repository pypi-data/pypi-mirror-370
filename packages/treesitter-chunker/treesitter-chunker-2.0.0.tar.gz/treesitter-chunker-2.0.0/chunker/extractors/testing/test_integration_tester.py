...
class MockExtractor(BaseExtractor):
    ...
    def extract_calls(
        self, source_code: str, file_path: Path = None,
    ) -> ExtractionResult:
...
class TestExtractorTestSuite(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            set(self.test_suite.extractors.keys()), set(expected_extractors),
        )

        # Should have test samples for all languages
        self.assertEqual(
            set(self.test_suite.test_samples.keys()), set(expected_extractors),
        )

        # Should have performance thresholds
        self.assertEqual(
            set(self.test_suite.performance_thresholds.keys()), set(expected_extractors),
        )
