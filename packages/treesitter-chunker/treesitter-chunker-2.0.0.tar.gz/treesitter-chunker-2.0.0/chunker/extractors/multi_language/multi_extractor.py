...
class GoPatterns:
    ...
    def __init__(self):
        ...
        self.function_call_pattern = re.compile(
            r"\b([a-zA-Z_][a-zA-Z0-9_]*)\s*\(", re.MULTILINE,
        )
        ...
        self.package_call_pattern = re.compile(
            r"([a-zA-Z_][a-zA-Z0-9_]*)\s*\.\s*([A-Z][a-zA-Z0-9_]*)\s*\(", re.MULTILINE,
        )
...
class CPatterns:
    ...
    def __init__(self):
        ...
        self.function_call_pattern = re.compile(
            r"(?<!\w)([a-zA-Z_][a-zA-Z0-9_]*)\s*\(", re.MULTILINE,
        )
...
class CppPatterns:
    ...
    def __init__(self):
        ...
        self.constructor_pattern = re.compile(
            r"(?:\bnew\s+)?([A-Z][a-zA-Z0-9_]*)\s*\(", re.MULTILINE,
        )

        # Operator calls: operator+(args)
        self.operator_call_pattern = re.compile(
            r"\boperator\s*([+\-*/=<>!&|^%]+)\s*\(", re.MULTILINE,
        )
        ...
        self.namespace_pattern = re.compile(
            r"^\s*namespace\s+[a-zA-Z_][a-zA-Z0-9_]*", re.MULTILINE,
        )

        # Class declarations
        self.class_pattern = re.compile(
            r"^\s*class\s+[a-zA-Z_][a-zA-Z0-9_]*", re.MULTILINE,
        )
...
class JavaPatterns:
    ...
    def __init__(self):
        ...
        # Static method calls: Class.method(args)
        self.static_method_pattern = re.compile(
            r"([A-Z][a-zA-Z0-9_]*)\s*\.\s*([a-zA-Z_][a-zA-Z0-9_]*)\s*\(", re.MULTILINE,
        )
        ...
        self.super_call_pattern = re.compile(
            r"\bsuper\s*(?:\.\s*([a-zA-Z_][a-zA-Z0-9_]*))?\s*\(", re.MULTILINE,
        )

        # This calls: this.method(args) or this(args)
        self.this_call_pattern = re.compile(
            r"\bthis\s*(?:\.\s*([a-zA-Z_][a-zA-Z0-9_]*))?\s*\(", re.MULTILINE,
        )
        ...
        # Class declarations
        self.class_pattern = re.compile(
            r"^\s*(?:public\s+)?class\s+[a-zA-Z_][a-zA-Z0-9_]*", re.MULTILINE,
        )

        # Interface declarations
        self.interface_pattern = re.compile(
            r"^\s*(?:public\s+)?interface\s+[a-zA-Z_][a-zA-Z0-9_]*", re.MULTILINE,
        )
