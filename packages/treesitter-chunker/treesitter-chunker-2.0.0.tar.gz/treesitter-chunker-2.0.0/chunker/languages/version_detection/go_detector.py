...
class GoVersionDetector:
    ...
    def __init__(self):
        ...
        logger.debug(
            "Initialized GoVersionDetector with %d patterns", len(self.version_patterns),
        )
        ...
        try:
            ...
            if matches:
                ...
                if versions:
                    ...
                    logger.debug(
                        "Found negated build constraint implying: %s", min_version,
                    )
                    return min_version
    ...
    def parse_version_constraints(self, version_str: str) -> dict[str, str]:
        ...
        try:
            ...
            logger.debug(
                "Parsed version constraints: %s -> %s", version_str, constraints,
            )
    ...
    def get_primary_version(
        self, detection_results: dict[str, str | None],
    ) -> str | None:
...
class GoVersionInfo:
    ...
    def __init__(
        self, go_version: str | None, build_constraints: list[str], source: str,
    ):
