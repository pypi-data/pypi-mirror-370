...
class GrammarVersion:
    ...
    def get_compatibility_level(
        self, lang_version: LanguageVersion,
    ) -> CompatibilityLevel:
...
class CompatibilityRule:
    ...
    def matches_language_version(self, lang_version: LanguageVersion) -> bool:
        ...
        return self._check_version_constraint(
            lang_version.version, self.language_version_constraint,
        )
    ...
    def matches_grammar_version(self, grammar_version: GrammarVersion) -> bool:
        ...
        return self._check_version_constraint(
            grammar_version.version, self.grammar_version_constraint,
        )
...
class CompatibilitySchema:
    ...
    def get_compatibility_level(
        self, lang_version: LanguageVersion, grammar_version: GrammarVersion,
    ) -> CompatibilityLevel:
    ...
    def get_breaking_changes(
        self, language: str, from_version: str, to_version: str,
    ) -> list[BreakingChange]:
        ...
        try:
            ...
            for change in self.breaking_changes:
                ...
                if self._version_in_range(
                    change.from_version, from_version, to_version,
                ) or self._version_in_range(
                    change.to_version, from_version, to_version,
                ):
    ...
    def _is_better_compatibility(
        self, level1: CompatibilityLevel, level2: CompatibilityLevel,
    ) -> bool:
