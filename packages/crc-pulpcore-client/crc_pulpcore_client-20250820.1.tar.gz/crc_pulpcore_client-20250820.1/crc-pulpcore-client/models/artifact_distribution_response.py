...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "prn", "pulp_last_updated", "pulp_labels", "pulp_href", "no_content_change_since", "base_path", "base_url", "hidden", "pulp_created", "name"]
