...
class PersonApi(object):
    ...
    def get_current_person(self, **kwargs):  # noqa: E501
        """Get Current Person  # noqa: E501

        Get information about the currently logged-in user.  <small>ref: [getCurrentPerson](#operation/getCurrentPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_current_person(async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted32 include_deleted: Whether to include all or some of the nested deleted objects.
        :param str uuid:
        ...
        if kwargs.get('async_req'):
            return self.get_current_person_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_current_person_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_current_person_with_http_info(self, **kwargs):  # noqa: E501
        """Get Current Person  # noqa: E501

        Get information about the currently logged-in user.  <small>ref: [getCurrentPerson](#operation/getCurrentPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_current_person_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['fields', 'embed', 'include_deleted', 'uuid', 'workspace_id', 'include_privileges']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_current_person" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='LPersonReadResponse',  # noqa: E501
    ...
    def get_person(self, id, **kwargs):  # noqa: E501
        ...
        Get an existing person  <small>ref: [getPerson](#operation/getPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted33 include_deleted: Whether to include all or some of the nested deleted objects.
        :param str uuid:
        :param str workspace_id:
        :param bool include_privileges: Include the user's maximal privileges and authorization roles
        :return: PersonReadResponse
    ...
    def list_person(self, **kwargs):  # noqa: E501
        """List people  # noqa: E501

        List existing people  <small>ref: [listPerson](#operation/listPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_person(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted34 include_deleted: Whether to include all or some of the nested deleted objects.
        ...
        :param str email:
        :param str state:
        :param str is_disabled:
        :param bool include_privileges: Include the user's maximal privileges and authorization roles
        :param str no_limit: If set to `true`, will not limit the number of objects.
        :param list[int] people_ids: If provided should return list of people by ids
        :param bool include_status: Include the user's status in workspace
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_person_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_person_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_person_with_http_info(self, **kwargs):  # noqa: E501
        """List people  # noqa: E501

        List existing people  <small>ref: [listPerson](#operation/listPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_person_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['fields', 'embed', 'include_deleted', 'limit', 'offset', 'filter_type', 'sort', 'filter_fields', 'filter', 'include_count', 'email', 'state', 'is_disabled', 'include_privileges', 'no_limit', 'people_ids', 'include_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'include_privileges' in params:
            query_params.append(('includePrivileges', params['include_privileges']))  # noqa: E501
        if 'no_limit' in params:
            query_params.append(('noLimit', params['no_limit']))  # noqa: E501
        if 'people_ids' in params:
            query_params.append(('peopleIds', params['people_ids']))  # noqa: E501
            collection_formats['peopleIds'] = 'multi'  # noqa: E501
    ...
    def list_workspace_admins(self, workspace_id, **kwargs):  # noqa: E501
        ...
        List admins for the specified workspace.  <small>ref: [listWorkspaceAdmins](#operation/listWorkspaceAdmins)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_workspace_admins_with_http_info(self, workspace_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/workspaces/{workspaceId}/admins', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LPersonList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def patch_workspace_user(self, body, workspace_id, id, **kwargs):  # noqa: E501
        """Patches workspace user  # noqa: E501

        Updates info for the specified user in the workspace  <small>ref: [patchWorkspaceUser](#operation/patchWorkspaceUser)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_workspace_user(body, workspace_id, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PersonUpdateRequest body: (required)
        :param int workspace_id: (required)
        :param int id: (required)
        :return: Person
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_workspace_user_with_http_info(body, workspace_id, id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_workspace_user_with_http_info(body, workspace_id, id, **kwargs)  # noqa: E501
            return data

    def patch_workspace_user_with_http_info(self, body, workspace_id, id, **kwargs):  # noqa: E501
        """Patches workspace user  # noqa: E501

        Updates info for the specified user in the workspace  <small>ref: [patchWorkspaceUser](#operation/patchWorkspaceUser)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_workspace_user_with_http_info(body, workspace_id, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'workspace_id', 'id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_workspace_user" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_workspace_user`")  # noqa: E501
        # verify the required parameter 'workspace_id' is set
        if ('workspace_id' not in params or
                params['workspace_id'] is None):
            raise ValueError("Missing the required parameter `workspace_id` when calling `patch_workspace_user`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `patch_workspace_user`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/workspaces/{workspaceId}/people/{id}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LPerson',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_workspace_user(self, body, workspace_id, id, **kwargs):  # noqa: E501
        """Updates workspace user  # noqa: E501

        Updates info for the specified user in the workspace. If requestor is modifying their own data, available fields are \"name\", \"outputHomeDir\", \"uploadDir\", \"authorizationRoles\". Otherwise allowed fields for modification are restricted to \"outputHomeDir\", \"uploadDir\", \"authorizationRoles\"  <small>ref: [updateWorkspaceUser](#operation/updateWorkspaceUser)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_workspace_user(body, workspace_id, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_workspace_user_with_http_info(body, workspace_id, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_workspace_user_with_http_info(body, workspace_id, id, **kwargs)  # noqa: E501
            return data

    def update_workspace_user_with_http_info(self, body, workspace_id, id, **kwargs):  # noqa: E501
        """Updates workspace user  # noqa: E501

        Updates info for the specified user in the workspace. If requestor is modifying their own data, available fields are \"name\", \"outputHomeDir\", \"uploadDir\", \"authorizationRoles\". Otherwise allowed fields for modification are restricted to \"outputHomeDir\", \"uploadDir\", \"authorizationRoles\"  <small>ref: [updateWorkspaceUser](#operation/updateWorkspaceUser)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_workspace_user_with_http_info(body, workspace_id, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_workspace_user`")  # noqa: E501
        # verify the required parameter 'workspace_id' is set
        if ('workspace_id' not in params or
                params['workspace_id'] is None):
            raise ValueError("Missing the required parameter `workspace_id` when calling `update_workspace_user`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_workspace_user`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/workspaces/{workspaceId}/people/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
