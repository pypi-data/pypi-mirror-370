...
class WebhookFlowTaskApi(object):
    ...
    def create_webhook_flow_task(self, body, **kwargs):  # noqa: E501
        """Create webhook  # noqa: E501

        Create a new webhook flow task  <small>ref: [createWebhookFlowTask](#operation/createWebhookFlowTask)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_webhook_flow_task(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param WebhookFlowTaskCreateRequest body: (required)
        :return: WebhookFlowTask
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_webhook_flow_task_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_webhook_flow_task_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_webhook_flow_task_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create webhook  # noqa: E501

        Create a new webhook flow task  <small>ref: [createWebhookFlowTask](#operation/createWebhookFlowTask)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_webhook_flow_task_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_webhook_flow_task" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_webhook_flow_task`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LWebhookFlowTask',  # noqa: E501
    ...
    def delete_webhook_flow_task(self, id, **kwargs):  # noqa: E501
        """Delete webhook  # noqa: E501

        Delete an existing webhook flow task  <small>ref: [deleteWebhookFlowTask](#operation/deleteWebhookFlowTask)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_webhook_flow_task(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_webhook_flow_task_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_webhook_flow_task_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_webhook_flow_task_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete webhook  # noqa: E501

        Delete an existing webhook flow task  <small>ref: [deleteWebhookFlowTask](#operation/deleteWebhookFlowTask)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_webhook_flow_task_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_webhook_flow_task" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_webhook_flow_task`")  # noqa: E501
    ...
    def get_webhook_flow_task(self, id, **kwargs):  # noqa: E501
        """Read webhook  # noqa: E501

        Get an existing webhook flow task  <small>ref: [getWebhookFlowTask](#operation/getWebhookFlowTask)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_webhook_flow_task(id, async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted43 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: WebhookFlowTask
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_webhook_flow_task_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_webhook_flow_task_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_webhook_flow_task_with_http_info(self, id, **kwargs):  # noqa: E501
        """Read webhook  # noqa: E501

        Get an existing webhook flow task  <small>ref: [getWebhookFlowTask](#operation/getWebhookFlowTask)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_webhook_flow_task_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_webhook_flow_task" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_webhook_flow_task`")  # noqa: E501
    ...
    def test_webhook(self, body, **kwargs):  # noqa: E501
        ...
        Allow to test a webhook task without running a job  **Quotas**:<br/>20 req./user/min, 30 req./workspace/min  <small>ref: [testWebhook](#operation/testWebhook)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def test_webhook_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LWebhookTestResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
