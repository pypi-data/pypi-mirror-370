...
class OAuth2ApiTokenApi(object):
    ...
    def get_o_auth2_api_token(self, sid, token_type, **kwargs):  # noqa: E501
        """Get o auth 2 api token  # noqa: E501

        Get an existing o auth 2 api token  <small>ref: [getOAuth2ApiToken](#operation/getOAuth2ApiToken)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_o_auth2_api_token(sid, token_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str sid: (required)
        :param TokenType token_type: Token type (required)
        :param str x_trifacta_person_workspace_id: header for unauthenticated internal endpoints to identify a (user, workspace) pair for OAuth2 Api Tokens. If you do not have this value, you can also use `x-trifacta-user-id` and `x-trifacta-workspace-id` combination as part of the request header.
        ...
        if kwargs.get('async_req'):
            return self.get_o_auth2_api_token_with_http_info(sid, token_type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_o_auth2_api_token_with_http_info(sid, token_type, **kwargs)  # noqa: E501
            return data

    def get_o_auth2_api_token_with_http_info(self, sid, token_type, **kwargs):  # noqa: E501
        """Get o auth 2 api token  # noqa: E501

        Get an existing o auth 2 api token  <small>ref: [getOAuth2ApiToken](#operation/getOAuth2ApiToken)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_o_auth2_api_token_with_http_info(sid, token_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['sid', 'token_type', 'x_trifacta_person_workspace_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_o_auth2_api_token" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('sid' not in params or
                params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `get_o_auth2_api_token`")  # noqa: E501
        # verify the required parameter 'token_type' is set
        if ('token_type' not in params or
                params['token_type'] is None):
            raise ValueError("Missing the required parameter `token_type` when calling `get_o_auth2_api_token`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LOAuth2ApiToken',  # noqa: E501
