...
import six
from src.client.legacy_models.person_public_info import LPersonPublicInfo  # noqa: F401,E501

class LFlowPermissionOnlyPersonResponse(LPersonPublicInfo):
    ...
    if hasattr(LPersonPublicInfo, "swagger_types"):
        swagger_types.update(LPersonPublicInfo.swagger_types)

    attribute_map = {
    }
    if hasattr(LPersonPublicInfo, "attribute_map"):
        attribute_map.update(LPersonPublicInfo.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """LFlowPermissionOnlyPersonResponse - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        LPersonPublicInfo.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LFlowPermissionOnlyPersonResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LFlowPermissionOnlyPersonResponse):
            return False
