...
class FlowPermissionApi(object):
    ...
    def share_flow(self, body, id, **kwargs):  # noqa: E501
        """Share Flow  # noqa: E501

        Share a flow with other users. Collaborators can add and edit recipes and datasets in this flow.  <small>ref: [shareFlow](#operation/shareFlow)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.share_flow(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FlowPermissionRequest body: (required)
        :param int id: (required)
        :return: FlowPermissionList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.share_flow_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.share_flow_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def share_flow_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Share Flow  # noqa: E501

        Share a flow with other users. Collaborators can add and edit recipes and datasets in this flow.  <small>ref: [shareFlow](#operation/shareFlow)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.share_flow_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `share_flow`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `share_flow`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LFlowPermissionList',  # noqa: E501
