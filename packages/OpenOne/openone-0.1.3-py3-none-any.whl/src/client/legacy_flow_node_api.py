...
class FlowNodeApi(object):
    ...
    def commit_edges(self, body, id, **kwargs):  # noqa: E501
        """Create new edges  # noqa: E501

        Create edges between nodes  <small>ref: [commitEdges](#operation/commitEdges)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commit_edges(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CommitEdgesPayload body: (required)
        :param int id: (required)
        :return: CommitEdgesResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.commit_edges_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.commit_edges_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def commit_edges_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Create new edges  # noqa: E501

        Create edges between nodes  <small>ref: [commitEdges](#operation/commitEdges)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.commit_edges_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `commit_edges`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `commit_edges`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/flowNodes/{id}/commitEdges', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LCommitEdgesResponse',  # noqa: E501
