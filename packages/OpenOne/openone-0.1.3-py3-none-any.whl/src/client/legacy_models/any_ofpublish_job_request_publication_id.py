...
class LAnyOfpublishJobRequestPublicationId(object):
    ...
    def __init__(self):  # noqa: E501
        """LAnyOfpublishJobRequestPublicationId - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LAnyOfpublishJobRequestPublicationId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LAnyOfpublishJobRequestPublicationId):
            return False
