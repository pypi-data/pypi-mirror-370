...
class LAnyOfflowPermissionWithPersonIdRequestPersonId(object):
    ...
    def __init__(self):  # noqa: E501
        """LAnyOfflowPermissionWithPersonIdRequestPersonId - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LAnyOfflowPermissionWithPersonIdRequestPersonId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LAnyOfflowPermissionWithPersonIdRequestPersonId):
            return False
