...
import six
from src.client.legacy_models.base_job_create_request import LBaseJobCreateRequest  # noqa: F401,E501

class LArtifactStagingJobCreateRequest(LBaseJobCreateRequest):
    ...
    if hasattr(LBaseJobCreateRequest, "swagger_types"):
        swagger_types.update(LBaseJobCreateRequest.swagger_types)

    attribute_map = {
        'artifact_id': 'artifactId'
    }
    if hasattr(LBaseJobCreateRequest, "attribute_map"):
        attribute_map.update(LBaseJobCreateRequest.attribute_map)

    def __init__(self, artifact_id=None, *args, **kwargs):  # noqa: E501
        """LArtifactStagingJobCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._artifact_id = None
        self.discriminator = None
        self.artifact_id = artifact_id
        LBaseJobCreateRequest.__init__(self, *args, **kwargs)

    @property
    def artifact_id(self):
        """Gets the artifact_id of this LArtifactStagingJobCreateRequest.  # noqa: E501

        unique identifier for this object.  # noqa: E501

        :return: The artifact_id of this LArtifactStagingJobCreateRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def artifact_id(self, artifact_id):
        """Sets the artifact_id of this LArtifactStagingJobCreateRequest.

        unique identifier for this object.  # noqa: E501

        :param artifact_id: The artifact_id of this LArtifactStagingJobCreateRequest.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LArtifactStagingJobCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other,LArtifactStagingJobCreateRequest):
            return False
