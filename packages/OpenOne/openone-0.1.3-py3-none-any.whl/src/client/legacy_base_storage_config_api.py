...
class BaseStorageConfigApi(object):
    ...
    def create_base_storage_configs(self, body, person_id, **kwargs):  # noqa: E501
        """Create Base Storage Configs  # noqa: E501

        Create new base storage configs  <small>ref: [createBaseStorageConfigs](#operation/createBaseStorageConfigs)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_base_storage_configs(body, person_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BaseStorageConfigsCreateOrUpdateRequest body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_base_storage_configs_with_http_info(body, person_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_base_storage_configs_with_http_info(body, person_id, **kwargs)  # noqa: E501
            return data

    def create_base_storage_configs_with_http_info(self, body, person_id, **kwargs):  # noqa: E501
        """Create Base Storage Configs  # noqa: E501

        Create new base storage configs  <small>ref: [createBaseStorageConfigs](#operation/createBaseStorageConfigs)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_base_storage_configs_with_http_info(body, person_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_base_storage_configs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_base_storage_configs`")  # noqa: E501
        # verify the required parameter 'person_id' is set
        if ('person_id' not in params or
                params['person_id'] is None):
            raise ValueError("Missing the required parameter `person_id` when calling `create_base_storage_configs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/people/{personId}/baseStorageConfigs', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_base_storage_configs_for_current_protocol(self, person_id, **kwargs):  # noqa: E501
        """Get Base Storage Configs For Current Protocol  # noqa: E501

        Get base storage configs for current protocol  <small>ref: [getBaseStorageConfigsForCurrentProtocol](#operation/getBaseStorageConfigsForCurrentProtocol)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_base_storage_configs_for_current_protocol(person_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int person_id: Person ID of the user (required)
        :param bool with_relative_paths: Whether base storage paths returned should be relative/absolute. By default the API returns absolute paths
        :return: BaseStorageConfigsForProtocol
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_base_storage_configs_for_current_protocol_with_http_info(person_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_base_storage_configs_for_current_protocol_with_http_info(person_id, **kwargs)  # noqa: E501
            return data

    def get_base_storage_configs_for_current_protocol_with_http_info(self, person_id, **kwargs):  # noqa: E501
        """Get Base Storage Configs For Current Protocol  # noqa: E501

        Get base storage configs for current protocol  <small>ref: [getBaseStorageConfigsForCurrentProtocol](#operation/getBaseStorageConfigsForCurrentProtocol)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_base_storage_configs_for_current_protocol_with_http_info(person_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['person_id', 'with_relative_paths']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_base_storage_configs_for_current_protocol" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'person_id' is set
        if ('person_id' not in params or
                params['person_id'] is None):
            raise ValueError("Missing the required parameter `person_id` when calling `get_base_storage_configs_for_current_protocol`")  # noqa: E501
        ...
        query_params = []
        if 'with_relative_paths' in params:
            query_params.append(('withRelativePaths', params['with_relative_paths']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/people/{personId}/baseStorageConfigs/current', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LBaseStorageConfigsForProtocol',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_base_storage_configs_for_protocol(self, person_id, base_storage_protocol, **kwargs):  # noqa: E501
        """Get Base Storage Configs For Protocol  # noqa: E501

        Get base storage configs for protocol  <small>ref: [getBaseStorageConfigsForProtocol](#operation/getBaseStorageConfigsForProtocol)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_base_storage_configs_for_protocol(person_id, base_storage_protocol, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int person_id: Person ID of the user (required)
        :param str base_storage_protocol: Base Storage Protocol (required)
        :param bool with_relative_paths: Whether base storage paths returned should be relative/absolute. By default the API returns absolute paths
        :return: BaseStorageConfigsForProtocol
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_base_storage_configs_for_protocol_with_http_info(person_id, base_storage_protocol, **kwargs)  # noqa: E501
        else:
            (data) = self.get_base_storage_configs_for_protocol_with_http_info(person_id, base_storage_protocol, **kwargs)  # noqa: E501
            return data

    def get_base_storage_configs_for_protocol_with_http_info(self, person_id, base_storage_protocol, **kwargs):  # noqa: E501
        """Get Base Storage Configs For Protocol  # noqa: E501

        Get base storage configs for protocol  <small>ref: [getBaseStorageConfigsForProtocol](#operation/getBaseStorageConfigsForProtocol)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_base_storage_configs_for_protocol_with_http_info(person_id, base_storage_protocol, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['person_id', 'base_storage_protocol', 'with_relative_paths']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_base_storage_configs_for_protocol" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'person_id' is set
        if ('person_id' not in params or
                params['person_id'] is None):
            raise ValueError("Missing the required parameter `person_id` when calling `get_base_storage_configs_for_protocol`")  # noqa: E501
        # verify the required parameter 'base_storage_protocol' is set
        if ('base_storage_protocol' not in params or
                params['base_storage_protocol'] is None):
            raise ValueError("Missing the required parameter `base_storage_protocol` when calling `get_base_storage_configs_for_protocol`")  # noqa: E501
        ...
        if 'person_id' in params:
            path_params['personId'] = params['person_id']  # noqa: E501
        if 'base_storage_protocol' in params:
            path_params['baseStorageProtocol'] = params['base_storage_protocol']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/people/{personId}/baseStorageConfigs/{baseStorageProtocol}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
