...
class FlowNotificationSettingsApi(object):
    ...
    def create_flow_notification_settings(self, body, **kwargs):  # noqa: E501
        """Create flow notification settings  # noqa: E501

        Create a new flow notification settings  <small>ref: [createFlowNotificationSettings](#operation/createFlowNotificationSettings)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_flow_notification_settings(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FlowNotificationSettingsCreateRequest body: (required)
        :return: FlowNotificationSettings
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_flow_notification_settings_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_flow_notification_settings_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_flow_notification_settings_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create flow notification settings  # noqa: E501

        Create a new flow notification settings  <small>ref: [createFlowNotificationSettings](#operation/createFlowNotificationSettings)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_flow_notification_settings_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_flow_notification_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_flow_notification_settings`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/flowNotificationSettings', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LFlowNotificationSettings',  # noqa: E501
