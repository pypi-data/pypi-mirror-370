...
class PlanNodeApi(object):
    ...
    def create_plan_node(self, body, **kwargs):  # noqa: E501
        ...
        Create a new plan node  <small>ref: [createPlanNode](#operation/createPlanNode)</small>  # noqa: E501
    ...
    def create_plan_node_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LPlanNode',  # noqa: E501
    ...
    def delete_plan_node(self, id, **kwargs):  # noqa: E501
        ...
        Delete an existing plan node  <small>ref: [deletePlanNode](#operation/deletePlanNode)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_plan_node_run_parameters(self, id, **kwargs):  # noqa: E501
        ...
        List run parameters of a plan node. Only resources with run parameters will be included in the response.  <small>ref: [getPlanNodeRunParameters](#operation/getPlanNodeRunParameters)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_plan_node_run_parameters_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/planNodes/{id}/runParameters', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LPlanNodeRunParameterResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
