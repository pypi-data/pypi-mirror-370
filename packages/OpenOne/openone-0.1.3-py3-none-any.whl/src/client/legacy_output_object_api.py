...
class OutputObjectApi(object):
    ...
    def count_output_objects(self, **kwargs):  # noqa: E501
        """Count output objects  # noqa: E501

        Count existing output objects  <small>ref: [countOutputObjects](#operation/countOutputObjects)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_output_objects(async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted30 include_deleted: Whether to include all or some of the nested deleted objects.
        ...
        if kwargs.get('async_req'):
            return self.count_output_objects_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.count_output_objects_with_http_info(**kwargs)  # noqa: E501
            return data

    def count_output_objects_with_http_info(self, **kwargs):  # noqa: E501
        """Count output objects  # noqa: E501

        Count existing output objects  <small>ref: [countOutputObjects](#operation/countOutputObjects)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_output_objects_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method count_output_objects" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def create_output_object(self, body, **kwargs):  # noqa: E501
        """Create output object  # noqa: E501

        If an [outputObject](#tag/OutputObject) already exists for the [recipe](#tag/Recipe) (`flowNodeId`) to which you are posting, you must either modify the object instead or delete it before posting your new object.  <small>ref: [createOutputObject](#operation/createOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_output_object(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OutputObjectCreateRequest body: (required)
        :return: OutputObject
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_output_object_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_output_object_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_output_object_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create output object  # noqa: E501

        If an [outputObject](#tag/OutputObject) already exists for the [recipe](#tag/Recipe) (`flowNodeId`) to which you are posting, you must either modify the object instead or delete it before posting your new object.  <small>ref: [createOutputObject](#operation/createOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_output_object_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_output_object" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_output_object`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LOutputObject',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_output_object(self, id, **kwargs):  # noqa: E501
        """Delete output object  # noqa: E501

        Delete an existing output object  <small>ref: [deleteOutputObject](#operation/deleteOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_output_object(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_output_object_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_output_object_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_output_object_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete output object  # noqa: E501

        Delete an existing output object  <small>ref: [deleteOutputObject](#operation/deleteOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_output_object_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_output_object" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_output_object`")  # noqa: E501
    ...
    def get_output_object(self, id, **kwargs):  # noqa: E501
        """Get output object  # noqa: E501

        Get the specified [outputObject](#tag/OutputObject).  Note that it is possible to include [writeSettings](#tag/WriteSetting) and [publications](#tag/Publication) that are linked to this [outputObject](#tag/OutputObject). See [embedding resources](#section/Overview/Embedding-Resources) for more information.  ``` /v4/outputObjects/{id}?embed=writeSettings,publications ```    <small>ref: [getOutputObject](#operation/getOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_output_object(id, async_req=True)
        >>> result = thread.get()
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted31 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: OutputObject
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_output_object_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_output_object_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_output_object_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get output object  # noqa: E501

        Get the specified [outputObject](#tag/OutputObject).  Note that it is possible to include [writeSettings](#tag/WriteSetting) and [publications](#tag/Publication) that are linked to this [outputObject](#tag/OutputObject). See [embedding resources](#section/Overview/Embedding-Resources) for more information.  ``` /v4/outputObjects/{id}?embed=writeSettings,publications ```    <small>ref: [getOutputObject](#operation/getOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_output_object_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_output_object" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_output_object`")  # noqa: E501
    ...
    def get_python_script_for_output_object_input(self, body, id, **kwargs):  # noqa: E501
        """Generate python script for wrangle recipe linked to an output object  # noqa: E501

        Generate python script for input recipe to the output object. EXPERIMENTAL FEATURE: This feature is intended for demonstration purposes only.  In a future release, it can be modified or removed without warning.  This endpoint should not be deployed in a production environment.  <small>ref: [getPythonScriptForOutputObjectInput](#operation/getPythonScriptForOutputObjectInput)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_python_script_for_output_object_input(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OutputObjectPythonScriptRequest body: (required)
        :param int id: (required)
        :return: GetPythonScriptForOutputObjectInput
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_python_script_for_output_object_input_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_python_script_for_output_object_input_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def get_python_script_for_output_object_input_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Generate python script for wrangle recipe linked to an output object  # noqa: E501

        Generate python script for input recipe to the output object. EXPERIMENTAL FEATURE: This feature is intended for demonstration purposes only.  In a future release, it can be modified or removed without warning.  This endpoint should not be deployed in a production environment.  <small>ref: [getPythonScriptForOutputObjectInput](#operation/getPythonScriptForOutputObjectInput)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_python_script_for_output_object_input_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_python_script_for_output_object_input" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_python_script_for_output_object_input`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_python_script_for_output_object_input`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/outputObjects/{id}/wrangleToPython', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LGetPythonScriptForOutputObjectInput',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_output_objects(self, **kwargs):  # noqa: E501
        """List output objects  # noqa: E501

        List existing output objects  <small>ref: [listOutputObjects](#operation/listOutputObjects)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_output_objects(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted6 include_deleted: Whether to include all or some of the nested deleted objects.
        :param int limit: Maximum number of objects to fetch.
        :param int offset: Offset after which to start returning objects. For use with `limit`.
        :param str filter_type: Defined the filter type, one of [\"fuzzy\", \"contains\", \"exact\", \"exactIgnoreCase\"]. For use with `filter`.
        :param str sort: Defines sort order for returned objects
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_output_objects_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_output_objects_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_output_objects_with_http_info(self, **kwargs):  # noqa: E501
        """List output objects  # noqa: E501

        List existing output objects  <small>ref: [listOutputObjects](#operation/listOutputObjects)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_output_objects_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_output_objects" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def patch_output_object(self, body, id, **kwargs):  # noqa: E501
        """Patch output object  # noqa: E501

        Patch an existing output object  <small>ref: [patchOutputObject](#operation/patchOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_output_object(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OutputObjectUpdateRequest body: (required)
        :param int id: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_output_object_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_output_object_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def patch_output_object_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Patch output object  # noqa: E501

        Patch an existing output object  <small>ref: [patchOutputObject](#operation/patchOutputObject)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_output_object_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_output_object" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_output_object`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `patch_output_object`")  # noqa: E501
