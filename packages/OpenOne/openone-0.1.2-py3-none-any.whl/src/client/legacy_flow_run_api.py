...
class FlowRunApi(object):
    ...
    def get_flow_run(self, id, **kwargs):  # noqa: E501
        """Get flow run  # noqa: E501

        Get an existing flow run  <small>ref: [getFlowRun](#operation/getFlowRun)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flow_run(id, async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted15 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: FlowRun
        ...
        if kwargs.get('async_req'):
            return self.get_flow_run_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_flow_run_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_flow_run_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get flow run  # noqa: E501

        Get an existing flow run  <small>ref: [getFlowRun](#operation/getFlowRun)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flow_run_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_flow_run`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LFlowRun',  # noqa: E501
    ...
    def get_flow_run_job_groups(self, id, **kwargs):  # noqa: E501
        """Get JobGroups for Flow Run  # noqa: E501

        Get the list of  [jobGroups](#tag/JobGroup).  <small>ref: [getFlowRunJobGroups](#operation/getFlowRunJobGroups)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flow_run_job_groups(id, async_req=True)
        >>> result = thread.get()
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted16 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: JobGroupList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_flow_run_job_groups_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_flow_run_job_groups_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_flow_run_job_groups_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get JobGroups for Flow Run  # noqa: E501

        Get the list of  [jobGroups](#tag/JobGroup).  <small>ref: [getFlowRunJobGroups](#operation/getFlowRunJobGroups)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flow_run_job_groups_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_flow_run_job_groups" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_flow_run_job_groups`")  # noqa: E501
    ...
    def get_flow_run_status(self, id, **kwargs):  # noqa: E501
        """Get Flow Run Status  # noqa: E501

        Get the status of a Flow Run. It combines the status of the underlying [Job Groups](#tag/JobGroup).  <small>ref: [getFlowRunStatus](#operation/getFlowRunStatus)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flow_run_status(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_flow_run_status_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_flow_run_status_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_flow_run_status_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get Flow Run Status  # noqa: E501

        Get the status of a Flow Run. It combines the status of the underlying [Job Groups](#tag/JobGroup).  <small>ref: [getFlowRunStatus](#operation/getFlowRunStatus)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flow_run_status_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_flow_run_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_flow_run_status`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LFlowRunStatus',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
