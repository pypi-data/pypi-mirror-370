...
class ConnectionApi(object):
    ...
    def count_connections(self, **kwargs):  # noqa: E501
        """Count connections  # noqa: E501

        Count existing connections  <small>ref: [countConnections](#operation/countConnections)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_connections(async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted12 include_deleted: Whether to include all or some of the nested deleted objects.
        ...
        :param str shared_role: Which type of role to count the connections
        :return: Count
        ...
        if kwargs.get('async_req'):
            return self.count_connections_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.count_connections_with_http_info(**kwargs)  # noqa: E501
            return data

    def count_connections_with_http_info(self, **kwargs):  # noqa: E501
        """Count connections  # noqa: E501

        Count existing connections  <small>ref: [countConnections](#operation/countConnections)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_connections_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['fields', 'embed', 'include_deleted', 'limit', 'offset', 'filter_type', 'sort', 'filter_fields', 'filter', 'include_count', 'shared_role']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method count_connections" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'shared_role' in params:
            query_params.append(('sharedRole', params['shared_role']))  # noqa: E501
    ...
    def create_connection(self, body, **kwargs):  # noqa: E501
        ...
        Create a new connection  <small>ref: [createConnection](#operation/createConnection)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_connection_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LConnection',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_connection(self, id, **kwargs):  # noqa: E501
        ...
        Delete an existing connection  <small>ref: [deleteConnection](#operation/deleteConnection)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_connection(self, id, **kwargs):  # noqa: E501
        ...
        Get an existing connection  <small>ref: [getConnection](#operation/getConnection)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted13 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: Connection
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_connection_status(self, id, **kwargs):  # noqa: E501
        """Get connection status  # noqa: E501

        Get the connection status  <small>ref: [getConnectionStatus](#operation/getConnectionStatus)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_connection_status(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: (required)
        :return: ConnectionSuccessInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_connection_status_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_connection_status_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LConnectionSuccessInfo',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_connections(self, **kwargs):  # noqa: E501
        ...
        List existing connections  <small>ref: [listConnections](#operation/listConnections)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str filter: Value for filtering objects. See `filterFields`.
        :param bool include_count: If includeCount is true, it will include the total number of objects as a count object in the response
        :param str shared_role: Which type of role to list the connections
        :param list[str] vendors: Filter connections by vendors. Add values like vendors[]=oracle&vendors[]=sqlserver
        :param list[str] operations: Filter connections by operations. Add values like operations[]=none&operations[]=import&operations[]=none. Lists all connection if not specified
    ...
    def list_connections_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['fields', 'embed', 'include_deleted', 'limit', 'offset', 'filter_type', 'sort', 'filter_fields', 'filter', 'include_count', 'shared_role', 'vendors', 'operations']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'vendors' in params:
            query_params.append(('vendors', params['vendors']))  # noqa: E501
            collection_formats['vendors'] = 'multi'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LConnectionList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
