...
class PlanSnapshotRunApi(object):
    ...
    def cancel_plan_snapshot_run(self, id, **kwargs):  # noqa: E501
        ...
        Cancel the plan execution.   <small>ref: [cancelPlanSnapshotRun](#operation/cancelPlanSnapshotRun)</small>  # noqa: E501
    ...
    def cancel_plan_snapshot_run_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/planSnapshotRuns/{id}/cancel', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LPlanSnapshotRun',  # noqa: E501
    ...
    def count_plan_snapshot_runs(self, **kwargs):  # noqa: E501
        ...
        Count existing plan snapshot runs  <small>ref: [countPlanSnapshotRuns](#operation/countPlanSnapshotRuns)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param IncludeDeleted36 include_deleted: Whether to include all or some of the nested deleted objects.
    ...
    def get_plan_snapshot_run(self, id, **kwargs):  # noqa: E501
        ...
        Return a plan snapshot run that contains the current status of a plan execution  <small>ref: [getPlanSnapshotRun](#operation/getPlanSnapshotRun)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted37 include_deleted: Whether to include all or some of the nested deleted objects.
    ...
    def get_schedule_for_plan_run(self, id, **kwargs):  # noqa: E501
        ...
        Get the schedule definition that triggered the plan snapshot run.  <small>ref: [getScheduleForPlanRun](#operation/getScheduleForPlanRun)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_schedule_for_plan_run_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/planSnapshotRuns/{id}/schedule', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LScheduleHistory',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_plan_snapshot_runs(self, **kwargs):  # noqa: E501
        ...
        List existing plan snapshot runs  <small>ref: [listPlanSnapshotRuns](#operation/listPlanSnapshotRuns)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted35 include_deleted: Whether to include all or some of the nested deleted objects.
        :param int limit: Maximum number of objects to fetch.
        :param int offset: Offset after which to start returning objects. For use with `limit`.
        :param str filter_type: Defined the filter type, one of [\"fuzzy\", \"contains\", \"exact\", \"exactIgnoreCase\"]. For use with `filter`.
        :param str sort: Defines sort order for returned objects
    ...
    def list_plan_snapshot_runs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LPlanSnapshotRunList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
