...
class SqlScriptApi(object):
    ...
    def count_sql_scripts(self, **kwargs):  # noqa: E501
        """Count sql scripts  # noqa: E501

        Count existing sql scripts  <small>ref: [countSqlScripts](#operation/countSqlScripts)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_sql_scripts(async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted39 include_deleted: Whether to include all or some of the nested deleted objects.
        ...
        if kwargs.get('async_req'):
            return self.count_sql_scripts_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.count_sql_scripts_with_http_info(**kwargs)  # noqa: E501
            return data

    def count_sql_scripts_with_http_info(self, **kwargs):  # noqa: E501
        """Count sql scripts  # noqa: E501

        Count existing sql scripts  <small>ref: [countSqlScripts](#operation/countSqlScripts)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_sql_scripts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method count_sql_scripts" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def create_sql_script(self, body, **kwargs):  # noqa: E501
        """Create sql script  # noqa: E501

        Create a new sql script  <small>ref: [createSqlScript](#operation/createSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_sql_script(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SqlScriptCreateRequest body: (required)
        :return: SqlScript
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_sql_script_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_sql_script_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_sql_script_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create sql script  # noqa: E501

        Create a new sql script  <small>ref: [createSqlScript](#operation/createSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_sql_script_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_sql_script" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_sql_script`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LSqlScript',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_sql_script(self, id, **kwargs):  # noqa: E501
        """Delete sql script  # noqa: E501

        Delete an existing sql script  <small>ref: [deleteSqlScript](#operation/deleteSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_sql_script(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_sql_script_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_sql_script_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_sql_script_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete sql script  # noqa: E501

        Delete an existing sql script  <small>ref: [deleteSqlScript](#operation/deleteSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_sql_script_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_sql_script" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_sql_script`")  # noqa: E501
    ...
    def get_sql_script(self, id, **kwargs):  # noqa: E501
        """Get sql script  # noqa: E501

        Get an existing sql script  <small>ref: [getSqlScript](#operation/getSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sql_script(id, async_req=True)
        >>> result = thread.get()
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted40 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: SqlScript
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_sql_script_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_sql_script_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_sql_script_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get sql script  # noqa: E501

        Get an existing sql script  <small>ref: [getSqlScript](#operation/getSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sql_script_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_sql_script`")  # noqa: E501
    ...
    def list_sql_scripts(self, **kwargs):  # noqa: E501
        """List sql scripts  # noqa: E501

        List existing sql scripts  <small>ref: [listSqlScripts](#operation/listSqlScripts)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_sql_scripts(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted8 include_deleted: Whether to include all or some of the nested deleted objects.
        :param int limit: Maximum number of objects to fetch.
        :param int offset: Offset after which to start returning objects. For use with `limit`.
        :param str filter_type: Defined the filter type, one of [\"fuzzy\", \"contains\", \"exact\", \"exactIgnoreCase\"]. For use with `filter`.
        :param str sort: Defines sort order for returned objects
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_sql_scripts_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_sql_scripts_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_sql_scripts_with_http_info(self, **kwargs):  # noqa: E501
        """List sql scripts  # noqa: E501

        List existing sql scripts  <small>ref: [listSqlScripts](#operation/listSqlScripts)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_sql_scripts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_sql_scripts" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LSqlScriptList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def patch_sql_script(self, body, id, **kwargs):  # noqa: E501
        """Patch sql script  # noqa: E501

        Patch an existing sql script  <small>ref: [patchSqlScript](#operation/patchSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_sql_script(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SqlScriptUpdateRequest body: (required)
        :param int id: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_sql_script_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_sql_script_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def patch_sql_script_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Patch sql script  # noqa: E501

        Patch an existing sql script  <small>ref: [patchSqlScript](#operation/patchSqlScript)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_sql_script_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_sql_script" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_sql_script`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `patch_sql_script`")  # noqa: E501
