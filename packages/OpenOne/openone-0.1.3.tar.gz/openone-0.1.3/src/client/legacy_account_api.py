...
class AccountApi(object):
    ...
    def invite_users_to_account_workspace(self, body, account_id, workspace_id, **kwargs):  # noqa: E501
        """Invite Users to Workspace that belongs to Account  # noqa: E501

        Invite User(s) to Workspace that belongs to Account  <small>ref: [inviteUsersToAccountWorkspace](#operation/inviteUsersToAccountWorkspace)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.invite_users_to_account_workspace(body, account_id, workspace_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param InviteUsersToAccountWorkspaceRequest body: (required)
        :param str account_id: ID of the account the workspace belongs to (required)
        :param str workspace_id: ID of the workspace to invite users to (required)
        ...
        if kwargs.get('async_req'):
            return self.invite_users_to_account_workspace_with_http_info(body, account_id, workspace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.invite_users_to_account_workspace_with_http_info(body, account_id, workspace_id, **kwargs)  # noqa: E501
            return data

    def invite_users_to_account_workspace_with_http_info(self, body, account_id, workspace_id, **kwargs):  # noqa: E501
        """Invite Users to Workspace that belongs to Account  # noqa: E501

        Invite User(s) to Workspace that belongs to Account  <small>ref: [inviteUsersToAccountWorkspace](#operation/inviteUsersToAccountWorkspace)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.invite_users_to_account_workspace_with_http_info(body, account_id, workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'account_id', 'workspace_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method invite_users_to_account_workspace" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `invite_users_to_account_workspace`")  # noqa: E501
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `invite_users_to_account_workspace`")  # noqa: E501
        # verify the required parameter 'workspace_id' is set
        if ('workspace_id' not in params or
                params['workspace_id'] is None):
            raise ValueError("Missing the required parameter `workspace_id` when calling `invite_users_to_account_workspace`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/accounts/peopleworkspaces', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LAccountUserIdList',  # noqa: E501
