...
class AwsConfigApi(object):
    ...
    def create_aws_config(self, body, **kwargs):  # noqa: E501
        """Create AWS Config  # noqa: E501

        Create a new AWS config  <small>ref: [createAwsConfig](#operation/createAwsConfig)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_aws_config(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AwsConfigCreateRequest body: (required)
        :return: AwsConfig
        ...
        if kwargs.get('async_req'):
            return self.create_aws_config_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_aws_config_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_aws_config_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create AWS Config  # noqa: E501

        Create a new AWS config  <small>ref: [createAwsConfig](#operation/createAwsConfig)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_aws_config_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_aws_config" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_aws_config`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LAwsConfig',  # noqa: E501
    ...
    def list_aws_configs(self, **kwargs):  # noqa: E501
        """List AWS configs  # noqa: E501

        List existing aws configs  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [listAwsConfigs](#operation/listAwsConfigs)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_aws_configs(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_aws_configs_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_aws_configs_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_aws_configs_with_http_info(self, **kwargs):  # noqa: E501
        """List AWS configs  # noqa: E501

        List existing aws configs  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [listAwsConfigs](#operation/listAwsConfigs)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_aws_configs_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_aws_configs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LAwsConfigList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_aws_config(self, body, id, **kwargs):  # noqa: E501
        """Update AWS Config  # noqa: E501

        The request body contains the parameters of the awsConfigs object that you wish to modify. You do not have to include parameters that are not being modified.  ### Request Body - bucket assignment: The following changes the default bucket for the AWS configuration object. ``` { \"defaultBucket\": \"testing2\" } ```  <small>ref: [updateAwsConfig](#operation/updateAwsConfig)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_aws_config(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AwsConfigUpdateRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_aws_config_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_aws_config_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_aws_config_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update AWS Config  # noqa: E501

        The request body contains the parameters of the awsConfigs object that you wish to modify. You do not have to include parameters that are not being modified.  ### Request Body - bucket assignment: The following changes the default bucket for the AWS configuration object. ``` { \"defaultBucket\": \"testing2\" } ```  <small>ref: [updateAwsConfig](#operation/updateAwsConfig)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_aws_config_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_aws_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_aws_config`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_aws_config`")  # noqa: E501
