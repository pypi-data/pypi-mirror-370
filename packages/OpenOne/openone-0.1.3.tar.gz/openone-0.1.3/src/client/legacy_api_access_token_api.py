...
class ApiAccessTokenApi(object):
    ...
    def create_access_token(self, body, **kwargs):  # noqa: E501
        ...
        Create an API Access Token. See the [Authentication](#section/Authentication) section for more information about API Access Token.  > ⚠️ **API tokens inherit the API access of the user who creates them. Treat tokens as passwords and keep them in a secure place.**  This request requires you to be authenticated. - If you do not have a valid access token to use at this time, you must first create one using the UI.   - If you have a valid access token, you can submit that token in your Authentication header with this request.  <small>ref: [createAccessToken](#operation/createAccessToken)</small>  # noqa: E501
        ...
        :param ApiAccessTokenCreateRequest body: (required)
        :param str x_trifacta_person_workspace_id: header for unauthenticated internal endpoints to identify a (user, workspace) pair for API Access Tokens. If you do not have this value, you can also use `x-trifacta-user-id` and `x-trifacta-workspace-id` combination as part of the request header.
    ...
    def create_access_token_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_access_token_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_trifacta_person_workspace_id']  # noqa: E501
        ...
        header_params = {}
        if 'x_trifacta_person_workspace_id' in params:
            header_params['x-trifacta-person-workspace-id'] = params['x_trifacta_person_workspace_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LApiAccessTokenCreateResponse',  # noqa: E501
    ...
    def delete_api_access_token(self, token_id, **kwargs):  # noqa: E501
        """Delete api access token  # noqa: E501

        Delete the specified access token. > ⚠️ **If you delete an active access token, you may prevent the user from accessing the platform outside of the Trifacta application.**  <small>ref: [deleteApiAccessToken](#operation/deleteApiAccessToken)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_api_access_token_with_http_info(token_id, **kwargs)  # noqa: E501
            return data
    ...
    def delete_api_access_token_with_http_info(self, token_id, **kwargs):  # noqa: E501
        ...
        all_params = ['token_id', 'x_trifacta_person_workspace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('token_id' not in params or
            ...
            raise ValueError("Missing the required parameter `token_id` when calling `delete_api_access_token`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/apiAccessTokens/:tokenId', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_api_access_token(self, token_id, **kwargs):  # noqa: E501
        ...
        Get an existing api access token  <small>ref: [getApiAccessToken](#operation/getApiAccessToken)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_api_access_token_with_http_info(token_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_api_access_token_with_http_info(self, token_id, **kwargs):  # noqa: E501
        ...
        if ('token_id' not in params or
                params['token_id'] is None):
            raise ValueError("Missing the required parameter `token_id` when calling `get_api_access_token`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/apiAccessTokens/:tokenId', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LApiAccessToken',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_api_access_tokens(self, **kwargs):  # noqa: E501
        """List api access tokens  # noqa: E501

        List API Access Tokens of the current user  <small>ref: [listApiAccessTokens](#operation/listApiAccessTokens)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_api_access_tokens(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str x_trifacta_person_workspace_id: header for unauthenticated internal endpoints to identify a (user, workspace) pair for API Access Tokens. If you do not have this value, you can also use `x-trifacta-user-id` and `x-trifacta-workspace-id` combination as part of the request header.
        :return: ApiAccessTokenList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_api_access_tokens_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_api_access_tokens_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_api_access_tokens_with_http_info(self, **kwargs):  # noqa: E501
        """List api access tokens  # noqa: E501

        List API Access Tokens of the current user  <small>ref: [listApiAccessTokens](#operation/listApiAccessTokens)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_api_access_tokens_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['x_trifacta_person_workspace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_api_access_tokens" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LApiAccessTokenList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
