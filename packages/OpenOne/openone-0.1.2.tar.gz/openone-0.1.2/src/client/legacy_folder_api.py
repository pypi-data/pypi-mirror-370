...
class FolderApi(object):
    ...
    def count_folders(self, **kwargs):  # noqa: E501
        """Count folders  # noqa: E501

        Count existing folders  <small>ref: [countFolders](#operation/countFolders)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_folders(async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted22 include_deleted: Whether to include all or some of the nested deleted objects.
        ...
        if kwargs.get('async_req'):
            return self.count_folders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.count_folders_with_http_info(**kwargs)  # noqa: E501
            return data

    def count_folders_with_http_info(self, **kwargs):  # noqa: E501
        """Count folders  # noqa: E501

        Count existing folders  <small>ref: [countFolders](#operation/countFolders)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_folders_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def create_folder(self, body, **kwargs):  # noqa: E501
        ...
        Create a new folder  <small>ref: [createFolder](#operation/createFolder)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param FolderCreateRequest body: (required)
        :return: Folder
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def create_folder_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LFolder',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_folder(self, id, **kwargs):  # noqa: E501
        ...
        Delete an existing folder  <small>ref: [deleteFolder](#operation/deleteFolder)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_folder(self, id, **kwargs):  # noqa: E501
        ...
        Get an existing folder  <small>ref: [getFolder](#operation/getFolder)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted23 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: Folder
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_folders(self, **kwargs):  # noqa: E501
        ...
        List existing folders  <small>ref: [listFolders](#operation/listFolders)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_folders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LFolderList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def patch_folder(self, body, id, **kwargs):  # noqa: E501
        """Patch folder  # noqa: E501

        Patch an existing folder  <small>ref: [patchFolder](#operation/patchFolder)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_folder(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FolderUpdateRequest body: (required)
        :param int id: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_folder_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_folder_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def patch_folder_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Patch folder  # noqa: E501

        Patch an existing folder  <small>ref: [patchFolder](#operation/patchFolder)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_folder_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_folder`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `patch_folder`")  # noqa: E501
