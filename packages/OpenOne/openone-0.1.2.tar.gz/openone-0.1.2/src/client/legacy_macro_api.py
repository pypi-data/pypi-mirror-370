...
class MacroApi(object):
    ...
    def get_macro_package(self, id, **kwargs):  # noqa: E501
        """Get Macro Package  # noqa: E501

        Retrieve a package containing the definition of the specified macro. Response body is the contents of the package, which is an importable version of the macro definition.  > ✅ **TIP**: The response body can be pasted as the request when you import the macro into a different environment. For more information, see [Import Macro Package](#operation/importMacroPackage).  > ℹ️ **NOTE**: Modification of the macro definition is not supported outside of the Alteryx Analytics Cloud.  <small>ref: [getMacroPackage](#operation/getMacroPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_macro_package(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: (required)
        :return: ExportMacroPackageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_macro_package_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_macro_package_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_macro_package_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get Macro Package  # noqa: E501

        Retrieve a package containing the definition of the specified macro. Response body is the contents of the package, which is an importable version of the macro definition.  > ✅ **TIP**: The response body can be pasted as the request when you import the macro into a different environment. For more information, see [Import Macro Package](#operation/importMacroPackage).  > ℹ️ **NOTE**: Modification of the macro definition is not supported outside of the Alteryx Analytics Cloud.  <small>ref: [getMacroPackage](#operation/getMacroPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_macro_package_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_macro_package" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_macro_package`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LExportMacroPackageResponse',  # noqa: E501
    ...
    def import_macro_package(self, **kwargs):  # noqa: E501
        """Import Macro Package  # noqa: E501

        Performs an import of a macro package.  > ℹ️ **NOTE**: You cannot import a macro that was exported from a later version of the product.  > ✅ **TIP**: You can paste the response of the exported macro page as the request.  > ℹ️ **NOTE**: Modification of the macro definition is not supported outside of the Alteryx Analytics Cloud.  <small>ref: [importMacroPackage](#operation/importMacroPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_macro_package(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ImportMacroPackageRequest body:
        :return: ImportMacroPackageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_macro_package_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.import_macro_package_with_http_info(**kwargs)  # noqa: E501
            return data

    def import_macro_package_with_http_info(self, **kwargs):  # noqa: E501
        """Import Macro Package  # noqa: E501

        Performs an import of a macro package.  > ℹ️ **NOTE**: You cannot import a macro that was exported from a later version of the product.  > ✅ **TIP**: You can paste the response of the exported macro page as the request.  > ℹ️ **NOTE**: Modification of the macro definition is not supported outside of the Alteryx Analytics Cloud.  <small>ref: [importMacroPackage](#operation/importMacroPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_macro_package_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method import_macro_package" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'hash' in params:
            form_params.append(('hash', params['hash']))  # noqa: E501
        if 'data' in params:
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LImportMacroPackageResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def import_macro_package_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['type', 'kind', 'hash', 'data', 'metadata']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
