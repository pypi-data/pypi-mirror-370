...
class PublicationApi(object):
    ...
    def count_publications(self, **kwargs):  # noqa: E501
        """Count publications  # noqa: E501

        Count existing publications  <small>ref: [countPublications](#operation/countPublications)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_publications(async_req=True)
        >>> result = thread.get()
        ...
        :param IncludeDeleted41 include_deleted: Whether to include all or some of the nested deleted objects.
        ...
        if kwargs.get('async_req'):
            return self.count_publications_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.count_publications_with_http_info(**kwargs)  # noqa: E501
            return data

    def count_publications_with_http_info(self, **kwargs):  # noqa: E501
        """Count publications  # noqa: E501

        Count existing publications  <small>ref: [countPublications](#operation/countPublications)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_publications_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def create_publication(self, body, **kwargs):  # noqa: E501
        """Create publication  # noqa: E501

        Create a new publication  <small>ref: [createPublication](#operation/createPublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_publication(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PublicationCreateRequest body: (required)
        :return: Publication
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_publication_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_publication_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_publication_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create publication  # noqa: E501

        Create a new publication  <small>ref: [createPublication](#operation/createPublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_publication_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_publication" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_publication`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LPublication',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_publication(self, id, **kwargs):  # noqa: E501
        """Delete publication  # noqa: E501

        Delete an existing publication  <small>ref: [deletePublication](#operation/deletePublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_publication_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_publication_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_publication_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete publication  # noqa: E501

        Delete an existing publication  <small>ref: [deletePublication](#operation/deletePublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_publication_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_publication" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_publication`")  # noqa: E501
    ...
    def get_publication(self, id, **kwargs):  # noqa: E501
        """Get publication  # noqa: E501

        Get an existing publication  <small>ref: [getPublication](#operation/getPublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted42 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: Publication
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_publications(self, **kwargs):  # noqa: E501
        """List publications  # noqa: E501

        List existing publications  <small>ref: [listPublications](#operation/listPublications)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_publications(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        :param IncludeDeleted9 include_deleted: Whether to include all or some of the nested deleted objects.
        :param int limit: Maximum number of objects to fetch.
        :param int offset: Offset after which to start returning objects. For use with `limit`.
        :param str filter_type: Defined the filter type, one of [\"fuzzy\", \"contains\", \"exact\", \"exactIgnoreCase\"]. For use with `filter`.
        :param str sort: Defines sort order for returned objects
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_publications_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_publications_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_publications_with_http_info(self, **kwargs):  # noqa: E501
        """List publications  # noqa: E501

        List existing publications  <small>ref: [listPublications](#operation/listPublications)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_publications_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_publications" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def patch_publication(self, body, id, **kwargs):  # noqa: E501
        """Patch publication  # noqa: E501

        Patch an existing publication  <small>ref: [patchPublication](#operation/patchPublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_publication(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PublicationUpdateRequest body: (required)
        :param int id: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_publication_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_publication_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def patch_publication_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Patch publication  # noqa: E501

        Patch an existing publication  <small>ref: [patchPublication](#operation/patchPublication)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_publication_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_publication" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_publication`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `patch_publication`")  # noqa: E501
