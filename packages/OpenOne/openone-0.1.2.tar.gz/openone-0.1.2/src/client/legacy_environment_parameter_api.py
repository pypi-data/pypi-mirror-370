...
class EnvironmentParameterApi(object):
    ...
    def create_environment_parameter(self, body, **kwargs):  # noqa: E501
        """Create environment parameter  # noqa: E501

        Create a new environment parameter to be used in the workspace.  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [createEnvironmentParameter](#operation/createEnvironmentParameter)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_environment_parameter(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EnvironmentParameterCreateRequest body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_environment_parameter_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_environment_parameter_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_environment_parameter_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create environment parameter  # noqa: E501

        Create a new environment parameter to be used in the workspace.  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [createEnvironmentParameter](#operation/createEnvironmentParameter)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_environment_parameter_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_environment_parameter" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_environment_parameter`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LEnvironmentParameter',  # noqa: E501
    ...
    def delete_environment_parameter(self, id, **kwargs):  # noqa: E501
        """Delete environment parameter  # noqa: E501

        Delete an existing environment parameter  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [deleteEnvironmentParameter](#operation/deleteEnvironmentParameter)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_environment_parameter(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_environment_parameter_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_environment_parameter_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_environment_parameter_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete environment parameter  # noqa: E501

        Delete an existing environment parameter  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [deleteEnvironmentParameter](#operation/deleteEnvironmentParameter)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_environment_parameter_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_environment_parameter" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_environment_parameter`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/environmentParameters/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_environment_parameter(self, id, **kwargs):  # noqa: E501
        """Get environment parameter  # noqa: E501

        Get an existing environment parameter  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [getEnvironmentParameter](#operation/getEnvironmentParameter)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_environment_parameter(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: (required)
        :param str include_usage_info: Include information about where the environment parameter is used.
        ...
        :param IncludeDeleted14 include_deleted: Whether to include all or some of the nested deleted objects.
        :return: EnvironmentParameter
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_environment_parameter_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_environment_parameter_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_environment_parameter_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get environment parameter  # noqa: E501

        Get an existing environment parameter  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [getEnvironmentParameter](#operation/getEnvironmentParameter)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_environment_parameter_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'include_usage_info', 'fields', 'embed', 'include_deleted']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_environment_parameter" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_environment_parameter`")  # noqa: E501
        ...
        query_params = []
        if 'include_usage_info' in params:
            query_params.append(('includeUsageInfo', params['include_usage_info']))  # noqa: E501
        if 'fields' in params:
        ...
        return self.api_client.call_api(
            '/v4/environmentParameters/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_environment_parameters_package(self, **kwargs):  # noqa: E501
        """Export environment parameters list  # noqa: E501

        Retrieve a package containing the list of environment parameters.  Response body is the contents of the package. Package contents are a ZIPped version of the list of environment parameters.  The environment parameters package can be used to import the environment parameters in another environment.  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [getEnvironmentParametersPackage](#operation/getEnvironmentParametersPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_environment_parameters_package(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param bool hide_secrets: If included, the secret values will be hidden.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_environment_parameters_package_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_environment_parameters_package_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_environment_parameters_package_with_http_info(self, **kwargs):  # noqa: E501
        """Export environment parameters list  # noqa: E501

        Retrieve a package containing the list of environment parameters.  Response body is the contents of the package. Package contents are a ZIPped version of the list of environment parameters.  The environment parameters package can be used to import the environment parameters in another environment.  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [getEnvironmentParametersPackage](#operation/getEnvironmentParametersPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_environment_parameters_package_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['hide_secrets']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_environment_parameters_package" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'hide_secrets' in params:
            query_params.append(('hideSecrets', params['hide_secrets']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/environmentParameters/package', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def import_environment_parameters_package(self, **kwargs):  # noqa: E501
        """Import environment parameters package  # noqa: E501

        Import the environment parameters from the given package. A `ZIP` file as exported by the [export environment parameters endpoint](#operation/getEnvironmentParametersPackage) is accepted.  This endpoint accept a `multipart/form` content type.  Here is how to send the `ZIP` package using [curl](https://curl.haxx.se/). ``` curl -X POST https://us1.alteryxcloud.com/v4/environmentParameters/package \\ -H 'authorization: Bearer <api-token>' \\ -H 'content-type: multipart/form-data' \\ -F 'data=@path/to/environment-parameters-package.zip' ```  The response lists the objects that have been created.  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [importEnvironmentParametersPackage](#operation/importEnvironmentParametersPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_environment_parameters_package(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object body:
        :param bool from_ui: If true, will return the list of imported environment parameters for confirmation.
        :return: ImportEnvironmentParameterPackageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_environment_parameters_package_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.import_environment_parameters_package_with_http_info(**kwargs)  # noqa: E501
            return data

    def import_environment_parameters_package_with_http_info(self, **kwargs):  # noqa: E501
        """Import environment parameters package  # noqa: E501

        Import the environment parameters from the given package. A `ZIP` file as exported by the [export environment parameters endpoint](#operation/getEnvironmentParametersPackage) is accepted.  This endpoint accept a `multipart/form` content type.  Here is how to send the `ZIP` package using [curl](https://curl.haxx.se/). ``` curl -X POST https://us1.alteryxcloud.com/v4/environmentParameters/package \\ -H 'authorization: Bearer <api-token>' \\ -H 'content-type: multipart/form-data' \\ -F 'data=@path/to/environment-parameters-package.zip' ```  The response lists the objects that have been created.  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [importEnvironmentParametersPackage](#operation/importEnvironmentParametersPackage)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_environment_parameters_package_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'from_ui']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method import_environment_parameters_package" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v4/environmentParameters/package', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LImportEnvironmentParameterPackageResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_environment_parameters(self, **kwargs):  # noqa: E501
        """List environment parameters  # noqa: E501

        List existing environment parameters  <small>ref: [listEnvironmentParameters](#operation/listEnvironmentParameters)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_environment_parameters(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str include_usage_info: Include information about where the environment parameter is used.
        :param str filter: Filter environment parameters using the attached overrideKey
        :param str fields: Semi-colons-separated list of fields
        :param str embed: Comma-separated list of objects to pull in as part of the response. See [Embedding Resources](#section/Overview/Embedding-Resources) for more information.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_environment_parameters_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_environment_parameters_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_environment_parameters_with_http_info(self, **kwargs):  # noqa: E501
        """List environment parameters  # noqa: E501

        List existing environment parameters  <small>ref: [listEnvironmentParameters](#operation/listEnvironmentParameters)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_environment_parameters_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['include_usage_info', 'filter', 'fields', 'embed', 'include_deleted', 'limit', 'offset', 'filter_type', 'sort', 'filter_fields', 'filter', 'include_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_environment_parameters" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LEnvironmentParametersList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
