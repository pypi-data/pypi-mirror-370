...
class LPlanList(object):
    ...
    def __init__(self, data=None, count=None):  # noqa: E501
        """LPlanList - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._count = None
    ...
    @property
    def data(self):
        """Gets the data of this LPlanList.  # noqa: E501


        :return: The data of this LPlanList.  # noqa: E501
        :rtype: list[LPlan]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this LPlanList.


        :param data: The data of this LPlanList.  # noqa: E501
        :type: list[LPlan]
        """
        if data is None:
    ...
    @property
    def count(self):
        """Gets the count of this LPlanList.  # noqa: E501


        :return: The count of this LPlanList.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this LPlanList.


        :param count: The count of this LPlanList.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LPlanList):
            return False
