...
class AuthorizationApi(object):
    ...
    def assign_role_to_subjects_for_person(self, body, id, **kwargs):  # noqa: E501
        """Assign role to subject (person)  # noqa: E501

        Assign a role to each person in the list.  > ℹ️ **NOTE**: **Workspace admin** role is required to use this endpoint.  <small>ref: [assignRoleToSubjectsForPerson](#operation/assignRoleToSubjectsForPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assign_role_to_subjects_for_person(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.assign_role_to_subjects_for_person_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.assign_role_to_subjects_for_person_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def assign_role_to_subjects_for_person_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Assign role to subject (person)  # noqa: E501

        Assign a role to each person in the list.  > ℹ️ **NOTE**: **Workspace admin** role is required to use this endpoint.  <small>ref: [assignRoleToSubjectsForPerson](#operation/assignRoleToSubjectsForPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assign_role_to_subjects_for_person_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method assign_role_to_subjects_for_person" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `assign_role_to_subjects_for_person`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `assign_role_to_subjects_for_person`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/authorization/roles/{id}/people', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LAuthorizationRole',  # noqa: E501
    ...
    def list_authorization_roles(self, **kwargs):  # noqa: E501
        """List authorization roles  # noqa: E501

        Get a list of roles in this workspace (in authorization-service)  <small>ref: [listAuthorizationRoles](#operation/listAuthorizationRoles)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_authorization_roles(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int limit: Limit the number of results to show
        :param int offset: Offset for the paginated results
        :param int workspace_id: Optional workspaceId (for account admin api access)
        :param str account_id: Optional account ID (for account admin api access)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_authorization_roles_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_authorization_roles_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_authorization_roles_with_http_info(self, **kwargs):  # noqa: E501
        """List authorization roles  # noqa: E501

        Get a list of roles in this workspace (in authorization-service)  <small>ref: [listAuthorizationRoles](#operation/listAuthorizationRoles)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_authorization_roles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['limit', 'offset', 'workspace_id', 'account_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_authorization_roles" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LAuthorizationRoleList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def unassign_subject_from_policy_for_person(self, id, subject_id, **kwargs):  # noqa: E501
        """Unassign subject from policy for person  # noqa: E501

        Remove a subject from a given policy and remove roles associated with that subject and policy  > ℹ️ **NOTE**: **Workspace admin** role is required to use this endpoint.  <small>ref: [unassignSubjectFromPolicyForPerson](#operation/unassignSubjectFromPolicyForPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unassign_subject_from_policy_for_person(id, subject_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unassign_subject_from_policy_for_person_with_http_info(id, subject_id, **kwargs)  # noqa: E501
        else:
            (data) = self.unassign_subject_from_policy_for_person_with_http_info(id, subject_id, **kwargs)  # noqa: E501
            return data

    def unassign_subject_from_policy_for_person_with_http_info(self, id, subject_id, **kwargs):  # noqa: E501
        """Unassign subject from policy for person  # noqa: E501

        Remove a subject from a given policy and remove roles associated with that subject and policy  > ℹ️ **NOTE**: **Workspace admin** role is required to use this endpoint.  <small>ref: [unassignSubjectFromPolicyForPerson](#operation/unassignSubjectFromPolicyForPerson)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unassign_subject_from_policy_for_person_with_http_info(id, subject_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unassign_subject_from_policy_for_person" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `unassign_subject_from_policy_for_person`")  # noqa: E501
        # verify the required parameter 'subject_id' is set
        if ('subject_id' not in params or
                params['subject_id'] is None):
            raise ValueError("Missing the required parameter `subject_id` when calling `unassign_subject_from_policy_for_person`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/authorization/roles/{id}/people/{subjectId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
