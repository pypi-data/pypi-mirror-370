...
class ConnectionPermissionApi(object):
    ...
    def create_connection_permission(self, body, id, **kwargs):  # noqa: E501
        """Create Connection Permission  # noqa: E501

        Creates connection permissions as part of connection sharing  <small>ref: [createConnectionPermission](#operation/createConnectionPermission)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_connection_permission(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ConnectionPermissionCreateRequest body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_connection_permission_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_connection_permission_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def create_connection_permission_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Create Connection Permission  # noqa: E501

        Creates connection permissions as part of connection sharing  <small>ref: [createConnectionPermission](#operation/createConnectionPermission)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_connection_permission_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_connection_permission" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_connection_permission`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `create_connection_permission`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v4/connections/{id}/permissions', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LConnectionPermissions',  # noqa: E501
