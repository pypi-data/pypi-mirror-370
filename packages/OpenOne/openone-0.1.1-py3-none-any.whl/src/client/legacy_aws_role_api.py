...
class AwsRoleApi(object):
    ...
    def create_aws_role(self, body, **kwargs):  # noqa: E501
        """Create AWS role  # noqa: E501

        Create an aws role.   > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [createAwsRole](#operation/createAwsRole)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_aws_role(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AwsRoleCreateRequest body: (required)
        :return: AwsRoleCreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_aws_role_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_aws_role_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_aws_role_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create AWS role  # noqa: E501

        Create an aws role.   > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [createAwsRole](#operation/createAwsRole)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_aws_role_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_aws_role`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LAwsRoleCreateResponse',  # noqa: E501
    ...
    def delete_aws_role(self, id, **kwargs):  # noqa: E501
        """Delete AWS role  # noqa: E501

        Delete an existing aws role  <small>ref: [deleteAwsRole](#operation/deleteAwsRole)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_aws_role(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_aws_role_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_aws_role_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_aws_role_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete AWS role  # noqa: E501

        Delete an existing aws role  <small>ref: [deleteAwsRole](#operation/deleteAwsRole)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_aws_role_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_aws_role`")  # noqa: E501
    ...
    def list_aws_roles(self, **kwargs):  # noqa: E501
        """List AWS roles  # noqa: E501

        List AWS roles for a user          .  <small>ref: [listAwsRoles](#operation/listAwsRoles)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_aws_roles(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int person_id: person id
        :return: AwsRoleListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_aws_roles_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_aws_roles_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_aws_roles_with_http_info(self, **kwargs):  # noqa: E501
        """List AWS roles  # noqa: E501

        List AWS roles for a user          .  <small>ref: [listAwsRoles](#operation/listAwsRoles)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_aws_roles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LAwsRoleListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_aws_role(self, body, id, **kwargs):  # noqa: E501
        """Update AWS role  # noqa: E501

        Update an existing aws role  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [updateAwsRole](#operation/updateAwsRole)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_aws_role(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AwsRoleUpdateRequest body: (required)
        :param int id: (required)
        :return: AwsRoleCreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_aws_role_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_aws_role_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_aws_role_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update AWS role  # noqa: E501

        Update an existing aws role  > ℹ️ **NOTE**: **Admin** role is required to use this endpoint.  <small>ref: [updateAwsRole](#operation/updateAwsRole)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_aws_role_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_aws_role`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_aws_role`")  # noqa: E501
