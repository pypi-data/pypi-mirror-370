...
class MiscApi(object):
    ...
    def auth_check(self, **kwargs):  # noqa: E501
        """Check if the user is authenticated  # noqa: E501

        Check if the user is authenticated. There could be different situations for Access and Refresh Token as described below:  #### If Access Token is not expired - **Response**: Status code is 200. No Access/ Refresh Token Pair is supplied as part of set-cookie header. - **Recommendation for back-end calling service**: Relay 200 HTTP code to user's browser.  #### If Access Token is expired but still has valid Refresh Token - **Response**: Status code is 200 with set-cookie containing a new pair of Access and Refresh Token. - **Recommendation for back-end calling service**: Calling service must relay the Set-Cookie header on its response back to the user's browser. - **Recommendation for users browser**: Set the new cookie in the browser.  #### If Access Token and Refresh Token both expired - **Response**: Status code is 401 (Unauthorized). No Access/ Refresh Token Pair is supplied as part of set-cookie header. - **Recommendation for back-end calling service**: Relay 401 HTTP code to users browser. - **Recommendation for users browser**: Notify the user, such as by redirecting the user to the sign-in page etc.  #### If no access/ refresh token is provided as part of calling request - **Response**: Status code is 401 (Unauthorized). No Access/ Refresh Token Pair is supplied as part of set-cookie header. - **Recommendation for back-end calling service**: Relay 401 HTTP code to users browser. - **Recommendation for users browser**: Notify the user, such as by redirecting the user to the sign-in page etc.  <small>ref: [authCheck](#operation/authCheck)</small>  # noqa: E501
        ...
        :param str x_trifacta_workspace_name: Name of the workspace for bearer token authentication.   `Required if`  - `token authentication is for workspace`  - `x-trifacta-workspace-id header is not provided`
        :param int x_trifacta_workspace_id: Id of the workspace for bearer token authentication.  `Required if`  - `token authentication is for workspace`  - `no x-trifacta-workspace-name header is not provided`
        :param str x_alteryx_account_id: Alteryx billing account id for bearer token authentication.  `Required if`  - `token authentication is for billing account`
    ...
    def auth_check_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['x_trifacta_workspace_name', 'x_trifacta_workspace_id', 'x_alteryx_account_id']  # noqa: E501
        ...
        header_params = {}
        if 'x_trifacta_workspace_name' in params:
            header_params['x-trifacta-workspace-name'] = params['x_trifacta_workspace_name']  # noqa: E501
        if 'x_trifacta_workspace_id' in params:
            header_params['x-trifacta-workspace-id'] = params['x_trifacta_workspace_id']  # noqa: E501
        if 'x_alteryx_account_id' in params:
            header_params['x-alteryx-account-id'] = params['x_alteryx_account_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LAuthCheckResponse',  # noqa: E501
    ...
    def get_open_api_spec(self, **kwargs):  # noqa: E501
        """Get OpenAPI specification  # noqa: E501

        Get Open Api specifications  <small>ref: [getOpenApiSpec](#operation/getOpenApiSpec)</small>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_open_api_spec_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_open_api_spec_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LOpenApiSpecResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
