...
class Database:
    ...
    def annotate(
        ...
        *,
        ...
        """
        Annotate documents using either a model name OR a task name (exclusively).
        ...
        **Raises**
        ...
        - **HTTPException** - If no matching model is found.
        ...
        for doc in documents:
            ...
            self.add_annotations(doc_id, [prediction], model.config.name, json_path)
