...
class OtherChargeItemListParams(TypedDict, total=False):
    ...
    **NOTE**: If you use this parameter, you cannot also use `nameContains` or
    ...
    """
    Filter for other charge items updated on or after this date and time, in ISO
    ...
    """
    Filter for other charge items updated on or before this date and time, in ISO
    8601 format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD), the
