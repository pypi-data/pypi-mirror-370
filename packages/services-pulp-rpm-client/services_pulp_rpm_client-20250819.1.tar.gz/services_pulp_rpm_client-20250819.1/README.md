...
```python
import services-pulp_rpm-client
```
...
import services-pulp_rpm-client
from services-pulp_rpm-client.rest import ApiException
...
configuration = services-pulp_rpm-client.Configuration(
...
with services-pulp_rpm-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = services-pulp_rpm-client.AcsRpmApi(api_client)
    rpm_rpm_alternate_content_source_href = 'rpm_rpm_alternate_content_source_href_example' # str | 
    nested_role = services-pulp_rpm-client.NestedRole() # NestedRole | 
