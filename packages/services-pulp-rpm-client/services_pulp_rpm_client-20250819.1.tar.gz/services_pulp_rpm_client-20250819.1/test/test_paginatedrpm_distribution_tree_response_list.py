    ...
    def make_instance(self, include_optional) -> PaginatedrpmDistributionTreeResponseList:
        ...
        if include_optional:
            return PaginatedrpmDistributionTreeResponseList(
                ...
                results = [
                    services-pulp_rpm-client.models.rpm/distribution_tree_response.rpm.DistributionTreeResponse(
                        pulp_href = '', 
                        prn = '', 
                        header_version = '', 
                        release_name = '', 
                        ...
                        totaldiscs = 56, 
                        addons = [
                            services-pulp_rpm-client.models.addon_response.AddonResponse(
                                addon_id = '', 
                                uid = '', 
                                name = '', 
                                type = '', 
                        ...
                        checksums = [
                            services-pulp_rpm-client.models.checksum_response.ChecksumResponse(
                                path = '', 
                                checksum = '', )
                            ], 
                        images = [
                            services-pulp_rpm-client.models.image_response.ImageResponse(
                                name = '', 
                                path = '', 
                                platforms = '', 
                                artifact = null, )
                        ...
                        variants = [
                            services-pulp_rpm-client.models.variant_response.VariantResponse(
                                variant_id = '', 
                                uid = '', 
                                name = '', 
                                type = '', 
