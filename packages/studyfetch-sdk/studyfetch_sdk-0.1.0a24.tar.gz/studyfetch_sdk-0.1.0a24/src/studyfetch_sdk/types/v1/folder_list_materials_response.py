...
__all__ = ["FolderListMaterialsResponse", "FolderListMaterialsResponseItem", "FolderListMaterialsResponseItemContent"]


class FolderListMaterialsResponseItemContent(BaseModel):
...
class FolderListMaterialsResponseItem(BaseModel):
    api_id: str = FieldInfo(alias="_id")
    """Material ID"""

    content: FolderListMaterialsResponseItemContent
    """Material content"""
...
FolderListMaterialsResponse: TypeAlias = List[FolderListMaterialsResponseItem]
