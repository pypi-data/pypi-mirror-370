...
from ...types.v1.chat_analytic_analyze_response import ChatAnalyticAnalyzeResponse
from ...types.v1.chat_analytic_get_component_response import ChatAnalyticGetComponentResponse
    ...
    def analyze(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=ChatAnalyticAnalyzeResponse,
        )
    ...
    def get_component(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=ChatAnalyticGetComponentResponse,
        )
