...
from ....types.v1.assignment_grader.rubric_template_create_response import RubricTemplateCreateResponse
from ....types.v1.assignment_grader.rubric_template_get_by_id_response import RubricTemplateGetByIDResponse
...
class RubricTemplatesResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        criteria: Iterable[rubric_template_create_params.Criterion],
        name: str,
        ...
        return self._post(
            ...
            cast_to=RubricTemplateCreateResponse,
        )
    ...
    def get_by_id(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=RubricTemplateGetByIDResponse,
        )
