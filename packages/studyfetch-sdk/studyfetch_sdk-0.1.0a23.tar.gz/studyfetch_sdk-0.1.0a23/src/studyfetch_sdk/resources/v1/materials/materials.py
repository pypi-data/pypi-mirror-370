...
from ....types.v1.material_move_response import MaterialMoveResponse
from ....types.v1.material_create_response import MaterialCreateResponse
from ....types.v1.material_rename_response import MaterialRenameResponse
from ....types.v1.material_search_response import MaterialSearchResponse
from ....types.v1.material_generate_response import MaterialGenerateResponse
from ....types.v1.material_retrieve_response import MaterialRetrieveResponse
from ....types.v1.material_reprocess_response import MaterialReprocessResponse
...
from ....types.v1.material_create_and_process_response import MaterialCreateAndProcessResponse
from ....types.v1.material_generate_and_process_response import MaterialGenerateAndProcessResponse
...
class MaterialsResource(SyncAPIResource):
    ...
    def create_and_process(
        self,
        *,
        content: material_create_and_process_params.Content,
        name: str,
        folder_id: str | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            cast_to=MaterialCreateAndProcessResponse,
        )
    ...
    def generate(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=MaterialGenerateResponse,
        )
    ...
    def generate_and_process(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=MaterialGenerateAndProcessResponse,
        )
    ...
    def rename(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=MaterialRenameResponse,
        )
    ...
    def reprocess(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=MaterialReprocessResponse,
        )
