...
class Las2020List(BaseModel):
    ...
    l_tdate1: Optional[StrictStr] = Field(default=None, alias="LTdate1")
    l_tdate2: Optional[StrictStr] = Field(default=None, alias="LTdate2")
    l_tdate3: Optional[StrictStr] = Field(default=None, alias="LTdate3")
    l_tdate4: Optional[StrictStr] = Field(default=None, alias="LTdate4")
    l_tdate5: Optional[StrictStr] = Field(default=None, alias="LTdate5")
    ...
    n_start_x0020_date: Optional[StrictStr] = Field(default=None, alias="nStart_x0020_Date")
    ...
    reqdate1: Optional[StrictStr] = Field(default=None, alias="Reqdate1")
    reqdate2: Optional[StrictStr] = Field(default=None, alias="Reqdate2")
    reqdate3: Optional[StrictStr] = Field(default=None, alias="Reqdate3")
    reqdate4: Optional[StrictStr] = Field(default=None, alias="Reqdate4")
    ...
    tc_prep: Optional[LASTcprep] = Field(default=None, description="Type of tissue collection preparation (Embryo Collection currently not visible)", alias="TCPrep")
    tc_tiss: Optional[LASTctiss] = Field(default=None, description="Type of Tissue collected", alias="TCTiss")
