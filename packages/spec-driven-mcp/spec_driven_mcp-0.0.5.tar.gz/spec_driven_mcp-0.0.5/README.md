...
* **Database location:** Uses intelligent workspace detection with robust fallbacks:
  1. **Project-local**: `<workspace-root>/.spec-mcp/specs.db` when MCP client provides workspace context
