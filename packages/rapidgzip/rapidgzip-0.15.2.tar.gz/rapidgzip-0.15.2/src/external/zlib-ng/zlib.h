...
#define LIBRAPIDARCHIVE_deflateInit(strm, level) deflateInit_((strm), (level), ZLIB_VERSION, (int)sizeof(z_stream))
#define LIBRAPIDARCHIVE_inflateInit(strm) inflateInit_((strm), ZLIB_VERSION, (int)sizeof(z_stream))
#define LIBRAPIDARCHIVE_deflateInit2(strm, level, method, windowBits, memLevel, strategy) \
        deflateInit2_((strm), (level), (method), (windowBits), (memLevel), \
                     (strategy), ZLIB_VERSION, (int)sizeof(z_stream))
#define LIBRAPIDARCHIVE_inflateInit2(strm, windowBits) inflateInit2_((strm), (windowBits), ZLIB_VERSION, (int)sizeof(z_stream))
#define LIBRAPIDARCHIVE_inflateBackInit(strm, windowBits, window) \
...
#  define LIBRAPIDARCHIVE_gzgetc(g) ((g)->have ? ((g)->have--, (g)->pos++, *((g)->next)++) : (LIBRAPIDARCHIVE_gzgetc)(g))
...
#    define LIBRAPIDARCHIVE_gzopen LIBRAPIDARCHIVE_gzopen64
#    define LIBRAPIDARCHIVE_gzseek LIBRAPIDARCHIVE_gzseek64
#    define LIBRAPIDARCHIVE_gztell LIBRAPIDARCHIVE_gztell64
#    define LIBRAPIDARCHIVE_gzoffset LIBRAPIDARCHIVE_gzoffset64
#    define LIBRAPIDARCHIVE_adler32_combine LIBRAPIDARCHIVE_adler32_combine64
#    define LIBRAPIDARCHIVE_crc32_combine LIBRAPIDARCHIVE_crc32_combine64
#    define LIBRAPIDARCHIVE_crc32_combine_gen LIBRAPIDARCHIVE_crc32_combine_gen64
#  ifndef Z_LARGE64
     Z_EXTERN gzFile Z_EXPORT LIBRAPIDARCHIVE_gzopen64(const char *, const char *);
     Z_EXTERN z_off_t Z_EXPORT LIBRAPIDARCHIVE_gzseek64(gzFile, z_off_t, int);
     Z_EXTERN z_off_t Z_EXPORT LIBRAPIDARCHIVE_gztell64(gzFile);
     Z_EXTERN z_off_t Z_EXPORT LIBRAPIDARCHIVE_gzoffset64(gzFile);
     Z_EXTERN unsigned long Z_EXPORT LIBRAPIDARCHIVE_adler32_combine64(unsigned long, unsigned long, z_off_t);
     Z_EXTERN unsigned long Z_EXPORT LIBRAPIDARCHIVE_crc32_combine64(unsigned long, unsigned long, z_off_t);
     Z_EXTERN unsigned long Z_EXPORT LIBRAPIDARCHIVE_crc32_combine_gen64(z_off64_t);
#  endif
#else
#  ifndef Z_SOLO
   Z_EXTERN gzFile Z_EXPORT LIBRAPIDARCHIVE_gzopen(const char *, const char *);
   Z_EXTERN z_off_t Z_EXPORT LIBRAPIDARCHIVE_gzseek(gzFile, z_off_t, int);
   Z_EXTERN z_off_t Z_EXPORT LIBRAPIDARCHIVE_gztell(gzFile);
   Z_EXTERN z_off_t Z_EXPORT LIBRAPIDARCHIVE_gzoffset(gzFile);
#  endif
   Z_EXTERN unsigned long Z_EXPORT LIBRAPIDARCHIVE_adler32_combine(unsigned long, unsigned long, z_off_t);
   Z_EXTERN unsigned long Z_EXPORT LIBRAPIDARCHIVE_crc32_combine(unsigned long, unsigned long, z_off_t);
   Z_EXTERN unsigned long Z_EXPORT LIBRAPIDARCHIVE_crc32_combine_gen(z_off_t);
#endif
