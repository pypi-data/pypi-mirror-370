...
class TagmasterClassificationClient:
    ...
    BASE_URL = "https://tagmaster.ai/api"
    ...
    def get_projects(self) -> List[Dict[str, Any]]:
        ...
        """
        url = f"{self.base_url}/sdk/projects"
    ...
    def update_project(self, project_uuid: str, name: Optional[str] = None, description: Optional[str] = None) -> Dict[str, Any]:
        ...
        url = f"{self.base_url}/sdk/projects/{project_uuid}"
        payload = {}
        if name:
            payload["name"] = name.strip()
        if description:
    ...
    def get_categories(self, project_uuid: str) -> List[Dict[str, Any]]:
        ...
        Raises:
            requests.RequestException: If the API request fails
        """
        url = f"{self.base_url}/sdk/categories/project/{project_uuid}"
        response = self.session.get(url)
        response.raise_for_status()
        return response.json()
    ...
    def update_category(self, project_uuid: str, category_uuid: str, name: Optional[str] = None, description: Optional[str] = None) -> Dict[str, Any]:
        ...
        url = f"{self.base_url}/sdk/categories/{category_uuid}"
        payload = {}
        if name:
            payload["name"] = name.strip()
        if description:
    ...
    def bulk_delete_categories(self, category_uuids: List[str]) -> Dict[str, Any]:
        ...
        url = f"{self.base_url}/sdk/categories/bulk-delete"
    ...
    def import_categories_csv(self, project_uuid: str, csv_file_path: str) -> Dict[str, Any]:
        ...
        """
        url = f"{self.base_url}/sdk/categories/project/{project_uuid}/import"
    ...
    def export_categories_csv(self, project_uuid: str, output_file_path: Optional[str] = None) -> str:
        ...
        Raises:
            requests.RequestException: If the API request fails
        """
        url = f"{self.base_url}/sdk/categories/project/{project_uuid}/export"
        response = self.session.get(url)
        response.raise_for_status()
    ...
    def classify_text(self, text: str) -> Dict[str, Any]:
        ...
        """
        url = f"{self.base_url}/sdk/classify"
        payload = {"data": text}
    ...
    def classify_image(self, image_url: str) -> Dict[str, Any]:
        ...
        Raises:
            ...
            ValueError: If the response format is invalid
        """
        url = f"{self.base_url}/sdk/classify/image"
    ...
    def get_classification_history(self, 
        ...
        """
        url = f"{self.base_url}/sdk/classification-history"
        params = {
    ...
    def get_classification_request(self, request_uuid: str) -> Dict[str, Any]:
        ...
        Raises:
            requests.RequestException: If the API request fails
        """
        url = f"{self.base_url}/sdk/classification-history/{request_uuid}"
        response = self.session.get(url)
        response.raise_for_status()
        return response.json()
    ...
    def get_classification_stats(self, 
        ...
        Raises:
            requests.RequestException: If the API request fails
        """
        url = f"{self.base_url}/sdk/classification-history/stats"
        params = {}
    ...
    def export_classification_history_csv(self, 
        ...
        Raises:
            requests.RequestException: If the API request fails
        """
        url = f"{self.base_url}/sdk/classification-history/export"
        params = {}
