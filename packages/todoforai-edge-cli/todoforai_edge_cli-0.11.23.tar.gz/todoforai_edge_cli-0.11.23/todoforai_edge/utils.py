...
def generate_machine_fingerprint():
    ...
    # identifiers: {'platform': 'Linux', 'machine': 'x86_64', 'node': 'six', 'processor': 'x86_64', 'machine_id': '3f98af1f7c1c42e3baed3661bcb8df0f'}
    # self.fingerprint: eyJwbGF0Zm9ybSI6ICJMaW51eCIsICJtYWNoaW5lIjogIng4Nl82NCIsICJub2RlIjogInNpeCIsICJwcm9jZXNzb3IiOiAieDg2XzY0IiwgIm1hY2hpbmVfaWQiOiAiM2Y5OGFmMWY3YzFjNDJlM2JhZWQzNjYxYmNiOGRmMGYifQ==
