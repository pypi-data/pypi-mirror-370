...
class HeraldedDetectorErrorModel:
    ...
    def initializer(self) -> mwpf_incr.SolverInitializer:
        ...
        return mwpf_incr.SolverInitializer(vertex_num, weighted_edges, heralds=heralds)
...
class HeraldedDemPredictor(Predictor):
    ...
    def syndrome_of(self, dets_bit_packed: np.ndarray) -> mwpf_incr.SyndromePattern:
        ...
        return mwpf_incr.SyndromePattern(defect_vertices=defect_vertices, heralds=heralds)
