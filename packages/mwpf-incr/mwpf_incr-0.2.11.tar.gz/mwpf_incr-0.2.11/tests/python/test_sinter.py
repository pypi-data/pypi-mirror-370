...
@pytest.mark.parametrize(
    "decoder",
    [
        mwpf.SinterMWPFIncrDecoder(cluster_node_limit=50, **params),
        mwpf.SinterHUFIncrDecoder(**params),
        mwpf.SinterMWPFIncrDecoder(cluster_node_limit=0, **params),
    ],
)
@pytest.mark.parametrize(
    "p",
...
"""
    ...
    decoder = mwpf.SinterMWPFIncrDecoder(**params)
