...
class AlertRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enabled", "severity", "check_id", "channel_ids", "updated_at", "id", "name", "condition_parameters", "check_name", "cooldown_period", "created_at", "condition", "auto_resolve", "channels"]
