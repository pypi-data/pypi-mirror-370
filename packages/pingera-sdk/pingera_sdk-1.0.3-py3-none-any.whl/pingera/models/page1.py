...
class Page1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["notifications_email_footer", "email_logo", "notifications_from_email", "css_greens", "domain", "allow_email_subscribers", "css_button_hover_color", "css_spinner_color", "organization_id", "css_reds", "transactional_logo", "viewers_must_be_team_members", "css_oranges", "css_button_border_color", "css_light_font_color", "allow_webhook_subscribers", "country", "company_logo", "allow_rss_atom_feeds", "id", "language", "css_graph_color", "headline", "hidden_from_search", "created_at", "city", "allow_incident_subscribers", "css_no_data", "css_button_text_color", "time_zone", "state", "subdomain", "allow_sms_subscribers", "css_body_background_color", "css_button_color", "activity_score", "favicon_logo", "template_id", "template", "support_url", "hero_cover", "updated_at", "css_font_color", "name", "css_border_color", "css_link_color", "css_yellows", "allow_page_subscribers", "page_description", "ip_restrictions", "url", "css_blues"]
