...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["grace_seconds", "next_expected_ping", "last_ping_at", "status", "updated_at", "recent_pings", "id", "name", "period_seconds", "ping_url", "created_at", "active"]
