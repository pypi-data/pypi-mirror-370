...
class IncidentPostmortem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["updated_at", "body_draft_updated_at", "notify_subscribers", "id", "body", "published_at", "preview_key", "incident_id", "body_updated_at", "created_at", "body_draft"]
