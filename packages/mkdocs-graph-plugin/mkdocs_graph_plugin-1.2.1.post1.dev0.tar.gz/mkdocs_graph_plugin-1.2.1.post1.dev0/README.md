...
[![PyPI - Version](https://img.shields.io/pypi/v/mkdocs-graph-plugin)](https://pypi.org/project/mkdocs-graph-plugin/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/mkdocs-graph-plugin)](https://pypi.org/project/mkdocs-graph-plugin/)
[![GitHub License](https://img.shields.io/github/license/develmusa/mkdocs-graph-plugin)](https://github.com/develmusa/mkdocs-graph-plugin/blob/main/LICENSE)
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/develmusa/mkdocs-graph-plugin/ci.yaml)](https://github.com/develmusa/mkdocs-graph-plugin/actions)
[![Documentation](https://img.shields.io/badge/docs-mkdocs-blue)](https://develmusa.github.io/mkdocs-graph-plugin/)
