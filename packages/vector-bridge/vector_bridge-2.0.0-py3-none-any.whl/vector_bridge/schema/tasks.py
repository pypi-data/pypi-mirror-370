...
class Task(BaseModel):
    ...
    def get_history(
        ...
        """Get the history of changes for this task."""
        return client.admin.tasks.get_task_history(
            task_id=self.task_id, limit=limit, last_evaluated_key=last_evaluated_key
        )
    ...
    async def a_get_history(
        ...
        """Asynchronously get the history of changes for this task."""
        return await client.admin.tasks.get_task_history(
            task_id=self.task_id, limit=limit, last_evaluated_key=last_evaluated_key
        )
