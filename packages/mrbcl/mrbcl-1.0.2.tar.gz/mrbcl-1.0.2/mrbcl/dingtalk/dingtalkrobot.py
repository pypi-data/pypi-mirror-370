...
class DingTalkRobot:
    ...
    def send_link(self, title: str, text: str, message_url: str, pic_url: str = "", pc_slide: bool = True) -> Dict:
        ...
        # 控制链接打开方式需要加上这段
        default_url = "dingtalk://dingtalkclient/page/link?url="
        # 对链接进行编码
        encoded_url = urllib.parse.quote_plus(message_url)
        # 拼接完整的URL
        encoded_url = f"{default_url}{encoded_url}&pc_slide={str(pc_slide).lower()}"
    ...
    def send_action_card(self, title: str, text: str, single_title: str, single_url: str, btn_orientation: str = "0") -> Dict:
        """
        发送整体跳转ActionCard消息
    ...
    def send_action_card_btns(self, title: str, text: str, btns: List[Dict[str, str]], btn_orientation: str = "0") -> Dict:
        """
        发送独立跳转ActionCard消息
