    ...
    def _execute_bulk_api_sync(self, 
        ...
        try:
            ...
            if df_fields:
                ...
                if fields_to_remove:
                    print(f"⚠️  Removing {len(fields_to_remove)} problematic fields: {fields_to_remove}")
                    ...
                    if valid_fields:
                        ...
                        print(f"✅ Rebuilt query with {len(valid_fields)} valid fields")
                    else:
                        print(f"❌ No valid fields remaining after filtering!")
                else:
                    print(f"✅ No problematic fields found, keeping all {len(df_fields)} fields")
