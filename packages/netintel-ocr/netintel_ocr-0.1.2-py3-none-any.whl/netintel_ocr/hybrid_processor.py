        ...
        for image_file in tqdm(image_files, desc="Processing pages", total=total_pages):
            try:
                ...
                if auto_detect and not fast_mode and detector:
                    ...
                    page_text = None
                    try:
                        step_start = tracker.start_step("Transcribing page text")
                    ...
                    try:
                        step_start = tracker.start_step("Checking for network diagram")
                    ...
                    if detection.get("is_network_diagram") and detection.get("confidence", 0) >= confidence_threshold:
                        ...
                        try:
                            step_start = tracker.start_step("Extracting components")
                        ...
                        if extraction.get("extraction_successful"):
                            ...
                            try:
                                step_start = tracker.start_step("Generating Mermaid diagram")
