...
class FastExtractor:
    ...
    def __init__(self, model: str = "qwen2.5vl:latest", timeout: int = 30, use_improved_prompts: bool = True):
        self.model = model
...
def extract_with_optimization(image_path: str, model: str = "qwen2.5vl:latest", 
