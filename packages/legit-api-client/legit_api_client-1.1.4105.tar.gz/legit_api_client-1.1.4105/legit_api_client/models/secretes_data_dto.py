...
class SecretesDataDto(BaseModel):
    """
    SecretesDataDto
    """ # noqa: E501
    ai_validation_result: Optional[AiValidationResult] = Field(default=None, description="AI validation result for the secret", alias="aiValidationResult")
    validity_status: Optional[SecretIssueValidityStatus] = Field(default=None, description="Status of the secrete validity", alias="validityStatus")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecretesDataDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecretesDataDto from a dict"""
        if obj is None:
            return None
