...
class IssuesV2Api:
    ...
    def get_issue_action_history(
        ...
        Get issue id to the last 100 actions performed on it, for the provided issue ids. Some issues may not have any history (if no action was performed on them)
