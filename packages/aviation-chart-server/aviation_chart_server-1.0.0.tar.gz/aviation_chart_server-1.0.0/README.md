...
**This package requires GDAL to be installed first.** GDAL is a powerful geospatial library used for processing aviation charts.

### Recommended: Using Conda (All Platforms)

The easiest and most reliable way to install this package with all dependencies is using conda. Conda works consistently across Windows, macOS, and Linux and handles GDAL dependencies perfectly.
...
If you prefer not to use conda, you can install GDAL through your system package manager. **Note: This approach is more complex and may be error-prone.**
