...
class DialogflowConversationProfile(
    ...
    def __init__(
        ...
        *,
        ...
        :param display_name: Required. Human readable name for this profile. Max length 1024 bytes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#display_name DialogflowConversationProfile#display_name}
        :param location: desc. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#location DialogflowConversationProfile#location}
        :param automated_agent_config: automated_agent_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#automated_agent_config DialogflowConversationProfile#automated_agent_config}
        :param human_agent_assistant_config: human_agent_assistant_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#human_agent_assistant_config DialogflowConversationProfile#human_agent_assistant_config}
        :param human_agent_handoff_config: human_agent_handoff_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#human_agent_handoff_config DialogflowConversationProfile#human_agent_handoff_config}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#id DialogflowConversationProfile#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param language_code: Language code for the conversation profile. This should be a BCP-47 language tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#language_code DialogflowConversationProfile#language_code}
        :param logging_config: logging_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#logging_config DialogflowConversationProfile#logging_config}
        :param new_message_event_notification_config: new_message_event_notification_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#new_message_event_notification_config DialogflowConversationProfile#new_message_event_notification_config}
        :param notification_config: notification_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#notification_config DialogflowConversationProfile#notification_config}
        :param project: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#project DialogflowConversationProfile#project}.
        :param security_settings: Name of the CX SecuritySettings reference for the agent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#security_settings DialogflowConversationProfile#security_settings}
        :param stt_config: stt_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#stt_config DialogflowConversationProfile#stt_config}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#timeouts DialogflowConversationProfile#timeouts}
        :param time_zone: The time zone of this conversational profile. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#time_zone DialogflowConversationProfile#time_zone}
        :param tts_config: tts_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#tts_config DialogflowConversationProfile#tts_config}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DialogflowConversationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#import import section} in the documentation of this resource for the id to use
    ...
    def put_automated_agent_config(
        ...
        *,
        ...
        '''
        :param agent: ID of the Dialogflow agent environment to use. Expects the format "projects//locations//agent/environments/". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#agent DialogflowConversationProfile#agent}
        :param session_ttl: Configure lifetime of the Dialogflow session. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#session_ttl DialogflowConversationProfile#session_ttl}
        '''
    ...
    def put_human_agent_assistant_config(
        ...
        *,
        ...
        '''
        :param end_user_suggestion_config: end_user_suggestion_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#end_user_suggestion_config DialogflowConversationProfile#end_user_suggestion_config}
        :param human_agent_suggestion_config: human_agent_suggestion_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#human_agent_suggestion_config DialogflowConversationProfile#human_agent_suggestion_config}
        :param message_analysis_config: message_analysis_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#message_analysis_config DialogflowConversationProfile#message_analysis_config}
        :param notification_config: notification_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#notification_config DialogflowConversationProfile#notification_config}
        '''
    ...
    def put_human_agent_handoff_config(
        ...
        *,
        ...
        '''
        :param live_person_config: live_person_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#live_person_config DialogflowConversationProfile#live_person_config}
        '''
    ...
    def put_logging_config(
        ...
        *,
        ...
        '''
        :param enable_stackdriver_logging: Whether to log conversation events. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_stackdriver_logging DialogflowConversationProfile#enable_stackdriver_logging}
        '''
    ...
    def put_new_message_event_notification_config(
        ...
        *,
        ...
        '''
        :param message_format: Format of the message Possible values: ["MESSAGE_FORMAT_UNSPECIFIED", "PROTO", "JSON"]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#message_format DialogflowConversationProfile#message_format}
        :param topic: Name of the Pub/Sub topic to publish conversation events. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#topic DialogflowConversationProfile#topic}
        '''
    ...
    def put_stt_config(
        ...
        *,
        ...
        '''
        :param audio_encoding: Audio encoding of the audio content to process. Possible values: ["AUDIO_ENCODING_UNSPECIFIED", "AUDIO_ENCODING_LINEAR_16", "AUDIO_ENCODING_FLAC", "AUDIO_ENCODING_MULAW", "AUDIO_ENCODING_AMR", "AUDIO_ENCODING_AMR_WB", "AUDIO_ENCODING_OGG_OPUS", "AUDIOENCODING_SPEEX_WITH_HEADER_BYTE"]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#audio_encoding DialogflowConversationProfile#audio_encoding}
        :param enable_word_info: If true, Dialogflow returns SpeechWordInfo in StreamingRecognitionResult with information about the recognized speech words. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_word_info DialogflowConversationProfile#enable_word_info}
        :param language_code: The language of the supplied audio. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#language_code DialogflowConversationProfile#language_code}
        :param model: Which Speech model to select. Leave this field unspecified to use Agent Speech settings for model selection. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#model DialogflowConversationProfile#model}
        :param sample_rate_hertz: Sample rate (in Hertz) of the audio content sent in the query. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#sample_rate_hertz DialogflowConversationProfile#sample_rate_hertz}
        :param speech_model_variant: The speech model used in speech to text. Possible values: ["SPEECH_MODEL_VARIANT_UNSPECIFIED", "USE_BEST_AVAILABLE", "USE_STANDARD", "USE_ENHANCED"]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#speech_model_variant DialogflowConversationProfile#speech_model_variant}
        :param use_timeout_based_endpointing: Use timeout based endpointing, interpreting endpointer sensitivy as seconds of timeout value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#use_timeout_based_endpointing DialogflowConversationProfile#use_timeout_based_endpointing}
        '''
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#create DialogflowConversationProfile#create}.
        :param delete: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#delete DialogflowConversationProfile#delete}.
        :param update: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#update DialogflowConversationProfile#update}.
        '''
    ...
    def put_tts_config(
        ...
        *,
        ...
        '''
        :param effects_profile_id: An identifier which selects 'audio effects' profiles that are applied on (post synthesized) text to speech. Effects are applied on top of each other in the order they are given. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#effects_profile_id DialogflowConversationProfile#effects_profile_id}
        :param pitch: Speaking pitch, in the range [-20.0, 20.0]. 20 means increase 20 semitones from the original pitch. -20 means decrease 20 semitones from the original pitch. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#pitch DialogflowConversationProfile#pitch}
        :param speaking_rate: Speaking rate/speed, in the range [0.25, 4.0]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#speaking_rate DialogflowConversationProfile#speaking_rate}
        :param voice: voice block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#voice DialogflowConversationProfile#voice}
        :param volume_gain_db: Volume gain (in dB) of the normal native volume supported by the specific voice. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#volume_gain_db DialogflowConversationProfile#volume_gain_db}
        '''
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigs:
    def __init__(
        ...
        *,
        ...
        '''
        :param conversation_model_config: conversation_model_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#conversation_model_config DialogflowConversationProfile#conversation_model_config}
        :param conversation_process_config: conversation_process_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#conversation_process_config DialogflowConversationProfile#conversation_process_config}
        :param disable_agent_query_logging: Disable the logging of search queries sent by human agents. It can prevent those queries from being stored at answer records. This feature is only supported for types: KNOWLEDGE_SEARCH. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#disable_agent_query_logging DialogflowConversationProfile#disable_agent_query_logging}
        :param enable_conversation_augmented_query: Enable including conversation context during query answer generation. This feature is only supported for types: KNOWLEDGE_SEARCH. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_conversation_augmented_query DialogflowConversationProfile#enable_conversation_augmented_query}
        :param enable_event_based_suggestion: Automatically iterates all participants and tries to compile suggestions. This feature is only supported for types: ARTICLE_SUGGESTION, FAQ, DIALOGFLOW_ASSIST, KNOWLEDGE_ASSIST. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_event_based_suggestion DialogflowConversationProfile#enable_event_based_suggestion}
        :param enable_query_suggestion_only: Enable query suggestion only. This feature is only supported for types: KNOWLEDGE_ASSIST. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_query_suggestion_only DialogflowConversationProfile#enable_query_suggestion_only}
        :param enable_query_suggestion_when_no_answer: Enable query suggestion even if we can't find its answer. By default, queries are suggested only if we find its answer. This feature is only supported for types: KNOWLEDGE_ASSIST. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_query_suggestion_when_no_answer DialogflowConversationProfile#enable_query_suggestion_when_no_answer}
        :param query_config: query_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#query_config DialogflowConversationProfile#query_config}
        :param suggestion_feature: suggestion_feature block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#suggestion_feature DialogflowConversationProfile#suggestion_feature}
        :param suggestion_trigger_settings: suggestion_trigger_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#suggestion_trigger_settings DialogflowConversationProfile#suggestion_trigger_settings}
        '''
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsConversationModelConfig:
    def __init__(
        ...
        *,
        ...
        '''
        :param baseline_model_version: Version of current baseline model. It will be ignored if model is set. Valid versions are: Article Suggestion baseline model: - 0.9 - 1.0 (default) Summarization baseline model: - 1.0 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#baseline_model_version DialogflowConversationProfile#baseline_model_version}
        :param model: Conversation model resource name. Format: projects//conversationModels/. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#model DialogflowConversationProfile#model}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsConversationProcessConfig:
    def __init__(
        ...
        *,
        ...
        '''
        :param recent_sentences_count: Number of recent non-small-talk sentences to use as context for article and FAQ suggestion. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#recent_sentences_count DialogflowConversationProfile#recent_sentences_count}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsOutputReference(
    ...
    def put_query_config(
        ...
        *,
        ...
        '''
        :param confidence_threshold: Confidence threshold of query result. This feature is only supported for types: ARTICLE_SUGGESTION, FAQ, SMART_REPLY, SMART_COMPOSE, KNOWLEDGE_SEARCH, KNOWLEDGE_ASSIST, ENTITY_EXTRACTION. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#confidence_threshold DialogflowConversationProfile#confidence_threshold}
        :param context_filter_settings: context_filter_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#context_filter_settings DialogflowConversationProfile#context_filter_settings}
        :param dialogflow_query_source: dialogflow_query_source block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#dialogflow_query_source DialogflowConversationProfile#dialogflow_query_source}
        :param document_query_source: document_query_source block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#document_query_source DialogflowConversationProfile#document_query_source}
        :param knowledge_base_query_source: knowledge_base_query_source block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#knowledge_base_query_source DialogflowConversationProfile#knowledge_base_query_source}
        :param max_results: Maximum number of results to return. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#max_results DialogflowConversationProfile#max_results}
        :param sections: sections block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#sections DialogflowConversationProfile#sections}
        '''
    ...
    def put_suggestion_feature(
        ...
        *,
        ...
        '''
        :param type: Type of Human Agent Assistant API feature to request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#type DialogflowConversationProfile#type}
        '''
    ...
    def put_suggestion_trigger_settings(
        ...
        *,
        ...
        '''
        :param no_small_talk: Do not trigger if last utterance is small talk. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#no_small_talk DialogflowConversationProfile#no_small_talk}
        :param only_end_user: Only trigger suggestion if participant role of last utterance is END_USER. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#only_end_user DialogflowConversationProfile#only_end_user}
        '''
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigContextFilterSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param drop_handoff_messages: If set to true, the last message from virtual agent (hand off message) and the message before it (trigger message of hand off) are dropped. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#drop_handoff_messages DialogflowConversationProfile#drop_handoff_messages}
        :param drop_ivr_messages: If set to true, all messages from ivr stage are dropped. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#drop_ivr_messages DialogflowConversationProfile#drop_ivr_messages}
        :param drop_virtual_agent_messages: If set to true, all messages from virtual agent are dropped. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#drop_virtual_agent_messages DialogflowConversationProfile#drop_virtual_agent_messages}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigDialogflowQuerySource:
    def __init__(
        ...
        *,
        ...
        '''
        :param agent: he name of a Dialogflow virtual agent used for end user side intent detection and suggestion. Format: projects//locations//agent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#agent DialogflowConversationProfile#agent}
        :param human_agent_side_config: human_agent_side_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#human_agent_side_config DialogflowConversationProfile#human_agent_side_config}
        '''
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigDialogflowQuerySourceHumanAgentSideConfig:
    def __init__(self, *, agent: typing.Optional[builtins.str] = None) -> None:
        '''
        :param agent: The name of a dialogflow virtual agent used for intent detection and suggestion triggered by human agent. Format: projects//locations//agent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#agent DialogflowConversationProfile#agent}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigDocumentQuerySource:
    def __init__(self, *, documents: typing.Sequence[builtins.str]) -> None:
        '''
        :param documents: Knowledge documents to query from. Format: projects//locations//knowledgeBases//documents/. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#documents DialogflowConversationProfile#documents}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigKnowledgeBaseQuerySource:
    def __init__(self, *, knowledge_bases: typing.Sequence[builtins.str]) -> None:
        '''
        :param knowledge_bases: Knowledge bases to query. Format: projects//locations//knowledgeBases/. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#knowledge_bases DialogflowConversationProfile#knowledge_bases}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentAssistantConfigMessageAnalysisConfig:
    def __init__(
        ...
        *,
        ...
        '''
        :param enable_entity_extraction: Enable entity extraction in conversation messages on agent assist stage. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_entity_extraction DialogflowConversationProfile#enable_entity_extraction}
        :param enable_sentiment_analysis: Enable sentiment analysis in conversation messages on agent assist stage. Sentiment analysis inspects user input and identifies the prevailing subjective opinion, especially to determine a user's attitude as positive, negative, or neutral. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#enable_sentiment_analysis DialogflowConversationProfile#enable_sentiment_analysis}
        '''
        if __debug__:
...
class DialogflowConversationProfileHumanAgentHandoffConfigLivePersonConfig:
    def __init__(self, *, account_number: builtins.str) -> None:
        '''
        :param account_number: Account number of the LivePerson account to connect. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#account_number DialogflowConversationProfile#account_number}
        '''
        if __debug__:
...
class DialogflowConversationProfileTtsConfigOutputReference(
    ...
    def put_voice(
        ...
        *,
        ...
        '''
        :param name: The name of the voice. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#name DialogflowConversationProfile#name}
        :param ssml_gender: The preferred gender of the voice. Possible values: ["SSML_VOICE_GENDER_UNSPECIFIED", "SSML_VOICE_GENDER_MALE", "SSML_VOICE_GENDER_FEMALE", "SSML_VOICE_GENDER_NEUTRAL"]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dialogflow_conversation_profile#ssml_gender DialogflowConversationProfile#ssml_gender}
        '''
