...
# from .html_blocks import FormularioDinamicoBlock

# Manter apenas as outras importações necessárias
from wagtail import blocks
from wagtail.images.blocks import ImageChooserBlock
...
class SecaoContatoBlock(blocks.StructBlock):
    ...
    formulario = blocks.StructBlock([
        ...
        # Usar os campos dinâmicos existentes
        ('campos', blocks.StreamBlock(
            BASE_FORM_FIELD_BLOCKS,  # Certifique-se que está importado
