...
```python
import services-pulp_gem-client
```
...
import services-pulp_gem-client
from services-pulp_gem-client.rest import ApiException
...
configuration = services-pulp_gem-client.Configuration(
...
with services-pulp_gem-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = services-pulp_gem-client.ContentGemApi(api_client)
