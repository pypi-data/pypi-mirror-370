...
class ExperimentManager(DeviceSequenceMixin):
    ...
    def __new__(cls, *_args, **_kwargs) -> "ExperimentManager":
        """
    ...
    def run(self) -> None:
        ...
        try:
            ...
            logger.exception("Error during stat-up of devices")
    ...
    def finish(self) -> None:
        ...
        try:
            ...
            logger.exception("Error during finishing the experiment", exc_info=e)
            self._change_status(ExperimentStatus.ERROR)
            raise ExperimentError from e
        else:
    ...
    def add_device(self, name: str, device: Device) -> None:
        ...
        if self.status == ExperimentStatus.RUNNING:
            ...
            try:
                ...
                logger.exception("Error at adding a new Device", exc_info=e)
                self._change_status(ExperimentStatus.ERROR)
                raise ExperimentError from e
