...
> - Please use **[HoloLink](https://pypi.org/project/HoloLink/)** for all new development. HoloLink is a direct evolution of SkillsManager, offering the same powerful features plus new improvements and ongoing support.
> - For file or skill syncing, use **[HoloSync](https://pypi.org/project/HoloSync/)**.
>
> | Package       | Purpose                                  |
> | ------------- | ---------------------------------------- |
