...
def _compute_daily_sector_median_returns(mapping_file, returns_file,
    ...
    mapping_df = mapping_df.rename(columns=lambda x: x.strip().capitalize())
    returns_df = returns_df.rename(columns=lambda x: x.strip().capitalize())
