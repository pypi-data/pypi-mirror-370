...
from Backtester_Tushar.Data.utils import _aggregate_parquet
import calendar
import os
import re
import numpy as np
...
class DataHandler:
    ...
    def save_relative_bbg_stock_data_as_parquet(self, parquet_dir,
                                                mapping_file,
        ...
        df_all = _aggregate_parquet(parquet_dir, ticker_column_name, datetime_column_name)
