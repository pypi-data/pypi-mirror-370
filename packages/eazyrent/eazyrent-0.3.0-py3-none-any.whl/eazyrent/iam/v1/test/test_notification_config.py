    ...
    def make_instance(self, include_optional) -> NotificationConfig:
        ...
        if include_optional:
            return NotificationConfig(
                app = iam.v1.models.app_notification_config.AppNotificationConfig(
                ...
                email = iam.v1.models.email_notification_config.EmailNotificationConfig(
                    rental_file_submitted = True, 
                    rental_file_created = True, 
                    rental_file_deletion = True, 
                    rental_file_analyzed = True, 
