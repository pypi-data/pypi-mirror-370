...
class TestUpdateUserGrants(unittest.TestCase):
    """UpdateUserGrants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateUserGrants:
        """Test UpdateUserGrants
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateUserGrants`
        """
        model = UpdateUserGrants()
        if include_optional:
            return UpdateUserGrants(
                grants = [
                    'org:admin'
                    ]
            )
