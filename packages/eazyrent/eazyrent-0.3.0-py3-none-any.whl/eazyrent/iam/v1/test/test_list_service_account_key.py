...
class TestListServiceAccountKey(unittest.TestCase):
    """ListServiceAccountKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListServiceAccountKey:
        """Test ListServiceAccountKey
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListServiceAccountKey`
        """
        model = ListServiceAccountKey()
        if include_optional:
            return ListServiceAccountKey(
                id = '',
                type = '',
    ...
    def testListServiceAccountKey(self):
        """Test ListServiceAccountKey"""
