...
class TestServiceAccountKeys(unittest.TestCase):
    """ServiceAccountKeys unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAccountKeys:
        """Test ServiceAccountKeys
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceAccountKeys`
        """
        model = ServiceAccountKeys()
        if include_optional:
            return ServiceAccountKeys(
                count = 56,
                results = [
                    iam.v1.models.list_service_account_key.ListServiceAccountKey(
                        id = '', 
                        type = '', 
    ...
    def testServiceAccountKeys(self):
        """Test ServiceAccountKeys"""
