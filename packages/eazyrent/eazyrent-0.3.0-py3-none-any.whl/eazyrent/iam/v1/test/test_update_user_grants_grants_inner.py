...
class TestUpdateUserGrantsGrantsInner(unittest.TestCase):
    """UpdateUserGrantsGrantsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateUserGrantsGrantsInner:
        """Test UpdateUserGrantsGrantsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateUserGrantsGrantsInner`
        """
        model = UpdateUserGrantsGrantsInner()
        if include_optional:
            return UpdateUserGrantsGrantsInner(
            )
        else:
            return UpdateUserGrantsGrantsInner(
        )
    ...
    def testUpdateUserGrantsGrantsInner(self):
        """Test UpdateUserGrantsGrantsInner"""
