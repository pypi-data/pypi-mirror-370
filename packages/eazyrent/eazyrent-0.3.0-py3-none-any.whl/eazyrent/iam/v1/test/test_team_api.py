...
class TestTeamApi(unittest.TestCase):
    ...
    def test_add_organization_members(self) -> None:
        """Test case for add_organization_members
    ...
    def test_deactivate_member(self) -> None:
        """Test case for deactivate_member
    ...
    def test_sync_user_from_auth_service(self) -> None:
        """Test case for sync_user_from_auth_service

        Sync user from auth service
        """
        pass

    def test_unlock_member(self) -> None:
        """Test case for unlock_member
