...
class TestUserConfigPropertyRentSubscriptionsInner(unittest.TestCase):
    """UserConfigPropertyRentSubscriptionsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test UserConfigPropertyRentSubscriptionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UserConfigPropertyRentSubscriptionsInner`
        """
        model = UserConfigPropertyRentSubscriptionsInner()
        if include_optional:
            return UserConfigPropertyRentSubscriptionsInner(
            )
        else:
            return UserConfigPropertyRentSubscriptionsInner(
        )
    ...
    def testUserConfigPropertyRentSubscriptionsInner(self):
        """Test UserConfigPropertyRentSubscriptionsInner"""
