...
class ServiceAccountsApi:
    ...
    def _create_key_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/service-accounts/{id}/keys/",
    ...
    def _delete_key_serialize(
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/service-accounts/{id}/keys/{key_id}/",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_keys_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceAccountKeys]:
        """List keys
