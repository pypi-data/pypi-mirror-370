...
class TestPhotoColumn(unittest.TestCase):
    """PhotoColumn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhotoColumn:
        """Test PhotoColumn
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PhotoColumn`
        """
        model = PhotoColumn()
        if include_optional:
            return PhotoColumn(
