...
class TestSecurityFacilities(unittest.TestCase):
    """SecurityFacilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecurityFacilities:
        """Test SecurityFacilities
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SecurityFacilities`
        """
        model = SecurityFacilities()
        if include_optional:
    ...
    def testSecurityFacilities(self):
        """Test SecurityFacilities"""
