...
class TestZipDescriptor(unittest.TestCase):
    """ZipDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZipDescriptor:
        """Test ZipDescriptor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ZipDescriptor`
        """
        model = ZipDescriptor()
        if include_optional:
