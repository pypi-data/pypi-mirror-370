...
class TestPaginatedResponseUnionListForRentProductListForSalesProduct(
    unittest.TestCase
):
    """PaginatedResponseUnionListForRentProductListForSalesProduct unit test stubs"""
    ...
    def make_instance(
        ...
        """Test PaginatedResponseUnionListForRentProductListForSalesProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseUnionListForRentProductListForSalesProduct`
        """
        model = PaginatedResponseUnionListForRentProductListForSalesProduct()
        if include_optional:
            return PaginatedResponseUnionListForRentProductListForSalesProduct(
                count = 56,
                next = None,
                previous = None,
                results = [
    ...
    def testPaginatedResponseUnionListForRentProductListForSalesProduct(self):
        """Test PaginatedResponseUnionListForRentProductListForSalesProduct"""
