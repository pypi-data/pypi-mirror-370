...
class TestBuildingInformation(unittest.TestCase):
    """BuildingInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildingInformation:
        """Test BuildingInformation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BuildingInformation`
        """
    ...
    def testBuildingInformation(self):
        """Test BuildingInformation"""
