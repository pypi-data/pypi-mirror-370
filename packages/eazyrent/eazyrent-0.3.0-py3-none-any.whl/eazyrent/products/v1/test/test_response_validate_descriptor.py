...
class TestResponseValidateDescriptor(unittest.TestCase):
    """ResponseValidateDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseValidateDescriptor:
        """Test ResponseValidateDescriptor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ResponseValidateDescriptor`
        """
        model = ResponseValidateDescriptor()
        if include_optional:
            return ResponseValidateDescriptor(
                match_on = [
                    ''
                    ],
                columns = {
                ...
                photos = products.v1.models.photo_column.PhotoColumn(
                    ...
                    suffix = '', ),
                format = 'zip',
                csv_params = products.v1.models.csv_params.CsvParams(
                    delimiter = '', 
                    encoding = '', 
                    skip_rows = 56, ),
                json_params = products.v1.models.json_params.JsonParams(
                    encoding = '', 
                    root_path = '', ),
                xml_params = products.v1.models.xml_params.XmlParams(
                    encoding = '', 
                    root_path = '', ),
                zip_params = products.v1.models.zip_params.ZipParams(
                    file_path = '', 
                    descriptor = null, )
            )
        else:
    ...
    def testResponseValidateDescriptor(self):
        """Test ResponseValidateDescriptor"""
