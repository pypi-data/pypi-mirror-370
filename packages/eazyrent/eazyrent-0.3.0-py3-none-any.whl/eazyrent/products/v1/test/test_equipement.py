...
class TestEquipement(unittest.TestCase):
    """Equipement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Equipement:
        """Test Equipement
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Equipement`
        """
        model = Equipement()
        if include_optional:
            return Equipement(
