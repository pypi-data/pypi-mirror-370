...
class TestUsecols(unittest.TestCase):
    """Usecols unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Usecols:
        """Test Usecols
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Usecols`
        """
        model = Usecols()
        if include_optional:
            return Usecols(
