...
class TestUpdateForSaleProduct(unittest.TestCase):
    """UpdateForSaleProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateForSaleProduct:
        """Test UpdateForSaleProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateForSaleProduct`
        """
        model = UpdateForSaleProduct()
        if include_optional:
            return UpdateForSaleProduct(
    ...
    def testUpdateForSaleProduct(self):
        """Test UpdateForSaleProduct"""
