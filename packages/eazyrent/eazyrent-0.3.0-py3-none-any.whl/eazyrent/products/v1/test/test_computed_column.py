...
class TestComputedColumn(unittest.TestCase):
    """ComputedColumn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputedColumn:
        """Test ComputedColumn
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ComputedColumn`
        """
