...
class TestCreateForSaleProductInput(unittest.TestCase):
    """CreateForSaleProductInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateForSaleProductInput:
        """Test CreateForSaleProductInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateForSaleProductInput`
        """
        model = CreateForSaleProductInput()
        if include_optional:
            return CreateForSaleProductInput(
    ...
    def testCreateForSaleProductInput(self):
        """Test CreateForSaleProductInput"""
