...
class TestZipParams(unittest.TestCase):
    """ZipParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZipParams:
        """Test ZipParams
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ZipParams`
        """
        model = ZipParams()
        if include_optional:
            return ZipParams(
