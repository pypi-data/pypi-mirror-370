...
USECOLS_ANY_OF_SCHEMAS = ["List[int]", "List[str]", "str"]


class Usecols(BaseModel):
    """
    Usecols
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = Usecols.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in Usecols with anyOf schemas: List[int], List[str], str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into Usecols with anyOf schemas: List[int], List[str], str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
