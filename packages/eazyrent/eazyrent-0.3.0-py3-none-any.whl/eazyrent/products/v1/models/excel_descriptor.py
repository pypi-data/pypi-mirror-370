...
class ExcelDescriptor(BaseModel):
    """
    ExcelDescriptor
    """  # noqa: E501
    ...
    def format_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["excel"]):
            raise ValueError("must be one of enum values ('excel')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of excel_params
        if self.excel_params:
            _dict["excel_params"] = self.excel_params.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "excel_params": ExcelParams.from_dict(obj["excel_params"])
                if obj.get("excel_params") is not None
                else None,
            }
        )
        return _obj
