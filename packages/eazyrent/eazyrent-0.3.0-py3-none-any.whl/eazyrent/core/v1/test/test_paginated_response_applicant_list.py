...
class TestPaginatedResponseApplicantList(unittest.TestCase):
    """PaginatedResponseApplicantList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseApplicantList:
        """Test PaginatedResponseApplicantList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseApplicantList`
        """
        model = PaginatedResponseApplicantList()
        if include_optional:
            return PaginatedResponseApplicantList(
                count = 56,
                next = None,
                previous = None,
                results = [
    ...
    def testPaginatedResponseApplicantList(self):
        """Test PaginatedResponseApplicantList"""
