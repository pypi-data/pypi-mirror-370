...
class TestPaginatedResponsePropertyRentList(unittest.TestCase):
    """PaginatedResponsePropertyRentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponsePropertyRentList:
        """Test PaginatedResponsePropertyRentList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponsePropertyRentList`
        """
        model = PaginatedResponsePropertyRentList()
        if include_optional:
            return PaginatedResponsePropertyRentList(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v1.models.property_rent_list.PropertyRentList(
                        id = '', 
                        reference = '', 
                        photo_uri = '', 
                        title = '', 
    ...
    def testPaginatedResponsePropertyRentList(self):
        """Test PaginatedResponsePropertyRentList"""
