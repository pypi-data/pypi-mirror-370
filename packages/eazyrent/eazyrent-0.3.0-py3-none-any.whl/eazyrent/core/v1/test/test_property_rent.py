...
class TestPropertyRent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PropertyRent:
        """Test PropertyRent
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PropertyRent`
        """
        model = PropertyRent()
        if include_optional:
            return PropertyRent(
