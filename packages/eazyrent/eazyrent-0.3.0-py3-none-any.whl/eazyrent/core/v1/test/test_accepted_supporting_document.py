...
class TestAcceptedSupportingDocument(unittest.TestCase):
    """AcceptedSupportingDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptedSupportingDocument:
        """Test AcceptedSupportingDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AcceptedSupportingDocument`
        """
        model = AcceptedSupportingDocument()
        if include_optional:
            return AcceptedSupportingDocument(
                id = '',
                name = '',
    ...
    def testAcceptedSupportingDocument(self):
        """Test AcceptedSupportingDocument"""
