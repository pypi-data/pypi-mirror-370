...
class TestApplicantList(unittest.TestCase):
    """ApplicantList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicantList:
        """Test ApplicantList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApplicantList`
        """
        model = ApplicantList()
        if include_optional:
