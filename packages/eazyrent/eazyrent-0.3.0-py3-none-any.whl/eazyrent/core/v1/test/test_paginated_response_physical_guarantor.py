...
class TestPaginatedResponsePhysicalGuarantor(unittest.TestCase):
    """PaginatedResponsePhysicalGuarantor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponsePhysicalGuarantor:
        """Test PaginatedResponsePhysicalGuarantor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponsePhysicalGuarantor`
        """
        model = PaginatedResponsePhysicalGuarantor()
        if include_optional:
            return PaginatedResponsePhysicalGuarantor(
                count = 56,
                next = None,
                previous = None,
                results = [
    ...
    def testPaginatedResponsePhysicalGuarantor(self):
        """Test PaginatedResponsePhysicalGuarantor"""
