...
class TestApisCoreSchemasV1ApplicantsPhysicalGuarantor(unittest.TestCase):
    """ApisCoreSchemasV1ApplicantsPhysicalGuarantor unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ApisCoreSchemasV1ApplicantsPhysicalGuarantor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApisCoreSchemasV1ApplicantsPhysicalGuarantor`
        """
        model = ApisCoreSchemasV1ApplicantsPhysicalGuarantor()
        if include_optional:
            return ApisCoreSchemasV1ApplicantsPhysicalGuarantor(
                id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testApisCoreSchemasV1ApplicantsPhysicalGuarantor(self):
        """Test ApisCoreSchemasV1ApplicantsPhysicalGuarantor"""
