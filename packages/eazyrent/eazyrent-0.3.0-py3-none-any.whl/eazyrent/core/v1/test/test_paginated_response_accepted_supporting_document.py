...
class TestPaginatedResponseAcceptedSupportingDocument(unittest.TestCase):
    """PaginatedResponseAcceptedSupportingDocument unit test stubs"""
    ...
    def make_instance(
        ...
        """Test PaginatedResponseAcceptedSupportingDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseAcceptedSupportingDocument`
        """
        model = PaginatedResponseAcceptedSupportingDocument()
        if include_optional:
            return PaginatedResponseAcceptedSupportingDocument(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v1.models.accepted_supporting_document.AcceptedSupportingDocument(
                        id = '', 
                        name = '', 
                        max_accepted_files = 56, 
                        analyze_as = 'ID_CARD', 
                        analyzed = True, 
                        category = '', 
                        category_name = '', 
    ...
    def testPaginatedResponseAcceptedSupportingDocument(self):
        """Test PaginatedResponseAcceptedSupportingDocument"""
