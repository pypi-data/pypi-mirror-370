...
class TestPropertyRentCreate(unittest.TestCase):
    """PropertyRentCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyRentCreate:
        """Test PropertyRentCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PropertyRentCreate`
        """
        model = PropertyRentCreate()
        if include_optional:
            return PropertyRentCreate(
                title = '0',
                reference = '',
                rent_amount = 1.337,
    ...
    def testPropertyRentCreate(self):
        """Test PropertyRentCreate"""
