...
class TestRentalFileFull(unittest.TestCase):
    """RentalFileFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFileFull:
        """Test RentalFileFull
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFileFull`
        """
        model = RentalFileFull()
        if include_optional:
            return RentalFileFull(
                id = '',
                status = 'NEW',
