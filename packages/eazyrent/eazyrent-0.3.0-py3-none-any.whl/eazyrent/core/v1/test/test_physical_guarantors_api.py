...
class TestPhysicalGuarantorsApi(unittest.TestCase):
    """PhysicalGuarantorsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PhysicalGuarantorsApi()

    def tearDown(self) -> None:
        pass

    def test_create_physical_guarantors(self) -> None:
        """Test case for create_physical_guarantors

        Create physical guarantors
        """
        pass

    def test_delete_physical_guarantors(self) -> None:
        """Test case for delete_physical_guarantors

        Delete physical guarantors
        """
        pass

    def test_get_physical_guarantors(self) -> None:
        """Test case for get_physical_guarantors

        Get physical guarantors
        """
        pass

    def test_list_physical_guarantors(self) -> None:
        """Test case for list_physical_guarantors
