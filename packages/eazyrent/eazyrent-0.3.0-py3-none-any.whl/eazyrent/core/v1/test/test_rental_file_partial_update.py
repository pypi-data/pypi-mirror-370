...
class TestRentalFilePartialUpdate(unittest.TestCase):
    """RentalFilePartialUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFilePartialUpdate:
        """Test RentalFilePartialUpdate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFilePartialUpdate`
        """
        model = RentalFilePartialUpdate()
        if include_optional:
            return RentalFilePartialUpdate(
                property_rent = '',
    ...
    def testRentalFilePartialUpdate(self):
        """Test RentalFilePartialUpdate"""
