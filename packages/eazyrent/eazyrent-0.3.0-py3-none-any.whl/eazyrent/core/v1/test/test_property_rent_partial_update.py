...
class TestPropertyRentPartialUpdate(unittest.TestCase):
    """PropertyRentPartialUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyRentPartialUpdate:
        """Test PropertyRentPartialUpdate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PropertyRentPartialUpdate`
        """
        model = PropertyRentPartialUpdate()
        if include_optional:
            return PropertyRentPartialUpdate(
                title = '0',
                reference = '',
                rent_amount = 1.337,
    ...
    def testPropertyRentPartialUpdate(self):
        """Test PropertyRentPartialUpdate"""
