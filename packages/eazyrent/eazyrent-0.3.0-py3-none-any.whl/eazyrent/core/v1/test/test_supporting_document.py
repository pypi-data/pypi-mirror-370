...
class TestSupportingDocument(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupportingDocument:
        """Test SupportingDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupportingDocument`
        """
        ...
        if include_optional:
            return SupportingDocument(
                id = '',
                uploaded_files = [
                    core.v1.models.light_upload_file.LightUploadFile(
                        id = '', 
                        format = 'pdf', 
                        number_of_pages = 56, 
                        file = '', )
