...
class TestRentalFileList(unittest.TestCase):
    """RentalFileList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFileList:
        """Test RentalFileList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFileList`
        """
        model = RentalFileList()
        if include_optional:
            return RentalFileList(
                id = '',
                status = 'NEW',
                property_rent = '',
                applicants = [
