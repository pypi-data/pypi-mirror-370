...
class TestSupportingDocumentList(unittest.TestCase):
    """SupportingDocumentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportingDocumentList:
        """Test SupportingDocumentList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupportingDocumentList`
        """
        model = SupportingDocumentList()
        if include_optional:
    ...
    def testSupportingDocumentList(self):
        """Test SupportingDocumentList"""
