...
class TestPhysicalGuarantorCreate(unittest.TestCase):
    """PhysicalGuarantorCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhysicalGuarantorCreate:
        """Test PhysicalGuarantorCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PhysicalGuarantorCreate`
        """
        model = PhysicalGuarantorCreate()
        if include_optional:
            return PhysicalGuarantorCreate(
                first_name = '0',
                last_name = '0',
                email = '0',
                phone = '0',
    ...
    def testPhysicalGuarantorCreate(self):
        """Test PhysicalGuarantorCreate"""
