...
class TestLightUploadFile(unittest.TestCase):
    """LightUploadFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LightUploadFile:
        """Test LightUploadFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LightUploadFile`
        """
        model = LightUploadFile()
        if include_optional:
            return LightUploadFile(
                id = '',
                format = 'pdf',
                number_of_pages = 56,
                file = ''
