...
class TestRentPartialUpdate(unittest.TestCase):
    """RentPartialUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentPartialUpdate:
        """Test RentPartialUpdate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentPartialUpdate`
        """
        model = RentPartialUpdate()
        if include_optional:
            return RentPartialUpdate(
                reference = '',
                title = '',
                rent_amount = 1.337
            )
    ...
    def testRentPartialUpdate(self):
        """Test RentPartialUpdate"""
