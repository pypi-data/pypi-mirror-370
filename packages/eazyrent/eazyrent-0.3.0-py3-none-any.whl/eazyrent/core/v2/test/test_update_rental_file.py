...
class TestUpdateRentalFile(unittest.TestCase):
    """UpdateRentalFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateRentalFile:
        """Test UpdateRentalFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateRentalFile`
        """
        model = UpdateRentalFile()
        if include_optional:
            return UpdateRentalFile(
                ...
                applicants = [
                    core.v2.models.update_applicant.UpdateApplicant(
                        first_name = '', 
                        last_name = '', 
                        email = '', 
                        phone = '', 
