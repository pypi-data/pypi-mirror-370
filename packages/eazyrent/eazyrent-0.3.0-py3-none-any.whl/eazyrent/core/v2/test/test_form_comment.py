...
class TestFormComment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FormComment:
        """Test FormComment
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FormComment`
        """
        model = FormComment()
        if include_optional:
            return FormComment(
