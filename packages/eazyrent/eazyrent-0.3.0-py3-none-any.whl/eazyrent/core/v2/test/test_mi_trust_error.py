...
class TestMiTrustError(unittest.TestCase):
    """MiTrustError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MiTrustError:
        """Test MiTrustError
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MiTrustError`
        """
        model = MiTrustError()
        if include_optional:
            return MiTrustError(
