...
class TestPaginatedResponseDocumentView(unittest.TestCase):
    """PaginatedResponseDocumentView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseDocumentView:
        """Test PaginatedResponseDocumentView
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseDocumentView`
        """
        model = PaginatedResponseDocumentView()
        if include_optional:
            return PaginatedResponseDocumentView(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v2.models.document_view.DocumentView(
                        id = '', 
                        document_type = '', 
                        status = 'RECEIVED', 
    ...
    def testPaginatedResponseDocumentView(self):
        """Test PaginatedResponseDocumentView"""
