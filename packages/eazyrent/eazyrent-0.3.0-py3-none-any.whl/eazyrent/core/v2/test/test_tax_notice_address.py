...
class TestTaxNoticeAddress(unittest.TestCase):
    """TaxNoticeAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxNoticeAddress:
        """Test TaxNoticeAddress
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxNoticeAddress`
        """
        model = TaxNoticeAddress()
        if include_optional:
            return TaxNoticeAddress(
                country = '',
                formatted = ''
            )
        else:
