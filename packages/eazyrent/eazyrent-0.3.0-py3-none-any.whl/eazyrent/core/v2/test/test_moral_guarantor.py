...
class TestMoralGuarantor(unittest.TestCase):
    """MoralGuarantor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoralGuarantor:
        """Test MoralGuarantor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MoralGuarantor`
        """
        model = MoralGuarantor()
        if include_optional:
            return MoralGuarantor(
                file_path = '',
                type = '',
