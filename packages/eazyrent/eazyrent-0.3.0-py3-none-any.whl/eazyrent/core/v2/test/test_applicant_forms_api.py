...
class TestApplicantFormsApi(unittest.TestCase):
    """ApplicantFormsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ApplicantFormsApi()

    def tearDown(self) -> None:
        pass

    def test_get_applicant_form(self) -> None:
        """Test case for get_applicant_form

        Get applicant form
        """
        pass

    def test_get_applicant_form_comment(self) -> None:
        """Test case for get_applicant_form_comment
