...
class TestListProductsProjection(unittest.TestCase):
    """ListProductsProjection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListProductsProjection:
        """Test ListProductsProjection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListProductsProjection`
        """
        model = ListProductsProjection()
        if include_optional:
            return ListProductsProjection(
    ...
    def testListProductsProjection(self):
        """Test ListProductsProjection"""
