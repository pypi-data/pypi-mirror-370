...
class TestPartialUpdateAcceptedDocument(unittest.TestCase):
    """PartialUpdateAcceptedDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialUpdateAcceptedDocument:
        """Test PartialUpdateAcceptedDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PartialUpdateAcceptedDocument`
        """
        model = PartialUpdateAcceptedDocument()
        if include_optional:
            return PartialUpdateAcceptedDocument(
                name = '',
                max_pages = 56,
                analyzed_as = 'ID',
                examples = [
    ...
    def testPartialUpdateAcceptedDocument(self):
        """Test PartialUpdateAcceptedDocument"""
