...
class TestPaginatedResponseListRentalFile(unittest.TestCase):
    """PaginatedResponseListRentalFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseListRentalFile:
        """Test PaginatedResponseListRentalFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseListRentalFile`
        """
        model = PaginatedResponseListRentalFile()
        if include_optional:
            return PaginatedResponseListRentalFile(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v2.models.list_rental_file.ListRentalFile(
                        product_id = '', 
                        meta = null, 
                        ...
                        applicants = [
                            core.v2.models.list_applicant.ListApplicant(
                                first_name = '', 
                                last_name = '', 
                                email = '', 
                                phone = '', 
    ...
    def testPaginatedResponseListRentalFile(self):
        """Test PaginatedResponseListRentalFile"""
