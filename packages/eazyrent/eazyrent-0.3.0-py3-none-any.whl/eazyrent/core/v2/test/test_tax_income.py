...
class TestTaxIncome(unittest.TestCase):
    """TaxIncome unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxIncome:
        """Test TaxIncome
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxIncome`
        """
        model = TaxIncome()
        if include_optional:
            return TaxIncome(
