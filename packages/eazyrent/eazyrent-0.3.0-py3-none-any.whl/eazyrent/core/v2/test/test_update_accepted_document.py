...
class TestUpdateAcceptedDocument(unittest.TestCase):
    """UpdateAcceptedDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAcceptedDocument:
        """Test UpdateAcceptedDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateAcceptedDocument`
        """
        model = UpdateAcceptedDocument()
        if include_optional:
            return UpdateAcceptedDocument(
                name = '',
                max_pages = 56,
    ...
    def testUpdateAcceptedDocument(self):
        """Test UpdateAcceptedDocument"""
