...
class TestPayingInstitution(unittest.TestCase):
    """PayingInstitution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayingInstitution:
        """Test PayingInstitution
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PayingInstitution`
        """
        model = PayingInstitution()
        if include_optional:
            return PayingInstitution(
                registration_status = '',
    ...
    def testPayingInstitution(self):
        """Test PayingInstitution"""
