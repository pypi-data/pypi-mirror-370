...
class TestRentalFileCommentIn(unittest.TestCase):
    """RentalFileCommentIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFileCommentIn:
        """Test RentalFileCommentIn
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFileCommentIn`
        """
        model = RentalFileCommentIn()
        if include_optional:
            return RentalFileCommentIn(
                comment = ''
            )
        else:
            return RentalFileCommentIn(
    ...
    def testRentalFileCommentIn(self):
        """Test RentalFileCommentIn"""
