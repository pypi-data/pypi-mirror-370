...
class TestApisCoreSchemasV2ApplicantsFinancialResume(unittest.TestCase):
    """ApisCoreSchemasV2ApplicantsFinancialResume unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ApisCoreSchemasV2ApplicantsFinancialResume
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApisCoreSchemasV2ApplicantsFinancialResume`
        """
        model = ApisCoreSchemasV2ApplicantsFinancialResume()
        if include_optional:
            return ApisCoreSchemasV2ApplicantsFinancialResume(
                payslip_incomes = 1.337,
                taxnotice_incomes = 1.337,
                wages = [
                    core.v2.models.wage.Wage(
                        period = '', 
                        amount = 1.337, )
                    ],
                estimated_incomes = 1.337,
                estimated_solvency = 1.337
            )
        else:
            return ApisCoreSchemasV2ApplicantsFinancialResume(
        )
    ...
    def testApisCoreSchemasV2ApplicantsFinancialResume(self):
        """Test ApisCoreSchemasV2ApplicantsFinancialResume"""
