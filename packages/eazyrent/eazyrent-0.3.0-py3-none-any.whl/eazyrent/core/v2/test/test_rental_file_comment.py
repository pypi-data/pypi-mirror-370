...
class TestRentalFileComment(unittest.TestCase):
    """RentalFileComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFileComment:
        """Test RentalFileComment
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFileComment`
        """
        model = RentalFileComment()
        if include_optional:
            return RentalFileComment(
                id = '',
                tenant = '',
    ...
    def testRentalFileComment(self):
        """Test RentalFileComment"""
