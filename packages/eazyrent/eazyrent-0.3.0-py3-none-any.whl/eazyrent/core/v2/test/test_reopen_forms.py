...
class TestReopenForms(unittest.TestCase):
    """ReopenForms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReopenForms:
        """Test ReopenForms
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReopenForms`
        """
        model = ReopenForms()
        if include_optional:
            return ReopenForms(
