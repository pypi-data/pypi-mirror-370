...
class TestToDownload(unittest.TestCase):
    """ToDownload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToDownload:
        """Test ToDownload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ToDownload`
        """
        model = ToDownload()
        if include_optional:
            return ToDownload(
