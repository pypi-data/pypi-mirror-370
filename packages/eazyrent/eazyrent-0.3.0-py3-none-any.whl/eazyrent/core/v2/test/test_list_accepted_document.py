...
class TestListAcceptedDocument(unittest.TestCase):
    """ListAcceptedDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAcceptedDocument:
        """Test ListAcceptedDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListAcceptedDocument`
        """
        model = ListAcceptedDocument()
        if include_optional:
            return ListAcceptedDocument(
                name = '',
                max_pages = 56,
    ...
    def testListAcceptedDocument(self):
        """Test ListAcceptedDocument"""
