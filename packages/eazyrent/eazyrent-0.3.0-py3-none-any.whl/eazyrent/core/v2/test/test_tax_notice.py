...
class TestTaxNotice(unittest.TestCase):
    """TaxNotice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxNotice:
        """Test TaxNotice
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxNotice`
        """
        model = TaxNotice()
        if include_optional:
            return TaxNotice(
                declarers = None,
                property_income_net_amount = None,
