...
class TestCloseRentalFile(unittest.TestCase):
    """CloseRentalFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloseRentalFile:
        """Test CloseRentalFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CloseRentalFile`
        """
        model = CloseRentalFile()
        if include_optional:
            return CloseRentalFile(
                archive = True
            )
        else:
            return CloseRentalFile(
