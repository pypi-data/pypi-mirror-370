...
class TestListDocument(unittest.TestCase):
    """ListDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDocument:
        """Test ListDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListDocument`
        """
        model = ListDocument()
        if include_optional:
            return ListDocument(
