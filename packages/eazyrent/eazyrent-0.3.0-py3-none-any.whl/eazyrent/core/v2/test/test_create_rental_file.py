...
class TestCreateRentalFile(unittest.TestCase):
    """CreateRentalFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRentalFile:
        """Test CreateRentalFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateRentalFile`
        """
        model = CreateRentalFile()
        if include_optional:
            return CreateRentalFile(
                product_id = '',
                meta = None,
                allow_user_engagement = True,
                applicants_situation = 'SINGLE',
                applicants = [
                    core.v2.models.create_applicant.CreateApplicant(
                        first_name = '', 
                        last_name = '', 
                        email = '', 
                        phone = '', 
