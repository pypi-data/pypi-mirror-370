...
class TestSolvencyCheckSection(unittest.TestCase):
    """SolvencyCheckSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SolvencyCheckSection:
        """Test SolvencyCheckSection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SolvencyCheckSection`
        """
        model = SolvencyCheckSection()
        if include_optional:
            return SolvencyCheckSection(
                id = '',
                title = '',
                description = '',
    ...
    def testSolvencyCheckSection(self):
        """Test SolvencyCheckSection"""
