...
class TestMiTrustData(unittest.TestCase):
    """MiTrustData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MiTrustData:
        """Test MiTrustData
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MiTrustData`
        """
        model = MiTrustData()
        if include_optional:
            return MiTrustData(
