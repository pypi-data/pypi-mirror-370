...
class TestExternalData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExternalData:
        ...
        if include_optional:
            return ExternalData(
                identity = core.v2.models.identity_user_info.IdentityUserInfo(
                    identity = core.v2.models.identity.Identity(
                        nationality = '', 
                        given_name = '', 
                        family_name = '', 
                        gender = '', 
                ...
                tax = core.v2.models.tax_user_info.TaxUserInfo(
                    finances = core.v2.models.finance.Finance(
                        income = core.v2.models.finance_income.FinanceIncome(
                            ...
                            worked_months = 56, ), ), 
                    tax = core.v2.models.tax.Tax(
                        income = core.v2.models.tax_income.TaxIncome(
                            tax_notice = core.v2.models.tax_notice.TaxNotice(
                                declarers = null, 
                                property_income_net_amount = null, 
                                postal_address = core.v2.models.address.Address(
                                    formatted = '', 
                                    country = 'FR', ), ), ), ), 
                    name = '', 
                    given_name = '', 
                    family_name = '', 
                    address = core.v2.models.tax_notice_address.TaxNoticeAddress(
                        country = '', 
                        formatted = '', ), 
                    birthdate = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), ),
                student = None,
                open_banking = core.v2.models.open_banking_user_info.OpenBankingUserInfo(
                    finances = core.v2.models.finance.Finance(
                        income = core.v2.models.finance_income.FinanceIncome(
                            table = [
                                core.v2.models.income_record.IncomeRecord(
