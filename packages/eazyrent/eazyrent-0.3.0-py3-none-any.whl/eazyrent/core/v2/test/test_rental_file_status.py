...
class TestRentalFileStatus(unittest.TestCase):
    """RentalFileStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFileStatus:
        """Test RentalFileStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFileStatus`
        """
        model = RentalFileStatus()
        if include_optional:
            return RentalFileStatus(
                id = '',
                status = 'NEW'
            )
        else:
