...
class TestMiTrustSection(unittest.TestCase):
    """MiTrustSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MiTrustSection:
        """Test MiTrustSection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MiTrustSection`
        """
        model = MiTrustSection()
        if include_optional:
            return MiTrustSection(
                id = '',
                title = '',
                description = '',
                component = 'MiTrust',
