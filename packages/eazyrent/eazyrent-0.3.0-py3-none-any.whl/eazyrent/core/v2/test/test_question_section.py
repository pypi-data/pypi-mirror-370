...
class TestQuestionSection(unittest.TestCase):
    """QuestionSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuestionSection:
        """Test QuestionSection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QuestionSection`
        """
