...
class QuestionSection(BaseModel):
    ...
    component: Optional[StrictStr] = "QuestionSection"
    ...
    def component_validate_enum(cls, value):
        ...
        if value not in set(["QuestionSection"]):
            raise ValueError("must be one of enum values ('QuestionSection')")
        return value
