...
class Applicant(BaseModel):
    ...
    financial_resume: Optional[ApisCoreSchemasV2ApplicantsFinancialResume] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.external_data:
            _dict["external_data"] = self.external_data.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "financial_resume": ApisCoreSchemasV2ApplicantsFinancialResume.from_dict(
                ...
                "external_data": ExternalData.from_dict(obj["external_data"])
                if obj.get("external_data") is not None
                else None,
            }
        )
        return _obj
