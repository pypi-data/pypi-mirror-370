...
class MiTrustSection(BaseModel):
    """
    MiTrustSection
    """  # noqa: E501
    ...
    def component_validate_enum(cls, value):
        ...
        if value not in set(["MiTrust"]):
            raise ValueError("must be one of enum values ('MiTrust')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of component_data
        if self.component_data:
            _dict["component_data"] = self.component_data.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "component_data": MiTrustData.from_dict(obj["component_data"])
                if obj.get("component_data") is not None
                else None,
                ...
                "errors": [MiTrustError.from_dict(_item) for _item in obj["errors"]]
