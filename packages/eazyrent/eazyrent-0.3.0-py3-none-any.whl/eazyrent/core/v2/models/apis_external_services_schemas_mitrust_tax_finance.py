...
class ApisExternalServicesSchemasMitrustTaxFinance(BaseModel):
    """
    ApisExternalServicesSchemasMitrustTaxFinance
    """  # noqa: E501

    income: ApisExternalServicesSchemasMitrustTaxFinanceIncome
    __properties: ClassVar[List[str]] = ["income"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "income": ApisExternalServicesSchemasMitrustTaxFinanceIncome.from_dict(
                    obj["income"]
                )
