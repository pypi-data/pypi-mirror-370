...
class TaxNotice(BaseModel):
    ...
    declarers: Optional[Any]
    property_income_net_amount: Optional[Any]
    postal_address: Address
    __properties: ClassVar[List[str]] = [
        "declarers",
        "property_income_net_amount",
        "postal_address",
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if declarers (nullable) is None
        # and model_fields_set contains the field
        if self.declarers is None and "declarers" in self.model_fields_set:
            _dict["declarers"] = None

        # set to None if property_income_net_amount (nullable) is None
        # and model_fields_set contains the field
        if (
            self.property_income_net_amount is None
            and "property_income_net_amount" in self.model_fields_set
        ):
            _dict["property_income_net_amount"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "declarers": obj.get("declarers"),
                "property_income_net_amount": obj.get("property_income_net_amount"),
                "postal_address": Address.from_dict(obj["postal_address"])
                if obj.get("postal_address") is not None
                else None,
            }
        )
        return _obj
