...
class DocumentSection(BaseModel):
    ...
    component: Optional[StrictStr] = "DocumentCollectSection"
    mandatory: Optional[StrictBool] = False
    display_condition: Optional[DisplayCondition] = None
    documents: Optional[List[DocumentToUpload]] = None
    min_docs: Optional[StrictInt] = 1
    completed: Optional[StrictBool] = False
    uploads: Optional[List[TenantUploadedFile]] = None
    ...
    def component_validate_enum(cls, value):
        ...
        if value not in set(["DocumentCollectSection"]):
            raise ValueError("must be one of enum values ('DocumentCollectSection')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "documents": [
                    DocumentToUpload.from_dict(_item) for _item in obj["documents"]
                ]
                if obj.get("documents") is not None
                else None,
                "min_docs": obj.get("min_docs")
                if obj.get("min_docs") is not None
                else 1,
                "completed": obj.get("completed")
                if obj.get("completed") is not None
                else False,
                "uploads": [
                    TenantUploadedFile.from_dict(_item) for _item in obj["uploads"]
                ]
