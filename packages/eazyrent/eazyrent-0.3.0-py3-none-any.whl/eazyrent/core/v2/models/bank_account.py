...
class BankAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["iban", "account_holder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.account_holder:
            _dict["account_holder"] = self.account_holder.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "iban": obj.get("iban"),
                "account_holder": BankAccountHolder.from_dict(obj["account_holder"])
                if obj.get("account_holder") is not None
                else None,
            }
        )
        return _obj
