...
class PayingInstitution(BaseModel):
    ...
    registration_status: StrictStr
    business_sector_code: StrictStr
    registration_date: date
    legal_business_name: StrictStr
    site: PayingInstitutionSite
    legal_form: StrictStr
        ...
        _obj = cls.model_validate(
            {
                ...
                "business_sector_code": obj.get("business_sector_code"),
                "registration_date": obj.get("registration_date"),
                "legal_business_name": obj.get("legal_business_name"),
                "site": PayingInstitutionSite.from_dict(obj["site"])
