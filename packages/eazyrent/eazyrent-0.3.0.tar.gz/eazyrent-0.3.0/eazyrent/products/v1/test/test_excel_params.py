...
class TestExcelParams(unittest.TestCase):
    """ExcelParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExcelParams:
        """Test ExcelParams
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExcelParams`
        """
        model = ExcelParams()
        if include_optional:
            return ExcelParams(
