...
class TestCsvDescriptor(unittest.TestCase):
    """CsvDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvDescriptor:
        """Test CsvDescriptor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CsvDescriptor`
        """
        model = CsvDescriptor()
        if include_optional:
