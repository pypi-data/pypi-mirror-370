...
class TestInternalInformation(unittest.TestCase):
    """InternalInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalInformation:
        """Test InternalInformation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InternalInformation`
        """
        model = InternalInformation()
        if include_optional:
    ...
    def testInternalInformation(self):
        """Test InternalInformation"""
