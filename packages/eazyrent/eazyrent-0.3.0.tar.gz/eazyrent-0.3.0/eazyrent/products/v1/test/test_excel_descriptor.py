...
class TestExcelDescriptor(unittest.TestCase):
    """ExcelDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExcelDescriptor:
        """Test ExcelDescriptor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExcelDescriptor`
        """
        model = ExcelDescriptor()
        if include_optional:
            return ExcelDescriptor(
                match_on = [
                    ''
                    ],
                columns = {
                ...
                photos = products.v1.models.photo_column.PhotoColumn(
                    ...
                    suffix = '', ),
                format = 'excel',
                excel_params = products.v1.models.excel_params.ExcelParams(
                    sheet_name = null, 
                    skiprows = 56, 
                    header = 56, 
                    usecols = null, 
