...
class TestResponseCreateProduct(unittest.TestCase):
    """ResponseCreateProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseCreateProduct:
        """Test ResponseCreateProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ResponseCreateProduct`
        """
        model = ResponseCreateProduct()
        if include_optional:
    ...
    def testResponseCreateProduct(self):
        """Test ResponseCreateProduct"""
