...
class TestManagersEq(unittest.TestCase):
    """ManagersEq unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagersEq:
        """Test ManagersEq
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ManagersEq`
        """
        model = ManagersEq()
        if include_optional:
            return ManagersEq(
