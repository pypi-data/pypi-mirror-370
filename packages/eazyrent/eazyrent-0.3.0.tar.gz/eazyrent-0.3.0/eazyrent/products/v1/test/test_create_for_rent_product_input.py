...
class TestCreateForRentProductInput(unittest.TestCase):
    """CreateForRentProductInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateForRentProductInput:
        """Test CreateForRentProductInput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateForRentProductInput`
        """
        model = CreateForRentProductInput()
        if include_optional:
            return CreateForRentProductInput(
    ...
    def testCreateForRentProductInput(self):
        """Test CreateForRentProductInput"""
