...
class TestForRentProduct(unittest.TestCase):
    """ForRentProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForRentProduct:
        """Test ForRentProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ForRentProduct`
        """
        model = ForRentProduct()
        if include_optional:
            return ForRentProduct(
