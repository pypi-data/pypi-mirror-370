...
class TestPaginatedResponseUnionListForRentProductListForSalesProductResultsInner(
    unittest.TestCase
):
    """PaginatedResponseUnionListForRentProductListForSalesProductResultsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test PaginatedResponseUnionListForRentProductListForSalesProductResultsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseUnionListForRentProductListForSalesProductResultsInner`
        """
        model = PaginatedResponseUnionListForRentProductListForSalesProductResultsInner()
        if include_optional:
            return PaginatedResponseUnionListForRentProductListForSalesProductResultsInner(
    ...
    def testPaginatedResponseUnionListForRentProductListForSalesProductResultsInner(
        self,
    ):
        """Test PaginatedResponseUnionListForRentProductListForSalesProductResultsInner"""
