...
class TestUpdateForRentProduct(unittest.TestCase):
    """UpdateForRentProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateForRentProduct:
        """Test UpdateForRentProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateForRentProduct`
        """
        model = UpdateForRentProduct()
        if include_optional:
            return UpdateForRentProduct(
    ...
    def testUpdateForRentProduct(self):
        """Test UpdateForRentProduct"""
