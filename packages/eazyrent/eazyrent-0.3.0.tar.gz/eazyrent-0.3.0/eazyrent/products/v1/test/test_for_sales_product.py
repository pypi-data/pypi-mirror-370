...
class TestForSalesProduct(unittest.TestCase):
    """ForSalesProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForSalesProduct:
        """Test ForSalesProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ForSalesProduct`
        """
        model = ForSalesProduct()
        if include_optional:
            return ForSalesProduct(
