...
class TestListForSalesProduct(unittest.TestCase):
    """ListForSalesProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListForSalesProduct:
        """Test ListForSalesProduct
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListForSalesProduct`
        """
        model = ListForSalesProduct()
        if include_optional:
            return ListForSalesProduct(
    ...
    def testListForSalesProduct(self):
        """Test ListForSalesProduct"""
