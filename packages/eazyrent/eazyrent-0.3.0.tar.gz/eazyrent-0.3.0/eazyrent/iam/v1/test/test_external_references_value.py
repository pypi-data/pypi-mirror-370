...
class TestExternalReferencesValue(unittest.TestCase):
    """ExternalReferencesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalReferencesValue:
        """Test ExternalReferencesValue
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExternalReferencesValue`
        """
        model = ExternalReferencesValue()
        if include_optional:
            return ExternalReferencesValue(
            )
        else:
            return ExternalReferencesValue(
        )
    ...
    def testExternalReferencesValue(self):
        """Test ExternalReferencesValue"""
