...
class TestPartialUpdateUser(unittest.TestCase):
    """PartialUpdateUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialUpdateUser:
        """Test PartialUpdateUser
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PartialUpdateUser`
        """
        model = PartialUpdateUser()
        if include_optional:
    ...
    def testPartialUpdateUser(self):
        """Test PartialUpdateUser"""
