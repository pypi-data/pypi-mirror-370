...
class TestJoinOrganization(unittest.TestCase):
    """JoinOrganization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JoinOrganization:
        """Test JoinOrganization
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `JoinOrganization`
        """
        model = JoinOrganization()
        if include_optional:
