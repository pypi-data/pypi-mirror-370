...
class TestJSONKey(unittest.TestCase):
    """JSONKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JSONKey:
        """Test JSONKey
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `JSONKey`
        """
        model = JSONKey()
        if include_optional:
            return JSONKey(
