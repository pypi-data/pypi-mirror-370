...
class TestRegisterOrganizationSerializer(unittest.TestCase):
    """RegisterOrganizationSerializer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterOrganizationSerializer:
        """Test RegisterOrganizationSerializer
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RegisterOrganizationSerializer`
        """
        model = RegisterOrganizationSerializer()
        if include_optional:
            return RegisterOrganizationSerializer(
                name = '',
                registration_number = '',
                pairing_code = ''
            )
    ...
    def testRegisterOrganizationSerializer(self):
        """Test RegisterOrganizationSerializer"""
