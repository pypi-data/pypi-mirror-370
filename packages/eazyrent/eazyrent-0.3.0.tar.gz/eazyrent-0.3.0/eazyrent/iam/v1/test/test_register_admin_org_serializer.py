...
class TestRegisterAdminOrgSerializer(unittest.TestCase):
    """RegisterAdminOrgSerializer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterAdminOrgSerializer:
        """Test RegisterAdminOrgSerializer
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RegisterAdminOrgSerializer`
        """
        model = RegisterAdminOrgSerializer()
        if include_optional:
            return RegisterAdminOrgSerializer(
                first_name = '',
                last_name = '',
                email = '',
                phone = ''
    ...
    def testRegisterAdminOrgSerializer(self):
        """Test RegisterAdminOrgSerializer"""
