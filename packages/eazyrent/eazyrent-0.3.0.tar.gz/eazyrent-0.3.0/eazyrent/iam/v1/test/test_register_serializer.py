...
class TestRegisterSerializer(unittest.TestCase):
    """RegisterSerializer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterSerializer:
        """Test RegisterSerializer
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RegisterSerializer`
        """
        model = RegisterSerializer()
        if include_optional:
            return RegisterSerializer(
                organization = iam.v1.models.register_organization_serializer.RegisterOrganizationSerializer(
                    name = '', 
                    registration_number = '', 
                    pairing_code = '', ),
                org_admin = iam.v1.models.register_admin_org_serializer.RegisterAdminOrgSerializer(
                    first_name = '', 
                    last_name = '', 
                    email = '', 
                    phone = '', )
