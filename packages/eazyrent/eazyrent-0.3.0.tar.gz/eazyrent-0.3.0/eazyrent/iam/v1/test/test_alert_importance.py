...
class TestAlertImportance(unittest.TestCase):
    """AlertImportance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertImportance:
        """Test AlertImportance
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlertImportance`
        """
        model = AlertImportance()
        if include_optional:
            return AlertImportance(
                alert_type = iam.v1.models.base_alert_type.BaseAlertType(
                    id = '', 
                    name = '', 
                    description = '', ),
                value = 0.0
