...
class TestPropertyRentList(unittest.TestCase):
    """PropertyRentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyRentList:
        """Test PropertyRentList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PropertyRentList`
        """
        model = PropertyRentList()
        if include_optional:
