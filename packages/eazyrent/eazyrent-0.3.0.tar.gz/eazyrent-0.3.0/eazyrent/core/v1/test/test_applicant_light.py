...
class TestApplicantLight(unittest.TestCase):
    """ApplicantLight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicantLight:
        """Test ApplicantLight
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApplicantLight`
        """
        model = ApplicantLight()
        if include_optional:
            return ApplicantLight(
                id = '',
                first_name = '',
                last_name = '',
                email = '',
