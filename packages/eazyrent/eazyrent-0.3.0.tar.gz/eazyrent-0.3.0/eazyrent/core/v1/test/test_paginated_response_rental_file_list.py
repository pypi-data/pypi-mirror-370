...
class TestPaginatedResponseRentalFileList(unittest.TestCase):
    """PaginatedResponseRentalFileList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseRentalFileList:
        """Test PaginatedResponseRentalFileList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseRentalFileList`
        """
        model = PaginatedResponseRentalFileList()
        if include_optional:
            return PaginatedResponseRentalFileList(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v1.models.rental_file_list.RentalFileList(
                        id = '', 
                        status = 'NEW', 
                        property_rent = '', 
                        applicants = [
    ...
    def testPaginatedResponseRentalFileList(self):
        """Test PaginatedResponseRentalFileList"""
