...
class TestRentsApi(unittest.TestCase):
    """RentsApi unit test stubs"""
    ...
    def test_create_rent(self) -> None:
        """Test case for create_rent

        Create rent
        """
        pass

    def test_delete_rent(self) -> None:
        """Test case for delete_rent

        Delete rent
        """
        pass

    def test_get_rent(self) -> None:
        """Test case for get_rent

        Get rent
        """
        pass

    def test_list_rents(self) -> None:
        """Test case for list_rents

        List rents
        """
        pass

    def test_partial_update_rent(self) -> None:
        """Test case for partial_update_rent

        Partial update rent
        """
        pass

    def test_update_rent(self) -> None:
        """Test case for update_rent
