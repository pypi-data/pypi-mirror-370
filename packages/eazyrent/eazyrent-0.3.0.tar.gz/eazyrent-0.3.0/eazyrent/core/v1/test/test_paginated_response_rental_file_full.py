...
class TestPaginatedResponseRentalFileFull(unittest.TestCase):
    """PaginatedResponseRentalFileFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseRentalFileFull:
        """Test PaginatedResponseRentalFileFull
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseRentalFileFull`
        """
        model = PaginatedResponseRentalFileFull()
        if include_optional:
            return PaginatedResponseRentalFileFull(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v1.models.rental_file_full.RentalFileFull(
                        id = '', 
                        status = 'NEW', 
                        property_rent = core.v1.models.property_rent_list.PropertyRentList(
                            id = '', 
                            reference = '', 
                            photo_uri = '', 
                            title = '', 
                            ...
                            applicant_file_count = 56, ), 
                        applicants = [
                            core.v1.models.applicant_list.ApplicantList(
                                id = '', 
                                first_name = '', 
                                last_name = '', 
                                email = '', 
    ...
    def testPaginatedResponseRentalFileFull(self):
        """Test PaginatedResponseRentalFileFull"""
