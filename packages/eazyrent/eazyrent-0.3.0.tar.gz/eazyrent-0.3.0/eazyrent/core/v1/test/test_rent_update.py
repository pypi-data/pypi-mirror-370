...
class TestRentUpdate(unittest.TestCase):
    """RentUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentUpdate:
        """Test RentUpdate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentUpdate`
        """
        model = RentUpdate()
        if include_optional:
            return RentUpdate(
