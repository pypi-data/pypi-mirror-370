...
class TestPaginatedResponseSupportingDocumentList(unittest.TestCase):
    """PaginatedResponseSupportingDocumentList unit test stubs"""
    ...
    def make_instance(
        ...
        """Test PaginatedResponseSupportingDocumentList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseSupportingDocumentList`
        """
        model = PaginatedResponseSupportingDocumentList()
        if include_optional:
            return PaginatedResponseSupportingDocumentList(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v1.models.supporting_document_list.SupportingDocumentList(
                        id = '', 
                        document_type = '', 
                        document_name = '', 
                        applicant = '', 
    ...
    def testPaginatedResponseSupportingDocumentList(self):
        """Test PaginatedResponseSupportingDocumentList"""
