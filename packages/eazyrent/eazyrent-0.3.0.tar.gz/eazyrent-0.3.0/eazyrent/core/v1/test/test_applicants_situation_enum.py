...
class TestApplicantsSituationEnum(unittest.TestCase):
    """ApplicantsSituationEnum unit test stubs"""
    ...
    def testApplicantsSituationEnum(self):
        """Test ApplicantsSituationEnum"""
        # inst = ApplicantsSituationEnum()
