...
class TestRentalFileCreate(unittest.TestCase):
    """RentalFileCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RentalFileCreate:
        """Test RentalFileCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RentalFileCreate`
        """
        model = RentalFileCreate()
        if include_optional:
            return RentalFileCreate(
                property_rent = '',
