...
class TestAlertPretty(unittest.TestCase):
    """AlertPretty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertPretty:
        """Test AlertPretty
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AlertPretty`
        """
        model = AlertPretty()
        if include_optional:
            return AlertPretty(
