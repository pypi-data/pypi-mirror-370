...
class ApisExternalServicesSchemasMitrustTaxFinanceIncome(BaseModel):
    """
    ApisExternalServicesSchemasMitrustTaxFinanceIncome
    """  # noqa: E501

    table: Optional[List[IncomeRecord]] = None
    worked_months: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["table", "worked_months"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.table:
            ...
            _dict["table"] = _items
        # set to None if worked_months (nullable) is None
        # and model_fields_set contains the field
        if self.worked_months is None and "worked_months" in self.model_fields_set:
            _dict["worked_months"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "table": [IncomeRecord.from_dict(_item) for _item in obj["table"]]
                if obj.get("table") is not None
                else None,
                "worked_months": obj.get("worked_months"),
            }
        )
        return _obj
