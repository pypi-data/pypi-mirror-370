...
class RentalFile(BaseModel):
    ...
    financial_resume: Optional[ApisCoreSchemasV2RentalFilesFinancialResume] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of financial_resume
        if self.financial_resume:
            _dict["financial_resume"] = self.financial_resume.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "financial_resume": ApisCoreSchemasV2RentalFilesFinancialResume.from_dict(
                    obj["financial_resume"]
                )
                if obj.get("financial_resume") is not None
                else None,
            }
        )
        return _obj
