...
class ExternalData(BaseModel):
    ...
    identity: Optional[IdentityUserInfo] = None
    tax: Optional[TaxUserInfo] = None
    student: Optional[Any] = None
    open_banking: Optional[OpenBankingUserInfo] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if open_banking (nullable) is None
        # and model_fields_set contains the field
        if self.open_banking is None and "open_banking" in self.model_fields_set:
            _dict["open_banking"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "identity": IdentityUserInfo.from_dict(obj["identity"])
                if obj.get("identity") is not None
                else None,
                "tax": TaxUserInfo.from_dict(obj["tax"])
                if obj.get("tax") is not None
                else None,
                "student": obj.get("student"),
                "open_banking": OpenBankingUserInfo.from_dict(obj["open_banking"])
                if obj.get("open_banking") is not None
                else None,
                "other": obj.get("other"),
            }
        )
