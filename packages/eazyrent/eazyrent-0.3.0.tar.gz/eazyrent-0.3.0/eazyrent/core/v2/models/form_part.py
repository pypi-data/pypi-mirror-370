...
class FormPart(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if component_data (nullable) is None
        # and model_fields_set contains the field
        if self.component_data is None and "component_data" in self.model_fields_set:
            _dict["component_data"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "sections": [
                    FormPartSectionsInner.from_dict(_item) for _item in obj["sections"]
                ]
                ...
                "component_data": obj.get("component_data"),
