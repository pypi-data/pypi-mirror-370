...
class MiTrustData(BaseModel):
    """
    MiTrustData
    """  # noqa: E501

    client_id: Optional[StrictStr] = ""
    redirect_uri: Optional[StrictStr] = "/oauth/callback/mitrust/"
    scope: Optional[List[StrictStr]] = None
    assets: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["client_id", "redirect_uri", "scope", "assets"]
        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("redirect_uri") is not None
                else "/oauth/callback/mitrust/",
                "scope": obj.get("scope"),
