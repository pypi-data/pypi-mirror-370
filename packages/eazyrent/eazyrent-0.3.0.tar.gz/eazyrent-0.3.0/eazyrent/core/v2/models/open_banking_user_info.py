...
class OpenBankingUserInfo(BaseModel):
    """
    OpenBankingUserInfo
    """  # noqa: E501

    finances: ApisExternalServicesSchemasMitrustBankingFinance
    financials: Financials
    name: StrictStr
    birthdate: date
    __properties: ClassVar[List[str]] = ["finances", "financials", "name", "birthdate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "finances": ApisExternalServicesSchemasMitrustBankingFinance.from_dict(
                    obj["finances"]
                )
                if obj.get("finances") is not None
                else None,
                "financials": Financials.from_dict(obj["financials"])
