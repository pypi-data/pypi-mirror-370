...
class TaxUserInfo(BaseModel):
    """
    TaxUserInfo
    """  # noqa: E501

    finances: ApisExternalServicesSchemasMitrustTaxFinance
    tax: Tax
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "finances": ApisExternalServicesSchemasMitrustTaxFinance.from_dict(
                    obj["finances"]
                )
                if obj.get("finances") is not None
                else None,
                "tax": Tax.from_dict(obj["tax"])
                if obj.get("tax") is not None
                else None,
                "name": obj.get("name"),
                "given_name": obj.get("given_name"),
                "family_name": obj.get("family_name"),
                "address": TaxNoticeAddress.from_dict(obj["address"])
