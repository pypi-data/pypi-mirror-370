...
class DisplayCondition(BaseModel):
    ...
    returns: Returns
    __properties: ClassVar[List[str]] = ["related_section", "returns"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of related_section
        if self.related_section:
            _dict["related_section"] = self.related_section.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "related_section": RelatedSection.from_dict(obj["related_section"])
                if obj.get("related_section") is not None
                else None,
                "returns": Returns.from_dict(obj["returns"])
