...
class TaxIncome(BaseModel):
    """
    TaxIncome
    """  # noqa: E501

    tax_notice: TaxNotice
    __properties: ClassVar[List[str]] = ["tax_notice"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tax_notice
        if self.tax_notice:
            _dict["tax_notice"] = self.tax_notice.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "tax_notice": TaxNotice.from_dict(obj["tax_notice"])
                if obj.get("tax_notice") is not None
                else None
            }
        )
        return _obj
