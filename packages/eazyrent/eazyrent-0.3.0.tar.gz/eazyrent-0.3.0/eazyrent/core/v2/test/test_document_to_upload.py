...
class TestDocumentToUpload(unittest.TestCase):
    """DocumentToUpload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentToUpload:
        """Test DocumentToUpload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DocumentToUpload`
        """
        model = DocumentToUpload()
        if include_optional:
