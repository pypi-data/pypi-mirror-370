...
class TestTenantUploadedFile(unittest.TestCase):
    """TenantUploadedFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantUploadedFile:
        """Test TenantUploadedFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TenantUploadedFile`
        """
        model = TenantUploadedFile()
        if include_optional:
            return TenantUploadedFile(
                name = '',
                number_of_pages = 56,
                size = 56,
    ...
    def testTenantUploadedFile(self):
        """Test TenantUploadedFile"""
