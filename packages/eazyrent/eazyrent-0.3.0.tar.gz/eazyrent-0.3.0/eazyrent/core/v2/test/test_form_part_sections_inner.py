...
class TestFormPartSectionsInner(unittest.TestCase):
    """FormPartSectionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormPartSectionsInner:
        """Test FormPartSectionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FormPartSectionsInner`
        """
        model = FormPartSectionsInner()
        if include_optional:
            return FormPartSectionsInner(
                id = '',
                title = '',
                description = '',
                component = 'Markdown',
                mandatory = True,
                display_condition = core.v2.models.display_condition.DisplayCondition(
                ...
                display = True,
                documents = [
                    core.v2.models.document_to_upload.DocumentToUpload(
                        name = '', 
                        max_pages = 56, 
                ...
                min_docs = 56,
                uploads = [
                    core.v2.models.tenant_uploaded_file.TenantUploadedFile(
                        name = '', 
                        number_of_pages = 56, 
                        size = 56, 
                ...
                component_data = core.v2.models.mi_trust_data.MiTrustData(
                    client_id = '', 
                ...
                errors = [
                    core.v2.models.mi_trust_error.MiTrustError(
                        code = '', 
                        message = '', 
                        handled = True, )
                    ],
    ...
    def testFormPartSectionsInner(self):
        """Test FormPartSectionsInner"""
