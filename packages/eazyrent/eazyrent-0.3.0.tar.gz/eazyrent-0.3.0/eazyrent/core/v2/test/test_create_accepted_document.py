...
class TestCreateAcceptedDocument(unittest.TestCase):
    """CreateAcceptedDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAcceptedDocument:
        """Test CreateAcceptedDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateAcceptedDocument`
        """
        model = CreateAcceptedDocument()
        if include_optional:
            return CreateAcceptedDocument(
                name = '',
                max_pages = 56,
    ...
    def testCreateAcceptedDocument(self):
        """Test CreateAcceptedDocument"""
