...
class TestUpdateApplicant(unittest.TestCase):
    """UpdateApplicant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateApplicant:
        """Test UpdateApplicant
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateApplicant`
        """
        model = UpdateApplicant()
        if include_optional:
