...
class TestTenantForm(unittest.TestCase):
    """TenantForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantForm:
        """Test TenantForm
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TenantForm`
        """
        model = TenantForm()
        if include_optional:
            return TenantForm(
                id = '',
                parts = [
                    core.v2.models.form_part.FormPart(
                        title = '', 
                        component = '', 
                        description = '', 
                        sections = [
