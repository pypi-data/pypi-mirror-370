...
class TestIdentityUserInfo(unittest.TestCase):
    """IdentityUserInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityUserInfo:
        """Test IdentityUserInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IdentityUserInfo`
        """
        model = IdentityUserInfo()
        if include_optional:
