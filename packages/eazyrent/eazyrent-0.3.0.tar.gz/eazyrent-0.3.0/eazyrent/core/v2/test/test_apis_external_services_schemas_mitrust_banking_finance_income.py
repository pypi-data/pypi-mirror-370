...
class TestApisExternalServicesSchemasMitrustBankingFinanceIncome(unittest.TestCase):
    """ApisExternalServicesSchemasMitrustBankingFinanceIncome unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ApisExternalServicesSchemasMitrustBankingFinanceIncome
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApisExternalServicesSchemasMitrustBankingFinanceIncome`
        """
        model = ApisExternalServicesSchemasMitrustBankingFinanceIncome()
        if include_optional:
            return ApisExternalServicesSchemasMitrustBankingFinanceIncome(
                table = [
    ...
    def testApisExternalServicesSchemasMitrustBankingFinanceIncome(self):
        """Test ApisExternalServicesSchemasMitrustBankingFinanceIncome"""
