...
class TestMarkdownSection(unittest.TestCase):
    """MarkdownSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkdownSection:
        """Test MarkdownSection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MarkdownSection`
        """
