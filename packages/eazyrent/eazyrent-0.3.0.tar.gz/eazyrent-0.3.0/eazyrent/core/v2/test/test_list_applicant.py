...
class TestListApplicant(unittest.TestCase):
    """ListApplicant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListApplicant:
        """Test ListApplicant
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListApplicant`
        """
        model = ListApplicant()
        if include_optional:
