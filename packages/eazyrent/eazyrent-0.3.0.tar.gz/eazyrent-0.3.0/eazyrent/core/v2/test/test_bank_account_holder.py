...
class TestBankAccountHolder(unittest.TestCase):
    """BankAccountHolder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountHolder:
        """Test BankAccountHolder
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BankAccountHolder`
        """
    ...
    def testBankAccountHolder(self):
        """Test BankAccountHolder"""
