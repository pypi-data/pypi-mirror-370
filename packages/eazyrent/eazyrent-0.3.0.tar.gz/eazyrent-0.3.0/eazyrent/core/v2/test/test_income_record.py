...
class TestIncomeRecord(unittest.TestCase):
    """IncomeRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomeRecord:
        """Test IncomeRecord
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IncomeRecord`
        """
        model = IncomeRecord()
        if include_optional:
            return IncomeRecord(
