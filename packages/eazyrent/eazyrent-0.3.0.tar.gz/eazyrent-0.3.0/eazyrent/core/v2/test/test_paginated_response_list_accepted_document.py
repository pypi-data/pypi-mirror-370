...
class TestPaginatedResponseListAcceptedDocument(unittest.TestCase):
    """PaginatedResponseListAcceptedDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseListAcceptedDocument:
        """Test PaginatedResponseListAcceptedDocument
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PaginatedResponseListAcceptedDocument`
        """
        model = PaginatedResponseListAcceptedDocument()
        if include_optional:
            return PaginatedResponseListAcceptedDocument(
                count = 56,
                next = None,
                previous = None,
                results = [
                    core.v2.models.list_accepted_document.ListAcceptedDocument(
                        name = '', 
                        max_pages = 56, 
    ...
    def testPaginatedResponseListAcceptedDocument(self):
        """Test PaginatedResponseListAcceptedDocument"""
