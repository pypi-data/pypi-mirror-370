...
class TestTaxUserInfo(unittest.TestCase):
    """TaxUserInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxUserInfo:
        """Test TaxUserInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxUserInfo`
        """
        model = TaxUserInfo()
        if include_optional:
            return TaxUserInfo(
