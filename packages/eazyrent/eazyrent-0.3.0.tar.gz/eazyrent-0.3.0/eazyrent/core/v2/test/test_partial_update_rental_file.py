...
class TestPartialUpdateRentalFile(unittest.TestCase):
    """PartialUpdateRentalFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialUpdateRentalFile:
        """Test PartialUpdateRentalFile
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PartialUpdateRentalFile`
        """
        model = PartialUpdateRentalFile()
        if include_optional:
            return PartialUpdateRentalFile(
                product_id = '',
                meta = None,
                allow_user_engagement = True,
                archived_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                tags = [
                    core.v2.models.tag_in.TagIn(
                        name = '', )
                    ],
                managers = [
                    ''
    ...
    def testPartialUpdateRentalFile(self):
        """Test PartialUpdateRentalFile"""
