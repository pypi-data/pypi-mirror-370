...
class TestDocumentSlice(unittest.TestCase):
    """DocumentSlice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentSlice:
        """Test DocumentSlice
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DocumentSlice`
        """
        model = DocumentSlice()
        if include_optional:
