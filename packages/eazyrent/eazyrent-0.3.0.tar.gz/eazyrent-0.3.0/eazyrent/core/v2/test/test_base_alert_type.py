...
class TestBaseAlertType(unittest.TestCase):
    """BaseAlertType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseAlertType:
        """Test BaseAlertType
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseAlertType`
        """
        model = BaseAlertType()
        if include_optional:
            return BaseAlertType(
                id = '',
                name = '',
                description = ''
            )
