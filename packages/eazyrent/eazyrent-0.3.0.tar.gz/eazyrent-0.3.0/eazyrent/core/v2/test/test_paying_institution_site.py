...
class TestPayingInstitutionSite(unittest.TestCase):
    """PayingInstitutionSite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayingInstitutionSite:
        """Test PayingInstitutionSite
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PayingInstitutionSite`
        """
        model = PayingInstitutionSite()
        if include_optional:
            return PayingInstitutionSite(
                registration_number = ''
            )
        else:
            return PayingInstitutionSite(
    ...
    def testPayingInstitutionSite(self):
        """Test PayingInstitutionSite"""
