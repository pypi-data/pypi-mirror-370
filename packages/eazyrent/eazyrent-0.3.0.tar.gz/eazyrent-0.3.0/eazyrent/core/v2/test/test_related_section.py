...
class TestRelatedSection(unittest.TestCase):
    """RelatedSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedSection:
        """Test RelatedSection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RelatedSection`
        """
        model = RelatedSection()
        if include_optional:
