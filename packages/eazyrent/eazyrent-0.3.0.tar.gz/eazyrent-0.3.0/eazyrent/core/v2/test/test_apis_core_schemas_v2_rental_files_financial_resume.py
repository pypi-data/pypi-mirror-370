...
class TestApisCoreSchemasV2RentalFilesFinancialResume(unittest.TestCase):
    """ApisCoreSchemasV2RentalFilesFinancialResume unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ApisCoreSchemasV2RentalFilesFinancialResume
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApisCoreSchemasV2RentalFilesFinancialResume`
        """
        model = ApisCoreSchemasV2RentalFilesFinancialResume()
        if include_optional:
            return ApisCoreSchemasV2RentalFilesFinancialResume(
    ...
    def testApisCoreSchemasV2RentalFilesFinancialResume(self):
        """Test ApisCoreSchemasV2RentalFilesFinancialResume"""
