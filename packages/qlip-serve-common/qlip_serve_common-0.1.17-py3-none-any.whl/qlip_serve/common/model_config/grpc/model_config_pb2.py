...
# TODO: use the same structure as here https://github.com/bentoml/BentoML/tree/main/src/bentoml/grpc/v1
# -*- coding: utf-8 -*-
...
_MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC = (
    _MODELOPTIMIZATIONPOLICY_CUDA.nested_types_by_name["GraphSpec"]
)
_MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC_SHAPE = (
    _MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC.nested_types_by_name["Shape"]
)
_MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC_LOWERBOUND = (
    _MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC.nested_types_by_name["LowerBound"]
)
_MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC_LOWERBOUND_INPUTENTRY = (
    _MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC_LOWERBOUND.nested_types_by_name[
        "InputEntry"
    ]
)
_MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC_INPUTENTRY = (
    _MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC.nested_types_by_name["InputEntry"]
)
_MODELOPTIMIZATIONPOLICY_EXECUTIONACCELERATORS = (
    _MODELOPTIMIZATIONPOLICY.nested_types_by_name["ExecutionAccelerators"]
)
_MODELOPTIMIZATIONPOLICY_EXECUTIONACCELERATORS_ACCELERATOR = (
    _MODELOPTIMIZATIONPOLICY_EXECUTIONACCELERATORS.nested_types_by_name["Accelerator"]
)
_MODELOPTIMIZATIONPOLICY_EXECUTIONACCELERATORS_ACCELERATOR_PARAMETERSENTRY = (
    _MODELOPTIMIZATIONPOLICY_EXECUTIONACCELERATORS_ACCELERATOR.nested_types_by_name[
        "ParametersEntry"
    ]
)
_MODELOPTIMIZATIONPOLICY_PINNEDMEMORYBUFFER = (
    _MODELOPTIMIZATIONPOLICY.nested_types_by_name["PinnedMemoryBuffer"]
)
...
_MODELDYNAMICBATCHING_PRIORITYQUEUEPOLICYENTRY = (
    _MODELDYNAMICBATCHING.nested_types_by_name["PriorityQueuePolicyEntry"]
)
...
_MODELREPOSITORYAGENTS_AGENT_PARAMETERSENTRY = (
    _MODELREPOSITORYAGENTS_AGENT.nested_types_by_name["ParametersEntry"]
)
...
_MODELINSTANCEGROUP_SECONDARYDEVICE_SECONDARYDEVICEKIND = (
    _MODELINSTANCEGROUP_SECONDARYDEVICE.enum_types_by_name["SecondaryDeviceKind"]
)
...
ModelInstanceGroup = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "SecondaryDevice": _reflection.GeneratedProtocolMessageType(
            "SecondaryDevice",
            (_message.Message,),
            {
...
ModelSequenceBatching = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "InitialState": _reflection.GeneratedProtocolMessageType(
            "InitialState",
            (_message.Message,),
            {
...
if _descriptor._USE_C_DESCRIPTORS == False:  # noqa: E712
    ...
    _MODELOPTIMIZATIONPOLICY_CUDA_GRAPHSPEC_LOWERBOUND_INPUTENTRY._serialized_start = (
        3054
    )
