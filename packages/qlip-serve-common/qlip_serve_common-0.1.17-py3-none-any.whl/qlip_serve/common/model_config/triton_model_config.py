...
@dataclasses.dataclass
class EnsembleStep:
    """Represents a step in an ensemble model."""

    model_name: str
    model_version: int = -1
    input_map: Dict[str, str] = dataclasses.field(default_factory=lambda: {})
    output_map: Dict[str, str] = dataclasses.field(default_factory=lambda: {})
...
class TritonModelConfig:
    ...
    ensemble_steps: Optional[Sequence[EnsembleStep]] = None
