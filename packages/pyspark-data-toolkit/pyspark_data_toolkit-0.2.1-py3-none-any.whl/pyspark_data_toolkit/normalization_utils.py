from typing import List, Union, Optional, Dict, Any, StringType, IntegerType, LongType, ShortType, ByteType, FloatType, DoubleType, DecimalType, BooleanType, DateType, TimestampType, BinaryType,ArrayType, MapType, StructType  
...
def normalize_prefix_add_columns(
    df: DataFrame, 
...
def normalize_with_custom_mapping(
    ...
    **kwargs
    ...
    return normalize_prefix_add_columns(
        df, 
        schema, 
        custom_prefix, 
        custom_mapping
