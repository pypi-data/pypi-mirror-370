...
def baseplanner(client, CONGRESS_ID: str, PLANNER_ID: str):
    ...
    return df[['Int ID','Abstract ID', 'Abstract Link', 'Priority', 'Session Title', 'Session Type', 'Abstract Title', 'Full Abstract Text', 'Authors', 'Institution',
