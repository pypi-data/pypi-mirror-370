...
class ProfileRepo(object):
    ...
    def get_active_profile(self) -> ComProfile | None:
        return self._active_profile

    def set_active_profile(self, profile: ComProfile) -> None:
...
pass_repo_context =  click.make_pass_decorator(ProfileRepo, ensure=True)
