...
class ModbusClient:
    ...
    def execute_write_request(self, request: ModbusWriteRequest) -> RequestResponse:
        pass
    ...
    def execute_read_request(self, request: ModbusReadRequest) -> RequestResponse:
            try:
                if request.function == "read_holding_register":
                ...
                elif request.function == "read_coil":
                    ...
                    return RequestResponse(
                        ...
                        content=f"Unsupported function {request.function}"
                    )
                if response.isError():
                    return RequestResponse(
                        status=RequestResult.FAILED,
