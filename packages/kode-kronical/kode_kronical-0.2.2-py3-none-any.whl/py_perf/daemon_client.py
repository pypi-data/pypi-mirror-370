"""
Daemon client for py-perf to communicate with the system monitoring daemon.
"""
...
class DaemonClient:
    """Client for communicating with py-perf-daemon."""
    ...
    def __init__(self, data_dir: Optional[str] = None):
        ...
        Args:
            data_dir: Directory where daemon stores data files.
                     Defaults to /var/lib/py-perf or ~/.py-perf/data
        """
        ...
        if data_dir:
            ...
            self.data_dirs = [
                Path('/var/lib/py-perf'),
                Path.home() / '.py-perf' / 'data',
