...
class SystemDynamoDBService:
    ...
    def __init__(self, table_name: str = "py-perf-system", region: str = "us-east-1"):
    ...
    def _ensure_table_exists(self):
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceNotFoundException':
                ...
                if self.table_name == "py-perf-system-v2":
    ...
    def _upload_legacy_format(self, metrics_batch: List[Dict[str, Any]], hostname: str) -> bool:
        ...
        try:
            ...
            latest_record = {
                'id': hostname_hash,  # Numeric ID based on hostname hash
                'hostname': hostname,
                'timestamp': record['timestamp'],
                'latest_record_id': record_id,  # Reference to the full record
                'compressed': True,
