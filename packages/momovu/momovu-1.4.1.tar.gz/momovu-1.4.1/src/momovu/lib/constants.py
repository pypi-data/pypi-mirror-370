...
GUTTER_SIZE_THRESHOLDS: Final[list[tuple[int, float]]] = [
    ...
    (150, 1.5),  # 61 to 150 pages: 1.5 mm (3 mm total for both pages)
    (400, 6.5),  # 151 to 400 pages: 6.5 mm (13 mm total for both pages)
    (600, 8.0),  # 401 to 600 pages: 8 mm (16 mm total for both pages)
    (9999, 9.5),  # Over 601 pages: 9.5 mm (19 mm total for both pages)
]
