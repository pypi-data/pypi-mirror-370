...
def test_qsikit_compiler():
    ...
    from tyxonq.compiler.qiskit_compiler import qiskit_compile
...
def test_composed_compiler():
    from tyxonq.compiler import DefaultCompiler
...
def test_replace_r():
    ...
    print(c.draw())
    c1 = tq.compiler.simple_compiler.replace_r(c)
    print(c1.draw())
...
def test_default_compiler():
    ...
    c1, _ = tq.compiler.simple_compiler.simple_compile(c)
    print(c1.draw())
