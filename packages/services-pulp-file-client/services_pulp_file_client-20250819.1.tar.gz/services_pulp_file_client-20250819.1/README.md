...
```python
import services-pulp_file-client
```
...
import services-pulp_file-client
from services-pulp_file-client.rest import ApiException
...
configuration = services-pulp_file-client.Configuration(
...
with services-pulp_file-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = services-pulp_file-client.AcsFileApi(api_client)
    file_file_alternate_content_source_href = 'file_file_alternate_content_source_href_example' # str | 
    nested_role = services-pulp_file-client.NestedRole() # NestedRole | 
