    ...
    def make_instance(self, include_optional) -> PaginatedfileFileRemoteResponseList:
        ...
        if include_optional:
            return PaginatedfileFileRemoteResponseList(
                ...
                results = [
                    services-pulp_file-client.models.file/file_remote_response.file.FileRemoteResponse(
                        pulp_href = '', 
                        prn = '', 
                        ...
                        rate_limit = 56, 
                        hidden_fields = [
                            services-pulp_file-client.models.file_file_remote_response_hidden_fields_inner.file_FileRemoteResponse_hidden_fields_inner(
                                name = '', 
                                is_set = True, )
                            ], )
                    ]
