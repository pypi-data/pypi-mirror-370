...
class AbstractGLGraphicsItem(QtCore.QObject, metaclass=meta.QABCMeta):
    ...
    def paint(self):
        if not (AbstractGLGraphicsItem.GLGraphicsItemFlag.ItemHasNoContents & AbstractGLGraphicsItem.flags(self)): 
            self._paintHelper()
            self._childPaint()
...
class _Temp(AbstractGLGraphicsItem):
    pass

class ABCGraphicsItemMeta(meta.QABCMeta):
    def __call__(cls, *args, **kwargs):
        ...
        AbstractGLGraphicsItem.__init__(self, parentItem=parentItem)
