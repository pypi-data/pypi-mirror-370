    ...
    def setParentItem(self, item: 'GL3DGraphicsItemMixin'):
        ...
        if not self.__parent is None:
            if item == self.__parent:
                ...
                self._GLGraphicsItem__parent.__removeChild(self)
