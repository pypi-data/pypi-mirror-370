...
class MainView(ABCMainViewQSplitter):
    ...
    def _initViews(self,
        ...
        for i, (title, axis) in enumerate(zip(subplot_names, MainView.__AXIS_DEPENDENCE__)):
            tick_engine = tick_engine_manager.get_engine(MainView.__AXIS_DEPENDENCE__[-i-1])
