...
class TestToolContext:
    ...
    async def test_server_with_no_tools(self):
        ...
        async with create_test_client(server) as client:
            ...
            non_report_tools = [t for t in tools_result.tools if t.name != "get_more_tools"]
    ...
    async def test_get_more_tools_exclusion_with_context(self):
        ...
        async with create_test_client(server) as client:
            ...
            get_more_tools_tool = next(t for t in tools_result.tools if t.name == "get_more_tools")
