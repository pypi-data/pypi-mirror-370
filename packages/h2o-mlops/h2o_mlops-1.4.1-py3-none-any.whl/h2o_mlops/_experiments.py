...
class MLOpsExperiments:
    ...
    def count(self) -> int:
        """Count the Experiments available in the Project."""
        return int(
    ...
    def link(self, uid: str) -> None:
        """Link an Experiment to the Project in H2O MLOps.
    ...
    def unlink(self, uid: str) -> None:
        """Unlink an Experiment from the Project in H2O MLOps.
