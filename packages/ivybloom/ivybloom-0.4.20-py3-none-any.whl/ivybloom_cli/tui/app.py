...
class IvyBloomTUI(App):
    ...
    def __init__(self, config: Config, auth_manager: AuthManager, initial_project_id: Optional[str] = None, show_header: bool = False, show_footer: bool = False) -> None:
        ...
        # Services
        self._logger = DebugLogger(enabled=bool(self.config.get("debug", False)), prefix="TUI")
        self._runner = CLIRunner(self.config, logger=self._logger)
    ...
    def action_open_palette(self) -> None:
        ...
        self.push_screen(CommandPalette(commands, logger=self._logger), self._on_palette_result)
