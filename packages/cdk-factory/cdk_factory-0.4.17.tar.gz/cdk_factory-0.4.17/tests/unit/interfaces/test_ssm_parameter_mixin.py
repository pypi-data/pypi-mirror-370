...
class TestConfig:
    ...
    def format_ssm_path(self, path, resource_type, resource_name, attribute, context=None):
...
class TestSsmParameterMixin(unittest.TestCase):
    ...
    @patch.object(SsmParameterMixin, 'export_ssm_parameters_from_config')
    def test_export_resource_to_ssm_with_resource_type_in_template(self, mock_export_ssm_parameters):
