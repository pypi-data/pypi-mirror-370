...
DEFAULTS = {
    ...
    # configs
    "SMS_PROVIDER_CONFIG_ADMIN_CLASS": "mad_notifications.admin.SMSProviderConfigAdmin",
    "FIREBASE_CONFIG_ADMIN_CLASS": "mad_notifications.admin.FirebaseConfigAdmin",
    #
    "SMS_PROVIDER_CONFIG_MODEL": "mad_notifications.SMSProviderConfig",
    "FIREBASE_CONFIG_MODEL": "mad_notifications.FirebaseConfig",
...
IMPORT_STRINGS = (
    ...
    "SMS_PROVIDER_CONFIG_ADMIN_CLASS",
    "FIREBASE_CONFIG_ADMIN_CLASS",
)
