...
BASE_URL = os.getenv("ENTITY_LINKER_BASE_URL", "http://localhost:6000")
...
class EntityLinker:
    ...
    def update_config(self, config_updates: EntityLinkingConfig) -> Dict[str, Any]:
        """
        Updates the configuration of this entity linker instance.

        Args:
            config_updates (EntityLinkingConfig): An object containing the configuration updates.
