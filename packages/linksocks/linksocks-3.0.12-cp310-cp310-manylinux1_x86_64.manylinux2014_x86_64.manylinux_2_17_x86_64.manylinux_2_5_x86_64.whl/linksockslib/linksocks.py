...
# gopy build -vm=/tmp/linksocks_pyvenv_eaygf2el/venv/bin/python -output=/project/_bindings/python/linksockslib -name=linksockslib -no-make=true -dynamic-link=true ./linksocks_go
