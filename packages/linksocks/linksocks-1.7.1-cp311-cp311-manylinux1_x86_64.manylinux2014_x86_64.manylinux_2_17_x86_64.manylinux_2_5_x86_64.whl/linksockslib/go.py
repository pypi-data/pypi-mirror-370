...
# gopy build -vm=/tmp/linksocks_pyvenv_27wnlt4x/venv/bin/python -output=/project/_bindings/python/linksockslib -name=linksockslib -no-make=true -dynamic-link=true ./linksocks_go
