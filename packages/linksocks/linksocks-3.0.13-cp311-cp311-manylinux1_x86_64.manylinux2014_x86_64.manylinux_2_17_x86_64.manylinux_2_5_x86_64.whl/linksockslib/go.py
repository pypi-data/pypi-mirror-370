...
# gopy build -vm=/tmp/linksocks_pyvenv_t6lzsy1u/venv/bin/python -output=/project/_bindings/python/linksockslib -name=linksockslib -no-make=true -dynamic-link=true ./linksocks_go
