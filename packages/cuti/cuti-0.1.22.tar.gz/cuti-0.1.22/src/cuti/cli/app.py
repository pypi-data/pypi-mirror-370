...
def container(
    ...
    rebuild: bool = typer.Option(False, "--rebuild", help="Force rebuild of container image"),
    ...
    # Handle rebuild flag
    if rebuild:
        console.print("[yellow]🔨 Rebuilding container image...[/yellow]")
        if not service.rebuild_container():
            console.print("[red]Failed to rebuild container[/red]")
            raise typer.Exit(1)
        console.print("[green]✅ Container image rebuilt successfully[/green]")
