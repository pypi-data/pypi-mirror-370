...
class EIPClient:
    ...
    def track_propagations(self,df_list: List[Union[pd.DataFrame, str]], propagation_level: int) -> pd.DataFrame:
        """
        Tracks and filters groups of data based on directional trend changes and propagation levels.

        The function processes a list of DataFrames, identifying initial trend changes
        and assigning a 'level' based on their order in the input list. 
