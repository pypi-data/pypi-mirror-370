...
class ClientResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "client_id", "client_secret", "redirect_uris", "allowed_scopes", "client_type", "grant_types", "client_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client_config": InLineClientConfig.from_dict(obj["client_config"]) if obj.get("client_config") is not None else None
        })
        return _obj
