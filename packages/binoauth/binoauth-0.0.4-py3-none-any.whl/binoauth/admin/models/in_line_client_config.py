...
class InLineClientConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["auth_methods", "link", "logo_uri", "description", "include_in_dashboard"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.include_in_dashboard is None and "include_in_dashboard" in self.model_fields_set:
