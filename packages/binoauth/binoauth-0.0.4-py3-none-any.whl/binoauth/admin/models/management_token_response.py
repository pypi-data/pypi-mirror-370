...
class ManagementTokenResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user", "access_token", "refresh_token", "access_token_type", "access_token_expires", "refresh_token_expires"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": ManagementUserResponse.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "access_token": obj.get("access_token"),
            "refresh_token": obj.get("refresh_token"),
            "access_token_type": obj.get("access_token_type") if obj.get("access_token_type") is not None else 'bearer',
            "access_token_expires": obj.get("access_token_expires") if obj.get("access_token_expires") is not None else 43200,
            "refresh_token_expires": obj.get("refresh_token_expires") if obj.get("refresh_token_expires") is not None else 2592000
        })
        return _obj
