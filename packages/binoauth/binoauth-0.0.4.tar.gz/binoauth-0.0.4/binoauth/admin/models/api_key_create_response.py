...
class ApiKeyCreateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "key_prefix", "user_id", "tenant_id", "scopes", "status", "created_at", "last_used_at", "expires_at", "usage_count", "is_active", "is_expired", "key"]
