...
class ProviderSettingsResponse(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "provider", "client_id", "client_secret", "is_enabled", "scopes", "extra_settings", "authorize_url", "token_url", "userinfo_url", "created_at", "updated_at"]
