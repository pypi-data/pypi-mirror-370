...
class Domain(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["domain", "is_primary", "is_subdomain", "is_active", "id", "tenant_id", "created_at", "verified_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_subdomain": obj.get("is_subdomain") if obj.get("is_subdomain") is not None else True,
