...
class LoginResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["access_token", "refresh_token", "requires_mfa", "token_type", "access_token_expires", "refresh_token_expires"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requires_mfa": obj.get("requires_mfa") if obj.get("requires_mfa") is not None else False,
