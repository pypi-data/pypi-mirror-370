...
class PhoneOTPRequest(BaseModel):
    ...
    PhoneOTPRequest
    """ # noqa: E501
    phone: StrictStr = Field(description="International phone number (e.g., +1234567890)")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.allowed_countries is None and "allowed_countries" in self.model_fields_set:
