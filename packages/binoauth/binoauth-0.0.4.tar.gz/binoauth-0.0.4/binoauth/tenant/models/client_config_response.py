...
class ClientConfigResponse(BaseModel):
    ...
    scope: StrictStr
    __properties: ClassVar[List[str]] = ["client_id", "auth_methods", "name", "description", "logo_uri", "authorize_endpoint", "userinfo_endpoint", "token_endpoint", "logout_endpoint", "revoke_endpoint", "scope"]
