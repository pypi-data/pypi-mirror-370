...
class TokenRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["grant_type", "code", "client_id", "client_secret", "refresh_token", "code_verifier", "scope", "username", "password", "email", "device_code", "user_code"]
