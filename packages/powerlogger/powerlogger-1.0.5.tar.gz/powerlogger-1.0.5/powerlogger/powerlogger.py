...
def get_logger(name: str = None, level: int = None, config_file: str = "log_config.ini") -> logging.Logger:
...
def get_logger_with_queue(name: str = None, level: int = None, 
                         config_file: str = "log_config.ini") -> logging.Logger:
...
def get_logger_with_queue_and_file(name: str = None, level: int = None, 
                                 log_file: str = None, config_file: str = "log_config.ini") -> logging.Logger:
