...
- **⚙️ Configuration Management**: Flexible configuration via `app_config.ini`
...
- **Configuration**: Verify `app_config.ini` is in the correct location
...
git clone https://github.com/kpandiyaraj/powerlogger.git
cd powerlogger
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/kpandiyaraj/powerlogger/blob/main/LICENSE) file for details.

## 📋 Changelog

See [CHANGELOG.md](https://github.com/kpandiyaraj/powerlogger/blob/main/CHANGELOG.md) for a detailed history of changes and features.
...
**Made with ❤️ by [Pandiyaraj Karuppasamy](https://github.com/kpandiyaraj)**
