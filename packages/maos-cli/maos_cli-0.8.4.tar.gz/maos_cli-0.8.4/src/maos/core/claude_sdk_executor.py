...
class ClaudeSDKExecutor:
    ...
    async def execute_agent(self, execution: AgentExecution) -> Dict[str, Any]:
        ...
        """
        # Use Claude Code SDK in non-interactive mode with -p flag
        cmd = [
            "claude",
        ...
        try:
            ...
            # Wait for completion with longer timeout for Claude Code startup
