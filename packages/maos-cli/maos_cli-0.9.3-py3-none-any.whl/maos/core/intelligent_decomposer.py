...
{{
  ...
  "orchestrator_prompt": "..."
            ...
            # Claude can take a long time for complex analysis, especially with large contexts
            timeout_seconds = 600  # 10 minutes - Claude needs time to think!
                ...
                while True:
                    try:
                        ...
                        if asyncio.get_event_loop().time() - start_time > timeout_seconds:
                            print(f"\n⏱️ Timeout reached ({timeout_seconds}s / {timeout_seconds//60} minutes)")
                            break
            ...
            logger.error("Claude timed out after 600 seconds")
            return self._create_fallback_decomposition(prompt)
        except Exception as e:
