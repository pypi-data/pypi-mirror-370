...
class InteractiveConfigSetup:
    ...
    def _build_config(self) -> Dict[str, Any]:
        ...
        # Configure agents with descriptions
        agent_descriptions = {
            'planner': 'Strategic planning and task breakdown',
            'developer': 'Code implementation and development',
            'tester': 'Testing and quality assurance',
            'ui_ux_expert': 'User interface and experience design',
            'db_expert': 'Database design and optimization',
            'devops_expert': 'Deployment and infrastructure'
        }
        ...
        for agent in self.agents:
            config['agents'][agent] = {
                ...
                'system_prompt': f"You are a {agent.replace('_', ' ')} agent."
            }
