...
def create_app(base_dir: str = None):
    ...
    Args:
        base_dir: Base directory for the application (for absolute path resolution)
    """
    app = FastAPI(
    ...
    if base_dir:
        ...
        # Try to determine base directory from this file's location
        base_path = Path(__file__).parent.parent
    
    # Set up paths with absolute references
    static_dir = base_path / "web_interface" / "static"
    templates_dir = base_path / "web_interface" / "templates"
