...
class DocumentORM(Base):
    ...
    details_document: Mapped["DocumentLineORM"] = relationship(back_populates="document", uselist=False, cascade="all, delete-orphan")
    details_image: Mapped["ImageLineORM"] = relationship(back_populates="document", uselist=False, cascade="all, delete-orphan")
    details_audio: Mapped["AudioLineORM"] = relationship(back_populates="document", uselist=False, cascade="all, delete-orphan", lazy="selectin")
