...
set_target_properties(pxr::pyWork PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "@rpath/_work.so"
  )
...
set_target_properties(pxr::work PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-work/lib/libPxrWork.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPxrWork.dylib"
  )

list(APPEND _cmake_import_check_targets pxr::work )
list(APPEND _cmake_import_check_files_for_pxr::work "${_IMPORT_PREFIX}/pxr-work/lib/libPxrWork.dylib" )
