...
class TabData(QMimeData):
    ...
    """
    def __init__(self, widget: QWidget, title: str, source_section: 'TabSection') -> None:
        """
        Initialise TabData with the widget, title, and source section.
        Args:
...
class DraggableTabBar(QTabBar):
    ...
    def start_drag(self) -> None:
        ...
        mime_data = TabData(widget, title, self.section)
        drag = QDrag(self)
