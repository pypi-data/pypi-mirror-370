...
class Requirements(Requirement, Enum):
    ...
    HI_003 = (
        ...
        "capabilities/hierarchy/requirements/root-prim-xformable.html",
        "OpenUSD",
        ("correctness",),
    )
    HI_006 = (
        ...
        "All prims representing objects or groups that require placement, posing or animation shall be xformable.",
    ...
    VG_028 = (
        ...
        "capabilities/geometry/requirements/normals-should-be-correct.html",
        "Core USD",
        ("correctness",),
    )
    VG_005 = (
    ...
    VG_026 = (
        ...
        "capabilities/geometry/requirements/logical-pivot-position.html",
        "Core USD",
        ("essential",),
    )
    VG_020 = (
    ...
    VG_019 = (
        ...
        "capabilities/geometry/requirements/usdgeom-mesh-zero-area.html",
        "Core USD",
        ("performance",),
    )
    VG_RTX_002 = (
    ...
    VG_027 = (
        "VG.027", 
        "normal-attribute-exists-usdgeom-mesh",
        "UsdGeomMesh (that is not utilizing subdivision) needs to have normal attributes.",
        "capabilities/geometry/requirements/normal-attribute-exists-usdgeom-mesh.html",
        "RTX",
        ("limitation",),
    )
    JT_ART_003 = (
