...
class DMPAPI:
    ...
    async def get_cluster_info(self, cluster_name: str) -> dict:
        """获取集群详细信息"""
        if not cluster_name:
    ...
    async def get_world_info(self, cluster_name: str) -> dict:
        """获取世界信息"""
        if not cluster_name:
            cluster_name = await self.get_first_available_cluster()
    ...
    async def get_room_info(self, cluster_name: str) -> dict:
        """获取房间信息"""
        if not cluster_name:
            cluster_name = await self.get_first_available_cluster()
    ...
    async def get_players(self, cluster_name: str) -> dict:
        """获取在线玩家列表"""
        if not cluster_name:
            cluster_name = await self.get_first_available_cluster()
    ...
    async def get_connection_info(self, cluster_name: str) -> dict:
        """获取服务器直连信息"""
        if not cluster_name:
            cluster_name = await self.get_first_available_cluster()
