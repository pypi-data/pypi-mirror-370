...
set_target_properties(pxr::pyTrace PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "_trace.so"
  )
...
set_target_properties(pxr::trace PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-trace/lib/libPxrTrace.so"
  IMPORTED_SONAME_RELEASE "libPxrTrace.so"
  )

list(APPEND _cmake_import_check_targets pxr::trace )
list(APPEND _cmake_import_check_files_for_pxr::trace "${_IMPORT_PREFIX}/pxr-trace/lib/libPxrTrace.so" )
