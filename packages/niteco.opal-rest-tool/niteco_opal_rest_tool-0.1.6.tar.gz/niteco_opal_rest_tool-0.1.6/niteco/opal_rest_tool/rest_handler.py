    ...
    def _prepare_request_data(self, 
        ...
        for param_name, value in parameters.items():
            ...
            if operation.method == "GET":
                ...
                if self._is_query_parameter(param_name):
                    query_params[param_name] = value
                else:
