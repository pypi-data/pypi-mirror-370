...
class LowData:
    ...
    """
    dof_positions: builtins.list[builtins.float]
    r"""
    List[float]: The DoF positions.
    
    Get the DoF positions with low-level data.
    """
    dof_velocities: builtins.list[builtins.float]
    r"""
    List[float]: The DoF velocities.
    
    Get the DoF velocities with low-level data.
    """
    debug_constraints: ConstraintDebugData
    r"""
    ConstraintDebugData: The debug constraints.
    
    Get the debug constraints with low-level data.
    """
    def set_dof_positions_unchecked(self, pos:typing.Sequence[builtins.float]) -> None:
        r"""
        Set the DoF positions with low-level data.
        
        Args:
            pos (List[float]): The DoF positions.
        """
