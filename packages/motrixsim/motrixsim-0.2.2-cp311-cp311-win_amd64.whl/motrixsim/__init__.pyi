...
class Camera:
    ...
    def get_pose(self, data:SceneData) -> numpy.typing.NDArray[numpy.float32]:
        ...
        Returns:
            NDArray[float]: A 7-element array containing the camera's position (x, y, z) and
            rotation (i, j, k, w).
        """
...
class SceneModel:
    ...
    def get_body_index(self, name:builtins.str) -> typing.Optional[builtins.int]:
        ...
        """
    def get_collider_index(self, name:builtins.str) -> typing.Optional[builtins.list[builtins.int]]:
        r"""
        ...
        Returns:
            Optional[List[int]]: Indices of the collider, or `None` if not found.
        """
