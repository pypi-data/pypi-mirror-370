...
from .predictors.vancy_network_keras import VacancyNN  # clase OOP de Keras (fit_from_json / predict_csv)

# Ruta con artefactos ya entrenados (si existen)
try:
    from .predictors.vancy_keras_predictor import ModelConfig, VacancyClassifierKeras
except Exception:
    ModelConfig = None
    VacancyClassifierKeras = None