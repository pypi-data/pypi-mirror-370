...
# --- Modelos Keras (pre-entrenado y OOP) ---
try:
    # Todo vive en vancy_network_keras.py
    from .predictors.vancy_network_keras import VacancyNN, ModelConfig, VacancyClassifierKeras
except Exception:
    # Si vfs.py no está en paquete (ejecutas como script plano), probá sin el punto
    from .predictors.vancy_network_keras import VacancyNN, ModelConfig, VacancyClassifierKeras
