...
cli_prefix = "mod__stock__"

cli.commands['run'].params.append(
    click.Option(
        ('--stock-t1/--no-stock-t1', cli_prefix + "stock_t1"),
        default=None,
        help="[stock] enable/disable stock T+1"
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        help="[stock] exclude match engine",
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        type=click.FLOAT,
        help="[stock] set commission multiplier"
    )
)
...
cli.commands['run'].params.append(
    ...
    click.Option(
        ...
        help="[Deprecated][stock] set matching type"
    )
)
