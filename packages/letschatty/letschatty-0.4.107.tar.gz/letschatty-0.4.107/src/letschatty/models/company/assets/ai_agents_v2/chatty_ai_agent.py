...
class N8NWorkspaceAgentType(StrEnum):
    ...
    @staticmethod
    def get_n8n_webhook_url(agent_type: 'N8NWorkspaceAgentType') -> str:
        return {
            N8NWorkspaceAgentType.CALENDAR_SCHEDULER: "https://n8n.letschatty.com/webhook/calendar_scheduler",
            N8NWorkspaceAgentType.TOKKO_BROKER: "https://n8n.letschatty.com/webhook/tokko_broker",
            N8NWorkspaceAgentType.DEFAULT: "https://n8n.letschatty.com/webhook/default",
        }[agent_type]
