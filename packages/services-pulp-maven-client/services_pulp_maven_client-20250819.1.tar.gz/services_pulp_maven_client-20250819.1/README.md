...
```python
import services-pulp_maven-client
```
...
import services-pulp_maven-client
from services-pulp_maven-client.rest import ApiException
...
configuration = services-pulp_maven-client.Configuration(
...
with services-pulp_maven-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = services-pulp_maven-client.ApiMavenApi(api_client)
