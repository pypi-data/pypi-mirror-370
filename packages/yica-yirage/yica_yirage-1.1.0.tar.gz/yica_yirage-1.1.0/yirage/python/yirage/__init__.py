...
try:
    ...
    Z3_AVAILABLE = False
    import warnings
    warnings.warn(f"Z3 solver not available: {e}. Advanced optimization features disabled.", UserWarning)
...
# Extended modules (profiler, visualize, analysis, export)
try:
    ...
    import warnings
    warnings.warn(f"YiRage extensions not fully available: {e}", UserWarning)
