...
class ResolvePromiseRequest(_message.Message):
    __slots__ = ('name', 'version', 'authentication', 'procedure_id', 'promise', 'offload', 'answered_questions')
    ...
    def __init__(self, name: _Optional[str]=..., version: _Optional[str]=..., authentication: _Optional[_Union[_authentication_pb2.Authentication, _Mapping]]=..., procedure_id: _Optional[str]=..., promise: _Optional[_Union[_promise_pb2.Promise, _Mapping]]=..., offload: _Optional[_Union[_offload_pb2.Offload, _Mapping]]=..., answered_questions: _Optional[_Iterable[_Union[_answered_question_pb2.AnsweredQuestion, _Mapping]]]=...) -> None:
        ...