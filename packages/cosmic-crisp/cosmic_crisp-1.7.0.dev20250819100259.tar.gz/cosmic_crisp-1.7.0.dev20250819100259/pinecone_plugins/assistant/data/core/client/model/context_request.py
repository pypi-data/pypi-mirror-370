...
class ContextRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            multi_modal (bool): Allow context snippets to contain images. If `false`, only text snippets are returned. [optional] if omitted the server will use the default value of True  # noqa: E501
            include_binary_content (bool): Include image data in snippets. If `false`, only the image caption is returned. Only available when `multi_modal=true`. [optional] if omitted the server will use the default value of True  # noqa: E501
        """
