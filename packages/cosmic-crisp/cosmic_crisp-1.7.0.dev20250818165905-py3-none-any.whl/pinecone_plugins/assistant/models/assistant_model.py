...
class AssistantModel:
    ...
    def upload_file(
        ...
        :param multi_modal: Optional flag to opt in to multi-modal file processing (PDFs only). Default is `false`.
        :type multi_modal: bool, optional
        ...
        try:
            with open(file_path, "rb") as file:
                return self._upload_file_stream(file, metadata, multi_modal, timeout)
    ...
    def upload_bytes_stream(
        ...
        return self._upload_file_stream(stream, metadata, multi_modal, timeout)
    ...
    def _upload_file_stream(
        ...
        timeout: Optional[int] = None,
            ...
            if multi_modal is not None:
                kwargs["multi_modal"] = str(multi_modal).lower()
    ...
    def chat(
        ...
        :type context_options: Optional[ContextOptions] (default None)
            ContextOptions:
                ...
                - multi_modal: bool, allow context snippets to contain images. If `false`, only text snippets are used. Default is True.
                - include_binary_content: bool, Include image data in snippets. If `false`, only the image caption is used. Only available when `multi_modal=true`. Default is True.
        ...
        - StreamChatResponseCitation
            ...
            'signed_url': 'example.com', 'multi_modal': false}, 'pages': [32]}]}}
        - StreamChatResponseMessageEnd
    ...
    def _chat_single(
        ...
        if context_options is not None:
            ...
            if context_options.multi_modal is not None:
                options["multi_modal"] = context_options.multi_modal
    ...
    def context(
        ...
        :param multi_modal: Optional bool to allow context snippets to contain images. If `false`, only text snippets are returned. Default is True.
        :type multi_modal: Optional[bool] (default None)

        :param include_binary_content: Optional bool to include image data in snippets. If `false`, only the image caption is returned. Only available when `multi_modal=true`. Default is True.
        ...
        if multi_modal is not None:
            kwargs["multi_modal"] = multi_modal
