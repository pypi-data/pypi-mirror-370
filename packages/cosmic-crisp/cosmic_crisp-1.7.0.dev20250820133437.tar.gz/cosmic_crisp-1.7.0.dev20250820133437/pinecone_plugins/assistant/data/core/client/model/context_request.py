...
class ContextRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            multi_modal (bool): Whether or not to retrieve image-related context snippets. If `false`, only text snippets are returned. [optional] if omitted the server will use the default value of True  # noqa: E501
            include_binary_content (bool): If image-related context snippets are returned, this field determines whether or not they should include base64 image data. If `false`, only the image caption is returned. Only available when `multi_modal=true`. [optional] if omitted the server will use the default value of True  # noqa: E501
        """
