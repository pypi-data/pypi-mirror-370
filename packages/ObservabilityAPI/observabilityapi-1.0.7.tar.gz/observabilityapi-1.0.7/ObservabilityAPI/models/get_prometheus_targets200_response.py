...
class GetPrometheusTargets200Response(BaseModel):
    """
    GetPrometheusTargets200Response
    """ # noqa: E501
    targets: Optional[List[GetPrometheusTargets200ResponseTargetsInner]] = None
    message: Optional[StrictStr] = Field(default=None, description="Response message")
    __properties: ClassVar[List[str]] = ["targets", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targets": [GetPrometheusTargets200ResponseTargetsInner.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None,
