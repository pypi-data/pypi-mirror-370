...
class RemovePrometheusTarget200Response(BaseModel):
    """
    RemovePrometheusTarget200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Success message")
    removed_target: Optional[StrictStr] = Field(default=None, description="Name of the removed target")
    __properties: ClassVar[List[str]] = ["message", "removed_target"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "removed_target": obj.get("removed_target")
        })
        return _obj
