...
class DeployGrafanaDashboards200Response(BaseModel):
    """
    DeployGrafanaDashboards200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Success message")
    dashboards_deployed: Optional[List[StrictStr]] = Field(default=None, description="List of deployed dashboard names")
    __properties: ClassVar[List[str]] = ["message", "dashboards_deployed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dashboards_deployed": obj.get("dashboards_deployed")
        })
        return _obj
