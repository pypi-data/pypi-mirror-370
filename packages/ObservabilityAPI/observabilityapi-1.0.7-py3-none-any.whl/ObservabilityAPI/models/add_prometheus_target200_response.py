...
class AddPrometheusTarget200Response(BaseModel):
    """
    AddPrometheusTarget200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Success message")
    target_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the added target")
    __properties: ClassVar[List[str]] = ["message", "target_id"]
