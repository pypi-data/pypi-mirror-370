...
def mesh_from_oriented_points(points: Annotated[ArrayLike, dict(dtype='float64', order='C', device='cpu')], normals: Annotated[ArrayLike, dict(dtype='float64', order='C', device='cpu')], octree_depth: int = 0, samples_per_node: float = 1.5, interpolation_weight: float = 2.0, use_normal_length_as_confidence: bool = False, use_dirichlet_boundary: bool = False, colors: Optional[Annotated[ArrayLike, dict(order='C', device='cpu')]] = None, output_vertex_depth_attribute_name: str = '', verbose: bool = False) -> lagrange.core.SurfaceMesh:
    """
