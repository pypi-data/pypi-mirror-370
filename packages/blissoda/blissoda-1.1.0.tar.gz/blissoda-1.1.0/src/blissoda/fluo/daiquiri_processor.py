...
from ..daiquiri.validators import exists_valid_json, exists_list
from ..utils import directories
from .processor import FluoProcessor, Scan
...
class DaiquiriFluoProcessor(
    ...
    def get_daiquiri_inputs(self, scan: Scan, workflow: str):
    ...
    def get_workflow_and_inputs(self, scan: Scan) -> List[dict]:
