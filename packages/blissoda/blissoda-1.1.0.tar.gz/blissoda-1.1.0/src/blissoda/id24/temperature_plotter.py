...
class Id24TemperaturePlotter(
    ...
    def get_workflow_type(self, scan: Scan) -> WorkflowType:
    ...
    def _scan_requires_workflow(self, scan: Scan) -> bool:
