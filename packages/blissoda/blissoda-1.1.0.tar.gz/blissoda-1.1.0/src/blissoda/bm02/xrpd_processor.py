...
from .utils import export_filename_prefix, get_current_filename
...
class Bm02XrpdProcessor(
    ...
    def _is_save_ascii_enabled(self, scan: Scan, lima_name: str) -> bool:
    ...
    def _get_ascii_export_inputs(self, scan: Scan, lima_name: str) -> List[dict]:
    ...
    def _is_cell_subtraction_enabled(self, scan: Scan, lima_name: str) -> bool:
        if "nbpt_azim" in self.get_integration_options(lima_name):
            logging.warning(
