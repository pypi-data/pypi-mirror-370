...
from ..xrpd.processor import XrpdProcessor, Scan, _get_scan_memory_url
...
class Id13XrpdProcessor(
    ...
    def get_external_output_filename(self, scan: Scan, lima_name: str):
    ...
    def get_neuralnetwork_inputs(self, scan: Scan, lima_name: str) -> List[dict]:
    ...
    def _set_workflow(self, scan: Scan, filename: str) -> None:
    ...
    def get_saving_info(self, scan: Scan) -> dict:
        return {
