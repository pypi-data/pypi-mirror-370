...
def _resolve_engine(
    ...
    if instance_type is not None:
        ...
        if instance_type not in ("realtime", "batch"):
            # TODO support more instance types
            raise ValueError(
                "Invalid instance type specified. Must be 'realtime' or 'batch'."
            )
...
def _create_execution_function(
    ...
    # Local job step
        ...
        elif engine == "remote" and instance_type == "batch":
...
def run(
    ...
    *,
    ...
    instance_type: Optional[Literal["realtime", "batch"]] = None,
...
def run(
    ...
    **kw_parameters,
    ...
    Args:
        ...
        instance_type: The type of instance to use for remote execution ('realtime' or 'batch').
