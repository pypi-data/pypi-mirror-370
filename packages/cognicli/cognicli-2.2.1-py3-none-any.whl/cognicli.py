            ...
            try:
                ...
                if quant_config:
                    if quant_config.get("load_in_4bit"):
                        ...
                        model_kwargs["bnb_4bit_compute_dtype"] = quant_config.get("bnb_4bit_compute_dtype", torch.float16)
                        model_kwargs["bnb_4bit_use_double_quant"] = quant_config.get("bnb_4bit_use_double_quant", True)
                        model_kwargs["bnb_4bit_quant_type"] = quant_config.get("bnb_4bit_quant_type", "nf4")
