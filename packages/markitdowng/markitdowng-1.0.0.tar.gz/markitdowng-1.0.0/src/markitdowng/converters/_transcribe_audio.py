...
def transcribe_audio(file_stream: BinaryIO, *, audio_format: str = "wav") -> str:
    ...
    if _dependency_exc_info is not None:
        raise MissingDependencyException(
            "Speech transcription requires installing MarkItdown with the [audio-transcription] optional dependencies. E.g., `pip install markitdowng[audio-transcription]` or `pip install markitdowng[all]`"
