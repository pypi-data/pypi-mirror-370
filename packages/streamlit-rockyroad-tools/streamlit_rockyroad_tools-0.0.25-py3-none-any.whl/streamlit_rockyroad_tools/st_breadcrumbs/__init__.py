...
# Add this for testing the component in isolation
if not _RELEASE:
    import streamlit as st
    
    st.title("Breadcrumbs Component Test")
    ...
    if clicked:
        st.write(f"You clicked on: {clicked}")
    else:
        st.write("Click on a breadcrumb link above")
