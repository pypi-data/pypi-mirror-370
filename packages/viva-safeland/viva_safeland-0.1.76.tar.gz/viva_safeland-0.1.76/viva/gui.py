...
class GUI:
    def __init__(self):
        ...
        # Set the theme
        self.root.tk.call('source', "viva/GUI/forest-dark.tcl")
        style = ttk.Style()
    ...
    def _setup_logo(self, parent):
        ...
        image = Image.open("docs/assets/viva_logo.png")
    ...
    def load_mp4_videos(self):
        ...
        for ext in video_extensions:
            ...
            video_files.extend(glob(os.path.join(directory, ext.upper())))
    ...
    def _start_simulation(self):
        ...
        try:
            ...
            # Don't capture stdout/stderr so FPS and other output goes directly to terminal
            self.current_process = subprocess.Popen(cmd)
            
            # Disable all UI except stop button
            self._disable_ui()
