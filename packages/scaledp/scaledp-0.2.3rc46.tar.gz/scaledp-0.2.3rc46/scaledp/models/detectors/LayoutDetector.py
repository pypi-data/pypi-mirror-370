...
from scaledp.params import HasBatchSize, HasDevice, HasWhiteList, HasModel
...
class LayoutDetector(BaseDetector, HasDevice, HasBatchSize, HasWhiteList, HasModel):
    ...
    def get_model(cls, params):
        ...
        logging.info(f"PaddleOCR LayoutDetection model '{model_name}' loaded successfully")
        return cls._model
    ...
    def call_detector(cls, images, params):
        ...
        layout_types = params.get("whiteList", ["text", "title", "list", "table", "figure"])
        ...
        for image, image_path in images:
            ...
            # # Convert RGB to BGR for OpenCV (PaddleOCR expects BGR)
            ...
            try:
                ...
                logging.warning(f"Error in layout detection for {image_path}: {str(e)}")
