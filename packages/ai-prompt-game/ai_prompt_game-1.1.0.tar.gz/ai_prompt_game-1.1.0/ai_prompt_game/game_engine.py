...
class PromptGame:
    ...
    def __init__(self, model_type="pollinations", verbose=False, visual_mode=True):
    ...
    def make_attempt(self, prompt):
        ...
        try:
            ...
            if generated_image is None:
                ...
                print("💡 This might be a network issue. Try again or check your internet connection.")
                return None
            ...
            if "Failed to resolve" in str(e) or "nodename nor servname" in str(e):
                ...
                print("💡 Or try: curl -I https://image.pollinations.ai")
            return None
    ...
    def display_target_image(self):
        ...
        # Method 1: Try matplotlib display first
            ...
            try:
                ...
                try:
                    ...
                    if hasattr(fig_manager, 'window'):
                        if hasattr(fig_manager.window, 'wm_attributes'):
                            fig_manager.window.wm_attributes('-topmost', 1)
                            fig_manager.window.wm_attributes('-topmost', 0)
                        elif hasattr(fig_manager.window, 'raise_'):
                ...
                print("🖼️  Target image displayed in popup window!")
                return
            except Exception as e:
                if self.verbose:
                    print(f"⚠️  Matplotlib display failed: {e}")
        
        # Method 2: Fallback to system viewer
        try:
            import subprocess
            import platform
