...
UTCDateTime = Annotated[
    datetime,
    AfterValidator(lambda x: x.replace(tzinfo=UTC)),
    PlainSerializer(_serialize_utc_timestamp, when_used="json"),
]
PosixPath = Annotated[Path, PlainSerializer(lambda x: x.as_posix())]
