...
FilesystemName = "filesystem_agentbox.Filesystem"
    ...
    def __init__(
        ...
        **opts,
        ...
        self._stat = connect.Client(
            ...
            url=f"{base_url}/{FilesystemName}/AgentBoxStat",
        ...
        self._make_dir = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxMakeDir",
        ...
        self._move = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxMove",
        ...
        self._list_dir = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxListDir",
        ...
        self._remove = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxRemove",
        ...
        self._watch_dir = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxWatchDir",
        ...
        self._create_watcher = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxCreateWatcher",
        ...
        self._get_watcher_events = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxGetWatcherEvents",
        ...
        self._remove_watcher = connect.Client(
            pool=pool,
            async_pool=async_pool,
            url=f"{base_url}/{FilesystemName}/AgentBoxRemoveWatcher",
