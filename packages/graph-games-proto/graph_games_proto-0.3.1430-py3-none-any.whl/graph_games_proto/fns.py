...
class EdgeTuple2Uuid(PClass):
    tuple2uuid = field(type=dict)  # Dict[Tuple[int, int], str]
    def __todict__(self):
        serial_list = [
            {"key": list(key), "value": value}
            for key, value in self.tuple2uuid.items()
        ]
        return {
            "tuple2uuid": serial_list,
        }
    @staticmethod
    def __fromdict__(d):
        tuple2uuid = {tuple(item["key"]): item["value"] for item in d["tuple2uuid"]}
        return EdgeTuple2Uuid(tuple2uuid=tuple2uuid)
...
class State(PClass):
    ...
    edgetuple2uuid = field(type=EdgeTuple2Uuid)
    ...
    def __todict__(self):
        return {
            ...
            "edgetuple2uuid": self.edgetuple2uuid.__todict__(),
    ...
    def __fromdict__(d):
        return State(
            ...
            edgetuple2uuid=EdgeTuple2Uuid.__fromdict__(d["edgetuple2uuid"]),
