...
from dlt_plus.transformations2.typing import TTransformationFunParams
from dlt_plus.transformations2.exceptions import (
...
from dlt_plus.transformations2.configuration import TransformationConfiguration
...
def make_transformation_resource(
    ...
    def transformation_function(*args: Any, **kwargs: Any) -> Iterator[TDataItems]:
        ...
        # Determine whether to materialize the model or return it to
        # be executed as sql in the load stage
