...
class BookGenerator:
    ...
    def generate_book(self,
        ...
        try:
            ...
            self.logger.info("📤 Calling PDF generator with skip_optimization=True")
    ...
    def _combine_files(self, files: List[Path]) -> str:
        ...
        self.logger.info("📚 Processing files with individual Typst optimization...")
            ...
            try:
                ...
                if self.content_optimizer:
                    try:
                        ...
                        self.logger.debug(f"✅ Typst optimization applied to {file_path.name}")
                    except Exception as e:
