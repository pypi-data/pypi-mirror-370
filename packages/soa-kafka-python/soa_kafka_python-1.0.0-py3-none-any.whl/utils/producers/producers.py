...
from src.utils.common_utils import _log, config_loader, delivery_callback
from src.utils.schema_registry_utils import SchemaRegistryHTTPClient
from src.utils.serialization_utils import AvroSerializer
...
class BaseProducer:
    ...
    def __init__(self, producer_id: str):
        ...
        self.bootstrap_servers = self.connection['kafka']['bootstrap_servers']
        self.schema_registry_url = self.connection['kafka']['schema_registry_url']
