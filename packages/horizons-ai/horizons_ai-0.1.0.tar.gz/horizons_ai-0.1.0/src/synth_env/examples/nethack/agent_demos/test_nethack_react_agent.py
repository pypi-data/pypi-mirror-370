    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        if config_path and os.path.exists(config_path):
            try:
                ...
                self.save_detailed_results = out_cfg.get("save_detailed_results", self.save_detailed_results)
...
async def main():
    ...
    try:
        ...
        print(f"\n📋 MARKDOWN TABLE ROW:")
        print("| Model            | Episodes | Mean Eval | Mean Balrog | Mean Relevant Rubric | Mean Relevant Shaped | Non-Zero Progress | Non-Zero Rubric | Assessment |")
        print("|------------------|----------|-----------|-------------|----------------------|----------------------|-------------------|-----------------|------------|")
        ...
        non_zero_rubric = sum(1 for key, value in rubric_results.items() 
        ...
        print(f"| {MODEL_NAME:<16} | {results['num_episodes']:>8} | {eval_metric:>9.3f} | {balrog_score:>11.3f} | {relevant_rubric_sum:>20.3f} | {relevant_shaped_sum:>20.3f} | {non_zero_progress:>17} | {non_zero_rubric:>15} | {assessment:<10} |")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run NetHack ReAct Agent Evaluation (TOML configurable)")
