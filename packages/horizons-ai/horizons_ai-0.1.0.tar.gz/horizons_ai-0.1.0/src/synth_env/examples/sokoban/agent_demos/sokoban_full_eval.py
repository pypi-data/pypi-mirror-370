...
class SokobanEvalFramework:
    ...
    async def run_evaluation(
        ...
        for model_name in model_names:
            ...
            for difficulty in difficulties:
                ...
                if condition_results:
                    ...
                    print(f"    {difficulty}: {success_rate:.1%} success, {avg_reward:.1f} reward, {avg_steps:.1f} steps, {avg_boxes:.1f} boxes")
        ...
        print(f"\n📋 MARKDOWN TABLE ROW:")
        print("| Model            | Episodes | Success Rate | Mean Reward | Mean Steps | Mean Boxes | Assessment |")
        print("|------------------|----------|--------------|-------------|------------|------------|------------|")
        ...
        print(f"| {main_model:<16} | {len(all_results):>8} | {overall_success_rate:>12.3f} | {overall_reward:>11.2f} | {mean_steps:>10.1f} | {mean_boxes:>10.1f} | {assessment:<10} |")
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        if config_path and os.path.exists(config_path):
            try:
                ...
                self.save_detailed_results = o.get("save_detailed_results", self.save_detailed_results)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--difficulty", "-d", type=str, help="Difficulty (single or comma-separated list)")
