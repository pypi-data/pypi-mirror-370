...
"""
    ...
    def __authenticate_in_microsoft_graph(self, secret_name:str) -> str:
        secret_info = self.get_secret(secret_name)
        tenant_id = secret_info.get("tenant_id")
        client_id = secret_info.get("client_id")
        client_secret = secret_info.get("client_secret")
    ...
    def __read_data_from_sharepoint(self, kwargs:dict, print_level=1) -> DataFrame:
        ...
        token = self.__authenticate_in_microsoft_graph(secret_name)
