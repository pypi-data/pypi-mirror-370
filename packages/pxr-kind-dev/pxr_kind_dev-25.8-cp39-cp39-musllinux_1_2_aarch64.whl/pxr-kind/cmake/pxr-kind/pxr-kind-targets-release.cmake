...
set_target_properties(pxr::pyKind PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "_kind.so"
  )
...
set_target_properties(pxr::kind PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-kind/lib/libPxrKind.so"
  IMPORTED_SONAME_RELEASE "libPxrKind.so"
  )

list(APPEND _cmake_import_check_targets pxr::kind )
list(APPEND _cmake_import_check_files_for_pxr::kind "${_IMPORT_PREFIX}/pxr-kind/lib/libPxrKind.so" )
