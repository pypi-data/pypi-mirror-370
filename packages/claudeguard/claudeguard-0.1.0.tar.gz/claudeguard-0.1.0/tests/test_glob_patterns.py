...
class TestGlobWildcards:
    ...
    def test_single_wildcard_matches_any_filename(
    ...
    def test_extension_wildcard_matches_specific_extension(
        self, pattern_matcher: PatternMatcher
    ):
    ...
    def test_extension_wildcard_no_match_different_extension(
        self, pattern_matcher: PatternMatcher
    ):
    ...
    def test_directory_wildcard_no_match_different_directory(
        self, pattern_matcher: PatternMatcher
    ):
    ...
    def test_complex_glob_pattern_matches_correctly(
        self, pattern_matcher: PatternMatcher
    ):
...
class TestPatternSpecificity:
    ...
    def test_more_specific_patterns_should_be_ordered_before_general(
        ...
        for pattern_str in specific_patterns:
            ...
            result = pattern_matcher.match_pattern(pattern, tool_call)
            assert result.matched is True, (
                f"Pattern {pattern_str} should match src/config.py"
            )
