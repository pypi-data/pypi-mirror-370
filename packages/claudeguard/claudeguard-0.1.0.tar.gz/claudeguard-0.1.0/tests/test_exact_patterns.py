...
class TestBasicExactMatching:
    ...
    def test_exact_edit_pattern_no_match_different_file(
    ...
    def test_exact_bash_command_no_match_different_command(
        self, pattern_matcher: PatternMatcher
    ):
...
class TestMCPExactMatching:
    ...
    def test_exact_mcp_pattern_with_resource_match(
        self, pattern_matcher: PatternMatcher
    ):
        """mcp__database__query_table(users) should match with resource extraction."""
        pattern = make_tool_pattern(
            pattern="mcp__database__query_table(users)", action="allow"
        )
        tool_call = make_mcp_tool_call(
    ...
    def test_exact_mcp_pattern_no_match_different_server(
        self, pattern_matcher: PatternMatcher
    ):
        ...
        tool_call = make_mcp_tool_call(
            mcp_server="database", tool_name="browser_console_messages"
        )
    ...
    def test_exact_mcp_pattern_no_match_different_tool(
        self, pattern_matcher: PatternMatcher
    ):
        ...
        tool_call = make_mcp_tool_call(
            mcp_server="playwright", tool_name="page_screenshot"
        )
    ...
    def test_exact_mcp_pattern_no_match_non_mcp_tool(
        self, pattern_matcher: PatternMatcher
    ):
...
class TestCaseSensitivity:
    ...
    def test_case_sensitive_pattern_matching(
        ...
        capitalized_pattern = make_tool_pattern(
            pattern="Edit(src/Main.py)", action="allow"
        )
    ...
    def test_case_sensitive_tool_name_matching(
        ...
        lowercase_tool_pattern = make_tool_pattern(
            pattern="edit(src/main.py)", action="allow"
        )
        capitalized_tool_call = make_edit_tool_call(file_path="src/main.py")

        result = pattern_matcher.match_pattern(
            lowercase_tool_pattern, capitalized_tool_call
        )
...
class TestNoResourcePatterns:
    ...
    def test_bare_tool_name_matches_empty_resource(
        self, pattern_matcher: PatternMatcher
    ):
    ...
    def test_bare_bash_matches_any_command(
        self, pattern_matcher: PatternMatcher
    ) -> None:
    ...
    def test_bare_tool_name_no_match_different_tool(
        self, pattern_matcher: PatternMatcher
    ):
    ...
    def test_bare_tool_name_case_sensitive(
        self, pattern_matcher: PatternMatcher
    ) -> None:
