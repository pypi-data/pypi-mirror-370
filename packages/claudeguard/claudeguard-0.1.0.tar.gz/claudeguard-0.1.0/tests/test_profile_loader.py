...
class TestHomeDirectoryFallback:
    ...
    def test_falls_back_to_home_directory_when_no_project_profile(
        self, temp_dir
    ) -> None:
        ...
        with patch("pathlib.Path.cwd", return_value=project_dir):
            with patch("pathlib.Path.home", return_value=home_dir):
                loader = ProfileLoader(
                    project_root=project_dir, home_directory=home_dir
                )
                profile = loader.load_profile()
...
class TestProfileLoaderErrorHandling:
    ...
    def test_raises_profile_load_error_for_missing_required_fields(
        self, project_dir
    ) -> None:
    ...
    def test_raises_profile_load_error_for_invalid_rule_structure(
        self, project_dir
    ) -> None:
    ...
    def test_raises_profile_load_error_for_invalid_action_values(
        self, project_dir
    ) -> None:
