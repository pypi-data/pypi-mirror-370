...
class TestclaudeguardSetupValidation:
    ...
    def test_validate_nonexistent_claudeguard_dir_exits_with_error(
    ...
    def test_validate_missing_profiles_dir_exits_with_error(
        self, tmp_path, capsys
    ) -> None:
        """
...
class TestProfilePathValidation:
    ...
    def test_validate_path_traversal_attempt_exits_with_error(
        self, tmp_path, capsys
    ) -> None:
        """
    ...
    def test_validate_symlink_traversal_attempt_exits_with_error(
        self, tmp_path, capsys
    ) -> None:
        """
...
class TestTemplateDataLoading:
    ...
    def test_load_nonexistent_custom_template_exits_with_error(
        self, tmp_path, capsys
    ) -> None:
        """
    ...
    def test_load_template_with_os_error_exits_with_error(
        self, tmp_path, capsys
    ) -> None:
        """
