...
set_target_properties(pxr::pyTs PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "@rpath/_ts.so"
  )
...
set_target_properties(pxr::ts PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-ts/lib/libPxrTs.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPxrTs.dylib"
  )

list(APPEND _cmake_import_check_targets pxr::ts )
list(APPEND _cmake_import_check_files_for_pxr::ts "${_IMPORT_PREFIX}/pxr-ts/lib/libPxrTs.dylib" )
