...
from pii_detection.schema.detect_anonymize_pii import AnonymizedPromptResponse
from pii_detection.services.detect_pii_gliner import create_pii_array_with_custom_keywords, extract_pii_elements, get_fict_pii
from pii_detection.utils.constants import ANONYMIZED_FILE_PATH, CSV_FILE, PDF_DOCX_FILE, TXT_FILE
...
async def get_pii_from_user_prompt_gliner(
    ...
    try:
        ...
        # )
        detected_pii_in_prompt = extract_pii_elements(prompt, pii_entities, preserve_keywords=preserve_keywords)
