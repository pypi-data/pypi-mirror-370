...
from watchgate.protocol.validation import MessageValidator, ValidationError
from watchgate.protocol.messages import MCPRequest, MCPResponse, MCPNotification, SenderContext, MessageSender
...
class TestMessageValidator:
    ...
    def test_validate_request_invalid_id_type(self):
        ...
        with pytest.raises(ValidationError, match="Request ID must be a string or integer"):
            self.validator.validate_request(invalid_data)
    ...
    def test_validate_response_with_both_result_and_error(self):
        ...
        with pytest.raises(ValidationError, match="Response must have exactly one of 'result' or 'error'"):
            self.validator.validate_response(invalid_data)
    ...
    def test_result_response_with_null_id_fails(self):
        ...
        with pytest.raises(ValidationError, match="Result response must have non-null id"):
            self.validator.validate_response(invalid_data)
    ...
    def test_error_response_non_parse_with_null_id_fails(self):
        ...
        with pytest.raises(ValidationError, match="Null id only permitted for parse error"):
            self.validator.validate_response(invalid_data)
    ...
    def test_create_error_response(self):
        ...
        from watchgate.protocol.errors import create_error_response
...
class TestMessageValidationEdgeCases:
    ...
    def test_method_with_leading_whitespace_fails(self):
        ...
        with pytest.raises(ValidationError, match="Method name cannot start or end with whitespace"):
            self.validator.validate_request(invalid_data)
...
class TestNewBehaviors:
    ...
    def setup_method(self):
        ...
        from watchgate.protocol.validation import MessageValidator
        self.validator = MessageValidator()
    ...
    def test_null_id_with_method_not_found_fails(self):
        ...
        from watchgate.protocol.errors import MCPErrorCodes
        from watchgate.protocol.validation import ValidationError
        ...
        with pytest.raises(ValidationError, match="Null id only permitted for parse error or invalid request"):
    ...
    def test_non_serializable_metadata_raises_json_error(self):
        ...
        from watchgate.protocol.validation import ValidationError, ValidationErrorType
        import datetime
    ...
    def test_validation_limits_override(self):
        ...
        from watchgate.protocol.validation import ValidationLimits, ValidationError, ValidationErrorType
        
        # Create validator with tiny size limit (need to set both limits consistently)
        tiny_limits = ValidationLimits(max_message_size=1000, max_batch_element_size=500)
    ...
    def test_sender_context_normalization_in_from_dict(self):
        ...
        from watchgate.protocol.messages import MCPRequest, SenderContext, MessageSender
