...
"""
import pytest
from watchgate.protocol.messages import MessageSender, SenderContext
...
class TestSenderContext:
    ...
    def test_sender_context_creation_full(self):
        ...
        metadata = {"version": "1.0", "capabilities": ["tools"], "connection_id": "conn-789", "session_id": "session-abc"}
        context = SenderContext(
            sender=MessageSender.SERVER,
            identifier="mcp-server-456",
            metadata=metadata
        )
