"""Minimal notification-capable mock for testing Watchgate notification handling.
...
from watchgate.protocol.messages import MCPNotification, MCPRequest, MCPResponse
...
class NotificationCapableMock:
    ...
    allowing tests to verify Watchgate's notification processing logic
    ...
    def __init__(self, 
        ...
        self.transport = MockTransport(
            response_delay=notification_delay,
    ...
    async def start_periodic_notifications(self,
                                         method: str,
                                         interval: float = 1.0,
    ...
    async def simulate_progress_notifications(self,
                                            operation_id: str,
                                            steps: int = 10,
    ...
    async def simulate_resource_change_notifications(self,
                                                   resource_type: str = "tools") -> None:
    ...
    async def simulate_bidirectional_flow(self,
                                        client_to_server_count: int = 5,
                                        server_to_client_count: int = 5) -> None:
    ...
    async def wait_for_notifications(self, count: int, timeout: float = 5.0) -> List[MCPNotification]:
    ...
    async def simulate_error_notification(self, 
                                        error_type: str = "connection_lost",
                                        after_count: int = 5) -> None:
    ...
    async def simulate_burst_notifications(self,
                                         burst_size: int = 10,
                                         burst_count: int = 3,
    ...
    async def simulate_notification_with_delays(self,
                                              notifications: List[Tuple[MCPNotification, float]]) -> None:
    ...
    async def simulate_mixed_message_flow(self,
        ...
        messages.append(NotificationScenarios.log_message_notification("info", "Mixed flow test"))
    ...
    def get_notification_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "sent_method_counts": {
                method: sent_methods.count(method) 
                for method in set(sent_methods)
            },
...
class NotificationScenarios:
    ...
    @staticmethod
    def cancelled_notification(request_id: str, reason: str = "User cancelled") -> MCPNotification:
    ...
    @staticmethod
    def error_notification(error: str, details: Optional[Dict[str, Any]] = None) -> MCPNotification:
