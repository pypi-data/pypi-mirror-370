...
from watchgate.config.models import UpstreamConfig, ProxyConfig, TimeoutConfig, PluginsConfig, LoggingConfig
    ...
    async def test_request_behavior_during_server_failure(self):
        ...
        try:
            ...
            with pytest.raises(Exception) as exc_info:
                await proxy._route_request(request)
            ...
            assert "unavailable" in error_msg or "unknown" in error_msg or "no server" in error_msg
    ...
    async def test_concurrent_requests_to_failed_server(self):
        ...
        try:
            ...
            for i in range(5):
                ...
                requests.append(proxy._route_request(request))
            ...
            # Should fail quickly
            assert elapsed < 1.0, f"Concurrent requests should fail quickly, took {elapsed}s"
    ...
    async def test_concurrent_reconnection_attempts(self):
        ...
        try:
            ...
            for result in results:
                ...
                assert isinstance(result, bool), f"Expected boolean result, got {type(result)}: {result}"
...
''')
        ...
        try:
            ...
            assert len(unique_statuses) == 1, f"Inconsistent statuses: {unique_statuses}"
