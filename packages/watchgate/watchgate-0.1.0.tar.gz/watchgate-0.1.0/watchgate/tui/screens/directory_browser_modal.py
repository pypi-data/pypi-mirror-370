...
class DirectoryBrowserModal(ModalScreen[Optional[Path]]):
    ...
    def __init__(self, start_directory: Path):
        ...
        self.selected_directory: Optional[Path] = start_directory  # Pre-select the starting directory
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(classes="dialog"):
            ...
            with Container(classes="path-input-section"):
                yield Static("Type path directly or select from tree below:", classes="path-input-label")
                ...
                yield Static("💡 Use Tab to accept autocomplete or move to tree", classes="help-text")
    ...
    def _handle_select_action(self) -> None:
        ...
        if self.selected_directory and self.selected_directory.exists() and self.selected_directory.is_dir():
