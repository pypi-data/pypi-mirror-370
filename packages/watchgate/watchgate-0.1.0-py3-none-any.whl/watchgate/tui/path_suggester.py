            ...
            try:
                ...
                if prefix:
                    if self.case_sensitive:
                        matching_dirs = [d for d in directories if d.name.startswith(prefix)]
                    else:
                        prefix_lower = prefix.lower()
                        matching_dirs = [d for d in directories if d.name.lower().startswith(prefix_lower)]
                else:
...
class PathInput(Input):
    ...
    BINDINGS = [
        ...
        Binding("shift+left", "cursor_left(True)", "Move cursor left and select", show=False),
        Binding("ctrl+left", "cursor_left_word", "Move cursor left a word", show=False),
        Binding("ctrl+shift+left", "cursor_left_word(True)", "Move cursor left a word and select", show=False),
        Binding("right", "cursor_right", "Move cursor right or accept completion", show=False),
        Binding("shift+right", "cursor_right(True)", "Move cursor right and select", show=False),
        Binding("ctrl+right", "cursor_right_word", "Move cursor right a word", show=False),
        Binding("ctrl+shift+right", "cursor_right_word(True)", "Move cursor right a word and select", show=False),
