"""Security plugins for Watchgate MCP gateway.

This package contains security policy plugins that evaluate incoming MCP
...
def create_plugin_metadata(plugin_instance, reason_code=REASON_NONE, **additional_metadata):
...
from .prompt_injection import BasicPromptInjectionDefensePlugin
from .tool_allowlist import ToolAllowlistPlugin
from .pii import BasicPIIFilterPlugin
from .secrets import BasicSecretsFilterPlugin
