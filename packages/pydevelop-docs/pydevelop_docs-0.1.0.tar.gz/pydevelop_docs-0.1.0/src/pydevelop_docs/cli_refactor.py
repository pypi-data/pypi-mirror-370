...
Generated by pydevelop-docs init using shared configuration.
"""
...
# -- Load configuration from pydevelop_docs.config --------------------------
...
This configuration includes all extensions from PyDevelop-Docs (43+ extensions).
Generated by pydevelop-docs init with inline configuration.
"""
...
# -- Configuration from pydevelop_docs.config (inlined) ---------------------
'''
    ]
