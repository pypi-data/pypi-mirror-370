...
from .application_building_utils import IMPORTS
from .app_synchronizer import Synchronizer


class DataSet:

    def __init__(self, kawa, name: str, application, generator: Callable = None, datasource_id=None):
        self._k = kawa
        self._name = name
    ...
    class _SheetSynchronizer(Synchronizer):
        ...
        @override
        def _build_new_state(self):
            sheet_state = self._state['sheet']
            return sheet_state if sheet_state else self._new_sheet
