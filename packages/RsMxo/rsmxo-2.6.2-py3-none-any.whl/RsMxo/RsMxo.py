...
class RsMxo:
	...
	_driver_options = "SupportedInstrModels = MXO, SupportedIdnPatterns = MXO, SimulationIdnString = 'Rohde&Schwarz,MXO,100001,2.6.2.0059'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '2.6.2.0059'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '2.6.2.0059'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsMxo version failed. Current version: '2.6.2.0059', minimum required version: '{min_version}'")
