...
def help_menu():
    ...
    def return_to_menu():
        ...
        choice = input("Return to the menu? (y): ")
    ...
    def help_main():
        ...
        while True:
            ...
            print("5. Revultra                  11. Enumeration Menu")
            print("6. CDN Finder                12. Update Menu")
            print("13. URLSCAN.IO               14. DR ACCESS")
            print("15. Free Proxies             16. STAT")
            print("17. TLS Checker              18. Web Crawler")
            print("19. Hacker Target            20. User Redirect")
            print("21. Dossier                  22. ASN2")
            print("23. Websocket Scanner        24. NSLOOKUP")
            print("25. Dork Scanner             26. TCP/UDP Scan")
            print("27. DNS KEY                  28. TCP SSL")
            print("29. Open Port Checker        30. Access Control")
            print("31. Casper                   32. Subdomain Enum")
            print("33. Host Checker")
