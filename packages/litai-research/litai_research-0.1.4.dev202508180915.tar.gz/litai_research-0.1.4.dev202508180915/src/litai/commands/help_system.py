    ...
    def _init_context_commands(self):
        ...
        self.register("cadd", CommandHelp("cadd", "Context Add Command Help")
            ...
            .description(
                ...
                "Can add all papers, individual papers, or papers with a specific tag.",
            )
            .argument("(empty)", "Add all papers from collection as abstracts")
            ...
            .argument("context_type", "Type of content to add (default: full-text for single, abstract for bulk/tag)")
            ...
            .example("/cadd", "Add all papers from collection as abstracts")
