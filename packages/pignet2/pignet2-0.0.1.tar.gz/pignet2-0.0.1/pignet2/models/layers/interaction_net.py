...
from torch_geometric.nn import aggr as aggregation, Linear, MessagePassing
...
class InteractionNet(MessagePassing):
    def __init__(
        ...
        **kwargs
        ...
        self.aggr = aggr
        self.aggr_module = aggregation.MaxAggregation() if aggr == "max" else aggregation.SumAggregation()
