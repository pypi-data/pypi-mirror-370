...
class TestTransform:
    ...
    @pytest.mark.skip(reason="Greedy permutation not implemented yet")
...
class TestParams:
    ...
    @pytest.mark.skip(reason="Sparse distance matrices not implemented yet")
    ...
    @pytest.mark.skip(reason="Cocycles and greedy permutation not implemented yet")
