...
setup(
    ...
    description="Advanced AI agent framework with custom instructions, slash commands, Claude Code-style CLI, multi-agent orchestration, 36+ tools, and enterprise security",
