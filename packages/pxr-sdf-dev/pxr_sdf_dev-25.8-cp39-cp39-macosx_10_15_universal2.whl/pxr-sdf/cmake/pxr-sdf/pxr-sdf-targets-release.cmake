...
set_target_properties(pxr::pySdf PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "@rpath/_sdf.so"
  )
...
set_target_properties(pxr::sdf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-sdf/lib/libPxrSdf.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPxrSdf.dylib"
  )

list(APPEND _cmake_import_check_targets pxr::sdf )
list(APPEND _cmake_import_check_files_for_pxr::sdf "${_IMPORT_PREFIX}/pxr-sdf/lib/libPxrSdf.dylib" )
