...
class ImageProcessor:
    """
        ...
        Пример:
            ...
            hsv = proc.convert_bgr_to_hsv(img)                     # выполнится на GPU (если доступно)
    ...
    def bgr_to_rgb(self, image: CvImage, device: str | ComputeDevice | None = None) -> CvImage:
        ...
        return color.convert_bgr_to_rgb(image,
