...
class DataLabCompute15(
    RootModel[Union[DataLabCompute, DataLabCompute17, DataLabCompute18]]
):
    root: Union[DataLabCompute, DataLabCompute17, DataLabCompute18]


class DataLabComputeOrUnknown(RootModel[Optional[DataLabCompute15]]):
    root: Optional[DataLabCompute15]
