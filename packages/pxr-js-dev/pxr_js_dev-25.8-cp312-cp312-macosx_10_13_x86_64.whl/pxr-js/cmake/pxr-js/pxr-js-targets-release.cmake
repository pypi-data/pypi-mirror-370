...
set_target_properties(pxr::js PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/pxr-js/lib/libPxrJs.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libPxrJs.dylib"
  )

list(APPEND _cmake_import_check_targets pxr::js )
list(APPEND _cmake_import_check_files_for_pxr::js "${_IMPORT_PREFIX}/pxr-js/lib/libPxrJs.dylib" )
